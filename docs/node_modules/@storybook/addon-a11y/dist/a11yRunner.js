      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _input$element = input.element, element = _input$element === void 0 ? getElement() : _input$element, config = input.config, _input$options = input.options, options = _input$options === void 0 ? {
              restoreScroll: true
            } : _input$options;
