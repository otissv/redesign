import React, { FC } from 'react';
    ...
    export const AccessPointNetworkIcon: FC<IconInterface> = function AccessPointNetworkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccessPointNetworkIcon ${className}`;
      return (
        <Icon alt="AccessPointNetwork" className={classNames} {...propsRest}>
