import React, { FC } from 'react';
    ...
    export const AccessPointNetworkOffIcon: FC<IconInterface> = function AccessPointNetworkOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccessPointNetworkOffIcon ${className}`;
      return (
        <Icon alt="AccessPointNetworkOff" className={classNames} {...propsRest}>
