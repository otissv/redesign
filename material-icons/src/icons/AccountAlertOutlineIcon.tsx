import React, { FC } from 'react';
    ...
    export const AccountAlertOutlineIcon: FC<IconInterface> = function AccountAlertOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountAlertOutlineIcon ${className}`;
      return (
        <Icon alt="AccountAlertOutline" className={classNames} {...propsRest}>
