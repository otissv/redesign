import React, { FC } from 'react';
    ...
    export const AccountArrowRightOutlineIcon: FC<IconInterface> = function AccountArrowRightOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountArrowRightOutlineIcon ${className}`;
      return (
        <Icon alt="AccountArrowRightOutline" className={classNames} {...propsRest}>
    ...
    AccountArrowRightOutlineIcon.displayName = 'AccountArrowRightOutlineIcon';
