import React, { FC } from 'react';
    ...
    export const AccountBoxIcon: FC<IconInterface> = function AccountBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountBoxIcon ${className}`;
      return (
        <Icon alt="AccountBox" className={classNames} {...propsRest}>
