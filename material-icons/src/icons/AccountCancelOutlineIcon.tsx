import React, { FC } from 'react';
    ...
    export const AccountCancelOutlineIcon: FC<IconInterface> = function AccountCancelOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountCancelOutlineIcon ${className}`;
      return (
        <Icon alt="AccountCancelOutline" className={classNames} {...propsRest}>
    ...
    AccountCancelOutlineIcon.displayName = 'AccountCancelOutlineIcon';
