import React, { FC } from 'react';
    ...
    export const AccountCashOutlineIcon: FC<IconInterface> = function AccountCashOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountCashOutlineIcon ${className}`;
      return (
        <Icon alt="AccountCashOutline" className={classNames} {...propsRest}>
    ...
    AccountCashOutlineIcon.displayName = 'AccountCashOutlineIcon';
