import React, { FC } from 'react';
    ...
    export const AccountCheckOutlineIcon: FC<IconInterface> = function AccountCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountCheckOutlineIcon ${className}`;
      return (
        <Icon alt="AccountCheckOutline" className={classNames} {...propsRest}>
