import React, { FC } from 'react';
    ...
    export const AccountChildCircleIcon: FC<IconInterface> = function AccountChildCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountChildCircleIcon ${className}`;
      return (
        <Icon alt="AccountChildCircle" className={classNames} {...propsRest}>
