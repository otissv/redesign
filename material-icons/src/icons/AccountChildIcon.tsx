import React, { FC } from 'react';
    ...
    export const AccountChildIcon: FC<IconInterface> = function AccountChildIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountChildIcon ${className}`;
      return (
        <Icon alt="AccountChild" className={classNames} {...propsRest}>
