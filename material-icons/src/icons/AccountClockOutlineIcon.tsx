import React, { FC } from 'react';
    ...
    export const AccountClockOutlineIcon: FC<IconInterface> = function AccountClockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountClockOutlineIcon ${className}`;
      return (
        <Icon alt="AccountClockOutline" className={classNames} {...propsRest}>
    ...
    AccountClockOutlineIcon.displayName = 'AccountClockOutlineIcon';
