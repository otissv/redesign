import React, { FC } from 'react';
    ...
    export const AccountCogOutlineIcon: FC<IconInterface> = function AccountCogOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountCogOutlineIcon ${className}`;
      return (
        <Icon alt="AccountCogOutline" className={classNames} {...propsRest}>
    ...
    AccountCogOutlineIcon.displayName = 'AccountCogOutlineIcon';
