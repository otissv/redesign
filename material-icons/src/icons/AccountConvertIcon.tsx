import React, { FC } from 'react';
    ...
    export const AccountConvertIcon: FC<IconInterface> = function AccountConvertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountConvertIcon ${className}`;
      return (
        <Icon alt="AccountConvert" className={classNames} {...propsRest}>
