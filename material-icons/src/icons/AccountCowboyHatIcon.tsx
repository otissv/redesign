import React, { FC } from 'react';
    ...
    export const AccountCowboyHatIcon: FC<IconInterface> = function AccountCowboyHatIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountCowboyHatIcon ${className}`;
      return (
        <Icon alt="AccountCowboyHat" className={classNames} {...propsRest}>
    ...
    AccountCowboyHatIcon.displayName = 'AccountCowboyHatIcon';
