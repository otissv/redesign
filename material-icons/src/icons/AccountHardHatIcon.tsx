import React, { FC } from 'react';
    ...
    export const AccountHardHatIcon: FC<IconInterface> = function AccountHardHatIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountHardHatIcon ${className}`;
      return (
        <Icon alt="AccountHardHat" className={classNames} {...propsRest}>
    ...
    AccountHardHatIcon.displayName = 'AccountHardHatIcon';
