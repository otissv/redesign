import React, { FC } from 'react';
    ...
    export const AccountHeartIcon: FC<IconInterface> = function AccountHeartIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountHeartIcon ${className}`;
      return (
        <Icon alt="AccountHeart" className={classNames} {...propsRest}>
