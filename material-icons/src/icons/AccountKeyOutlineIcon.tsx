import React, { FC } from 'react';
    ...
    export const AccountKeyOutlineIcon: FC<IconInterface> = function AccountKeyOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountKeyOutlineIcon ${className}`;
      return (
        <Icon alt="AccountKeyOutline" className={classNames} {...propsRest}>
