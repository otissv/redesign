import React, { FC } from 'react';
    ...
    export const AccountMultipleCheckOutlineIcon: FC<IconInterface> = function AccountMultipleCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountMultipleCheckOutlineIcon ${className}`;
      return (
        <Icon alt="AccountMultipleCheckOutline" className={classNames} {...propsRest}>
    ...
    AccountMultipleCheckOutlineIcon.displayName = 'AccountMultipleCheckOutlineIcon';
