import React, { FC } from 'react';
    ...
    export const AccountMultipleMinusOutlineIcon: FC<IconInterface> = function AccountMultipleMinusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountMultipleMinusOutlineIcon ${className}`;
      return (
        <Icon alt="AccountMultipleMinusOutline" className={classNames} {...propsRest}>
