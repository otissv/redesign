import React, { FC } from 'react';
    ...
    export const AccountMultipleOutlineIcon: FC<IconInterface> = function AccountMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="AccountMultipleOutline" className={classNames} {...propsRest}>
