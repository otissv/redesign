import React, { FC } from 'react';
    ...
    export const AccountMultiplePlusOutlineIcon: FC<IconInterface> = function AccountMultiplePlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountMultiplePlusOutlineIcon ${className}`;
      return (
        <Icon alt="AccountMultiplePlusOutline" className={classNames} {...propsRest}>
