import React, { FC } from 'react';
    ...
    export const AccountMultipleRemoveIcon: FC<IconInterface> = function AccountMultipleRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountMultipleRemoveIcon ${className}`;
      return (
        <Icon alt="AccountMultipleRemove" className={classNames} {...propsRest}>
    ...
    AccountMultipleRemoveIcon.displayName = 'AccountMultipleRemoveIcon';
