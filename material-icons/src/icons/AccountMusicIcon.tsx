import React, { FC } from 'react';
    ...
    export const AccountMusicIcon: FC<IconInterface> = function AccountMusicIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountMusicIcon ${className}`;
      return (
        <Icon alt="AccountMusic" className={classNames} {...propsRest}>
    ...
    AccountMusicIcon.displayName = 'AccountMusicIcon';
