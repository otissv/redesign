import React, { FC } from 'react';
    ...
    export const AccountOffIcon: FC<IconInterface> = function AccountOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountOffIcon ${className}`;
      return (
        <Icon alt="AccountOff" className={classNames} {...propsRest}>
