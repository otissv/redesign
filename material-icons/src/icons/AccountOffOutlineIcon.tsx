import React, { FC } from 'react';
    ...
    export const AccountOffOutlineIcon: FC<IconInterface> = function AccountOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountOffOutlineIcon ${className}`;
      return (
        <Icon alt="AccountOffOutline" className={classNames} {...propsRest}>
