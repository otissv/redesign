import React, { FC } from 'react';
    ...
    export const AccountPlusOutlineIcon: FC<IconInterface> = function AccountPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountPlusOutlineIcon ${className}`;
      return (
        <Icon alt="AccountPlusOutline" className={classNames} {...propsRest}>
