import React, { FC } from 'react';
    ...
    export const AccountQuestionIcon: FC<IconInterface> = function AccountQuestionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountQuestionIcon ${className}`;
      return (
        <Icon alt="AccountQuestion" className={classNames} {...propsRest}>
