import React, { FC } from 'react';
    ...
    export const AccountRemoveIcon: FC<IconInterface> = function AccountRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountRemoveIcon ${className}`;
      return (
        <Icon alt="AccountRemove" className={classNames} {...propsRest}>
