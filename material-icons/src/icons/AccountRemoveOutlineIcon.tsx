import React, { FC } from 'react';
    ...
    export const AccountRemoveOutlineIcon: FC<IconInterface> = function AccountRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="AccountRemoveOutline" className={classNames} {...propsRest}>
