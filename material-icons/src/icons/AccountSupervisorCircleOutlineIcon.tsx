import React, { FC } from 'react';
    ...
    export const AccountSupervisorCircleOutlineIcon: FC<IconInterface> = function AccountSupervisorCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountSupervisorCircleOutlineIcon ${className}`;
      return (
        <Icon alt="AccountSupervisorCircleOutline" className={classNames} {...propsRest}>
    ...
    AccountSupervisorCircleOutlineIcon.displayName = 'AccountSupervisorCircleOutlineIcon';
