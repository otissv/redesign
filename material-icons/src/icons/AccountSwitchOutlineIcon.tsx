import React, { FC } from 'react';
    ...
    export const AccountSwitchOutlineIcon: FC<IconInterface> = function AccountSwitchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountSwitchOutlineIcon ${className}`;
      return (
        <Icon alt="AccountSwitchOutline" className={classNames} {...propsRest}>
    ...
    AccountSwitchOutlineIcon.displayName = 'AccountSwitchOutlineIcon';
