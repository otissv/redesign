import React, { FC } from 'react';
    ...
    export const AccountTieOutlineIcon: FC<IconInterface> = function AccountTieOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountTieOutlineIcon ${className}`;
      return (
        <Icon alt="AccountTieOutline" className={classNames} {...propsRest}>
    ...
    AccountTieOutlineIcon.displayName = 'AccountTieOutlineIcon';
