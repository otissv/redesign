import React, { FC } from 'react';
    ...
    export const AccountTieVoiceIcon: FC<IconInterface> = function AccountTieVoiceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountTieVoiceIcon ${className}`;
      return (
        <Icon alt="AccountTieVoice" className={classNames} {...propsRest}>
    ...
    AccountTieVoiceIcon.displayName = 'AccountTieVoiceIcon';
