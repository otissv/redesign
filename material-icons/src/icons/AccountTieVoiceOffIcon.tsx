import React, { FC } from 'react';
    ...
    export const AccountTieVoiceOffIcon: FC<IconInterface> = function AccountTieVoiceOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountTieVoiceOffIcon ${className}`;
      return (
        <Icon alt="AccountTieVoiceOff" className={classNames} {...propsRest}>
    ...
    AccountTieVoiceOffIcon.displayName = 'AccountTieVoiceOffIcon';
