import React, { FC } from 'react';
    ...
    export const AccountTieVoiceOutlineIcon: FC<IconInterface> = function AccountTieVoiceOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AccountTieVoiceOutlineIcon ${className}`;
      return (
        <Icon alt="AccountTieVoiceOutline" className={classNames} {...propsRest}>
    ...
    AccountTieVoiceOutlineIcon.displayName = 'AccountTieVoiceOutlineIcon';
