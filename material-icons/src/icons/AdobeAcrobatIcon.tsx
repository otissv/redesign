import React, { FC } from 'react';
    ...
    export const AdobeAcrobatIcon: FC<IconInterface> = function AdobeAcrobatIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AdobeAcrobatIcon ${className}`;
      return (
        <Icon alt="AdobeAcrobat" className={classNames} {...propsRest}>
    ...
    AdobeAcrobatIcon.displayName = 'AdobeAcrobatIcon';
