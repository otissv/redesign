import React, { FC } from 'react';
    ...
    export const AirConditionerIcon: FC<IconInterface> = function AirConditionerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AirConditionerIcon ${className}`;
      return (
        <Icon alt="AirConditioner" className={classNames} {...propsRest}>
    ...
    AirConditionerIcon.displayName = 'AirConditionerIcon';
