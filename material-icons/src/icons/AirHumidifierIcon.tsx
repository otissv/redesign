import React, { FC } from 'react';
    ...
    export const AirHumidifierIcon: FC<IconInterface> = function AirHumidifierIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AirHumidifierIcon ${className}`;
      return (
        <Icon alt="AirHumidifier" className={classNames} {...propsRest}>
    ...
    AirHumidifierIcon.displayName = 'AirHumidifierIcon';
