import React, { FC } from 'react';
    ...
    export const AirPurifierIcon: FC<IconInterface> = function AirPurifierIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AirPurifierIcon ${className}`;
      return (
        <Icon alt="AirPurifier" className={classNames} {...propsRest}>
