import React, { FC } from 'react';
    ...
    export const AirballoonIcon: FC<IconInterface> = function AirballoonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AirballoonIcon ${className}`;
      return (
        <Icon alt="Airballoon" className={classNames} {...propsRest}>
