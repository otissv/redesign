import React, { FC } from 'react';
    ...
    export const AirballoonOutlineIcon: FC<IconInterface> = function AirballoonOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AirballoonOutlineIcon ${className}`;
      return (
        <Icon alt="AirballoonOutline" className={classNames} {...propsRest}>
    ...
    AirballoonOutlineIcon.displayName = 'AirballoonOutlineIcon';
