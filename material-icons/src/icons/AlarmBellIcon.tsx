import React, { FC } from 'react';
    ...
    export const AlarmBellIcon: FC<IconInterface> = function AlarmBellIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmBellIcon ${className}`;
      return (
        <Icon alt="AlarmBell" className={classNames} {...propsRest}>
    ...
    AlarmBellIcon.displayName = 'AlarmBellIcon';
