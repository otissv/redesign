import React, { FC } from 'react';
    ...
    export const AlarmCheckIcon: FC<IconInterface> = function AlarmCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmCheckIcon ${className}`;
      return (
        <Icon alt="AlarmCheck" className={classNames} {...propsRest}>
    ...
    AlarmCheckIcon.displayName = 'AlarmCheckIcon';
