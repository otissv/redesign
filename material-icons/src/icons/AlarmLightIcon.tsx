import React, { FC } from 'react';
    ...
    export const AlarmLightIcon: FC<IconInterface> = function AlarmLightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmLightIcon ${className}`;
      return (
        <Icon alt="AlarmLight" className={classNames} {...propsRest}>
    ...
    AlarmLightIcon.displayName = 'AlarmLightIcon';
