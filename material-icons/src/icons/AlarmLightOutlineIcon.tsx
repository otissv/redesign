import React, { FC } from 'react';
    ...
    export const AlarmLightOutlineIcon: FC<IconInterface> = function AlarmLightOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmLightOutlineIcon ${className}`;
      return (
        <Icon alt="AlarmLightOutline" className={classNames} {...propsRest}>
    ...
    AlarmLightOutlineIcon.displayName = 'AlarmLightOutlineIcon';
