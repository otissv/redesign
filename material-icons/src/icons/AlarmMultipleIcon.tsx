import React, { FC } from 'react';
    ...
    export const AlarmMultipleIcon: FC<IconInterface> = function AlarmMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmMultipleIcon ${className}`;
      return (
        <Icon alt="AlarmMultiple" className={classNames} {...propsRest}>
