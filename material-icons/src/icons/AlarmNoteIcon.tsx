import React, { FC } from 'react';
    ...
    export const AlarmNoteIcon: FC<IconInterface> = function AlarmNoteIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmNoteIcon ${className}`;
      return (
        <Icon alt="AlarmNote" className={classNames} {...propsRest}>
