import React, { FC } from 'react';
    ...
    export const AlarmNoteOffIcon: FC<IconInterface> = function AlarmNoteOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmNoteOffIcon ${className}`;
      return (
        <Icon alt="AlarmNoteOff" className={classNames} {...propsRest}>
    ...
    AlarmNoteOffIcon.displayName = 'AlarmNoteOffIcon';
