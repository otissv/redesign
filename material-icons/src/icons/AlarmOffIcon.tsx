import React, { FC } from 'react';
    ...
    export const AlarmOffIcon: FC<IconInterface> = function AlarmOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmOffIcon ${className}`;
      return (
        <Icon alt="AlarmOff" className={classNames} {...propsRest}>
