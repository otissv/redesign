import React, { FC } from 'react';
    ...
    export const AlarmPlusIcon: FC<IconInterface> = function AlarmPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmPlusIcon ${className}`;
      return (
        <Icon alt="AlarmPlus" className={classNames} {...propsRest}>
