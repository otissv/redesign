import React, { FC } from 'react';
    ...
    export const AlarmSnoozeIcon: FC<IconInterface> = function AlarmSnoozeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlarmSnoozeIcon ${className}`;
      return (
        <Icon alt="AlarmSnooze" className={classNames} {...propsRest}>
