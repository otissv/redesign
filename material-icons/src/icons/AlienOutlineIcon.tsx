import React, { FC } from 'react';
    ...
    export const AlienOutlineIcon: FC<IconInterface> = function AlienOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlienOutlineIcon ${className}`;
      return (
        <Icon alt="AlienOutline" className={classNames} {...propsRest}>
    ...
    AlienOutlineIcon.displayName = 'AlienOutlineIcon';
