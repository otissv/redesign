import React, { FC } from 'react';
    ...
    export const AllInclusiveIcon: FC<IconInterface> = function AllInclusiveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AllInclusiveIcon ${className}`;
      return (
        <Icon alt="AllInclusive" className={classNames} {...propsRest}>
