import React, { FC } from 'react';
    ...
    export const AlphaBBoxIcon: FC<IconInterface> = function AlphaBBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlphaBBoxIcon ${className}`;
      return (
        <Icon alt="AlphaBBox" className={classNames} {...propsRest}>
    ...
    AlphaBBoxIcon.displayName = 'AlphaBBoxIcon';
