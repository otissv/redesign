import React, { FC } from 'react';
    ...
    export const AlphaBCircleOutlineIcon: FC<IconInterface> = function AlphaBCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlphaBCircleOutlineIcon ${className}`;
      return (
        <Icon alt="AlphaBCircleOutline" className={classNames} {...propsRest}>
    ...
    AlphaBCircleOutlineIcon.displayName = 'AlphaBCircleOutlineIcon';
