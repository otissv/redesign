import React, { FC } from 'react';
    ...
    export const AlphaCBoxOutlineIcon: FC<IconInterface> = function AlphaCBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlphaCBoxOutlineIcon ${className}`;
      return (
        <Icon alt="AlphaCBoxOutline" className={classNames} {...propsRest}>
