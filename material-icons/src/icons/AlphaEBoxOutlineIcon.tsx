import React, { FC } from 'react';
    ...
    export const AlphaEBoxOutlineIcon: FC<IconInterface> = function AlphaEBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlphaEBoxOutlineIcon ${className}`;
      return (
        <Icon alt="AlphaEBoxOutline" className={classNames} {...propsRest}>
