import React, { FC } from 'react';
    ...
    export const AlphaQBoxIcon: FC<IconInterface> = function AlphaQBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlphaQBoxIcon ${className}`;
      return (
        <Icon alt="AlphaQBox" className={classNames} {...propsRest}>
