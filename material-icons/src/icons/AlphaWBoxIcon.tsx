import React, { FC } from 'react';
    ...
    export const AlphaWBoxIcon: FC<IconInterface> = function AlphaWBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlphaWBoxIcon ${className}`;
      return (
        <Icon alt="AlphaWBox" className={classNames} {...propsRest}>
