import React, { FC } from 'react';
    ...
    export const AlphabetGreekIcon: FC<IconInterface> = function AlphabetGreekIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlphabetGreekIcon ${className}`;
      return (
        <Icon alt="AlphabetGreek" className={classNames} {...propsRest}>
