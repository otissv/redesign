import React, { FC } from 'react';
    ...
    export const AlphabeticalIcon: FC<IconInterface> = function AlphabeticalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlphabeticalIcon ${className}`;
      return (
        <Icon alt="Alphabetical" className={classNames} {...propsRest}>
