import React, { FC } from 'react';
    ...
    export const AlphabeticalOffIcon: FC<IconInterface> = function AlphabeticalOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AlphabeticalOffIcon ${className}`;
      return (
        <Icon alt="AlphabeticalOff" className={classNames} {...propsRest}>
    ...
    AlphabeticalOffIcon.displayName = 'AlphabeticalOffIcon';
