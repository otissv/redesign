import React, { FC } from 'react';
    ...
    export const AmbulanceIcon: FC<IconInterface> = function AmbulanceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AmbulanceIcon ${className}`;
      return (
        <Icon alt="Ambulance" className={classNames} {...propsRest}>
