import React, { FC } from 'react';
    ...
    export const AmmunitionIcon: FC<IconInterface> = function AmmunitionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AmmunitionIcon ${className}`;
      return (
        <Icon alt="Ammunition" className={classNames} {...propsRest}>
