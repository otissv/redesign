import React, { FC } from 'react';
    ...
    export const AmpersandIcon: FC<IconInterface> = function AmpersandIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AmpersandIcon ${className}`;
      return (
        <Icon alt="Ampersand" className={classNames} {...propsRest}>
