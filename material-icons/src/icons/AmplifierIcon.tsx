import React, { FC } from 'react';
    ...
    export const AmplifierIcon: FC<IconInterface> = function AmplifierIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AmplifierIcon ${className}`;
      return (
        <Icon alt="Amplifier" className={classNames} {...propsRest}>
