import React, { FC } from 'react';
    ...
    export const AmplifierOffIcon: FC<IconInterface> = function AmplifierOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AmplifierOffIcon ${className}`;
      return (
        <Icon alt="AmplifierOff" className={classNames} {...propsRest}>
    ...
    AmplifierOffIcon.displayName = 'AmplifierOffIcon';
