import React, { FC } from 'react';
    ...
    export const AndroidAutoIcon: FC<IconInterface> = function AndroidAutoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AndroidAutoIcon ${className}`;
      return (
        <Icon alt="AndroidAuto" className={classNames} {...propsRest}>
