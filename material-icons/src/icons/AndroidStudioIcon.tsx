import React, { FC } from 'react';
    ...
    export const AndroidStudioIcon: FC<IconInterface> = function AndroidStudioIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AndroidStudioIcon ${className}`;
      return (
        <Icon alt="AndroidStudio" className={classNames} {...propsRest}>
