import React, { FC } from 'react';
    ...
    export const AngleAcuteIcon: FC<IconInterface> = function AngleAcuteIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AngleAcuteIcon ${className}`;
      return (
        <Icon alt="AngleAcute" className={classNames} {...propsRest}>
