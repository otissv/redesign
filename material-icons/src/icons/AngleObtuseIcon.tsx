import React, { FC } from 'react';
    ...
    export const AngleObtuseIcon: FC<IconInterface> = function AngleObtuseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AngleObtuseIcon ${className}`;
      return (
        <Icon alt="AngleObtuse" className={classNames} {...propsRest}>
