import React, { FC } from 'react';
    ...
    export const AngularjsIcon: FC<IconInterface> = function AngularjsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AngularjsIcon ${className}`;
      return (
        <Icon alt="Angularjs" className={classNames} {...propsRest}>
