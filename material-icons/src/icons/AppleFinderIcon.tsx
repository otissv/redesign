import React, { FC } from 'react';
    ...
    export const AppleFinderIcon: FC<IconInterface> = function AppleFinderIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AppleFinderIcon ${className}`;
      return (
        <Icon alt="AppleFinder" className={classNames} {...propsRest}>
