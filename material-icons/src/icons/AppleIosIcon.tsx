import React, { FC } from 'react';
    ...
    export const AppleIosIcon: FC<IconInterface> = function AppleIosIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AppleIosIcon ${className}`;
      return (
        <Icon alt="AppleIos" className={classNames} {...propsRest}>
