import React, { FC } from 'react';
    ...
    export const AppleKeyboardCommandIcon: FC<IconInterface> = function AppleKeyboardCommandIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AppleKeyboardCommandIcon ${className}`;
      return (
        <Icon alt="AppleKeyboardCommand" className={classNames} {...propsRest}>
