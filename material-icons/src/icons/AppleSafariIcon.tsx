import React, { FC } from 'react';
    ...
    export const AppleSafariIcon: FC<IconInterface> = function AppleSafariIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AppleSafariIcon ${className}`;
      return (
        <Icon alt="AppleSafari" className={classNames} {...propsRest}>
    ...
    AppleSafariIcon.displayName = 'AppleSafariIcon';
