import React, { FC } from 'react';
    ...
    export const ApproximatelyEqualBoxIcon: FC<IconInterface> = function ApproximatelyEqualBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ApproximatelyEqualBoxIcon ${className}`;
      return (
        <Icon alt="ApproximatelyEqualBox" className={classNames} {...propsRest}>
    ...
    ApproximatelyEqualBoxIcon.displayName = 'ApproximatelyEqualBoxIcon';
