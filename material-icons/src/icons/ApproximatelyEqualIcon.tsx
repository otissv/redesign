import React, { FC } from 'react';
    ...
    export const ApproximatelyEqualIcon: FC<IconInterface> = function ApproximatelyEqualIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ApproximatelyEqualIcon ${className}`;
      return (
        <Icon alt="ApproximatelyEqual" className={classNames} {...propsRest}>
