import React, { FC } from 'react';
    ...
    export const ArmFlexOutlineIcon: FC<IconInterface> = function ArmFlexOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArmFlexOutlineIcon ${className}`;
      return (
        <Icon alt="ArmFlexOutline" className={classNames} {...propsRest}>
    ...
    ArmFlexOutlineIcon.displayName = 'ArmFlexOutlineIcon';
