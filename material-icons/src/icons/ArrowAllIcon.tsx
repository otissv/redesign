import React, { FC } from 'react';
    ...
    export const ArrowAllIcon: FC<IconInterface> = function ArrowAllIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowAllIcon ${className}`;
      return (
        <Icon alt="ArrowAll" className={classNames} {...propsRest}>
    ...
    ArrowAllIcon.displayName = 'ArrowAllIcon';
