import React, { FC } from 'react';
    ...
    export const ArrowBottomRightBoldOutlineIcon: FC<IconInterface> = function ArrowBottomRightBoldOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowBottomRightBoldOutlineIcon ${className}`;
      return (
        <Icon alt="ArrowBottomRightBoldOutline" className={classNames} {...propsRest}>
