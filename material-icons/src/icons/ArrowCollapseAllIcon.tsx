import React, { FC } from 'react';
    ...
    export const ArrowCollapseAllIcon: FC<IconInterface> = function ArrowCollapseAllIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowCollapseAllIcon ${className}`;
      return (
        <Icon alt="ArrowCollapseAll" className={classNames} {...propsRest}>
