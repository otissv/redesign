import React, { FC } from 'react';
    ...
    export const ArrowDecisionAutoIcon: FC<IconInterface> = function ArrowDecisionAutoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowDecisionAutoIcon ${className}`;
      return (
        <Icon alt="ArrowDecisionAuto" className={classNames} {...propsRest}>
