import React, { FC } from 'react';
    ...
    export const ArrowDecisionAutoOutlineIcon: FC<IconInterface> = function ArrowDecisionAutoOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowDecisionAutoOutlineIcon ${className}`;
      return (
        <Icon alt="ArrowDecisionAutoOutline" className={classNames} {...propsRest}>
