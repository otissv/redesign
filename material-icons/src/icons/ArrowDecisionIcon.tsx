import React, { FC } from 'react';
    ...
    export const ArrowDecisionIcon: FC<IconInterface> = function ArrowDecisionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowDecisionIcon ${className}`;
      return (
        <Icon alt="ArrowDecision" className={classNames} {...propsRest}>
    ...
    ArrowDecisionIcon.displayName = 'ArrowDecisionIcon';
