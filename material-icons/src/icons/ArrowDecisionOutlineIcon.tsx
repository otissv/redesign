import React, { FC } from 'react';
    ...
    export const ArrowDecisionOutlineIcon: FC<IconInterface> = function ArrowDecisionOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowDecisionOutlineIcon ${className}`;
      return (
        <Icon alt="ArrowDecisionOutline" className={classNames} {...propsRest}>
