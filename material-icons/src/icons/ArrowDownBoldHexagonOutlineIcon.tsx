import React, { FC } from 'react';
    ...
    export const ArrowDownBoldHexagonOutlineIcon: FC<IconInterface> = function ArrowDownBoldHexagonOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowDownBoldHexagonOutlineIcon ${className}`;
      return (
        <Icon alt="ArrowDownBoldHexagonOutline" className={classNames} {...propsRest}>
    ...
    ArrowDownBoldHexagonOutlineIcon.displayName = 'ArrowDownBoldHexagonOutlineIcon';
