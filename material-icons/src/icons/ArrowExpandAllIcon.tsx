import React, { FC } from 'react';
    ...
    export const ArrowExpandAllIcon: FC<IconInterface> = function ArrowExpandAllIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowExpandAllIcon ${className}`;
      return (
        <Icon alt="ArrowExpandAll" className={classNames} {...propsRest}>
    ...
    ArrowExpandAllIcon.displayName = 'ArrowExpandAllIcon';
