import React, { FC } from 'react';
    ...
    export const ArrowHorizontalLockIcon: FC<IconInterface> = function ArrowHorizontalLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowHorizontalLockIcon ${className}`;
      return (
        <Icon alt="ArrowHorizontalLock" className={classNames} {...propsRest}>
    ...
    ArrowHorizontalLockIcon.displayName = 'ArrowHorizontalLockIcon';
