import React, { FC } from 'react';
    ...
    export const ArrowLeftBoldHexagonOutlineIcon: FC<IconInterface> = function ArrowLeftBoldHexagonOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowLeftBoldHexagonOutlineIcon ${className}`;
      return (
        <Icon alt="ArrowLeftBoldHexagonOutline" className={classNames} {...propsRest}>
    ...
    ArrowLeftBoldHexagonOutlineIcon.displayName = 'ArrowLeftBoldHexagonOutlineIcon';
