import React, { FC } from 'react';
    ...
    export const ArrowRightBoldHexagonOutlineIcon: FC<IconInterface> = function ArrowRightBoldHexagonOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowRightBoldHexagonOutlineIcon ${className}`;
      return (
        <Icon alt="ArrowRightBoldHexagonOutline" className={classNames} {...propsRest}>
    ...
    ArrowRightBoldHexagonOutlineIcon.displayName = 'ArrowRightBoldHexagonOutlineIcon';
