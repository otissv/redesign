import React, { FC } from 'react';
    ...
    export const ArrowUpBoldHexagonOutlineIcon: FC<IconInterface> = function ArrowUpBoldHexagonOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ArrowUpBoldHexagonOutlineIcon ${className}`;
      return (
        <Icon alt="ArrowUpBoldHexagonOutline" className={classNames} {...propsRest}>
    ...
    ArrowUpBoldHexagonOutlineIcon.displayName = 'ArrowUpBoldHexagonOutlineIcon';
