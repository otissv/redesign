import React, { FC } from 'react';
    ...
    export const AsteriskIcon: FC<IconInterface> = function AsteriskIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AsteriskIcon ${className}`;
      return (
        <Icon alt="Asterisk" className={classNames} {...propsRest}>
