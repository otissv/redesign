import React, { FC } from 'react';
    ...
    export const AtlassianIcon: FC<IconInterface> = function AtlassianIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AtlassianIcon ${className}`;
      return (
        <Icon alt="Atlassian" className={classNames} {...propsRest}>
