import React, { FC } from 'react';
    ...
    export const AtomVariantIcon: FC<IconInterface> = function AtomVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AtomVariantIcon ${className}`;
      return (
        <Icon alt="AtomVariant" className={classNames} {...propsRest}>
