import React, { FC } from 'react';
    ...
    export const AudioVideoIcon: FC<IconInterface> = function AudioVideoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AudioVideoIcon ${className}`;
      return (
        <Icon alt="AudioVideo" className={classNames} {...propsRest}>
