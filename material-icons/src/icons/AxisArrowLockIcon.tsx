import React, { FC } from 'react';
    ...
    export const AxisArrowLockIcon: FC<IconInterface> = function AxisArrowLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AxisArrowLockIcon ${className}`;
      return (
        <Icon alt="AxisArrowLock" className={classNames} {...propsRest}>
