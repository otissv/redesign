import React, { FC } from 'react';
    ...
    export const AxisLockIcon: FC<IconInterface> = function AxisLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AxisLockIcon ${className}`;
      return (
        <Icon alt="AxisLock" className={classNames} {...propsRest}>
    ...
    AxisLockIcon.displayName = 'AxisLockIcon';
