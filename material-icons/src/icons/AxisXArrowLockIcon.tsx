import React, { FC } from 'react';
    ...
    export const AxisXArrowLockIcon: FC<IconInterface> = function AxisXArrowLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AxisXArrowLockIcon ${className}`;
      return (
        <Icon alt="AxisXArrowLock" className={classNames} {...propsRest}>
    ...
    AxisXArrowLockIcon.displayName = 'AxisXArrowLockIcon';
