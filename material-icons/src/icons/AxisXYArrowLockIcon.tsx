import React, { FC } from 'react';
    ...
    export const AxisXYArrowLockIcon: FC<IconInterface> = function AxisXYArrowLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AxisXYArrowLockIcon ${className}`;
      return (
        <Icon alt="AxisXYArrowLock" className={classNames} {...propsRest}>
    ...
    AxisXYArrowLockIcon.displayName = 'AxisXYArrowLockIcon';
