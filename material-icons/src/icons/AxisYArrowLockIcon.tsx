import React, { FC } from 'react';
    ...
    export const AxisYArrowLockIcon: FC<IconInterface> = function AxisYArrowLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AxisYArrowLockIcon ${className}`;
      return (
        <Icon alt="AxisYArrowLock" className={classNames} {...propsRest}>
    ...
    AxisYArrowLockIcon.displayName = 'AxisYArrowLockIcon';
