import React, { FC } from 'react';
    ...
    export const AxisYRotateCounterclockwiseIcon: FC<IconInterface> = function AxisYRotateCounterclockwiseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AxisYRotateCounterclockwiseIcon ${className}`;
      return (
        <Icon alt="AxisYRotateCounterclockwise" className={classNames} {...propsRest}>
