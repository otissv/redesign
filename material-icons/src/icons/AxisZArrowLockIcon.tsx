import React, { FC } from 'react';
    ...
    export const AxisZArrowLockIcon: FC<IconInterface> = function AxisZArrowLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AxisZArrowLockIcon ${className}`;
      return (
        <Icon alt="AxisZArrowLock" className={classNames} {...propsRest}>
    ...
    AxisZArrowLockIcon.displayName = 'AxisZArrowLockIcon';
