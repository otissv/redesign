import React, { FC } from 'react';
    ...
    export const AxisZRotateClockwiseIcon: FC<IconInterface> = function AxisZRotateClockwiseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `AxisZRotateClockwiseIcon ${className}`;
      return (
        <Icon alt="AxisZRotateClockwise" className={classNames} {...propsRest}>
