import React, { FC } from 'react';
    ...
    export const BabyBottleOutlineIcon: FC<IconInterface> = function BabyBottleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BabyBottleOutlineIcon ${className}`;
      return (
        <Icon alt="BabyBottleOutline" className={classNames} {...propsRest}>
    ...
    BabyBottleOutlineIcon.displayName = 'BabyBottleOutlineIcon';
