import React, { FC } from 'react';
    ...
    export const BabyBuggyIcon: FC<IconInterface> = function BabyBuggyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BabyBuggyIcon ${className}`;
      return (
        <Icon alt="BabyBuggy" className={classNames} {...propsRest}>
