import React, { FC } from 'react';
    ...
    export const BabyFaceIcon: FC<IconInterface> = function BabyFaceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BabyFaceIcon ${className}`;
      return (
        <Icon alt="BabyFace" className={classNames} {...propsRest}>
