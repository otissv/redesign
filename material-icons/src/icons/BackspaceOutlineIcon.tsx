import React, { FC } from 'react';
    ...
    export const BackspaceOutlineIcon: FC<IconInterface> = function BackspaceOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BackspaceOutlineIcon ${className}`;
      return (
        <Icon alt="BackspaceOutline" className={classNames} {...propsRest}>
