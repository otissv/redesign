import React, { FC } from 'react';
    ...
    export const BackspaceReverseIcon: FC<IconInterface> = function BackspaceReverseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BackspaceReverseIcon ${className}`;
      return (
        <Icon alt="BackspaceReverse" className={classNames} {...propsRest}>
