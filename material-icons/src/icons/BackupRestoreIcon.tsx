import React, { FC } from 'react';
    ...
    export const BackupRestoreIcon: FC<IconInterface> = function BackupRestoreIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BackupRestoreIcon ${className}`;
      return (
        <Icon alt="BackupRestore" className={classNames} {...propsRest}>
