import React, { FC } from 'react';
    ...
    export const BacteriaIcon: FC<IconInterface> = function BacteriaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BacteriaIcon ${className}`;
      return (
        <Icon alt="Bacteria" className={classNames} {...propsRest}>
