import React, { FC } from 'react';
    ...
    export const BacteriaOutlineIcon: FC<IconInterface> = function BacteriaOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BacteriaOutlineIcon ${className}`;
      return (
        <Icon alt="BacteriaOutline" className={classNames} {...propsRest}>
