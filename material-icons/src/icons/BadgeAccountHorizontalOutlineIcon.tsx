import React, { FC } from 'react';
    ...
    export const BadgeAccountHorizontalOutlineIcon: FC<IconInterface> = function BadgeAccountHorizontalOutlineIcon({
      ...
      const classNames =  `BadgeAccountHorizontalOutlineIcon ${className}`;
      return (
        <Icon alt="BadgeAccountHorizontalOutline" className={classNames} {...propsRest}>
    ...
    BadgeAccountHorizontalOutlineIcon.displayName = 'BadgeAccountHorizontalOutlineIcon';
