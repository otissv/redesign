import React, { FC } from 'react';
    ...
    export const BadmintonIcon: FC<IconInterface> = function BadmintonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BadmintonIcon ${className}`;
      return (
        <Icon alt="Badminton" className={classNames} {...propsRest}>
