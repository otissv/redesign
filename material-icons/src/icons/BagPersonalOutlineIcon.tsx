import React, { FC } from 'react';
    ...
    export const BagPersonalOutlineIcon: FC<IconInterface> = function BagPersonalOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BagPersonalOutlineIcon ${className}`;
      return (
        <Icon alt="BagPersonalOutline" className={classNames} {...propsRest}>
