import React, { FC } from 'react';
    ...
    export const BallotRecountIcon: FC<IconInterface> = function BallotRecountIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BallotRecountIcon ${className}`;
      return (
        <Icon alt="BallotRecount" className={classNames} {...propsRest}>
