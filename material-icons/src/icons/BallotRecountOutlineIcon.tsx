import React, { FC } from 'react';
    ...
    export const BallotRecountOutlineIcon: FC<IconInterface> = function BallotRecountOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BallotRecountOutlineIcon ${className}`;
      return (
        <Icon alt="BallotRecountOutline" className={classNames} {...propsRest}>
