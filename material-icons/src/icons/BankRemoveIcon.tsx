import React, { FC } from 'react';
    ...
    export const BankRemoveIcon: FC<IconInterface> = function BankRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BankRemoveIcon ${className}`;
      return (
        <Icon alt="BankRemove" className={classNames} {...propsRest}>
