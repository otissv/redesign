import React, { FC } from 'react';
    ...
    export const BarcodeOffIcon: FC<IconInterface> = function BarcodeOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BarcodeOffIcon ${className}`;
      return (
        <Icon alt="BarcodeOff" className={classNames} {...propsRest}>
