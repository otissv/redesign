import React, { FC } from 'react';
    ...
    export const BarcodeScanIcon: FC<IconInterface> = function BarcodeScanIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BarcodeScanIcon ${className}`;
      return (
        <Icon alt="BarcodeScan" className={classNames} {...propsRest}>
