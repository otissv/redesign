import React, { FC } from 'react';
    ...
    export const BarleyOffIcon: FC<IconInterface> = function BarleyOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BarleyOffIcon ${className}`;
      return (
        <Icon alt="BarleyOff" className={classNames} {...propsRest}>
