import React, { FC } from 'react';
    ...
    export const BaseballBatIcon: FC<IconInterface> = function BaseballBatIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BaseballBatIcon ${className}`;
      return (
        <Icon alt="BaseballBat" className={classNames} {...propsRest}>
