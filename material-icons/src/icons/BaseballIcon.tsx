import React, { FC } from 'react';
    ...
    export const BaseballIcon: FC<IconInterface> = function BaseballIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BaseballIcon ${className}`;
      return (
        <Icon alt="Baseball" className={classNames} {...propsRest}>
