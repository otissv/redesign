import React, { FC } from 'react';
    ...
    export const BasketFillIcon: FC<IconInterface> = function BasketFillIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BasketFillIcon ${className}`;
      return (
        <Icon alt="BasketFill" className={classNames} {...propsRest}>
    ...
    BasketFillIcon.displayName = 'BasketFillIcon';
