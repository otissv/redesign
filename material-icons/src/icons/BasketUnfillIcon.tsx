import React, { FC } from 'react';
    ...
    export const BasketUnfillIcon: FC<IconInterface> = function BasketUnfillIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BasketUnfillIcon ${className}`;
      return (
        <Icon alt="BasketUnfill" className={classNames} {...propsRest}>
