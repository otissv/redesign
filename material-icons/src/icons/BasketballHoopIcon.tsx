import React, { FC } from 'react';
    ...
    export const BasketballHoopIcon: FC<IconInterface> = function BasketballHoopIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BasketballHoopIcon ${className}`;
      return (
        <Icon alt="BasketballHoop" className={classNames} {...propsRest}>
