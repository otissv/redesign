import React, { FC } from 'react';
    ...
    export const BasketballHoopOutlineIcon: FC<IconInterface> = function BasketballHoopOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BasketballHoopOutlineIcon ${className}`;
      return (
        <Icon alt="BasketballHoopOutline" className={classNames} {...propsRest}>
