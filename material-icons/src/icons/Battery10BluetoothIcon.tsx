import React, { FC } from 'react';
    ...
    export const Battery10BluetoothIcon: FC<IconInterface> = function Battery10BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery10BluetoothIcon ${className}`;
      return (
        <Icon alt="Battery10Bluetooth" className={classNames} {...propsRest}>
    ...
    Battery10BluetoothIcon.displayName = 'Battery10BluetoothIcon';
