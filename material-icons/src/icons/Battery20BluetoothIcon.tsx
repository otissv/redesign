import React, { FC } from 'react';
    ...
    export const Battery20BluetoothIcon: FC<IconInterface> = function Battery20BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery20BluetoothIcon ${className}`;
      return (
        <Icon alt="Battery20Bluetooth" className={classNames} {...propsRest}>
    ...
    Battery20BluetoothIcon.displayName = 'Battery20BluetoothIcon';
