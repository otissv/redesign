import React, { FC } from 'react';
    ...
    export const Battery30BluetoothIcon: FC<IconInterface> = function Battery30BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery30BluetoothIcon ${className}`;
      return (
        <Icon alt="Battery30Bluetooth" className={classNames} {...propsRest}>
    ...
    Battery30BluetoothIcon.displayName = 'Battery30BluetoothIcon';
