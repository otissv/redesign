import React, { FC } from 'react';
    ...
    export const Battery40BluetoothIcon: FC<IconInterface> = function Battery40BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery40BluetoothIcon ${className}`;
      return (
        <Icon alt="Battery40Bluetooth" className={classNames} {...propsRest}>
    ...
    Battery40BluetoothIcon.displayName = 'Battery40BluetoothIcon';
