import React, { FC } from 'react';
    ...
    export const Battery50BluetoothIcon: FC<IconInterface> = function Battery50BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery50BluetoothIcon ${className}`;
      return (
        <Icon alt="Battery50Bluetooth" className={classNames} {...propsRest}>
    ...
    Battery50BluetoothIcon.displayName = 'Battery50BluetoothIcon';
