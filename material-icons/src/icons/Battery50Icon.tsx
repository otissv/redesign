import React, { FC } from 'react';
    ...
    export const Battery50Icon: FC<IconInterface> = function Battery50Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery50Icon ${className}`;
      return (
        <Icon alt="Battery50" className={classNames} {...propsRest}>
