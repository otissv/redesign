import React, { FC } from 'react';
    ...
    export const Battery60BluetoothIcon: FC<IconInterface> = function Battery60BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery60BluetoothIcon ${className}`;
      return (
        <Icon alt="Battery60Bluetooth" className={classNames} {...propsRest}>
    ...
    Battery60BluetoothIcon.displayName = 'Battery60BluetoothIcon';
