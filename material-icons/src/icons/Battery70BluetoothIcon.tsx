import React, { FC } from 'react';
    ...
    export const Battery70BluetoothIcon: FC<IconInterface> = function Battery70BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery70BluetoothIcon ${className}`;
      return (
        <Icon alt="Battery70Bluetooth" className={classNames} {...propsRest}>
