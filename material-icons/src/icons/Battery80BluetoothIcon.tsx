import React, { FC } from 'react';
    ...
    export const Battery80BluetoothIcon: FC<IconInterface> = function Battery80BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery80BluetoothIcon ${className}`;
      return (
        <Icon alt="Battery80Bluetooth" className={classNames} {...propsRest}>
