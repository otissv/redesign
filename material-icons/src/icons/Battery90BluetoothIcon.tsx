import React, { FC } from 'react';
    ...
    export const Battery90BluetoothIcon: FC<IconInterface> = function Battery90BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Battery90BluetoothIcon ${className}`;
      return (
        <Icon alt="Battery90Bluetooth" className={classNames} {...propsRest}>
    ...
    Battery90BluetoothIcon.displayName = 'Battery90BluetoothIcon';
