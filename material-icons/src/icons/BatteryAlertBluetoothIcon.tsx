import React, { FC } from 'react';
    ...
    export const BatteryAlertBluetoothIcon: FC<IconInterface> = function BatteryAlertBluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryAlertBluetoothIcon ${className}`;
      return (
        <Icon alt="BatteryAlertBluetooth" className={classNames} {...propsRest}>
    ...
    BatteryAlertBluetoothIcon.displayName = 'BatteryAlertBluetoothIcon';
