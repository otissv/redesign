import React, { FC } from 'react';
    ...
    export const BatteryBluetoothIcon: FC<IconInterface> = function BatteryBluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryBluetoothIcon ${className}`;
      return (
        <Icon alt="BatteryBluetooth" className={classNames} {...propsRest}>
    ...
    BatteryBluetoothIcon.displayName = 'BatteryBluetoothIcon';
