import React, { FC } from 'react';
    ...
    export const BatteryBluetoothVariantIcon: FC<IconInterface> = function BatteryBluetoothVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryBluetoothVariantIcon ${className}`;
      return (
        <Icon alt="BatteryBluetoothVariant" className={classNames} {...propsRest}>
