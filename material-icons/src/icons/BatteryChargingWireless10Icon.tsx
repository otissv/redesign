import React, { FC } from 'react';
    ...
    export const BatteryChargingWireless10Icon: FC<IconInterface> = function BatteryChargingWireless10Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryChargingWireless10Icon ${className}`;
      return (
        <Icon alt="BatteryChargingWireless10" className={classNames} {...propsRest}>
    ...
    BatteryChargingWireless10Icon.displayName = 'BatteryChargingWireless10Icon';
