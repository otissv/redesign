import React, { FC } from 'react';
    ...
    export const BatteryChargingWireless20Icon: FC<IconInterface> = function BatteryChargingWireless20Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryChargingWireless20Icon ${className}`;
      return (
        <Icon alt="BatteryChargingWireless20" className={classNames} {...propsRest}>
    ...
    BatteryChargingWireless20Icon.displayName = 'BatteryChargingWireless20Icon';
