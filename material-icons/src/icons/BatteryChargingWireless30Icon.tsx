import React, { FC } from 'react';
    ...
    export const BatteryChargingWireless30Icon: FC<IconInterface> = function BatteryChargingWireless30Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryChargingWireless30Icon ${className}`;
      return (
        <Icon alt="BatteryChargingWireless30" className={classNames} {...propsRest}>
    ...
    BatteryChargingWireless30Icon.displayName = 'BatteryChargingWireless30Icon';
