import React, { FC } from 'react';
    ...
    export const BatteryChargingWireless40Icon: FC<IconInterface> = function BatteryChargingWireless40Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryChargingWireless40Icon ${className}`;
      return (
        <Icon alt="BatteryChargingWireless40" className={classNames} {...propsRest}>
