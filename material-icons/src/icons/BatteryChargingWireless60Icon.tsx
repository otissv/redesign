import React, { FC } from 'react';
    ...
    export const BatteryChargingWireless60Icon: FC<IconInterface> = function BatteryChargingWireless60Icon({
      ...
      const classNames =  `BatteryChargingWireless60Icon ${className}`;
      return (
        <Icon alt="BatteryChargingWireless60" className={classNames} {...propsRest}>
    ...
    BatteryChargingWireless60Icon.displayName = 'BatteryChargingWireless60Icon';
