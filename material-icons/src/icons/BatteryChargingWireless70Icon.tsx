import React, { FC } from 'react';
    ...
    export const BatteryChargingWireless70Icon: FC<IconInterface> = function BatteryChargingWireless70Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryChargingWireless70Icon ${className}`;
      return (
        <Icon alt="BatteryChargingWireless70" className={classNames} {...propsRest}>
    ...
    BatteryChargingWireless70Icon.displayName = 'BatteryChargingWireless70Icon';
