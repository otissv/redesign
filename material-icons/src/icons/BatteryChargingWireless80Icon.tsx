import React, { FC } from 'react';
    ...
    export const BatteryChargingWireless80Icon: FC<IconInterface> = function BatteryChargingWireless80Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryChargingWireless80Icon ${className}`;
      return (
        <Icon alt="BatteryChargingWireless80" className={classNames} {...propsRest}>
