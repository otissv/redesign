import React, { FC } from 'react';
    ...
    export const BatteryChargingWirelessIcon: FC<IconInterface> = function BatteryChargingWirelessIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryChargingWirelessIcon ${className}`;
      return (
        <Icon alt="BatteryChargingWireless" className={classNames} {...propsRest}>
    ...
    BatteryChargingWirelessIcon.displayName = 'BatteryChargingWirelessIcon';
