import React, { FC } from 'react';
    ...
    export const BatteryHeartIcon: FC<IconInterface> = function BatteryHeartIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryHeartIcon ${className}`;
      return (
        <Icon alt="BatteryHeart" className={classNames} {...propsRest}>
    ...
    BatteryHeartIcon.displayName = 'BatteryHeartIcon';
