import React, { FC } from 'react';
    ...
    export const BatteryHeartOutlineIcon: FC<IconInterface> = function BatteryHeartOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryHeartOutlineIcon ${className}`;
      return (
        <Icon alt="BatteryHeartOutline" className={classNames} {...propsRest}>
    ...
    BatteryHeartOutlineIcon.displayName = 'BatteryHeartOutlineIcon';
