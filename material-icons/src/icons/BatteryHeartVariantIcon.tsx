import React, { FC } from 'react';
    ...
    export const BatteryHeartVariantIcon: FC<IconInterface> = function BatteryHeartVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryHeartVariantIcon ${className}`;
      return (
        <Icon alt="BatteryHeartVariant" className={classNames} {...propsRest}>
    ...
    BatteryHeartVariantIcon.displayName = 'BatteryHeartVariantIcon';
