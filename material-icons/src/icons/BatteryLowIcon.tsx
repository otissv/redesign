import React, { FC } from 'react';
    ...
    export const BatteryLowIcon: FC<IconInterface> = function BatteryLowIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryLowIcon ${className}`;
      return (
        <Icon alt="BatteryLow" className={classNames} {...propsRest}>
