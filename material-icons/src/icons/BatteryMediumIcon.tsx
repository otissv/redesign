import React, { FC } from 'react';
    ...
    export const BatteryMediumIcon: FC<IconInterface> = function BatteryMediumIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryMediumIcon ${className}`;
      return (
        <Icon alt="BatteryMedium" className={classNames} {...propsRest}>
