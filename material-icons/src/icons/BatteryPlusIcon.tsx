import React, { FC } from 'react';
    ...
    export const BatteryPlusIcon: FC<IconInterface> = function BatteryPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryPlusIcon ${className}`;
      return (
        <Icon alt="BatteryPlus" className={classNames} {...propsRest}>
