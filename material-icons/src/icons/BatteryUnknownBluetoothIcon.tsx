import React, { FC } from 'react';
    ...
    export const BatteryUnknownBluetoothIcon: FC<IconInterface> = function BatteryUnknownBluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BatteryUnknownBluetoothIcon ${className}`;
      return (
        <Icon alt="BatteryUnknownBluetooth" className={classNames} {...propsRest}>
