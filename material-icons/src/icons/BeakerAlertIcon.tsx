import React, { FC } from 'react';
    ...
    export const BeakerAlertIcon: FC<IconInterface> = function BeakerAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerAlertIcon ${className}`;
      return (
        <Icon alt="BeakerAlert" className={classNames} {...propsRest}>
    ...
    BeakerAlertIcon.displayName = 'BeakerAlertIcon';
