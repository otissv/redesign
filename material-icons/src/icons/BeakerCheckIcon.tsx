import React, { FC } from 'react';
    ...
    export const BeakerCheckIcon: FC<IconInterface> = function BeakerCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerCheckIcon ${className}`;
      return (
        <Icon alt="BeakerCheck" className={classNames} {...propsRest}>
    ...
    BeakerCheckIcon.displayName = 'BeakerCheckIcon';
