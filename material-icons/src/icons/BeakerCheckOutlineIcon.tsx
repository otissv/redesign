import React, { FC } from 'react';
    ...
    export const BeakerCheckOutlineIcon: FC<IconInterface> = function BeakerCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerCheckOutlineIcon ${className}`;
      return (
        <Icon alt="BeakerCheckOutline" className={classNames} {...propsRest}>
    ...
    BeakerCheckOutlineIcon.displayName = 'BeakerCheckOutlineIcon';
