import React, { FC } from 'react';
    ...
    export const BeakerMinusIcon: FC<IconInterface> = function BeakerMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerMinusIcon ${className}`;
      return (
        <Icon alt="BeakerMinus" className={classNames} {...propsRest}>
    ...
    BeakerMinusIcon.displayName = 'BeakerMinusIcon';
