import React, { FC } from 'react';
    ...
    export const BeakerPlusIcon: FC<IconInterface> = function BeakerPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerPlusIcon ${className}`;
      return (
        <Icon alt="BeakerPlus" className={classNames} {...propsRest}>
    ...
    BeakerPlusIcon.displayName = 'BeakerPlusIcon';
