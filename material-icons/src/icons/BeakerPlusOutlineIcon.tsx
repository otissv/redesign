import React, { FC } from 'react';
    ...
    export const BeakerPlusOutlineIcon: FC<IconInterface> = function BeakerPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerPlusOutlineIcon ${className}`;
      return (
        <Icon alt="BeakerPlusOutline" className={classNames} {...propsRest}>
    ...
    BeakerPlusOutlineIcon.displayName = 'BeakerPlusOutlineIcon';
