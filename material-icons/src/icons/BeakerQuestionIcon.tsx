import React, { FC } from 'react';
    ...
    export const BeakerQuestionIcon: FC<IconInterface> = function BeakerQuestionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerQuestionIcon ${className}`;
      return (
        <Icon alt="BeakerQuestion" className={classNames} {...propsRest}>
    ...
    BeakerQuestionIcon.displayName = 'BeakerQuestionIcon';
