import React, { FC } from 'react';
    ...
    export const BeakerQuestionOutlineIcon: FC<IconInterface> = function BeakerQuestionOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerQuestionOutlineIcon ${className}`;
      return (
        <Icon alt="BeakerQuestionOutline" className={classNames} {...propsRest}>
    ...
    BeakerQuestionOutlineIcon.displayName = 'BeakerQuestionOutlineIcon';
