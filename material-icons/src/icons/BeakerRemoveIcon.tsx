import React, { FC } from 'react';
    ...
    export const BeakerRemoveIcon: FC<IconInterface> = function BeakerRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerRemoveIcon ${className}`;
      return (
        <Icon alt="BeakerRemove" className={classNames} {...propsRest}>
    ...
    BeakerRemoveIcon.displayName = 'BeakerRemoveIcon';
