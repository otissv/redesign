import React, { FC } from 'react';
    ...
    export const BeakerRemoveOutlineIcon: FC<IconInterface> = function BeakerRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeakerRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="BeakerRemoveOutline" className={classNames} {...propsRest}>
    ...
    BeakerRemoveOutlineIcon.displayName = 'BeakerRemoveOutlineIcon';
