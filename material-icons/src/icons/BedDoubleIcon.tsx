import React, { FC } from 'react';
    ...
    export const BedDoubleIcon: FC<IconInterface> = function BedDoubleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BedDoubleIcon ${className}`;
      return (
        <Icon alt="BedDouble" className={classNames} {...propsRest}>
