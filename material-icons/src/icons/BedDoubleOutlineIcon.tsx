import React, { FC } from 'react';
    ...
    export const BedDoubleOutlineIcon: FC<IconInterface> = function BedDoubleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BedDoubleOutlineIcon ${className}`;
      return (
        <Icon alt="BedDoubleOutline" className={classNames} {...propsRest}>
    ...
    BedDoubleOutlineIcon.displayName = 'BedDoubleOutlineIcon';
