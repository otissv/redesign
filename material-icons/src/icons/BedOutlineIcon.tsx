import React, { FC } from 'react';
    ...
    export const BedOutlineIcon: FC<IconInterface> = function BedOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BedOutlineIcon ${className}`;
      return (
        <Icon alt="BedOutline" className={classNames} {...propsRest}>
    ...
    BedOutlineIcon.displayName = 'BedOutlineIcon';
