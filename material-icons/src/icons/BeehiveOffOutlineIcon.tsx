import React, { FC } from 'react';
    ...
    export const BeehiveOffOutlineIcon: FC<IconInterface> = function BeehiveOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeehiveOffOutlineIcon ${className}`;
      return (
        <Icon alt="BeehiveOffOutline" className={classNames} {...propsRest}>
    ...
    BeehiveOffOutlineIcon.displayName = 'BeehiveOffOutlineIcon';
