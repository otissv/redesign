import React, { FC } from 'react';
    ...
    export const BeehiveOutlineIcon: FC<IconInterface> = function BeehiveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeehiveOutlineIcon ${className}`;
      return (
        <Icon alt="BeehiveOutline" className={classNames} {...propsRest}>
    ...
    BeehiveOutlineIcon.displayName = 'BeehiveOutlineIcon';
