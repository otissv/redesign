import React, { FC } from 'react';
    ...
    export const BeekeeperIcon: FC<IconInterface> = function BeekeeperIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeekeeperIcon ${className}`;
      return (
        <Icon alt="Beekeeper" className={classNames} {...propsRest}>
    ...
    BeekeeperIcon.displayName = 'BeekeeperIcon';
