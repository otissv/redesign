import React, { FC } from 'react';
    ...
    export const BeerOutlineIcon: FC<IconInterface> = function BeerOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BeerOutlineIcon ${className}`;
      return (
        <Icon alt="BeerOutline" className={classNames} {...propsRest}>
    ...
    BeerOutlineIcon.displayName = 'BeerOutlineIcon';
