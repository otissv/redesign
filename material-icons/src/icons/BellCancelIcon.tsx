import React, { FC } from 'react';
    ...
    export const BellCancelIcon: FC<IconInterface> = function BellCancelIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellCancelIcon ${className}`;
      return (
        <Icon alt="BellCancel" className={classNames} {...propsRest}>
