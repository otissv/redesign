import React, { FC } from 'react';
    ...
    export const BellCancelOutlineIcon: FC<IconInterface> = function BellCancelOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellCancelOutlineIcon ${className}`;
      return (
        <Icon alt="BellCancelOutline" className={classNames} {...propsRest}>
    ...
    BellCancelOutlineIcon.displayName = 'BellCancelOutlineIcon';
