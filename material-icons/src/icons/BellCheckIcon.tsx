import React, { FC } from 'react';
    ...
    export const BellCheckIcon: FC<IconInterface> = function BellCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellCheckIcon ${className}`;
      return (
        <Icon alt="BellCheck" className={classNames} {...propsRest}>
