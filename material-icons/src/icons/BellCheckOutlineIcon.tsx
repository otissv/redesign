import React, { FC } from 'react';
    ...
    export const BellCheckOutlineIcon: FC<IconInterface> = function BellCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellCheckOutlineIcon ${className}`;
      return (
        <Icon alt="BellCheckOutline" className={classNames} {...propsRest}>
    ...
    BellCheckOutlineIcon.displayName = 'BellCheckOutlineIcon';
