import React, { FC } from 'react';
    ...
    export const BellCircleIcon: FC<IconInterface> = function BellCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellCircleIcon ${className}`;
      return (
        <Icon alt="BellCircle" className={classNames} {...propsRest}>
