import React, { FC } from 'react';
    ...
    export const BellCircleOutlineIcon: FC<IconInterface> = function BellCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellCircleOutlineIcon ${className}`;
      return (
        <Icon alt="BellCircleOutline" className={classNames} {...propsRest}>
