import React, { FC } from 'react';
    ...
    export const BellOffOutlineIcon: FC<IconInterface> = function BellOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellOffOutlineIcon ${className}`;
      return (
        <Icon alt="BellOffOutline" className={classNames} {...propsRest}>
