import React, { FC } from 'react';
    ...
    export const BellPlusOutlineIcon: FC<IconInterface> = function BellPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellPlusOutlineIcon ${className}`;
      return (
        <Icon alt="BellPlusOutline" className={classNames} {...propsRest}>
    ...
    BellPlusOutlineIcon.displayName = 'BellPlusOutlineIcon';
