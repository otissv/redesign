import React, { FC } from 'react';
    ...
    export const BellRemoveIcon: FC<IconInterface> = function BellRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellRemoveIcon ${className}`;
      return (
        <Icon alt="BellRemove" className={classNames} {...propsRest}>
    ...
    BellRemoveIcon.displayName = 'BellRemoveIcon';
