import React, { FC } from 'react';
    ...
    export const BellRemoveOutlineIcon: FC<IconInterface> = function BellRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BellRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="BellRemoveOutline" className={classNames} {...propsRest}>
    ...
    BellRemoveOutlineIcon.displayName = 'BellRemoveOutlineIcon';
