import React, { FC } from 'react';
    ...
    export const BiathlonIcon: FC<IconInterface> = function BiathlonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BiathlonIcon ${className}`;
      return (
        <Icon alt="Biathlon" className={classNames} {...propsRest}>
