import React, { FC } from 'react';
    ...
    export const BicycleBasketIcon: FC<IconInterface> = function BicycleBasketIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BicycleBasketIcon ${className}`;
      return (
        <Icon alt="BicycleBasket" className={classNames} {...propsRest}>
    ...
    BicycleBasketIcon.displayName = 'BicycleBasketIcon';
