import React, { FC } from 'react';
    ...
    export const BikeFastIcon: FC<IconInterface> = function BikeFastIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BikeFastIcon ${className}`;
      return (
        <Icon alt="BikeFast" className={classNames} {...propsRest}>
    ...
    BikeFastIcon.displayName = 'BikeFastIcon';
