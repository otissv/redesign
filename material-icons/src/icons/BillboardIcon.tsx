import React, { FC } from 'react';
    ...
    export const BillboardIcon: FC<IconInterface> = function BillboardIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BillboardIcon ${className}`;
      return (
        <Icon alt="Billboard" className={classNames} {...propsRest}>
    ...
    BillboardIcon.displayName = 'BillboardIcon';
