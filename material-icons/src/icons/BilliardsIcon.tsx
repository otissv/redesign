import React, { FC } from 'react';
    ...
    export const BilliardsIcon: FC<IconInterface> = function BilliardsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BilliardsIcon ${className}`;
      return (
        <Icon alt="Billiards" className={classNames} {...propsRest}>
