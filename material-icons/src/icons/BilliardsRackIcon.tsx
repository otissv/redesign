import React, { FC } from 'react';
    ...
    export const BilliardsRackIcon: FC<IconInterface> = function BilliardsRackIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BilliardsRackIcon ${className}`;
      return (
        <Icon alt="BilliardsRack" className={classNames} {...propsRest}>
    ...
    BilliardsRackIcon.displayName = 'BilliardsRackIcon';
