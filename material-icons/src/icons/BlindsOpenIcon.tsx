import React, { FC } from 'react';
    ...
    export const BlindsOpenIcon: FC<IconInterface> = function BlindsOpenIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BlindsOpenIcon ${className}`;
      return (
        <Icon alt="BlindsOpen" className={classNames} {...propsRest}>
    ...
    BlindsOpenIcon.displayName = 'BlindsOpenIcon';
