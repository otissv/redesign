import React, { FC } from 'react';
    ...
    export const BloodBagIcon: FC<IconInterface> = function BloodBagIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BloodBagIcon ${className}`;
      return (
        <Icon alt="BloodBag" className={classNames} {...propsRest}>
