import React, { FC } from 'react';
    ...
    export const BluetoothAudioIcon: FC<IconInterface> = function BluetoothAudioIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BluetoothAudioIcon ${className}`;
      return (
        <Icon alt="BluetoothAudio" className={classNames} {...propsRest}>
