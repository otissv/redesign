import React, { FC } from 'react';
    ...
    export const BluetoothConnectIcon: FC<IconInterface> = function BluetoothConnectIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BluetoothConnectIcon ${className}`;
      return (
        <Icon alt="BluetoothConnect" className={classNames} {...propsRest}>
