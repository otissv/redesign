import React, { FC } from 'react';
    ...
    export const BluetoothIcon: FC<IconInterface> = function BluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BluetoothIcon ${className}`;
      return (
        <Icon alt="Bluetooth" className={classNames} {...propsRest}>
