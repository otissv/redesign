import React, { FC } from 'react';
    ...
    export const BluetoothOffIcon: FC<IconInterface> = function BluetoothOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BluetoothOffIcon ${className}`;
      return (
        <Icon alt="BluetoothOff" className={classNames} {...propsRest}>
