import React, { FC } from 'react';
    ...
    export const BluetoothTransferIcon: FC<IconInterface> = function BluetoothTransferIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BluetoothTransferIcon ${className}`;
      return (
        <Icon alt="BluetoothTransfer" className={classNames} {...propsRest}>
    ...
    BluetoothTransferIcon.displayName = 'BluetoothTransferIcon';
