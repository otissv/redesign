import React, { FC } from 'react';
    ...
    export const BlurLinearIcon: FC<IconInterface> = function BlurLinearIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BlurLinearIcon ${className}`;
      return (
        <Icon alt="BlurLinear" className={classNames} {...propsRest}>
