import React, { FC } from 'react';
    ...
    export const BlurRadialIcon: FC<IconInterface> = function BlurRadialIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BlurRadialIcon ${className}`;
      return (
        <Icon alt="BlurRadial" className={classNames} {...propsRest}>
