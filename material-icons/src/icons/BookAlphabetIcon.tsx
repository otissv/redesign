import React, { FC } from 'react';
    ...
    export const BookAlphabetIcon: FC<IconInterface> = function BookAlphabetIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BookAlphabetIcon ${className}`;
      return (
        <Icon alt="BookAlphabet" className={classNames} {...propsRest}>
    ...
    BookAlphabetIcon.displayName = 'BookAlphabetIcon';
