import React, { FC } from 'react';
    ...
    export const BookCheckIcon: FC<IconInterface> = function BookCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BookCheckIcon ${className}`;
      return (
        <Icon alt="BookCheck" className={classNames} {...propsRest}>
