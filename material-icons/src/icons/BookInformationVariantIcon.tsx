import React, { FC } from 'react';
    ...
    export const BookInformationVariantIcon: FC<IconInterface> = function BookInformationVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BookInformationVariantIcon ${className}`;
      return (
        <Icon alt="BookInformationVariant" className={classNames} {...propsRest}>
    ...
    BookInformationVariantIcon.displayName = 'BookInformationVariantIcon';
