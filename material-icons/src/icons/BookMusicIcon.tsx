import React, { FC } from 'react';
    ...
    export const BookMusicIcon: FC<IconInterface> = function BookMusicIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BookMusicIcon ${className}`;
      return (
        <Icon alt="BookMusic" className={classNames} {...propsRest}>
    ...
    BookMusicIcon.displayName = 'BookMusicIcon';
