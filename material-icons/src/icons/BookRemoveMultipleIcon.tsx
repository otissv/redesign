import React, { FC } from 'react';
    ...
    export const BookRemoveMultipleIcon: FC<IconInterface> = function BookRemoveMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BookRemoveMultipleIcon ${className}`;
      return (
        <Icon alt="BookRemoveMultiple" className={classNames} {...propsRest}>
    ...
    BookRemoveMultipleIcon.displayName = 'BookRemoveMultipleIcon';
