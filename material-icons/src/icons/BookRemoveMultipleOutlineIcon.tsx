import React, { FC } from 'react';
    ...
    export const BookRemoveMultipleOutlineIcon: FC<IconInterface> = function BookRemoveMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BookRemoveMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="BookRemoveMultipleOutline" className={classNames} {...propsRest}>
    ...
    BookRemoveMultipleOutlineIcon.displayName = 'BookRemoveMultipleOutlineIcon';
