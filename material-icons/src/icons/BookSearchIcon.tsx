import React, { FC } from 'react';
    ...
    export const BookSearchIcon: FC<IconInterface> = function BookSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BookSearchIcon ${className}`;
      return (
        <Icon alt="BookSearch" className={classNames} {...propsRest}>
