import React, { FC } from 'react';
    ...
    export const BookSearchOutlineIcon: FC<IconInterface> = function BookSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BookSearchOutlineIcon ${className}`;
      return (
        <Icon alt="BookSearchOutline" className={classNames} {...propsRest}>
