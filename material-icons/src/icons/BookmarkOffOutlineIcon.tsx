import React, { FC } from 'react';
    ...
    export const BookmarkOffOutlineIcon: FC<IconInterface> = function BookmarkOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BookmarkOffOutlineIcon ${className}`;
      return (
        <Icon alt="BookmarkOffOutline" className={classNames} {...propsRest}>
