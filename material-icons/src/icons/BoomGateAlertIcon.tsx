import React, { FC } from 'react';
    ...
    export const BoomGateAlertIcon: FC<IconInterface> = function BoomGateAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BoomGateAlertIcon ${className}`;
      return (
        <Icon alt="BoomGateAlert" className={classNames} {...propsRest}>
    ...
    BoomGateAlertIcon.displayName = 'BoomGateAlertIcon';
