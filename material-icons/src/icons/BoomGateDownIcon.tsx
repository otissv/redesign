import React, { FC } from 'react';
    ...
    export const BoomGateDownIcon: FC<IconInterface> = function BoomGateDownIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BoomGateDownIcon ${className}`;
      return (
        <Icon alt="BoomGateDown" className={classNames} {...propsRest}>
