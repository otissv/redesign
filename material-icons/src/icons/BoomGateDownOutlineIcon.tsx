import React, { FC } from 'react';
    ...
    export const BoomGateDownOutlineIcon: FC<IconInterface> = function BoomGateDownOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BoomGateDownOutlineIcon ${className}`;
      return (
        <Icon alt="BoomGateDownOutline" className={classNames} {...propsRest}>
