import React, { FC } from 'react';
    ...
    export const BoomGateIcon: FC<IconInterface> = function BoomGateIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BoomGateIcon ${className}`;
      return (
        <Icon alt="BoomGate" className={classNames} {...propsRest}>
