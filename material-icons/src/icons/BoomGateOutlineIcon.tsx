import React, { FC } from 'react';
    ...
    export const BoomGateOutlineIcon: FC<IconInterface> = function BoomGateOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BoomGateOutlineIcon ${className}`;
      return (
        <Icon alt="BoomGateOutline" className={classNames} {...propsRest}>
    ...
    BoomGateOutlineIcon.displayName = 'BoomGateOutlineIcon';
