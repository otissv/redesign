import React, { FC } from 'react';
    ...
    export const BoomGateUpIcon: FC<IconInterface> = function BoomGateUpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BoomGateUpIcon ${className}`;
      return (
        <Icon alt="BoomGateUp" className={classNames} {...propsRest}>
    ...
    BoomGateUpIcon.displayName = 'BoomGateUpIcon';
