import React, { FC } from 'react';
    ...
    export const BoomGateUpOutlineIcon: FC<IconInterface> = function BoomGateUpOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BoomGateUpOutlineIcon ${className}`;
      return (
        <Icon alt="BoomGateUpOutline" className={classNames} {...propsRest}>
