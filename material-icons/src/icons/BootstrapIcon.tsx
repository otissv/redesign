import React, { FC } from 'react';
    ...
    export const BootstrapIcon: FC<IconInterface> = function BootstrapIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BootstrapIcon ${className}`;
      return (
        <Icon alt="Bootstrap" className={classNames} {...propsRest}>
