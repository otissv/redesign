import React, { FC } from 'react';
    ...
    export const BorderBottomIcon: FC<IconInterface> = function BorderBottomIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BorderBottomIcon ${className}`;
      return (
        <Icon alt="BorderBottom" className={classNames} {...propsRest}>
