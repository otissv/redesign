import React, { FC } from 'react';
    ...
    export const BorderHorizontalIcon: FC<IconInterface> = function BorderHorizontalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BorderHorizontalIcon ${className}`;
      return (
        <Icon alt="BorderHorizontal" className={classNames} {...propsRest}>
