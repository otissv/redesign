import React, { FC } from 'react';
    ...
    export const BorderLeftIcon: FC<IconInterface> = function BorderLeftIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BorderLeftIcon ${className}`;
      return (
        <Icon alt="BorderLeft" className={classNames} {...propsRest}>
