import React, { FC } from 'react';
    ...
    export const BorderNoneIcon: FC<IconInterface> = function BorderNoneIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BorderNoneIcon ${className}`;
      return (
        <Icon alt="BorderNone" className={classNames} {...propsRest}>
