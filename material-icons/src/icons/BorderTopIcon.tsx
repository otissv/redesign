import React, { FC } from 'react';
    ...
    export const BorderTopIcon: FC<IconInterface> = function BorderTopIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BorderTopIcon ${className}`;
      return (
        <Icon alt="BorderTop" className={classNames} {...propsRest}>
