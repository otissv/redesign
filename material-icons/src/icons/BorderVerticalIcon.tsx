import React, { FC } from 'react';
    ...
    export const BorderVerticalIcon: FC<IconInterface> = function BorderVerticalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BorderVerticalIcon ${className}`;
      return (
        <Icon alt="BorderVertical" className={classNames} {...propsRest}>
