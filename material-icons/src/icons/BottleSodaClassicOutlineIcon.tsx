import React, { FC } from 'react';
    ...
    export const BottleSodaClassicOutlineIcon: FC<IconInterface> = function BottleSodaClassicOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BottleSodaClassicOutlineIcon ${className}`;
      return (
        <Icon alt="BottleSodaClassicOutline" className={classNames} {...propsRest}>
    ...
    BottleSodaClassicOutlineIcon.displayName = 'BottleSodaClassicOutlineIcon';
