import React, { FC } from 'react';
    ...
    export const BottleTonicSkullIcon: FC<IconInterface> = function BottleTonicSkullIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BottleTonicSkullIcon ${className}`;
      return (
        <Icon alt="BottleTonicSkull" className={classNames} {...propsRest}>
    ...
    BottleTonicSkullIcon.displayName = 'BottleTonicSkullIcon';
