import React, { FC } from 'react';
    ...
    export const BottleTonicSkullOutlineIcon: FC<IconInterface> = function BottleTonicSkullOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BottleTonicSkullOutlineIcon ${className}`;
      return (
        <Icon alt="BottleTonicSkullOutline" className={classNames} {...propsRest}>
    ...
    BottleTonicSkullOutlineIcon.displayName = 'BottleTonicSkullOutlineIcon';
