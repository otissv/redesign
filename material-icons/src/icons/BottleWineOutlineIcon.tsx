import React, { FC } from 'react';
    ...
    export const BottleWineOutlineIcon: FC<IconInterface> = function BottleWineOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BottleWineOutlineIcon ${className}`;
      return (
        <Icon alt="BottleWineOutline" className={classNames} {...propsRest}>
    ...
    BottleWineOutlineIcon.displayName = 'BottleWineOutlineIcon';
