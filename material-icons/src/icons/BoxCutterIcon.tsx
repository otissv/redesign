import React, { FC } from 'react';
    ...
    export const BoxCutterIcon: FC<IconInterface> = function BoxCutterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BoxCutterIcon ${className}`;
      return (
        <Icon alt="BoxCutter" className={classNames} {...propsRest}>
