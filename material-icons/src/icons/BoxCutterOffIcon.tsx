import React, { FC } from 'react';
    ...
    export const BoxCutterOffIcon: FC<IconInterface> = function BoxCutterOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BoxCutterOffIcon ${className}`;
      return (
        <Icon alt="BoxCutterOff" className={classNames} {...propsRest}>
    ...
    BoxCutterOffIcon.displayName = 'BoxCutterOffIcon';
