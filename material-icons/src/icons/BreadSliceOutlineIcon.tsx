import React, { FC } from 'react';
    ...
    export const BreadSliceOutlineIcon: FC<IconInterface> = function BreadSliceOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BreadSliceOutlineIcon ${className}`;
      return (
        <Icon alt="BreadSliceOutline" className={classNames} {...propsRest}>
    ...
    BreadSliceOutlineIcon.displayName = 'BreadSliceOutlineIcon';
