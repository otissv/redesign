import React, { FC } from 'react';
    ...
    export const BriefcaseAccountIcon: FC<IconInterface> = function BriefcaseAccountIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseAccountIcon ${className}`;
      return (
        <Icon alt="BriefcaseAccount" className={classNames} {...propsRest}>
