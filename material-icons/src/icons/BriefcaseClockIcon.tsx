import React, { FC } from 'react';
    ...
    export const BriefcaseClockIcon: FC<IconInterface> = function BriefcaseClockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseClockIcon ${className}`;
      return (
        <Icon alt="BriefcaseClock" className={classNames} {...propsRest}>
    ...
    BriefcaseClockIcon.displayName = 'BriefcaseClockIcon';
