import React, { FC } from 'react';
    ...
    export const BriefcaseClockOutlineIcon: FC<IconInterface> = function BriefcaseClockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseClockOutlineIcon ${className}`;
      return (
        <Icon alt="BriefcaseClockOutline" className={classNames} {...propsRest}>
    ...
    BriefcaseClockOutlineIcon.displayName = 'BriefcaseClockOutlineIcon';
