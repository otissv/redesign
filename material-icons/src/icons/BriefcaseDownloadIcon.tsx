import React, { FC } from 'react';
    ...
    export const BriefcaseDownloadIcon: FC<IconInterface> = function BriefcaseDownloadIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseDownloadIcon ${className}`;
      return (
        <Icon alt="BriefcaseDownload" className={classNames} {...propsRest}>
