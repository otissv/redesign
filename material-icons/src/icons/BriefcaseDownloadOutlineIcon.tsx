import React, { FC } from 'react';
    ...
    export const BriefcaseDownloadOutlineIcon: FC<IconInterface> = function BriefcaseDownloadOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseDownloadOutlineIcon ${className}`;
      return (
        <Icon alt="BriefcaseDownloadOutline" className={classNames} {...propsRest}>
