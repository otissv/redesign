import React, { FC } from 'react';
    ...
    export const BriefcaseEditIcon: FC<IconInterface> = function BriefcaseEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseEditIcon ${className}`;
      return (
        <Icon alt="BriefcaseEdit" className={classNames} {...propsRest}>
