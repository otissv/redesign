import React, { FC } from 'react';
    ...
    export const BriefcaseEditOutlineIcon: FC<IconInterface> = function BriefcaseEditOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseEditOutlineIcon ${className}`;
      return (
        <Icon alt="BriefcaseEditOutline" className={classNames} {...propsRest}>
