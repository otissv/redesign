import React, { FC } from 'react';
    ...
    export const BriefcaseMinusIcon: FC<IconInterface> = function BriefcaseMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseMinusIcon ${className}`;
      return (
        <Icon alt="BriefcaseMinus" className={classNames} {...propsRest}>
    ...
    BriefcaseMinusIcon.displayName = 'BriefcaseMinusIcon';
