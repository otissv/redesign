import React, { FC } from 'react';
    ...
    export const BriefcaseMinusOutlineIcon: FC<IconInterface> = function BriefcaseMinusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseMinusOutlineIcon ${className}`;
      return (
        <Icon alt="BriefcaseMinusOutline" className={classNames} {...propsRest}>
