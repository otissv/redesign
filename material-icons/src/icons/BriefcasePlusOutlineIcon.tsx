import React, { FC } from 'react';
    ...
    export const BriefcasePlusOutlineIcon: FC<IconInterface> = function BriefcasePlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcasePlusOutlineIcon ${className}`;
      return (
        <Icon alt="BriefcasePlusOutline" className={classNames} {...propsRest}>
