import React, { FC } from 'react';
    ...
    export const BriefcaseRemoveOutlineIcon: FC<IconInterface> = function BriefcaseRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="BriefcaseRemoveOutline" className={classNames} {...propsRest}>
    ...
    BriefcaseRemoveOutlineIcon.displayName = 'BriefcaseRemoveOutlineIcon';
