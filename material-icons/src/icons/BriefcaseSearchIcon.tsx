import React, { FC } from 'react';
    ...
    export const BriefcaseSearchIcon: FC<IconInterface> = function BriefcaseSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseSearchIcon ${className}`;
      return (
        <Icon alt="BriefcaseSearch" className={classNames} {...propsRest}>
