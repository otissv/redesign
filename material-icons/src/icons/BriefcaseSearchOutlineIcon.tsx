import React, { FC } from 'react';
    ...
    export const BriefcaseSearchOutlineIcon: FC<IconInterface> = function BriefcaseSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BriefcaseSearchOutlineIcon ${className}`;
      return (
        <Icon alt="BriefcaseSearchOutline" className={classNames} {...propsRest}>
    ...
    BriefcaseSearchOutlineIcon.displayName = 'BriefcaseSearchOutlineIcon';
