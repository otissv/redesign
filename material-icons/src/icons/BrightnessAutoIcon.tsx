import React, { FC } from 'react';
    ...
    export const BrightnessAutoIcon: FC<IconInterface> = function BrightnessAutoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BrightnessAutoIcon ${className}`;
      return (
        <Icon alt="BrightnessAuto" className={classNames} {...propsRest}>
