import React, { FC } from 'react';
    ...
    export const BuddhismIcon: FC<IconInterface> = function BuddhismIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BuddhismIcon ${className}`;
      return (
        <Icon alt="Buddhism" className={classNames} {...propsRest}>
