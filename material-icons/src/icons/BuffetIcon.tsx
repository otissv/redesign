import React, { FC } from 'react';
    ...
    export const BuffetIcon: FC<IconInterface> = function BuffetIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BuffetIcon ${className}`;
      return (
        <Icon alt="Buffet" className={classNames} {...propsRest}>
    ...
    BuffetIcon.displayName = 'BuffetIcon';
