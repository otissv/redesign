import React, { FC } from 'react';
    ...
    export const BugCheckIcon: FC<IconInterface> = function BugCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BugCheckIcon ${className}`;
      return (
        <Icon alt="BugCheck" className={classNames} {...propsRest}>
