import React, { FC } from 'react';
    ...
    export const BugCheckOutlineIcon: FC<IconInterface> = function BugCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BugCheckOutlineIcon ${className}`;
      return (
        <Icon alt="BugCheckOutline" className={classNames} {...propsRest}>
