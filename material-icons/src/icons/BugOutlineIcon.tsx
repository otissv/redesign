import React, { FC } from 'react';
    ...
    export const BugOutlineIcon: FC<IconInterface> = function BugOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BugOutlineIcon ${className}`;
      return (
        <Icon alt="BugOutline" className={classNames} {...propsRest}>
