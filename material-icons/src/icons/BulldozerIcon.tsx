import React, { FC } from 'react';
    ...
    export const BulldozerIcon: FC<IconInterface> = function BulldozerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BulldozerIcon ${className}`;
      return (
        <Icon alt="Bulldozer" className={classNames} {...propsRest}>
