import React, { FC } from 'react';
    ...
    export const BullhornOutlineIcon: FC<IconInterface> = function BullhornOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BullhornOutlineIcon ${className}`;
      return (
        <Icon alt="BullhornOutline" className={classNames} {...propsRest}>
