import React, { FC } from 'react';
    ...
    export const BunkBedIcon: FC<IconInterface> = function BunkBedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BunkBedIcon ${className}`;
      return (
        <Icon alt="BunkBed" className={classNames} {...propsRest}>
    ...
    BunkBedIcon.displayName = 'BunkBedIcon';
