import React, { FC } from 'react';
    ...
    export const BusAlertIcon: FC<IconInterface> = function BusAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BusAlertIcon ${className}`;
      return (
        <Icon alt="BusAlert" className={classNames} {...propsRest}>
