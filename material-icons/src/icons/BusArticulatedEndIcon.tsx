import React, { FC } from 'react';
    ...
    export const BusArticulatedEndIcon: FC<IconInterface> = function BusArticulatedEndIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BusArticulatedEndIcon ${className}`;
      return (
        <Icon alt="BusArticulatedEnd" className={classNames} {...propsRest}>
