import React, { FC } from 'react';
    ...
    export const BusArticulatedFrontIcon: FC<IconInterface> = function BusArticulatedFrontIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BusArticulatedFrontIcon ${className}`;
      return (
        <Icon alt="BusArticulatedFront" className={classNames} {...propsRest}>
    ...
    BusArticulatedFrontIcon.displayName = 'BusArticulatedFrontIcon';
