import React, { FC } from 'react';
    ...
    export const BusDoubleDeckerIcon: FC<IconInterface> = function BusDoubleDeckerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BusDoubleDeckerIcon ${className}`;
      return (
        <Icon alt="BusDoubleDecker" className={classNames} {...propsRest}>
