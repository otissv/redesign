import React, { FC } from 'react';
    ...
    export const BusMultipleIcon: FC<IconInterface> = function BusMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BusMultipleIcon ${className}`;
      return (
        <Icon alt="BusMultiple" className={classNames} {...propsRest}>
    ...
    BusMultipleIcon.displayName = 'BusMultipleIcon';
