import React, { FC } from 'react';
    ...
    export const BusSchoolIcon: FC<IconInterface> = function BusSchoolIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BusSchoolIcon ${className}`;
      return (
        <Icon alt="BusSchool" className={classNames} {...propsRest}>
