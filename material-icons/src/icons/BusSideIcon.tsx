import React, { FC } from 'react';
    ...
    export const BusSideIcon: FC<IconInterface> = function BusSideIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `BusSideIcon ${className}`;
      return (
        <Icon alt="BusSide" className={classNames} {...propsRest}>
    ...
    BusSideIcon.displayName = 'BusSideIcon';
