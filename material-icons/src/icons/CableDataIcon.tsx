import React, { FC } from 'react';
    ...
    export const CableDataIcon: FC<IconInterface> = function CableDataIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CableDataIcon ${className}`;
      return (
        <Icon alt="CableData" className={classNames} {...propsRest}>
    ...
    CableDataIcon.displayName = 'CableDataIcon';
