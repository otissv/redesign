import React, { FC } from 'react';
    ...
    export const CakeLayeredIcon: FC<IconInterface> = function CakeLayeredIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CakeLayeredIcon ${className}`;
      return (
        <Icon alt="CakeLayered" className={classNames} {...propsRest}>
