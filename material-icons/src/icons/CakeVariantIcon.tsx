import React, { FC } from 'react';
    ...
    export const CakeVariantIcon: FC<IconInterface> = function CakeVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CakeVariantIcon ${className}`;
      return (
        <Icon alt="CakeVariant" className={classNames} {...propsRest}>
    ...
    CakeVariantIcon.displayName = 'CakeVariantIcon';
