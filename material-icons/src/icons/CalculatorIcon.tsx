import React, { FC } from 'react';
    ...
    export const CalculatorIcon: FC<IconInterface> = function CalculatorIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CalculatorIcon ${className}`;
      return (
        <Icon alt="Calculator" className={classNames} {...propsRest}>
