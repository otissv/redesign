import React, { FC } from 'react';
    ...
    export const CalculatorVariantIcon: FC<IconInterface> = function CalculatorVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CalculatorVariantIcon ${className}`;
      return (
        <Icon alt="CalculatorVariant" className={classNames} {...propsRest}>
