import React, { FC } from 'react';
    ...
    export const CalendarCheckIcon: FC<IconInterface> = function CalendarCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CalendarCheckIcon ${className}`;
      return (
        <Icon alt="CalendarCheck" className={classNames} {...propsRest}>
