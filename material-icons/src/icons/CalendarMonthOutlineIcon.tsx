import React, { FC } from 'react';
    ...
    export const CalendarMonthOutlineIcon: FC<IconInterface> = function CalendarMonthOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CalendarMonthOutlineIcon ${className}`;
      return (
        <Icon alt="CalendarMonthOutline" className={classNames} {...propsRest}>
