import React, { FC } from 'react';
    ...
    export const CalendarMultipleCheckIcon: FC<IconInterface> = function CalendarMultipleCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CalendarMultipleCheckIcon ${className}`;
      return (
        <Icon alt="CalendarMultipleCheck" className={classNames} {...propsRest}>
