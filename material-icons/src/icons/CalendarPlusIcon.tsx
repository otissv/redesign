import React, { FC } from 'react';
    ...
    export const CalendarPlusIcon: FC<IconInterface> = function CalendarPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CalendarPlusIcon ${className}`;
      return (
        <Icon alt="CalendarPlus" className={classNames} {...propsRest}>
