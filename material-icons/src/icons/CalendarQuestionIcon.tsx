import React, { FC } from 'react';
    ...
    export const CalendarQuestionIcon: FC<IconInterface> = function CalendarQuestionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CalendarQuestionIcon ${className}`;
      return (
        <Icon alt="CalendarQuestion" className={classNames} {...propsRest}>
