import React, { FC } from 'react';
    ...
    export const CalendarRefreshIcon: FC<IconInterface> = function CalendarRefreshIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CalendarRefreshIcon ${className}`;
      return (
        <Icon alt="CalendarRefresh" className={classNames} {...propsRest}>
    ...
    CalendarRefreshIcon.displayName = 'CalendarRefreshIcon';
