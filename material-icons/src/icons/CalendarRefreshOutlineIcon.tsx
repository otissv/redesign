import React, { FC } from 'react';
    ...
    export const CalendarRefreshOutlineIcon: FC<IconInterface> = function CalendarRefreshOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CalendarRefreshOutlineIcon ${className}`;
      return (
        <Icon alt="CalendarRefreshOutline" className={classNames} {...propsRest}>
    ...
    CalendarRefreshOutlineIcon.displayName = 'CalendarRefreshOutlineIcon';
