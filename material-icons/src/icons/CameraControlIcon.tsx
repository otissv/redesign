import React, { FC } from 'react';
    ...
    export const CameraControlIcon: FC<IconInterface> = function CameraControlIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraControlIcon ${className}`;
      return (
        <Icon alt="CameraControl" className={classNames} {...propsRest}>
