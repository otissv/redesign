import React, { FC } from 'react';
    ...
    export const CameraEnhanceOutlineIcon: FC<IconInterface> = function CameraEnhanceOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraEnhanceOutlineIcon ${className}`;
      return (
        <Icon alt="CameraEnhanceOutline" className={classNames} {...propsRest}>
