import React, { FC } from 'react';
    ...
    export const CameraFrontVariantIcon: FC<IconInterface> = function CameraFrontVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraFrontVariantIcon ${className}`;
      return (
        <Icon alt="CameraFrontVariant" className={classNames} {...propsRest}>
