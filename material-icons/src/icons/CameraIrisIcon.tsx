import React, { FC } from 'react';
    ...
    export const CameraIrisIcon: FC<IconInterface> = function CameraIrisIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraIrisIcon ${className}`;
      return (
        <Icon alt="CameraIris" className={classNames} {...propsRest}>
    ...
    CameraIrisIcon.displayName = 'CameraIrisIcon';
