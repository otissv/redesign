import React, { FC } from 'react';
    ...
    export const CameraMeteringCenterIcon: FC<IconInterface> = function CameraMeteringCenterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraMeteringCenterIcon ${className}`;
      return (
        <Icon alt="CameraMeteringCenter" className={classNames} {...propsRest}>
    ...
    CameraMeteringCenterIcon.displayName = 'CameraMeteringCenterIcon';
