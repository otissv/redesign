import React, { FC } from 'react';
    ...
    export const CameraMeteringPartialIcon: FC<IconInterface> = function CameraMeteringPartialIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraMeteringPartialIcon ${className}`;
      return (
        <Icon alt="CameraMeteringPartial" className={classNames} {...propsRest}>
    ...
    CameraMeteringPartialIcon.displayName = 'CameraMeteringPartialIcon';
