import React, { FC } from 'react';
    ...
    export const CameraOutlineIcon: FC<IconInterface> = function CameraOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraOutlineIcon ${className}`;
      return (
        <Icon alt="CameraOutline" className={classNames} {...propsRest}>
