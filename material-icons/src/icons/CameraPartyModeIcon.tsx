import React, { FC } from 'react';
    ...
    export const CameraPartyModeIcon: FC<IconInterface> = function CameraPartyModeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraPartyModeIcon ${className}`;
      return (
        <Icon alt="CameraPartyMode" className={classNames} {...propsRest}>
