import React, { FC } from 'react';
    ...
    export const CameraPlusOutlineIcon: FC<IconInterface> = function CameraPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraPlusOutlineIcon ${className}`;
      return (
        <Icon alt="CameraPlusOutline" className={classNames} {...propsRest}>
