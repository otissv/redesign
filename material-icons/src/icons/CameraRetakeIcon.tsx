import React, { FC } from 'react';
    ...
    export const CameraRetakeIcon: FC<IconInterface> = function CameraRetakeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraRetakeIcon ${className}`;
      return (
        <Icon alt="CameraRetake" className={classNames} {...propsRest}>
    ...
    CameraRetakeIcon.displayName = 'CameraRetakeIcon';
