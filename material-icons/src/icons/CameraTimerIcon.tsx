import React, { FC } from 'react';
    ...
    export const CameraTimerIcon: FC<IconInterface> = function CameraTimerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraTimerIcon ${className}`;
      return (
        <Icon alt="CameraTimer" className={classNames} {...propsRest}>
    ...
    CameraTimerIcon.displayName = 'CameraTimerIcon';
