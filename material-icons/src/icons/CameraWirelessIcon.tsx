import React, { FC } from 'react';
    ...
    export const CameraWirelessIcon: FC<IconInterface> = function CameraWirelessIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraWirelessIcon ${className}`;
      return (
        <Icon alt="CameraWireless" className={classNames} {...propsRest}>
