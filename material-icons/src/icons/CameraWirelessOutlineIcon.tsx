import React, { FC } from 'react';
    ...
    export const CameraWirelessOutlineIcon: FC<IconInterface> = function CameraWirelessOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CameraWirelessOutlineIcon ${className}`;
      return (
        <Icon alt="CameraWirelessOutline" className={classNames} {...propsRest}>
