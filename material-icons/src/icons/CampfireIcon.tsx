import React, { FC } from 'react';
    ...
    export const CampfireIcon: FC<IconInterface> = function CampfireIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CampfireIcon ${className}`;
      return (
        <Icon alt="Campfire" className={classNames} {...propsRest}>
