import React, { FC } from 'react';
    ...
    export const CandycaneIcon: FC<IconInterface> = function CandycaneIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CandycaneIcon ${className}`;
      return (
        <Icon alt="Candycane" className={classNames} {...propsRest}>
