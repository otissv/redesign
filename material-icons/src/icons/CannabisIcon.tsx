import React, { FC } from 'react';
    ...
    export const CannabisIcon: FC<IconInterface> = function CannabisIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CannabisIcon ${className}`;
      return (
        <Icon alt="Cannabis" className={classNames} {...propsRest}>
