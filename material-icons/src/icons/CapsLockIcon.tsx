import React, { FC } from 'react';
    ...
    export const CapsLockIcon: FC<IconInterface> = function CapsLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CapsLockIcon ${className}`;
      return (
        <Icon alt="CapsLock" className={classNames} {...propsRest}>
