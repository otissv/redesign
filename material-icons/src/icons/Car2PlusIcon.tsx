import React, { FC } from 'react';
    ...
    export const Car2PlusIcon: FC<IconInterface> = function Car2PlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Car2PlusIcon ${className}`;
      return (
        <Icon alt="Car2Plus" className={classNames} {...propsRest}>
    ...
    Car2PlusIcon.displayName = 'Car2PlusIcon';
