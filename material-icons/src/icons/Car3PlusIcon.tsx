import React, { FC } from 'react';
    ...
    export const Car3PlusIcon: FC<IconInterface> = function Car3PlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Car3PlusIcon ${className}`;
      return (
        <Icon alt="Car3Plus" className={classNames} {...propsRest}>
    ...
    Car3PlusIcon.displayName = 'Car3PlusIcon';
