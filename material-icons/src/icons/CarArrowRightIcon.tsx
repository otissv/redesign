import React, { FC } from 'react';
    ...
    export const CarArrowRightIcon: FC<IconInterface> = function CarArrowRightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarArrowRightIcon ${className}`;
      return (
        <Icon alt="CarArrowRight" className={classNames} {...propsRest}>
    ...
    CarArrowRightIcon.displayName = 'CarArrowRightIcon';
