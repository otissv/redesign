import React, { FC } from 'react';
    ...
    export const CarBrakeAbsIcon: FC<IconInterface> = function CarBrakeAbsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarBrakeAbsIcon ${className}`;
      return (
        <Icon alt="CarBrakeAbs" className={classNames} {...propsRest}>
