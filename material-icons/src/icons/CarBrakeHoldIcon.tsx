import React, { FC } from 'react';
    ...
    export const CarBrakeHoldIcon: FC<IconInterface> = function CarBrakeHoldIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarBrakeHoldIcon ${className}`;
      return (
        <Icon alt="CarBrakeHold" className={classNames} {...propsRest}>
