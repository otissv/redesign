import React, { FC } from 'react';
    ...
    export const CarBrakeParkingIcon: FC<IconInterface> = function CarBrakeParkingIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarBrakeParkingIcon ${className}`;
      return (
        <Icon alt="CarBrakeParking" className={classNames} {...propsRest}>
    ...
    CarBrakeParkingIcon.displayName = 'CarBrakeParkingIcon';
