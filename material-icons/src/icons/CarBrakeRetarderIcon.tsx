import React, { FC } from 'react';
    ...
    export const CarBrakeRetarderIcon: FC<IconInterface> = function CarBrakeRetarderIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarBrakeRetarderIcon ${className}`;
      return (
        <Icon alt="CarBrakeRetarder" className={classNames} {...propsRest}>
    ...
    CarBrakeRetarderIcon.displayName = 'CarBrakeRetarderIcon';
