import React, { FC } from 'react';
    ...
    export const CarConnectedIcon: FC<IconInterface> = function CarConnectedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarConnectedIcon ${className}`;
      return (
        <Icon alt="CarConnected" className={classNames} {...propsRest}>
