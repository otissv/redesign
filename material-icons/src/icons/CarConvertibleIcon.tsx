import React, { FC } from 'react';
    ...
    export const CarConvertibleIcon: FC<IconInterface> = function CarConvertibleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarConvertibleIcon ${className}`;
      return (
        <Icon alt="CarConvertible" className={classNames} {...propsRest}>
    ...
    CarConvertibleIcon.displayName = 'CarConvertibleIcon';
