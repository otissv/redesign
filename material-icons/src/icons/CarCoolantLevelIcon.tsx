import React, { FC } from 'react';
    ...
    export const CarCoolantLevelIcon: FC<IconInterface> = function CarCoolantLevelIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarCoolantLevelIcon ${className}`;
      return (
        <Icon alt="CarCoolantLevel" className={classNames} {...propsRest}>
    ...
    CarCoolantLevelIcon.displayName = 'CarCoolantLevelIcon';
