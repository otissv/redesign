import React, { FC } from 'react';
    ...
    export const CarCruiseControlIcon: FC<IconInterface> = function CarCruiseControlIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarCruiseControlIcon ${className}`;
      return (
        <Icon alt="CarCruiseControl" className={classNames} {...propsRest}>
