import React, { FC } from 'react';
    ...
    export const CarDefrostFrontIcon: FC<IconInterface> = function CarDefrostFrontIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarDefrostFrontIcon ${className}`;
      return (
        <Icon alt="CarDefrostFront" className={classNames} {...propsRest}>
