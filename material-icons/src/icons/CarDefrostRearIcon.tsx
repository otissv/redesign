import React, { FC } from 'react';
    ...
    export const CarDefrostRearIcon: FC<IconInterface> = function CarDefrostRearIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarDefrostRearIcon ${className}`;
      return (
        <Icon alt="CarDefrostRear" className={classNames} {...propsRest}>
