import React, { FC } from 'react';
    ...
    export const CarEspIcon: FC<IconInterface> = function CarEspIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarEspIcon ${className}`;
      return (
        <Icon alt="CarEsp" className={classNames} {...propsRest}>
    ...
    CarEspIcon.displayName = 'CarEspIcon';
