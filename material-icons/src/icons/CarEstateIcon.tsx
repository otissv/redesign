import React, { FC } from 'react';
    ...
    export const CarEstateIcon: FC<IconInterface> = function CarEstateIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarEstateIcon ${className}`;
      return (
        <Icon alt="CarEstate" className={classNames} {...propsRest}>
