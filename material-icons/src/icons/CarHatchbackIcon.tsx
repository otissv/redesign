import React, { FC } from 'react';
    ...
    export const CarHatchbackIcon: FC<IconInterface> = function CarHatchbackIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarHatchbackIcon ${className}`;
      return (
        <Icon alt="CarHatchback" className={classNames} {...propsRest}>
    ...
    CarHatchbackIcon.displayName = 'CarHatchbackIcon';
