import React, { FC } from 'react';
    ...
    export const CarLightDimmedIcon: FC<IconInterface> = function CarLightDimmedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarLightDimmedIcon ${className}`;
      return (
        <Icon alt="CarLightDimmed" className={classNames} {...propsRest}>
    ...
    CarLightDimmedIcon.displayName = 'CarLightDimmedIcon';
