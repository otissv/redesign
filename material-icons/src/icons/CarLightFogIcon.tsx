import React, { FC } from 'react';
    ...
    export const CarLightFogIcon: FC<IconInterface> = function CarLightFogIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarLightFogIcon ${className}`;
      return (
        <Icon alt="CarLightFog" className={classNames} {...propsRest}>
