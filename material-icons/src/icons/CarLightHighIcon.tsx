import React, { FC } from 'react';
    ...
    export const CarLightHighIcon: FC<IconInterface> = function CarLightHighIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarLightHighIcon ${className}`;
      return (
        <Icon alt="CarLightHigh" className={classNames} {...propsRest}>
