import React, { FC } from 'react';
    ...
    export const CarOutlineIcon: FC<IconInterface> = function CarOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarOutlineIcon ${className}`;
      return (
        <Icon alt="CarOutline" className={classNames} {...propsRest}>
    ...
    CarOutlineIcon.displayName = 'CarOutlineIcon';
