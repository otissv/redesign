import React, { FC } from 'react';
    ...
    export const CarParkingLightsIcon: FC<IconInterface> = function CarParkingLightsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarParkingLightsIcon ${className}`;
      return (
        <Icon alt="CarParkingLights" className={classNames} {...propsRest}>
