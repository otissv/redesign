import React, { FC } from 'react';
    ...
    export const CarPickupIcon: FC<IconInterface> = function CarPickupIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarPickupIcon ${className}`;
      return (
        <Icon alt="CarPickup" className={classNames} {...propsRest}>
