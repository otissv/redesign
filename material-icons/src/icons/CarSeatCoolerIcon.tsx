import React, { FC } from 'react';
    ...
    export const CarSeatCoolerIcon: FC<IconInterface> = function CarSeatCoolerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarSeatCoolerIcon ${className}`;
      return (
        <Icon alt="CarSeatCooler" className={classNames} {...propsRest}>
    ...
    CarSeatCoolerIcon.displayName = 'CarSeatCoolerIcon';
