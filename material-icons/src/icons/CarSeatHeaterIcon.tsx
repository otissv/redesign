import React, { FC } from 'react';
    ...
    export const CarSeatHeaterIcon: FC<IconInterface> = function CarSeatHeaterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarSeatHeaterIcon ${className}`;
      return (
        <Icon alt="CarSeatHeater" className={classNames} {...propsRest}>
    ...
    CarSeatHeaterIcon.displayName = 'CarSeatHeaterIcon';
