import React, { FC } from 'react';
    ...
    export const CarSeatIcon: FC<IconInterface> = function CarSeatIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarSeatIcon ${className}`;
      return (
        <Icon alt="CarSeat" className={classNames} {...propsRest}>
    ...
    CarSeatIcon.displayName = 'CarSeatIcon';
