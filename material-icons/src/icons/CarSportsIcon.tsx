import React, { FC } from 'react';
    ...
    export const CarSportsIcon: FC<IconInterface> = function CarSportsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarSportsIcon ${className}`;
      return (
        <Icon alt="CarSports" className={classNames} {...propsRest}>
