import React, { FC } from 'react';
    ...
    export const CarTractionControlIcon: FC<IconInterface> = function CarTractionControlIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarTractionControlIcon ${className}`;
      return (
        <Icon alt="CarTractionControl" className={classNames} {...propsRest}>
