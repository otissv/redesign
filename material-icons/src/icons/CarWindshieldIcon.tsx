import React, { FC } from 'react';
    ...
    export const CarWindshieldIcon: FC<IconInterface> = function CarWindshieldIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarWindshieldIcon ${className}`;
      return (
        <Icon alt="CarWindshield" className={classNames} {...propsRest}>
    ...
    CarWindshieldIcon.displayName = 'CarWindshieldIcon';
