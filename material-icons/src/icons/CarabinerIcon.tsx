import React, { FC } from 'react';
    ...
    export const CarabinerIcon: FC<IconInterface> = function CarabinerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CarabinerIcon ${className}`;
      return (
        <Icon alt="Carabiner" className={classNames} {...propsRest}>
    ...
    CarabinerIcon.displayName = 'CarabinerIcon';
