import React, { FC } from 'react';
    ...
    export const CardAccountDetailsIcon: FC<IconInterface> = function CardAccountDetailsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardAccountDetailsIcon ${className}`;
      return (
        <Icon alt="CardAccountDetails" className={classNames} {...propsRest}>
    ...
    CardAccountDetailsIcon.displayName = 'CardAccountDetailsIcon';
