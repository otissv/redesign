import React, { FC } from 'react';
    ...
    export const CardAccountDetailsStarIcon: FC<IconInterface> = function CardAccountDetailsStarIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardAccountDetailsStarIcon ${className}`;
      return (
        <Icon alt="CardAccountDetailsStar" className={classNames} {...propsRest}>
    ...
    CardAccountDetailsStarIcon.displayName = 'CardAccountDetailsStarIcon';
