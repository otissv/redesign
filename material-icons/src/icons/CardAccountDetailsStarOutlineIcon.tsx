import React, { FC } from 'react';
    ...
    export const CardAccountDetailsStarOutlineIcon: FC<IconInterface> = function CardAccountDetailsStarOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardAccountDetailsStarOutlineIcon ${className}`;
      return (
        <Icon alt="CardAccountDetailsStarOutline" className={classNames} {...propsRest}>
    ...
    CardAccountDetailsStarOutlineIcon.displayName = 'CardAccountDetailsStarOutlineIcon';
