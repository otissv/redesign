import React, { FC } from 'react';
    ...
    export const CardAccountMailIcon: FC<IconInterface> = function CardAccountMailIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardAccountMailIcon ${className}`;
      return (
        <Icon alt="CardAccountMail" className={classNames} {...propsRest}>
    ...
    CardAccountMailIcon.displayName = 'CardAccountMailIcon';
