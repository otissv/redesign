import React, { FC } from 'react';
    ...
    export const CardAccountMailOutlineIcon: FC<IconInterface> = function CardAccountMailOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardAccountMailOutlineIcon ${className}`;
      return (
        <Icon alt="CardAccountMailOutline" className={classNames} {...propsRest}>
    ...
    CardAccountMailOutlineIcon.displayName = 'CardAccountMailOutlineIcon';
