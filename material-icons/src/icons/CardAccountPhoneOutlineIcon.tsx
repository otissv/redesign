import React, { FC } from 'react';
    ...
    export const CardAccountPhoneOutlineIcon: FC<IconInterface> = function CardAccountPhoneOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardAccountPhoneOutlineIcon ${className}`;
      return (
        <Icon alt="CardAccountPhoneOutline" className={classNames} {...propsRest}>
    ...
    CardAccountPhoneOutlineIcon.displayName = 'CardAccountPhoneOutlineIcon';
