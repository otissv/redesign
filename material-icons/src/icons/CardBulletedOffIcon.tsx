import React, { FC } from 'react';
    ...
    export const CardBulletedOffIcon: FC<IconInterface> = function CardBulletedOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardBulletedOffIcon ${className}`;
      return (
        <Icon alt="CardBulletedOff" className={classNames} {...propsRest}>
