import React, { FC } from 'react';
    ...
    export const CardBulletedOffOutlineIcon: FC<IconInterface> = function CardBulletedOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardBulletedOffOutlineIcon ${className}`;
      return (
        <Icon alt="CardBulletedOffOutline" className={classNames} {...propsRest}>
