import React, { FC } from 'react';
    ...
    export const CardSearchIcon: FC<IconInterface> = function CardSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardSearchIcon ${className}`;
      return (
        <Icon alt="CardSearch" className={classNames} {...propsRest}>
    ...
    CardSearchIcon.displayName = 'CardSearchIcon';
