import React, { FC } from 'react';
    ...
    export const CardSearchOutlineIcon: FC<IconInterface> = function CardSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardSearchOutlineIcon ${className}`;
      return (
        <Icon alt="CardSearchOutline" className={classNames} {...propsRest}>
    ...
    CardSearchOutlineIcon.displayName = 'CardSearchOutlineIcon';
