import React, { FC } from 'react';
    ...
    export const CardsClubIcon: FC<IconInterface> = function CardsClubIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardsClubIcon ${className}`;
      return (
        <Icon alt="CardsClub" className={classNames} {...propsRest}>
    ...
    CardsClubIcon.displayName = 'CardsClubIcon';
