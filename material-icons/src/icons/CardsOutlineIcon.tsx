import React, { FC } from 'react';
    ...
    export const CardsOutlineIcon: FC<IconInterface> = function CardsOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardsOutlineIcon ${className}`;
      return (
        <Icon alt="CardsOutline" className={classNames} {...propsRest}>
    ...
    CardsOutlineIcon.displayName = 'CardsOutlineIcon';
