import React, { FC } from 'react';
    ...
    export const CardsPlayingOutlineIcon: FC<IconInterface> = function CardsPlayingOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CardsPlayingOutlineIcon ${className}`;
      return (
        <Icon alt="CardsPlayingOutline" className={classNames} {...propsRest}>
