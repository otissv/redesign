import React, { FC } from 'react';
    ...
    export const CartArrowUpIcon: FC<IconInterface> = function CartArrowUpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CartArrowUpIcon ${className}`;
      return (
        <Icon alt="CartArrowUp" className={classNames} {...propsRest}>
    ...
    CartArrowUpIcon.displayName = 'CartArrowUpIcon';
