import React, { FC } from 'react';
    ...
    export const CartPlusIcon: FC<IconInterface> = function CartPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CartPlusIcon ${className}`;
      return (
        <Icon alt="CartPlus" className={classNames} {...propsRest}>
