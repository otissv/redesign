import React, { FC } from 'react';
    ...
    export const CartRemoveIcon: FC<IconInterface> = function CartRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CartRemoveIcon ${className}`;
      return (
        <Icon alt="CartRemove" className={classNames} {...propsRest}>
