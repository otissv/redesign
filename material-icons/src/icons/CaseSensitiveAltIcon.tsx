import React, { FC } from 'react';
    ...
    export const CaseSensitiveAltIcon: FC<IconInterface> = function CaseSensitiveAltIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CaseSensitiveAltIcon ${className}`;
      return (
        <Icon alt="CaseSensitiveAlt" className={classNames} {...propsRest}>
