import React, { FC } from 'react';
    ...
    export const CashLockIcon: FC<IconInterface> = function CashLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CashLockIcon ${className}`;
      return (
        <Icon alt="CashLock" className={classNames} {...propsRest}>
    ...
    CashLockIcon.displayName = 'CashLockIcon';
