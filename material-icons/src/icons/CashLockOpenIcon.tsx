import React, { FC } from 'react';
    ...
    export const CashLockOpenIcon: FC<IconInterface> = function CashLockOpenIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CashLockOpenIcon ${className}`;
      return (
        <Icon alt="CashLockOpen" className={classNames} {...propsRest}>
    ...
    CashLockOpenIcon.displayName = 'CashLockOpenIcon';
