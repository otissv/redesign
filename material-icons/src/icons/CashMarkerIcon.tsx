import React, { FC } from 'react';
    ...
    export const CashMarkerIcon: FC<IconInterface> = function CashMarkerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CashMarkerIcon ${className}`;
      return (
        <Icon alt="CashMarker" className={classNames} {...propsRest}>
