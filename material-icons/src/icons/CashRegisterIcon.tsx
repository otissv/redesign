import React, { FC } from 'react';
    ...
    export const CashRegisterIcon: FC<IconInterface> = function CashRegisterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CashRegisterIcon ${className}`;
      return (
        <Icon alt="CashRegister" className={classNames} {...propsRest}>
