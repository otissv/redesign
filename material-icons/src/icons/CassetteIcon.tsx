import React, { FC } from 'react';
    ...
    export const CassetteIcon: FC<IconInterface> = function CassetteIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CassetteIcon ${className}`;
      return (
        <Icon alt="Cassette" className={classNames} {...propsRest}>
