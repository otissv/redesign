import React, { FC } from 'react';
    ...
    export const CastAudioIcon: FC<IconInterface> = function CastAudioIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CastAudioIcon ${className}`;
      return (
        <Icon alt="CastAudio" className={classNames} {...propsRest}>
    ...
    CastAudioIcon.displayName = 'CastAudioIcon';
