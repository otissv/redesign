import React, { FC } from 'react';
    ...
    export const CastConnectedIcon: FC<IconInterface> = function CastConnectedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CastConnectedIcon ${className}`;
      return (
        <Icon alt="CastConnected" className={classNames} {...propsRest}>
