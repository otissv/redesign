import React, { FC } from 'react';
    ...
    export const CastEducationIcon: FC<IconInterface> = function CastEducationIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CastEducationIcon ${className}`;
      return (
        <Icon alt="CastEducation" className={classNames} {...propsRest}>
