import React, { FC } from 'react';
    ...
    export const CellphoneBasicIcon: FC<IconInterface> = function CellphoneBasicIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CellphoneBasicIcon ${className}`;
      return (
        <Icon alt="CellphoneBasic" className={classNames} {...propsRest}>
