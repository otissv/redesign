import React, { FC } from 'react';
    ...
    export const CellphoneLockIcon: FC<IconInterface> = function CellphoneLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CellphoneLockIcon ${className}`;
      return (
        <Icon alt="CellphoneLock" className={classNames} {...propsRest}>
