import React, { FC } from 'react';
    ...
    export const CellphoneMessageIcon: FC<IconInterface> = function CellphoneMessageIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CellphoneMessageIcon ${className}`;
      return (
        <Icon alt="CellphoneMessage" className={classNames} {...propsRest}>
