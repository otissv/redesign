import React, { FC } from 'react';
    ...
    export const CellphoneNfcIcon: FC<IconInterface> = function CellphoneNfcIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CellphoneNfcIcon ${className}`;
      return (
        <Icon alt="CellphoneNfc" className={classNames} {...propsRest}>
