import React, { FC } from 'react';
    ...
    export const CellphoneSoundIcon: FC<IconInterface> = function CellphoneSoundIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CellphoneSoundIcon ${className}`;
      return (
        <Icon alt="CellphoneSound" className={classNames} {...propsRest}>
