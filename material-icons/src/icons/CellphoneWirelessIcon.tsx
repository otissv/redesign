import React, { FC } from 'react';
    ...
    export const CellphoneWirelessIcon: FC<IconInterface> = function CellphoneWirelessIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CellphoneWirelessIcon ${className}`;
      return (
        <Icon alt="CellphoneWireless" className={classNames} {...propsRest}>
