import React, { FC } from 'react';
    ...
    export const ChartBarStackedIcon: FC<IconInterface> = function ChartBarStackedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChartBarStackedIcon ${className}`;
      return (
        <Icon alt="ChartBarStacked" className={classNames} {...propsRest}>
