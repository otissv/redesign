import React, { FC } from 'react';
    ...
    export const ChartBellCurveIcon: FC<IconInterface> = function ChartBellCurveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChartBellCurveIcon ${className}`;
      return (
        <Icon alt="ChartBellCurve" className={classNames} {...propsRest}>
