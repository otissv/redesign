import React, { FC } from 'react';
    ...
    export const ChartBubbleIcon: FC<IconInterface> = function ChartBubbleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChartBubbleIcon ${className}`;
      return (
        <Icon alt="ChartBubble" className={classNames} {...propsRest}>
