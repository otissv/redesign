import React, { FC } from 'react';
    ...
    export const ChartDonutVariantIcon: FC<IconInterface> = function ChartDonutVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChartDonutVariantIcon ${className}`;
      return (
        <Icon alt="ChartDonutVariant" className={classNames} {...propsRest}>
    ...
    ChartDonutVariantIcon.displayName = 'ChartDonutVariantIcon';
