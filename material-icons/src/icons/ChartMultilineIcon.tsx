import React, { FC } from 'react';
    ...
    export const ChartMultilineIcon: FC<IconInterface> = function ChartMultilineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChartMultilineIcon ${className}`;
      return (
        <Icon alt="ChartMultiline" className={classNames} {...propsRest}>
