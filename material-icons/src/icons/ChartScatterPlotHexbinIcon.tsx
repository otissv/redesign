import React, { FC } from 'react';
    ...
    export const ChartScatterPlotHexbinIcon: FC<IconInterface> = function ChartScatterPlotHexbinIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChartScatterPlotHexbinIcon ${className}`;
      return (
        <Icon alt="ChartScatterPlotHexbin" className={classNames} {...propsRest}>
