import React, { FC } from 'react';
    ...
    export const ChartScatterPlotIcon: FC<IconInterface> = function ChartScatterPlotIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChartScatterPlotIcon ${className}`;
      return (
        <Icon alt="ChartScatterPlot" className={classNames} {...propsRest}>
