import React, { FC } from 'react';
    ...
    export const ChartTimelineVariantIcon: FC<IconInterface> = function ChartTimelineVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChartTimelineVariantIcon ${className}`;
      return (
        <Icon alt="ChartTimelineVariant" className={classNames} {...propsRest}>
