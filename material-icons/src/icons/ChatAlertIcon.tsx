import React, { FC } from 'react';
    ...
    export const ChatAlertIcon: FC<IconInterface> = function ChatAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChatAlertIcon ${className}`;
      return (
        <Icon alt="ChatAlert" className={classNames} {...propsRest}>
    ...
    ChatAlertIcon.displayName = 'ChatAlertIcon';
