import React, { FC } from 'react';
    ...
    export const ChatAlertOutlineIcon: FC<IconInterface> = function ChatAlertOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChatAlertOutlineIcon ${className}`;
      return (
        <Icon alt="ChatAlertOutline" className={classNames} {...propsRest}>
    ...
    ChatAlertOutlineIcon.displayName = 'ChatAlertOutlineIcon';
