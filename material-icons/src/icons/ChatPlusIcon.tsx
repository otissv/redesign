import React, { FC } from 'react';
    ...
    export const ChatPlusIcon: FC<IconInterface> = function ChatPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChatPlusIcon ${className}`;
      return (
        <Icon alt="ChatPlus" className={classNames} {...propsRest}>
    ...
    ChatPlusIcon.displayName = 'ChatPlusIcon';
