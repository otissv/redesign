import React, { FC } from 'react';
    ...
    export const ChatPlusOutlineIcon: FC<IconInterface> = function ChatPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChatPlusOutlineIcon ${className}`;
      return (
        <Icon alt="ChatPlusOutline" className={classNames} {...propsRest}>
    ...
    ChatPlusOutlineIcon.displayName = 'ChatPlusOutlineIcon';
