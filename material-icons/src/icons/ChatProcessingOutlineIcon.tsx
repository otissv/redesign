import React, { FC } from 'react';
    ...
    export const ChatProcessingOutlineIcon: FC<IconInterface> = function ChatProcessingOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChatProcessingOutlineIcon ${className}`;
      return (
        <Icon alt="ChatProcessingOutline" className={classNames} {...propsRest}>
    ...
    ChatProcessingOutlineIcon.displayName = 'ChatProcessingOutlineIcon';
