import React, { FC } from 'react';
    ...
    export const ChatRemoveOutlineIcon: FC<IconInterface> = function ChatRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChatRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="ChatRemoveOutline" className={classNames} {...propsRest}>
    ...
    ChatRemoveOutlineIcon.displayName = 'ChatRemoveOutlineIcon';
