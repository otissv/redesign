import React, { FC } from 'react';
    ...
    export const ChatSleepIcon: FC<IconInterface> = function ChatSleepIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChatSleepIcon ${className}`;
      return (
        <Icon alt="ChatSleep" className={classNames} {...propsRest}>
    ...
    ChatSleepIcon.displayName = 'ChatSleepIcon';
