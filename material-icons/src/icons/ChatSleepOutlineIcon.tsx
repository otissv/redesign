import React, { FC } from 'react';
    ...
    export const ChatSleepOutlineIcon: FC<IconInterface> = function ChatSleepOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChatSleepOutlineIcon ${className}`;
      return (
        <Icon alt="ChatSleepOutline" className={classNames} {...propsRest}>
    ...
    ChatSleepOutlineIcon.displayName = 'ChatSleepOutlineIcon';
