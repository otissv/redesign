import React, { FC } from 'react';
    ...
    export const CheckBoxMultipleOutlineIcon: FC<IconInterface> = function CheckBoxMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CheckBoxMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="CheckBoxMultipleOutline" className={classNames} {...propsRest}>
