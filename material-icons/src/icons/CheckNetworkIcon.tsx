import React, { FC } from 'react';
    ...
    export const CheckNetworkIcon: FC<IconInterface> = function CheckNetworkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CheckNetworkIcon ${className}`;
      return (
        <Icon alt="CheckNetwork" className={classNames} {...propsRest}>
