import React, { FC } from 'react';
    ...
    export const CheckNetworkOutlineIcon: FC<IconInterface> = function CheckNetworkOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CheckNetworkOutlineIcon ${className}`;
      return (
        <Icon alt="CheckNetworkOutline" className={classNames} {...propsRest}>
    ...
    CheckNetworkOutlineIcon.displayName = 'CheckNetworkOutlineIcon';
