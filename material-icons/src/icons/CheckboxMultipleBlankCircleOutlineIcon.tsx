import React, { FC } from 'react';
    ...
    export const CheckboxMultipleBlankCircleOutlineIcon: FC<IconInterface> = function CheckboxMultipleBlankCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CheckboxMultipleBlankCircleOutlineIcon ${className}`;
      return (
        <Icon alt="CheckboxMultipleBlankCircleOutline" className={classNames} {...propsRest}>
