import React, { FC } from 'react';
    ...
    export const CheckerboardRemoveIcon: FC<IconInterface> = function CheckerboardRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CheckerboardRemoveIcon ${className}`;
      return (
        <Icon alt="CheckerboardRemove" className={classNames} {...propsRest}>
    ...
    CheckerboardRemoveIcon.displayName = 'CheckerboardRemoveIcon';
