import React, { FC } from 'react';
    ...
    export const CheeseOffIcon: FC<IconInterface> = function CheeseOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CheeseOffIcon ${className}`;
      return (
        <Icon alt="CheeseOff" className={classNames} {...propsRest}>
    ...
    CheeseOffIcon.displayName = 'CheeseOffIcon';
