import React, { FC } from 'react';
    ...
    export const ChemicalWeaponIcon: FC<IconInterface> = function ChemicalWeaponIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChemicalWeaponIcon ${className}`;
      return (
        <Icon alt="ChemicalWeapon" className={classNames} {...propsRest}>
    ...
    ChemicalWeaponIcon.displayName = 'ChemicalWeaponIcon';
