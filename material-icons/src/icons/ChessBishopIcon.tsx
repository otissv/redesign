import React, { FC } from 'react';
    ...
    export const ChessBishopIcon: FC<IconInterface> = function ChessBishopIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChessBishopIcon ${className}`;
      return (
        <Icon alt="ChessBishop" className={classNames} {...propsRest}>
