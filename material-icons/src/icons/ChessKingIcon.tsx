import React, { FC } from 'react';
    ...
    export const ChessKingIcon: FC<IconInterface> = function ChessKingIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChessKingIcon ${className}`;
      return (
        <Icon alt="ChessKing" className={classNames} {...propsRest}>
