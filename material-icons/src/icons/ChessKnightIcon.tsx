import React, { FC } from 'react';
    ...
    export const ChessKnightIcon: FC<IconInterface> = function ChessKnightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChessKnightIcon ${className}`;
      return (
        <Icon alt="ChessKnight" className={classNames} {...propsRest}>
