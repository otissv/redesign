import React, { FC } from 'react';
    ...
    export const ChessPawnIcon: FC<IconInterface> = function ChessPawnIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChessPawnIcon ${className}`;
      return (
        <Icon alt="ChessPawn" className={classNames} {...propsRest}>
