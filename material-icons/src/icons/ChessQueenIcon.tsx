import React, { FC } from 'react';
    ...
    export const ChessQueenIcon: FC<IconInterface> = function ChessQueenIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChessQueenIcon ${className}`;
      return (
        <Icon alt="ChessQueen" className={classNames} {...propsRest}>
