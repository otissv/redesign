import React, { FC } from 'react';
    ...
    export const ChevronLeftBoxOutlineIcon: FC<IconInterface> = function ChevronLeftBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChevronLeftBoxOutlineIcon ${className}`;
      return (
        <Icon alt="ChevronLeftBoxOutline" className={classNames} {...propsRest}>
