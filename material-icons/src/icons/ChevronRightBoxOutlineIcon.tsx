import React, { FC } from 'react';
    ...
    export const ChevronRightBoxOutlineIcon: FC<IconInterface> = function ChevronRightBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChevronRightBoxOutlineIcon ${className}`;
      return (
        <Icon alt="ChevronRightBoxOutline" className={classNames} {...propsRest}>
