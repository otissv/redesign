import React, { FC } from 'react';
    ...
    export const ChiliHotIcon: FC<IconInterface> = function ChiliHotIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChiliHotIcon ${className}`;
      return (
        <Icon alt="ChiliHot" className={classNames} {...propsRest}>
    ...
    ChiliHotIcon.displayName = 'ChiliHotIcon';
