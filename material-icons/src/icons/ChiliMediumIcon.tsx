import React, { FC } from 'react';
    ...
    export const ChiliMediumIcon: FC<IconInterface> = function ChiliMediumIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChiliMediumIcon ${className}`;
      return (
        <Icon alt="ChiliMedium" className={classNames} {...propsRest}>
