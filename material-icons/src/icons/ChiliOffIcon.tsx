import React, { FC } from 'react';
    ...
    export const ChiliOffIcon: FC<IconInterface> = function ChiliOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ChiliOffIcon ${className}`;
      return (
        <Icon alt="ChiliOff" className={classNames} {...propsRest}>
    ...
    ChiliOffIcon.displayName = 'ChiliOffIcon';
