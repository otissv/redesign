import React, { FC } from 'react';
    ...
    export const CigarIcon: FC<IconInterface> = function CigarIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CigarIcon ${className}`;
      return (
        <Icon alt="Cigar" className={classNames} {...propsRest}>
    ...
    CigarIcon.displayName = 'CigarIcon';
