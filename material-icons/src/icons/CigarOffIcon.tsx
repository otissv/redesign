import React, { FC } from 'react';
    ...
    export const CigarOffIcon: FC<IconInterface> = function CigarOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CigarOffIcon ${className}`;
      return (
        <Icon alt="CigarOff" className={classNames} {...propsRest}>
    ...
    CigarOffIcon.displayName = 'CigarOffIcon';
