import React, { FC } from 'react';
    ...
    export const CircleEditOutlineIcon: FC<IconInterface> = function CircleEditOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CircleEditOutlineIcon ${className}`;
      return (
        <Icon alt="CircleEditOutline" className={classNames} {...propsRest}>
    ...
    CircleEditOutlineIcon.displayName = 'CircleEditOutlineIcon';
