import React, { FC } from 'react';
    ...
    export const CircleSlice1Icon: FC<IconInterface> = function CircleSlice1Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `CircleSlice1Icon ${className}`;
      return (
        <Icon alt="CircleSlice1" className={classNames} {...propsRest}>
    ...
    CircleSlice1Icon.displayName = 'CircleSlice1Icon';
