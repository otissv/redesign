import React, { FC } from 'react';
    ...
    export const CircleSlice3Icon: FC<IconInterface> = function CircleSlice3Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `CircleSlice3Icon ${className}`;
      return (
        <Icon alt="CircleSlice3" className={classNames} {...propsRest}>
    ...
    CircleSlice3Icon.displayName = 'CircleSlice3Icon';
