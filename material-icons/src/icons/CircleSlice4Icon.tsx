import React, { FC } from 'react';
    ...
    export const CircleSlice4Icon: FC<IconInterface> = function CircleSlice4Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `CircleSlice4Icon ${className}`;
      return (
        <Icon alt="CircleSlice4" className={classNames} {...propsRest}>
    ...
    CircleSlice4Icon.displayName = 'CircleSlice4Icon';
