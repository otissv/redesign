import React, { FC } from 'react';
    ...
    export const CircleSlice6Icon: FC<IconInterface> = function CircleSlice6Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `CircleSlice6Icon ${className}`;
      return (
        <Icon alt="CircleSlice6" className={classNames} {...propsRest}>
