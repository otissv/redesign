import React, { FC } from 'react';
    ...
    export const CircleSlice7Icon: FC<IconInterface> = function CircleSlice7Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `CircleSlice7Icon ${className}`;
      return (
        <Icon alt="CircleSlice7" className={classNames} {...propsRest}>
    ...
    CircleSlice7Icon.displayName = 'CircleSlice7Icon';
