import React, { FC } from 'react';
    ...
    export const CircleSlice8Icon: FC<IconInterface> = function CircleSlice8Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `CircleSlice8Icon ${className}`;
      return (
        <Icon alt="CircleSlice8" className={classNames} {...propsRest}>
