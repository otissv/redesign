import React, { FC } from 'react';
    ...
    export const CircularSawIcon: FC<IconInterface> = function CircularSawIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CircularSawIcon ${className}`;
      return (
        <Icon alt="CircularSaw" className={classNames} {...propsRest}>
