import React, { FC } from 'react';
    ...
    export const CityVariantIcon: FC<IconInterface> = function CityVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CityVariantIcon ${className}`;
      return (
        <Icon alt="CityVariant" className={classNames} {...propsRest}>
