import React, { FC } from 'react';
    ...
    export const CityVariantOutlineIcon: FC<IconInterface> = function CityVariantOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CityVariantOutlineIcon ${className}`;
      return (
        <Icon alt="CityVariantOutline" className={classNames} {...propsRest}>
