import React, { FC } from 'react';
    ...
    export const ClipboardAccountOutlineIcon: FC<IconInterface> = function ClipboardAccountOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardAccountOutlineIcon ${className}`;
      return (
        <Icon alt="ClipboardAccountOutline" className={classNames} {...propsRest}>
