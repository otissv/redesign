import React, { FC } from 'react';
    ...
    export const ClipboardAlertIcon: FC<IconInterface> = function ClipboardAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardAlertIcon ${className}`;
      return (
        <Icon alt="ClipboardAlert" className={classNames} {...propsRest}>
    ...
    ClipboardAlertIcon.displayName = 'ClipboardAlertIcon';
