import React, { FC } from 'react';
    ...
    export const ClipboardCheckIcon: FC<IconInterface> = function ClipboardCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardCheckIcon ${className}`;
      return (
        <Icon alt="ClipboardCheck" className={classNames} {...propsRest}>
