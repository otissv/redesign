import React, { FC } from 'react';
    ...
    export const ClipboardCheckMultipleIcon: FC<IconInterface> = function ClipboardCheckMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardCheckMultipleIcon ${className}`;
      return (
        <Icon alt="ClipboardCheckMultiple" className={classNames} {...propsRest}>
    ...
    ClipboardCheckMultipleIcon.displayName = 'ClipboardCheckMultipleIcon';
