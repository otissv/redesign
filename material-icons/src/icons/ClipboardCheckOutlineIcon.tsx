import React, { FC } from 'react';
    ...
    export const ClipboardCheckOutlineIcon: FC<IconInterface> = function ClipboardCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardCheckOutlineIcon ${className}`;
      return (
        <Icon alt="ClipboardCheckOutline" className={classNames} {...propsRest}>
    ...
    ClipboardCheckOutlineIcon.displayName = 'ClipboardCheckOutlineIcon';
