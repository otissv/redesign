import React, { FC } from 'react';
    ...
    export const ClipboardEditIcon: FC<IconInterface> = function ClipboardEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardEditIcon ${className}`;
      return (
        <Icon alt="ClipboardEdit" className={classNames} {...propsRest}>
