import React, { FC } from 'react';
    ...
    export const ClipboardFileIcon: FC<IconInterface> = function ClipboardFileIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardFileIcon ${className}`;
      return (
        <Icon alt="ClipboardFile" className={classNames} {...propsRest}>
    ...
    ClipboardFileIcon.displayName = 'ClipboardFileIcon';
