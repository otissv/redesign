import React, { FC } from 'react';
    ...
    export const ClipboardFlowOutlineIcon: FC<IconInterface> = function ClipboardFlowOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardFlowOutlineIcon ${className}`;
      return (
        <Icon alt="ClipboardFlowOutline" className={classNames} {...propsRest}>
    ...
    ClipboardFlowOutlineIcon.displayName = 'ClipboardFlowOutlineIcon';
