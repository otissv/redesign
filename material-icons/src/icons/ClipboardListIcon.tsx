import React, { FC } from 'react';
    ...
    export const ClipboardListIcon: FC<IconInterface> = function ClipboardListIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardListIcon ${className}`;
      return (
        <Icon alt="ClipboardList" className={classNames} {...propsRest}>
