import React, { FC } from 'react';
    ...
    export const ClipboardMultipleIcon: FC<IconInterface> = function ClipboardMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardMultipleIcon ${className}`;
      return (
        <Icon alt="ClipboardMultiple" className={classNames} {...propsRest}>
    ...
    ClipboardMultipleIcon.displayName = 'ClipboardMultipleIcon';
