import React, { FC } from 'react';
    ...
    export const ClipboardPlusOutlineIcon: FC<IconInterface> = function ClipboardPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardPlusOutlineIcon ${className}`;
      return (
        <Icon alt="ClipboardPlusOutline" className={classNames} {...propsRest}>
    ...
    ClipboardPlusOutlineIcon.displayName = 'ClipboardPlusOutlineIcon';
