import React, { FC } from 'react';
    ...
    export const ClipboardPulseIcon: FC<IconInterface> = function ClipboardPulseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardPulseIcon ${className}`;
      return (
        <Icon alt="ClipboardPulse" className={classNames} {...propsRest}>
    ...
    ClipboardPulseIcon.displayName = 'ClipboardPulseIcon';
