import React, { FC } from 'react';
    ...
    export const ClipboardPulseOutlineIcon: FC<IconInterface> = function ClipboardPulseOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardPulseOutlineIcon ${className}`;
      return (
        <Icon alt="ClipboardPulseOutline" className={classNames} {...propsRest}>
    ...
    ClipboardPulseOutlineIcon.displayName = 'ClipboardPulseOutlineIcon';
