import React, { FC } from 'react';
    ...
    export const ClipboardTextMultipleIcon: FC<IconInterface> = function ClipboardTextMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardTextMultipleIcon ${className}`;
      return (
        <Icon alt="ClipboardTextMultiple" className={classNames} {...propsRest}>
    ...
    ClipboardTextMultipleIcon.displayName = 'ClipboardTextMultipleIcon';
