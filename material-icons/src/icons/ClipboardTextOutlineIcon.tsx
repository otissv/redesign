import React, { FC } from 'react';
    ...
    export const ClipboardTextOutlineIcon: FC<IconInterface> = function ClipboardTextOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardTextOutlineIcon ${className}`;
      return (
        <Icon alt="ClipboardTextOutline" className={classNames} {...propsRest}>
    ...
    ClipboardTextOutlineIcon.displayName = 'ClipboardTextOutlineIcon';
