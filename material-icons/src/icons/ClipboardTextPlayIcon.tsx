import React, { FC } from 'react';
    ...
    export const ClipboardTextPlayIcon: FC<IconInterface> = function ClipboardTextPlayIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClipboardTextPlayIcon ${className}`;
      return (
        <Icon alt="ClipboardTextPlay" className={classNames} {...propsRest}>
