import React, { FC } from 'react';
    ...
    export const ClippyIcon: FC<IconInterface> = function ClippyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClippyIcon ${className}`;
      return (
        <Icon alt="Clippy" className={classNames} {...propsRest}>
    ...
    ClippyIcon.displayName = 'ClippyIcon';
