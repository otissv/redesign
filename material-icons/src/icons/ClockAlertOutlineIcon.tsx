import React, { FC } from 'react';
    ...
    export const ClockAlertOutlineIcon: FC<IconInterface> = function ClockAlertOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClockAlertOutlineIcon ${className}`;
      return (
        <Icon alt="ClockAlertOutline" className={classNames} {...propsRest}>
