import React, { FC } from 'react';
    ...
    export const ClockEndIcon: FC<IconInterface> = function ClockEndIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClockEndIcon ${className}`;
      return (
        <Icon alt="ClockEnd" className={classNames} {...propsRest}>
