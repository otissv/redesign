import React, { FC } from 'react';
    ...
    export const ClockOutIcon: FC<IconInterface> = function ClockOutIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ClockOutIcon ${className}`;
      return (
        <Icon alt="ClockOut" className={classNames} {...propsRest}>
    ...
    ClockOutIcon.displayName = 'ClockOutIcon';
