import React, { FC } from 'react';
    ...
    export const CloseBoxMultipleIcon: FC<IconInterface> = function CloseBoxMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloseBoxMultipleIcon ${className}`;
      return (
        <Icon alt="CloseBoxMultiple" className={classNames} {...propsRest}>
