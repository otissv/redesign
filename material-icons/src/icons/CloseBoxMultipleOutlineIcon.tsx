import React, { FC } from 'react';
    ...
    export const CloseBoxMultipleOutlineIcon: FC<IconInterface> = function CloseBoxMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloseBoxMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="CloseBoxMultipleOutline" className={classNames} {...propsRest}>
