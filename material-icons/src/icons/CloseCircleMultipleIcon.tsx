import React, { FC } from 'react';
    ...
    export const CloseCircleMultipleIcon: FC<IconInterface> = function CloseCircleMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloseCircleMultipleIcon ${className}`;
      return (
        <Icon alt="CloseCircleMultiple" className={classNames} {...propsRest}>
    ...
    CloseCircleMultipleIcon.displayName = 'CloseCircleMultipleIcon';
