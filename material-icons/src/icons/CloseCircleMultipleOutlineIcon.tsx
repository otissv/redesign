import React, { FC } from 'react';
    ...
    export const CloseCircleMultipleOutlineIcon: FC<IconInterface> = function CloseCircleMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloseCircleMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="CloseCircleMultipleOutline" className={classNames} {...propsRest}>
    ...
    CloseCircleMultipleOutlineIcon.displayName = 'CloseCircleMultipleOutlineIcon';
