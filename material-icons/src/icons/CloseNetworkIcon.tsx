import React, { FC } from 'react';
    ...
    export const CloseNetworkIcon: FC<IconInterface> = function CloseNetworkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloseNetworkIcon ${className}`;
      return (
        <Icon alt="CloseNetwork" className={classNames} {...propsRest}>
    ...
    CloseNetworkIcon.displayName = 'CloseNetworkIcon';
