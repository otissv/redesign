import React, { FC } from 'react';
    ...
    export const CloseOutlineIcon: FC<IconInterface> = function CloseOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloseOutlineIcon ${className}`;
      return (
        <Icon alt="CloseOutline" className={classNames} {...propsRest}>
