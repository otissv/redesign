import React, { FC } from 'react';
    ...
    export const CloudBracesIcon: FC<IconInterface> = function CloudBracesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudBracesIcon ${className}`;
      return (
        <Icon alt="CloudBraces" className={classNames} {...propsRest}>
