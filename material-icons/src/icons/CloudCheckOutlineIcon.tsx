import React, { FC } from 'react';
    ...
    export const CloudCheckOutlineIcon: FC<IconInterface> = function CloudCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudCheckOutlineIcon ${className}`;
      return (
        <Icon alt="CloudCheckOutline" className={classNames} {...propsRest}>
    ...
    CloudCheckOutlineIcon.displayName = 'CloudCheckOutlineIcon';
