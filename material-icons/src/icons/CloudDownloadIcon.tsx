import React, { FC } from 'react';
    ...
    export const CloudDownloadIcon: FC<IconInterface> = function CloudDownloadIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudDownloadIcon ${className}`;
      return (
        <Icon alt="CloudDownload" className={classNames} {...propsRest}>
