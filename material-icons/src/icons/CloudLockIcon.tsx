import React, { FC } from 'react';
    ...
    export const CloudLockIcon: FC<IconInterface> = function CloudLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudLockIcon ${className}`;
      return (
        <Icon alt="CloudLock" className={classNames} {...propsRest}>
