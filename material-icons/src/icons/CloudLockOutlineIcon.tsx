import React, { FC } from 'react';
    ...
    export const CloudLockOutlineIcon: FC<IconInterface> = function CloudLockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudLockOutlineIcon ${className}`;
      return (
        <Icon alt="CloudLockOutline" className={classNames} {...propsRest}>
    ...
    CloudLockOutlineIcon.displayName = 'CloudLockOutlineIcon';
