import React, { FC } from 'react';
    ...
    export const CloudOffOutlineIcon: FC<IconInterface> = function CloudOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudOffOutlineIcon ${className}`;
      return (
        <Icon alt="CloudOffOutline" className={classNames} {...propsRest}>
