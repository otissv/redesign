import React, { FC } from 'react';
    ...
    export const CloudOutlineIcon: FC<IconInterface> = function CloudOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudOutlineIcon ${className}`;
      return (
        <Icon alt="CloudOutline" className={classNames} {...propsRest}>
