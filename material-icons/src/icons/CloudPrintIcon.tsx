import React, { FC } from 'react';
    ...
    export const CloudPrintIcon: FC<IconInterface> = function CloudPrintIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudPrintIcon ${className}`;
      return (
        <Icon alt="CloudPrint" className={classNames} {...propsRest}>
    ...
    CloudPrintIcon.displayName = 'CloudPrintIcon';
