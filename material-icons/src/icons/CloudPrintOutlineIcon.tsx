import React, { FC } from 'react';
    ...
    export const CloudPrintOutlineIcon: FC<IconInterface> = function CloudPrintOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudPrintOutlineIcon ${className}`;
      return (
        <Icon alt="CloudPrintOutline" className={classNames} {...propsRest}>
