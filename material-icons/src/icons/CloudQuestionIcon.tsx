import React, { FC } from 'react';
    ...
    export const CloudQuestionIcon: FC<IconInterface> = function CloudQuestionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudQuestionIcon ${className}`;
      return (
        <Icon alt="CloudQuestion" className={classNames} {...propsRest}>
