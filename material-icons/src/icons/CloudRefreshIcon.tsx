import React, { FC } from 'react';
    ...
    export const CloudRefreshIcon: FC<IconInterface> = function CloudRefreshIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudRefreshIcon ${className}`;
      return (
        <Icon alt="CloudRefresh" className={classNames} {...propsRest}>
    ...
    CloudRefreshIcon.displayName = 'CloudRefreshIcon';
