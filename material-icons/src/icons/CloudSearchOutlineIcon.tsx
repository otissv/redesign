import React, { FC } from 'react';
    ...
    export const CloudSearchOutlineIcon: FC<IconInterface> = function CloudSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudSearchOutlineIcon ${className}`;
      return (
        <Icon alt="CloudSearchOutline" className={classNames} {...propsRest}>
