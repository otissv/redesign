import React, { FC } from 'react';
    ...
    export const CloudSyncIcon: FC<IconInterface> = function CloudSyncIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudSyncIcon ${className}`;
      return (
        <Icon alt="CloudSync" className={classNames} {...propsRest}>
