import React, { FC } from 'react';
    ...
    export const CloudSyncOutlineIcon: FC<IconInterface> = function CloudSyncOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudSyncOutlineIcon ${className}`;
      return (
        <Icon alt="CloudSyncOutline" className={classNames} {...propsRest}>
    ...
    CloudSyncOutlineIcon.displayName = 'CloudSyncOutlineIcon';
