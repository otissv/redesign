import React, { FC } from 'react';
    ...
    export const CloudTagsIcon: FC<IconInterface> = function CloudTagsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CloudTagsIcon ${className}`;
      return (
        <Icon alt="CloudTags" className={classNames} {...propsRest}>
