import React, { FC } from 'react';
    ...
    export const CoffeeOffIcon: FC<IconInterface> = function CoffeeOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CoffeeOffIcon ${className}`;
      return (
        <Icon alt="CoffeeOff" className={classNames} {...propsRest}>
