import React, { FC } from 'react';
    ...
    export const CoffeeOffOutlineIcon: FC<IconInterface> = function CoffeeOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CoffeeOffOutlineIcon ${className}`;
      return (
        <Icon alt="CoffeeOffOutline" className={classNames} {...propsRest}>
    ...
    CoffeeOffOutlineIcon.displayName = 'CoffeeOffOutlineIcon';
