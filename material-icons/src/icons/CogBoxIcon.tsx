import React, { FC } from 'react';
    ...
    export const CogBoxIcon: FC<IconInterface> = function CogBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CogBoxIcon ${className}`;
      return (
        <Icon alt="CogBox" className={classNames} {...propsRest}>
    ...
    CogBoxIcon.displayName = 'CogBoxIcon';
