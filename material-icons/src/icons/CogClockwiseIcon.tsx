import React, { FC } from 'react';
    ...
    export const CogClockwiseIcon: FC<IconInterface> = function CogClockwiseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CogClockwiseIcon ${className}`;
      return (
        <Icon alt="CogClockwise" className={classNames} {...propsRest}>
    ...
    CogClockwiseIcon.displayName = 'CogClockwiseIcon';
