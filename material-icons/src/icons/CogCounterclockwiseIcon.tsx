import React, { FC } from 'react';
    ...
    export const CogCounterclockwiseIcon: FC<IconInterface> = function CogCounterclockwiseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CogCounterclockwiseIcon ${className}`;
      return (
        <Icon alt="CogCounterclockwise" className={classNames} {...propsRest}>
    ...
    CogCounterclockwiseIcon.displayName = 'CogCounterclockwiseIcon';
