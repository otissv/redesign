import React, { FC } from 'react';
    ...
    export const CogOffIcon: FC<IconInterface> = function CogOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CogOffIcon ${className}`;
      return (
        <Icon alt="CogOff" className={classNames} {...propsRest}>
    ...
    CogOffIcon.displayName = 'CogOffIcon';
