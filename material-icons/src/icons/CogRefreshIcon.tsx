import React, { FC } from 'react';
    ...
    export const CogRefreshIcon: FC<IconInterface> = function CogRefreshIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CogRefreshIcon ${className}`;
      return (
        <Icon alt="CogRefresh" className={classNames} {...propsRest}>
    ...
    CogRefreshIcon.displayName = 'CogRefreshIcon';
