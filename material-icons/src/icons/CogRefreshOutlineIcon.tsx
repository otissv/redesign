import React, { FC } from 'react';
    ...
    export const CogRefreshOutlineIcon: FC<IconInterface> = function CogRefreshOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CogRefreshOutlineIcon ${className}`;
      return (
        <Icon alt="CogRefreshOutline" className={classNames} {...propsRest}>
    ...
    CogRefreshOutlineIcon.displayName = 'CogRefreshOutlineIcon';
