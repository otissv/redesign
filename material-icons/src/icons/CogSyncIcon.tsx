import React, { FC } from 'react';
    ...
    export const CogSyncIcon: FC<IconInterface> = function CogSyncIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CogSyncIcon ${className}`;
      return (
        <Icon alt="CogSync" className={classNames} {...propsRest}>
    ...
    CogSyncIcon.displayName = 'CogSyncIcon';
