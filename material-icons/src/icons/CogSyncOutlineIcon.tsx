import React, { FC } from 'react';
    ...
    export const CogSyncOutlineIcon: FC<IconInterface> = function CogSyncOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CogSyncOutlineIcon ${className}`;
      return (
        <Icon alt="CogSyncOutline" className={classNames} {...propsRest}>
    ...
    CogSyncOutlineIcon.displayName = 'CogSyncOutlineIcon';
