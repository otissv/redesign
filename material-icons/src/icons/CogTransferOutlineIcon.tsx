import React, { FC } from 'react';
    ...
    export const CogTransferOutlineIcon: FC<IconInterface> = function CogTransferOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CogTransferOutlineIcon ${className}`;
      return (
        <Icon alt="CogTransferOutline" className={classNames} {...propsRest}>
    ...
    CogTransferOutlineIcon.displayName = 'CogTransferOutlineIcon';
