import React, { FC } from 'react';
    ...
    export const CommentAccountIcon: FC<IconInterface> = function CommentAccountIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentAccountIcon ${className}`;
      return (
        <Icon alt="CommentAccount" className={classNames} {...propsRest}>
    ...
    CommentAccountIcon.displayName = 'CommentAccountIcon';
