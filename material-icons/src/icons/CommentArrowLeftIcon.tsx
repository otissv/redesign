import React, { FC } from 'react';
    ...
    export const CommentArrowLeftIcon: FC<IconInterface> = function CommentArrowLeftIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentArrowLeftIcon ${className}`;
      return (
        <Icon alt="CommentArrowLeft" className={classNames} {...propsRest}>
