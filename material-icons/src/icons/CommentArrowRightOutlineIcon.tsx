import React, { FC } from 'react';
    ...
    export const CommentArrowRightOutlineIcon: FC<IconInterface> = function CommentArrowRightOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentArrowRightOutlineIcon ${className}`;
      return (
        <Icon alt="CommentArrowRightOutline" className={classNames} {...propsRest}>
