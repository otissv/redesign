import React, { FC } from 'react';
    ...
    export const CommentEditOutlineIcon: FC<IconInterface> = function CommentEditOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentEditOutlineIcon ${className}`;
      return (
        <Icon alt="CommentEditOutline" className={classNames} {...propsRest}>
    ...
    CommentEditOutlineIcon.displayName = 'CommentEditOutlineIcon';
