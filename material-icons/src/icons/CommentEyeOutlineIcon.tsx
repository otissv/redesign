import React, { FC } from 'react';
    ...
    export const CommentEyeOutlineIcon: FC<IconInterface> = function CommentEyeOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentEyeOutlineIcon ${className}`;
      return (
        <Icon alt="CommentEyeOutline" className={classNames} {...propsRest}>
