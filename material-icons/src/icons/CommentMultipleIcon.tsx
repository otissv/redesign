import React, { FC } from 'react';
    ...
    export const CommentMultipleIcon: FC<IconInterface> = function CommentMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentMultipleIcon ${className}`;
      return (
        <Icon alt="CommentMultiple" className={classNames} {...propsRest}>
