import React, { FC } from 'react';
    ...
    export const CommentOutlineIcon: FC<IconInterface> = function CommentOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentOutlineIcon ${className}`;
      return (
        <Icon alt="CommentOutline" className={classNames} {...propsRest}>
