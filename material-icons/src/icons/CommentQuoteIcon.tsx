import React, { FC } from 'react';
    ...
    export const CommentQuoteIcon: FC<IconInterface> = function CommentQuoteIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentQuoteIcon ${className}`;
      return (
        <Icon alt="CommentQuote" className={classNames} {...propsRest}>
    ...
    CommentQuoteIcon.displayName = 'CommentQuoteIcon';
