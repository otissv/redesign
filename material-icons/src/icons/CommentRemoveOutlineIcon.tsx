import React, { FC } from 'react';
    ...
    export const CommentRemoveOutlineIcon: FC<IconInterface> = function CommentRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="CommentRemoveOutline" className={classNames} {...propsRest}>
    ...
    CommentRemoveOutlineIcon.displayName = 'CommentRemoveOutlineIcon';
