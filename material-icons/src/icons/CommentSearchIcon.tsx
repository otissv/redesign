import React, { FC } from 'react';
    ...
    export const CommentSearchIcon: FC<IconInterface> = function CommentSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentSearchIcon ${className}`;
      return (
        <Icon alt="CommentSearch" className={classNames} {...propsRest}>
