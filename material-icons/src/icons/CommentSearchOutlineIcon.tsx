import React, { FC } from 'react';
    ...
    export const CommentSearchOutlineIcon: FC<IconInterface> = function CommentSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentSearchOutlineIcon ${className}`;
      return (
        <Icon alt="CommentSearchOutline" className={classNames} {...propsRest}>
