import React, { FC } from 'react';
    ...
    export const CommentTextIcon: FC<IconInterface> = function CommentTextIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentTextIcon ${className}`;
      return (
        <Icon alt="CommentText" className={classNames} {...propsRest}>
