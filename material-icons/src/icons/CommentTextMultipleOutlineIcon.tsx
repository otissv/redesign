import React, { FC } from 'react';
    ...
    export const CommentTextMultipleOutlineIcon: FC<IconInterface> = function CommentTextMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CommentTextMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="CommentTextMultipleOutline" className={classNames} {...propsRest}>
