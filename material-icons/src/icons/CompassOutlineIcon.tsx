import React, { FC } from 'react';
    ...
    export const CompassOutlineIcon: FC<IconInterface> = function CompassOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CompassOutlineIcon ${className}`;
      return (
        <Icon alt="CompassOutline" className={classNames} {...propsRest}>
