import React, { FC } from 'react';
    ...
    export const ContactlessPaymentCircleOutlineIcon: FC<IconInterface> = function ContactlessPaymentCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ContactlessPaymentCircleOutlineIcon ${className}`;
      return (
        <Icon alt="ContactlessPaymentCircleOutline" className={classNames} {...propsRest}>
    ...
    ContactlessPaymentCircleOutlineIcon.displayName = 'ContactlessPaymentCircleOutlineIcon';
