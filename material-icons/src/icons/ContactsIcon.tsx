import React, { FC } from 'react';
    ...
    export const ContactsIcon: FC<IconInterface> = function ContactsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ContactsIcon ${className}`;
      return (
        <Icon alt="Contacts" className={classNames} {...propsRest}>
