import React, { FC } from 'react';
    ...
    export const ContactsOutlineIcon: FC<IconInterface> = function ContactsOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ContactsOutlineIcon ${className}`;
      return (
        <Icon alt="ContactsOutline" className={classNames} {...propsRest}>
    ...
    ContactsOutlineIcon.displayName = 'ContactsOutlineIcon';
