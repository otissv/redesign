import React, { FC } from 'react';
    ...
    export const ContrastCircleIcon: FC<IconInterface> = function ContrastCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ContrastCircleIcon ${className}`;
      return (
        <Icon alt="ContrastCircle" className={classNames} {...propsRest}>
