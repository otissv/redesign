import React, { FC } from 'react';
    ...
    export const ControllerClassicIcon: FC<IconInterface> = function ControllerClassicIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ControllerClassicIcon ${className}`;
      return (
        <Icon alt="ControllerClassic" className={classNames} {...propsRest}>
