import React, { FC } from 'react';
    ...
    export const ControllerClassicOutlineIcon: FC<IconInterface> = function ControllerClassicOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ControllerClassicOutlineIcon ${className}`;
      return (
        <Icon alt="ControllerClassicOutline" className={classNames} {...propsRest}>
