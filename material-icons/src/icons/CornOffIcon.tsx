import React, { FC } from 'react';
    ...
    export const CornOffIcon: FC<IconInterface> = function CornOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CornOffIcon ${className}`;
      return (
        <Icon alt="CornOff" className={classNames} {...propsRest}>
    ...
    CornOffIcon.displayName = 'CornOffIcon';
