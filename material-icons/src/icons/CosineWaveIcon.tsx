import React, { FC } from 'react';
    ...
    export const CosineWaveIcon: FC<IconInterface> = function CosineWaveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CosineWaveIcon ${className}`;
      return (
        <Icon alt="CosineWave" className={classNames} {...propsRest}>
    ...
    CosineWaveIcon.displayName = 'CosineWaveIcon';
