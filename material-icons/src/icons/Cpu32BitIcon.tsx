import React, { FC } from 'react';
    ...
    export const Cpu32BitIcon: FC<IconInterface> = function Cpu32BitIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Cpu32BitIcon ${className}`;
      return (
        <Icon alt="Cpu32Bit" className={classNames} {...propsRest}>
