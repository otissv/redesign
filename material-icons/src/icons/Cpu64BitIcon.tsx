import React, { FC } from 'react';
    ...
    export const Cpu64BitIcon: FC<IconInterface> = function Cpu64BitIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Cpu64BitIcon ${className}`;
      return (
        <Icon alt="Cpu64Bit" className={classNames} {...propsRest}>
