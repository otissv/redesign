import React, { FC } from 'react';
    ...
    export const CreativeCommonsIcon: FC<IconInterface> = function CreativeCommonsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreativeCommonsIcon ${className}`;
      return (
        <Icon alt="CreativeCommons" className={classNames} {...propsRest}>
