import React, { FC } from 'react';
    ...
    export const CreditCardCheckIcon: FC<IconInterface> = function CreditCardCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardCheckIcon ${className}`;
      return (
        <Icon alt="CreditCardCheck" className={classNames} {...propsRest}>
