import React, { FC } from 'react';
    ...
    export const CreditCardClockIcon: FC<IconInterface> = function CreditCardClockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardClockIcon ${className}`;
      return (
        <Icon alt="CreditCardClock" className={classNames} {...propsRest}>
