import React, { FC } from 'react';
    ...
    export const CreditCardClockOutlineIcon: FC<IconInterface> = function CreditCardClockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardClockOutlineIcon ${className}`;
      return (
        <Icon alt="CreditCardClockOutline" className={classNames} {...propsRest}>
