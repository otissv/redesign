import React, { FC } from 'react';
    ...
    export const CreditCardMarkerIcon: FC<IconInterface> = function CreditCardMarkerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardMarkerIcon ${className}`;
      return (
        <Icon alt="CreditCardMarker" className={classNames} {...propsRest}>
