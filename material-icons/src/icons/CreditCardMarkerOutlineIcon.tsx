import React, { FC } from 'react';
    ...
    export const CreditCardMarkerOutlineIcon: FC<IconInterface> = function CreditCardMarkerOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardMarkerOutlineIcon ${className}`;
      return (
        <Icon alt="CreditCardMarkerOutline" className={classNames} {...propsRest}>
    ...
    CreditCardMarkerOutlineIcon.displayName = 'CreditCardMarkerOutlineIcon';
