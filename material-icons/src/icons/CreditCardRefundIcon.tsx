import React, { FC } from 'react';
    ...
    export const CreditCardRefundIcon: FC<IconInterface> = function CreditCardRefundIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardRefundIcon ${className}`;
      return (
        <Icon alt="CreditCardRefund" className={classNames} {...propsRest}>
