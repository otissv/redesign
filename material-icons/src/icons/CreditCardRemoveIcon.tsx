import React, { FC } from 'react';
    ...
    export const CreditCardRemoveIcon: FC<IconInterface> = function CreditCardRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardRemoveIcon ${className}`;
      return (
        <Icon alt="CreditCardRemove" className={classNames} {...propsRest}>
    ...
    CreditCardRemoveIcon.displayName = 'CreditCardRemoveIcon';
