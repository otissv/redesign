import React, { FC } from 'react';
    ...
    export const CreditCardRemoveOutlineIcon: FC<IconInterface> = function CreditCardRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="CreditCardRemoveOutline" className={classNames} {...propsRest}>
    ...
    CreditCardRemoveOutlineIcon.displayName = 'CreditCardRemoveOutlineIcon';
