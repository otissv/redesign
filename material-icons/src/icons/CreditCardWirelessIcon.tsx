import React, { FC } from 'react';
    ...
    export const CreditCardWirelessIcon: FC<IconInterface> = function CreditCardWirelessIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardWirelessIcon ${className}`;
      return (
        <Icon alt="CreditCardWireless" className={classNames} {...propsRest}>
