import React, { FC } from 'react';
    ...
    export const CreditCardWirelessOffIcon: FC<IconInterface> = function CreditCardWirelessOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardWirelessOffIcon ${className}`;
      return (
        <Icon alt="CreditCardWirelessOff" className={classNames} {...propsRest}>
    ...
    CreditCardWirelessOffIcon.displayName = 'CreditCardWirelessOffIcon';
