import React, { FC } from 'react';
    ...
    export const CreditCardWirelessOffOutlineIcon: FC<IconInterface> = function CreditCardWirelessOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardWirelessOffOutlineIcon ${className}`;
      return (
        <Icon alt="CreditCardWirelessOffOutline" className={classNames} {...propsRest}>
    ...
    CreditCardWirelessOffOutlineIcon.displayName = 'CreditCardWirelessOffOutlineIcon';
