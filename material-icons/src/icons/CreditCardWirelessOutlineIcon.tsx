import React, { FC } from 'react';
    ...
    export const CreditCardWirelessOutlineIcon: FC<IconInterface> = function CreditCardWirelessOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CreditCardWirelessOutlineIcon ${className}`;
      return (
        <Icon alt="CreditCardWirelessOutline" className={classNames} {...propsRest}>
    ...
    CreditCardWirelessOutlineIcon.displayName = 'CreditCardWirelessOutlineIcon';
