import React, { FC } from 'react';
    ...
    export const CropRotateIcon: FC<IconInterface> = function CropRotateIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CropRotateIcon ${className}`;
      return (
        <Icon alt="CropRotate" className={classNames} {...propsRest}>
