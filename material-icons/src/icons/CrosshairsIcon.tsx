import React, { FC } from 'react';
    ...
    export const CrosshairsIcon: FC<IconInterface> = function CrosshairsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CrosshairsIcon ${className}`;
      return (
        <Icon alt="Crosshairs" className={classNames} {...propsRest}>
    ...
    CrosshairsIcon.displayName = 'CrosshairsIcon';
