import React, { FC } from 'react';
    ...
    export const CrosshairsQuestionIcon: FC<IconInterface> = function CrosshairsQuestionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CrosshairsQuestionIcon ${className}`;
      return (
        <Icon alt="CrosshairsQuestion" className={classNames} {...propsRest}>
    ...
    CrosshairsQuestionIcon.displayName = 'CrosshairsQuestionIcon';
