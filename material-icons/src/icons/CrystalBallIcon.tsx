import React, { FC } from 'react';
    ...
    export const CrystalBallIcon: FC<IconInterface> = function CrystalBallIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CrystalBallIcon ${className}`;
      return (
        <Icon alt="CrystalBall" className={classNames} {...propsRest}>
