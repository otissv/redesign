import React, { FC } from 'react';
    ...
    export const CubeOffOutlineIcon: FC<IconInterface> = function CubeOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CubeOffOutlineIcon ${className}`;
      return (
        <Icon alt="CubeOffOutline" className={classNames} {...propsRest}>
    ...
    CubeOffOutlineIcon.displayName = 'CubeOffOutlineIcon';
