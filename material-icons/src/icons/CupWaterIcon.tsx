import React, { FC } from 'react';
    ...
    export const CupWaterIcon: FC<IconInterface> = function CupWaterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CupWaterIcon ${className}`;
      return (
        <Icon alt="CupWater" className={classNames} {...propsRest}>
