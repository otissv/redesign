import React, { FC } from 'react';
    ...
    export const CurrencyBdtIcon: FC<IconInterface> = function CurrencyBdtIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CurrencyBdtIcon ${className}`;
      return (
        <Icon alt="CurrencyBdt" className={classNames} {...propsRest}>
