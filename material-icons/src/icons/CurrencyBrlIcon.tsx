import React, { FC } from 'react';
    ...
    export const CurrencyBrlIcon: FC<IconInterface> = function CurrencyBrlIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CurrencyBrlIcon ${className}`;
      return (
        <Icon alt="CurrencyBrl" className={classNames} {...propsRest}>
