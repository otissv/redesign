import React, { FC } from 'react';
    ...
    export const CurrencyBtcIcon: FC<IconInterface> = function CurrencyBtcIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CurrencyBtcIcon ${className}`;
      return (
        <Icon alt="CurrencyBtc" className={classNames} {...propsRest}>
