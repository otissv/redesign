import React, { FC } from 'react';
    ...
    export const CurrencyEurOffIcon: FC<IconInterface> = function CurrencyEurOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CurrencyEurOffIcon ${className}`;
      return (
        <Icon alt="CurrencyEurOff" className={classNames} {...propsRest}>
    ...
    CurrencyEurOffIcon.displayName = 'CurrencyEurOffIcon';
