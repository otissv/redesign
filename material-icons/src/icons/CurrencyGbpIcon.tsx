import React, { FC } from 'react';
    ...
    export const CurrencyGbpIcon: FC<IconInterface> = function CurrencyGbpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CurrencyGbpIcon ${className}`;
      return (
        <Icon alt="CurrencyGbp" className={classNames} {...propsRest}>
