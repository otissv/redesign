import React, { FC } from 'react';
    ...
    export const CurrencyPhpIcon: FC<IconInterface> = function CurrencyPhpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CurrencyPhpIcon ${className}`;
      return (
        <Icon alt="CurrencyPhp" className={classNames} {...propsRest}>
