import React, { FC } from 'react';
    ...
    export const CurrencyUsdOffIcon: FC<IconInterface> = function CurrencyUsdOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CurrencyUsdOffIcon ${className}`;
      return (
        <Icon alt="CurrencyUsdOff" className={classNames} {...propsRest}>
