import React, { FC } from 'react';
    ...
    export const CursorDefaultGestureIcon: FC<IconInterface> = function CursorDefaultGestureIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CursorDefaultGestureIcon ${className}`;
      return (
        <Icon alt="CursorDefaultGesture" className={classNames} {...propsRest}>
    ...
    CursorDefaultGestureIcon.displayName = 'CursorDefaultGestureIcon';
