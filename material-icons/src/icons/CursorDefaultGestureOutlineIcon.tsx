import React, { FC } from 'react';
    ...
    export const CursorDefaultGestureOutlineIcon: FC<IconInterface> = function CursorDefaultGestureOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CursorDefaultGestureOutlineIcon ${className}`;
      return (
        <Icon alt="CursorDefaultGestureOutline" className={classNames} {...propsRest}>
    ...
    CursorDefaultGestureOutlineIcon.displayName = 'CursorDefaultGestureOutlineIcon';
