import React, { FC } from 'react';
    ...
    export const CursorPointerIcon: FC<IconInterface> = function CursorPointerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `CursorPointerIcon ${className}`;
      return (
        <Icon alt="CursorPointer" className={classNames} {...propsRest}>
