import React, { FC } from 'react';
    ...
    export const DatabaseCheckIcon: FC<IconInterface> = function DatabaseCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DatabaseCheckIcon ${className}`;
      return (
        <Icon alt="DatabaseCheck" className={classNames} {...propsRest}>
