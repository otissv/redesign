import React, { FC } from 'react';
    ...
    export const DatabaseEditIcon: FC<IconInterface> = function DatabaseEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DatabaseEditIcon ${className}`;
      return (
        <Icon alt="DatabaseEdit" className={classNames} {...propsRest}>
