import React, { FC } from 'react';
    ...
    export const DatabaseImportIcon: FC<IconInterface> = function DatabaseImportIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DatabaseImportIcon ${className}`;
      return (
        <Icon alt="DatabaseImport" className={classNames} {...propsRest}>
