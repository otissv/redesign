import React, { FC } from 'react';
    ...
    export const DatabaseLockIcon: FC<IconInterface> = function DatabaseLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DatabaseLockIcon ${className}`;
      return (
        <Icon alt="DatabaseLock" className={classNames} {...propsRest}>
