import React, { FC } from 'react';
    ...
    export const DatabaseMarkerIcon: FC<IconInterface> = function DatabaseMarkerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DatabaseMarkerIcon ${className}`;
      return (
        <Icon alt="DatabaseMarker" className={classNames} {...propsRest}>
    ...
    DatabaseMarkerIcon.displayName = 'DatabaseMarkerIcon';
