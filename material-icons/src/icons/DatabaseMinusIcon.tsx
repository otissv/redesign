import React, { FC } from 'react';
    ...
    export const DatabaseMinusIcon: FC<IconInterface> = function DatabaseMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DatabaseMinusIcon ${className}`;
      return (
        <Icon alt="DatabaseMinus" className={classNames} {...propsRest}>
