import React, { FC } from 'react';
    ...
    export const DatabaseRefreshIcon: FC<IconInterface> = function DatabaseRefreshIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DatabaseRefreshIcon ${className}`;
      return (
        <Icon alt="DatabaseRefresh" className={classNames} {...propsRest}>
