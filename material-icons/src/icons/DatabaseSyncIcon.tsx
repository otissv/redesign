import React, { FC } from 'react';
    ...
    export const DatabaseSyncIcon: FC<IconInterface> = function DatabaseSyncIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DatabaseSyncIcon ${className}`;
      return (
        <Icon alt="DatabaseSync" className={classNames} {...propsRest}>
