import React, { FC } from 'react';
    ...
    export const DeathStarVariantIcon: FC<IconInterface> = function DeathStarVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DeathStarVariantIcon ${className}`;
      return (
        <Icon alt="DeathStarVariant" className={classNames} {...propsRest}>
