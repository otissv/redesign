import React, { FC } from 'react';
    ...
    export const DeathlyHallowsIcon: FC<IconInterface> = function DeathlyHallowsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DeathlyHallowsIcon ${className}`;
      return (
        <Icon alt="DeathlyHallows" className={classNames} {...propsRest}>
