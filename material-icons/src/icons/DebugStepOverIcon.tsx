import React, { FC } from 'react';
    ...
    export const DebugStepOverIcon: FC<IconInterface> = function DebugStepOverIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DebugStepOverIcon ${className}`;
      return (
        <Icon alt="DebugStepOver" className={classNames} {...propsRest}>
    ...
    DebugStepOverIcon.displayName = 'DebugStepOverIcon';
