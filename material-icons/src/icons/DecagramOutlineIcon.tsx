import React, { FC } from 'react';
    ...
    export const DecagramOutlineIcon: FC<IconInterface> = function DecagramOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DecagramOutlineIcon ${className}`;
      return (
        <Icon alt="DecagramOutline" className={classNames} {...propsRest}>
    ...
    DecagramOutlineIcon.displayName = 'DecagramOutlineIcon';
