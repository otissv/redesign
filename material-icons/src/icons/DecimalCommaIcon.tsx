import React, { FC } from 'react';
    ...
    export const DecimalCommaIcon: FC<IconInterface> = function DecimalCommaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DecimalCommaIcon ${className}`;
      return (
        <Icon alt="DecimalComma" className={classNames} {...propsRest}>
    ...
    DecimalCommaIcon.displayName = 'DecimalCommaIcon';
