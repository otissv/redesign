import React, { FC } from 'react';
    ...
    export const DecimalIncreaseIcon: FC<IconInterface> = function DecimalIncreaseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DecimalIncreaseIcon ${className}`;
      return (
        <Icon alt="DecimalIncrease" className={classNames} {...propsRest}>
