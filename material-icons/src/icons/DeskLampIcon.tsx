import React, { FC } from 'react';
    ...
    export const DeskLampIcon: FC<IconInterface> = function DeskLampIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DeskLampIcon ${className}`;
      return (
        <Icon alt="DeskLamp" className={classNames} {...propsRest}>
