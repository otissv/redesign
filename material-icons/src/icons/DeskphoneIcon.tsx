import React, { FC } from 'react';
    ...
    export const DeskphoneIcon: FC<IconInterface> = function DeskphoneIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DeskphoneIcon ${className}`;
      return (
        <Icon alt="Deskphone" className={classNames} {...propsRest}>
