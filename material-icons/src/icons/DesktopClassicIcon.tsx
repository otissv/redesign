import React, { FC } from 'react';
    ...
    export const DesktopClassicIcon: FC<IconInterface> = function DesktopClassicIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DesktopClassicIcon ${className}`;
      return (
        <Icon alt="DesktopClassic" className={classNames} {...propsRest}>
