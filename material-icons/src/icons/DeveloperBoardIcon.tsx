import React, { FC } from 'react';
    ...
    export const DeveloperBoardIcon: FC<IconInterface> = function DeveloperBoardIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DeveloperBoardIcon ${className}`;
      return (
        <Icon alt="DeveloperBoard" className={classNames} {...propsRest}>
