import React, { FC } from 'react';
    ...
    export const DiabetesIcon: FC<IconInterface> = function DiabetesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiabetesIcon ${className}`;
      return (
        <Icon alt="Diabetes" className={classNames} {...propsRest}>
    ...
    DiabetesIcon.displayName = 'DiabetesIcon';
