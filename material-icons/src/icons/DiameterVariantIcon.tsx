import React, { FC } from 'react';
    ...
    export const DiameterVariantIcon: FC<IconInterface> = function DiameterVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiameterVariantIcon ${className}`;
      return (
        <Icon alt="DiameterVariant" className={classNames} {...propsRest}>
