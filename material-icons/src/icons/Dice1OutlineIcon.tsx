import React, { FC } from 'react';
    ...
    export const Dice1OutlineIcon: FC<IconInterface> = function Dice1OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Dice1OutlineIcon ${className}`;
      return (
        <Icon alt="Dice1Outline" className={classNames} {...propsRest}>
    ...
    Dice1OutlineIcon.displayName = 'Dice1OutlineIcon';
