import React, { FC } from 'react';
    ...
    export const Dice3OutlineIcon: FC<IconInterface> = function Dice3OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Dice3OutlineIcon ${className}`;
      return (
        <Icon alt="Dice3Outline" className={classNames} {...propsRest}>
    ...
    Dice3OutlineIcon.displayName = 'Dice3OutlineIcon';
