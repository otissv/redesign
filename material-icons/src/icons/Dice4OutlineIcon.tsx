import React, { FC } from 'react';
    ...
    export const Dice4OutlineIcon: FC<IconInterface> = function Dice4OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Dice4OutlineIcon ${className}`;
      return (
        <Icon alt="Dice4Outline" className={classNames} {...propsRest}>
    ...
    Dice4OutlineIcon.displayName = 'Dice4OutlineIcon';
