import React, { FC } from 'react';
    ...
    export const Dice5OutlineIcon: FC<IconInterface> = function Dice5OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Dice5OutlineIcon ${className}`;
      return (
        <Icon alt="Dice5Outline" className={classNames} {...propsRest}>
    ...
    Dice5OutlineIcon.displayName = 'Dice5OutlineIcon';
