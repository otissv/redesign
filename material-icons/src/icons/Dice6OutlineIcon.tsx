import React, { FC } from 'react';
    ...
    export const Dice6OutlineIcon: FC<IconInterface> = function Dice6OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Dice6OutlineIcon ${className}`;
      return (
        <Icon alt="Dice6Outline" className={classNames} {...propsRest}>
    ...
    Dice6OutlineIcon.displayName = 'Dice6OutlineIcon';
