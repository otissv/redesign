import React, { FC } from 'react';
    ...
    export const DiceD10OutlineIcon: FC<IconInterface> = function DiceD10OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiceD10OutlineIcon ${className}`;
      return (
        <Icon alt="DiceD10Outline" className={classNames} {...propsRest}>
    ...
    DiceD10OutlineIcon.displayName = 'DiceD10OutlineIcon';
