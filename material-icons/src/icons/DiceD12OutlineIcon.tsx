import React, { FC } from 'react';
    ...
    export const DiceD12OutlineIcon: FC<IconInterface> = function DiceD12OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiceD12OutlineIcon ${className}`;
      return (
        <Icon alt="DiceD12Outline" className={classNames} {...propsRest}>
    ...
    DiceD12OutlineIcon.displayName = 'DiceD12OutlineIcon';
