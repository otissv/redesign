import React, { FC } from 'react';
    ...
    export const DiceD20Icon: FC<IconInterface> = function DiceD20Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiceD20Icon ${className}`;
      return (
        <Icon alt="DiceD20" className={classNames} {...propsRest}>
    ...
    DiceD20Icon.displayName = 'DiceD20Icon';
