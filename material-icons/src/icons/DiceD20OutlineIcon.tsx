import React, { FC } from 'react';
    ...
    export const DiceD20OutlineIcon: FC<IconInterface> = function DiceD20OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiceD20OutlineIcon ${className}`;
      return (
        <Icon alt="DiceD20Outline" className={classNames} {...propsRest}>
    ...
    DiceD20OutlineIcon.displayName = 'DiceD20OutlineIcon';
