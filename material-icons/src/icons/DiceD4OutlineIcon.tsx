import React, { FC } from 'react';
    ...
    export const DiceD4OutlineIcon: FC<IconInterface> = function DiceD4OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiceD4OutlineIcon ${className}`;
      return (
        <Icon alt="DiceD4Outline" className={classNames} {...propsRest}>
    ...
    DiceD4OutlineIcon.displayName = 'DiceD4OutlineIcon';
