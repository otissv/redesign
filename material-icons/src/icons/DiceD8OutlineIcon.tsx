import React, { FC } from 'react';
    ...
    export const DiceD8OutlineIcon: FC<IconInterface> = function DiceD8OutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiceD8OutlineIcon ${className}`;
      return (
        <Icon alt="DiceD8Outline" className={classNames} {...propsRest}>
    ...
    DiceD8OutlineIcon.displayName = 'DiceD8OutlineIcon';
