import React, { FC } from 'react';
    ...
    export const DiceMultipleIcon: FC<IconInterface> = function DiceMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiceMultipleIcon ${className}`;
      return (
        <Icon alt="DiceMultiple" className={classNames} {...propsRest}>
