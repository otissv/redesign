import React, { FC } from 'react';
    ...
    export const DiceMultipleOutlineIcon: FC<IconInterface> = function DiceMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DiceMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="DiceMultipleOutline" className={classNames} {...propsRest}>
    ...
    DiceMultipleOutlineIcon.displayName = 'DiceMultipleOutlineIcon';
