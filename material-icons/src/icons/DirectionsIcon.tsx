import React, { FC } from 'react';
    ...
    export const DirectionsIcon: FC<IconInterface> = function DirectionsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DirectionsIcon ${className}`;
      return (
        <Icon alt="Directions" className={classNames} {...propsRest}>
