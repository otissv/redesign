import React, { FC } from 'react';
    ...
    export const DishwasherAlertIcon: FC<IconInterface> = function DishwasherAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DishwasherAlertIcon ${className}`;
      return (
        <Icon alt="DishwasherAlert" className={classNames} {...propsRest}>
    ...
    DishwasherAlertIcon.displayName = 'DishwasherAlertIcon';
