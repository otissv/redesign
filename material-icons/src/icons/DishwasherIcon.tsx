import React, { FC } from 'react';
    ...
    export const DishwasherIcon: FC<IconInterface> = function DishwasherIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DishwasherIcon ${className}`;
      return (
        <Icon alt="Dishwasher" className={classNames} {...propsRest}>
