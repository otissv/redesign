import React, { FC } from 'react';
    ...
    export const DishwasherOffIcon: FC<IconInterface> = function DishwasherOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DishwasherOffIcon ${className}`;
      return (
        <Icon alt="DishwasherOff" className={classNames} {...propsRest}>
    ...
    DishwasherOffIcon.displayName = 'DishwasherOffIcon';
