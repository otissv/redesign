import React, { FC } from 'react';
    ...
    export const DivingFlippersIcon: FC<IconInterface> = function DivingFlippersIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DivingFlippersIcon ${className}`;
      return (
        <Icon alt="DivingFlippers" className={classNames} {...propsRest}>
    ...
    DivingFlippersIcon.displayName = 'DivingFlippersIcon';
