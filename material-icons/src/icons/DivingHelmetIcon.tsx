import React, { FC } from 'react';
    ...
    export const DivingHelmetIcon: FC<IconInterface> = function DivingHelmetIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DivingHelmetIcon ${className}`;
      return (
        <Icon alt="DivingHelmet" className={classNames} {...propsRest}>
