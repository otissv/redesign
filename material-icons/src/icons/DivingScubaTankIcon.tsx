import React, { FC } from 'react';
    ...
    export const DivingScubaTankIcon: FC<IconInterface> = function DivingScubaTankIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DivingScubaTankIcon ${className}`;
      return (
        <Icon alt="DivingScubaTank" className={classNames} {...propsRest}>
