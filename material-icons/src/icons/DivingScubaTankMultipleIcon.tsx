import React, { FC } from 'react';
    ...
    export const DivingScubaTankMultipleIcon: FC<IconInterface> = function DivingScubaTankMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DivingScubaTankMultipleIcon ${className}`;
      return (
        <Icon alt="DivingScubaTankMultiple" className={classNames} {...propsRest}>
