import React, { FC } from 'react';
    ...
    export const DivisionBoxIcon: FC<IconInterface> = function DivisionBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DivisionBoxIcon ${className}`;
      return (
        <Icon alt="DivisionBox" className={classNames} {...propsRest}>
    ...
    DivisionBoxIcon.displayName = 'DivisionBoxIcon';
