import React, { FC } from 'react';
    ...
    export const DnsOutlineIcon: FC<IconInterface> = function DnsOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DnsOutlineIcon ${className}`;
      return (
        <Icon alt="DnsOutline" className={classNames} {...propsRest}>
