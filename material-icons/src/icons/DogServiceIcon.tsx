import React, { FC } from 'react';
    ...
    export const DogServiceIcon: FC<IconInterface> = function DogServiceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DogServiceIcon ${className}`;
      return (
        <Icon alt="DogService" className={classNames} {...propsRest}>
