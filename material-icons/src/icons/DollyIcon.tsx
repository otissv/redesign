import React, { FC } from 'react';
    ...
    export const DollyIcon: FC<IconInterface> = function DollyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DollyIcon ${className}`;
      return (
        <Icon alt="Dolly" className={classNames} {...propsRest}>
    ...
    DollyIcon.displayName = 'DollyIcon';
