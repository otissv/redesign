import React, { FC } from 'react';
    ...
    export const DomainOffIcon: FC<IconInterface> = function DomainOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DomainOffIcon ${className}`;
      return (
        <Icon alt="DomainOff" className={classNames} {...propsRest}>
    ...
    DomainOffIcon.displayName = 'DomainOffIcon';
