import React, { FC } from 'react';
    ...
    export const DomainPlusIcon: FC<IconInterface> = function DomainPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DomainPlusIcon ${className}`;
      return (
        <Icon alt="DomainPlus" className={classNames} {...propsRest}>
    ...
    DomainPlusIcon.displayName = 'DomainPlusIcon';
