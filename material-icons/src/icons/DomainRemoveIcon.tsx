import React, { FC } from 'react';
    ...
    export const DomainRemoveIcon: FC<IconInterface> = function DomainRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DomainRemoveIcon ${className}`;
      return (
        <Icon alt="DomainRemove" className={classNames} {...propsRest}>
    ...
    DomainRemoveIcon.displayName = 'DomainRemoveIcon';
