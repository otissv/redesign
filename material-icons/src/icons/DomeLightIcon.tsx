import React, { FC } from 'react';
    ...
    export const DomeLightIcon: FC<IconInterface> = function DomeLightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DomeLightIcon ${className}`;
      return (
        <Icon alt="DomeLight" className={classNames} {...propsRest}>
    ...
    DomeLightIcon.displayName = 'DomeLightIcon';
