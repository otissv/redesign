import React, { FC } from 'react';
    ...
    export const DoorClosedLockIcon: FC<IconInterface> = function DoorClosedLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DoorClosedLockIcon ${className}`;
      return (
        <Icon alt="DoorClosedLock" className={classNames} {...propsRest}>
    ...
    DoorClosedLockIcon.displayName = 'DoorClosedLockIcon';
