import React, { FC } from 'react';
    ...
    export const DoorbellVideoIcon: FC<IconInterface> = function DoorbellVideoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DoorbellVideoIcon ${className}`;
      return (
        <Icon alt="DoorbellVideo" className={classNames} {...propsRest}>
