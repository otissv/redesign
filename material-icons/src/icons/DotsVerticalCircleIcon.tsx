import React, { FC } from 'react';
    ...
    export const DotsVerticalCircleIcon: FC<IconInterface> = function DotsVerticalCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DotsVerticalCircleIcon ${className}`;
      return (
        <Icon alt="DotsVerticalCircle" className={classNames} {...propsRest}>
