import React, { FC } from 'react';
    ...
    export const DotsVerticalCircleOutlineIcon: FC<IconInterface> = function DotsVerticalCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DotsVerticalCircleOutlineIcon ${className}`;
      return (
        <Icon alt="DotsVerticalCircleOutline" className={classNames} {...propsRest}>
