import React, { FC } from 'react';
    ...
    export const DragHorizontalIcon: FC<IconInterface> = function DragHorizontalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DragHorizontalIcon ${className}`;
      return (
        <Icon alt="DragHorizontal" className={classNames} {...propsRest}>
