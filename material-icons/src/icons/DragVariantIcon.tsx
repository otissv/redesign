import React, { FC } from 'react';
    ...
    export const DragVariantIcon: FC<IconInterface> = function DragVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DragVariantIcon ${className}`;
      return (
        <Icon alt="DragVariant" className={classNames} {...propsRest}>
