import React, { FC } from 'react';
    ...
    export const DrawingBoxIcon: FC<IconInterface> = function DrawingBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `DrawingBoxIcon ${className}`;
      return (
        <Icon alt="DrawingBox" className={classNames} {...propsRest}>
