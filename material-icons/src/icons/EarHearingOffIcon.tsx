import React, { FC } from 'react';
    ...
    export const EarHearingOffIcon: FC<IconInterface> = function EarHearingOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarHearingOffIcon ${className}`;
      return (
        <Icon alt="EarHearingOff" className={classNames} {...propsRest}>
