import React, { FC } from 'react';
    ...
    export const EarthArrowRightIcon: FC<IconInterface> = function EarthArrowRightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarthArrowRightIcon ${className}`;
      return (
        <Icon alt="EarthArrowRight" className={classNames} {...propsRest}>
    ...
    EarthArrowRightIcon.displayName = 'EarthArrowRightIcon';
