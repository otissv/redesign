import React, { FC } from 'react';
    ...
    export const EarthBoxIcon: FC<IconInterface> = function EarthBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarthBoxIcon ${className}`;
      return (
        <Icon alt="EarthBox" className={classNames} {...propsRest}>
    ...
    EarthBoxIcon.displayName = 'EarthBoxIcon';
