import React, { FC } from 'react';
    ...
    export const EarthBoxMinusIcon: FC<IconInterface> = function EarthBoxMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarthBoxMinusIcon ${className}`;
      return (
        <Icon alt="EarthBoxMinus" className={classNames} {...propsRest}>
    ...
    EarthBoxMinusIcon.displayName = 'EarthBoxMinusIcon';
