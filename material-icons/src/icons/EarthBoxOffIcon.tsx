import React, { FC } from 'react';
    ...
    export const EarthBoxOffIcon: FC<IconInterface> = function EarthBoxOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarthBoxOffIcon ${className}`;
      return (
        <Icon alt="EarthBoxOff" className={classNames} {...propsRest}>
