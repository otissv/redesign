import React, { FC } from 'react';
    ...
    export const EarthBoxPlusIcon: FC<IconInterface> = function EarthBoxPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarthBoxPlusIcon ${className}`;
      return (
        <Icon alt="EarthBoxPlus" className={classNames} {...propsRest}>
    ...
    EarthBoxPlusIcon.displayName = 'EarthBoxPlusIcon';
