import React, { FC } from 'react';
    ...
    export const EarthBoxRemoveIcon: FC<IconInterface> = function EarthBoxRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarthBoxRemoveIcon ${className}`;
      return (
        <Icon alt="EarthBoxRemove" className={classNames} {...propsRest}>
    ...
    EarthBoxRemoveIcon.displayName = 'EarthBoxRemoveIcon';
