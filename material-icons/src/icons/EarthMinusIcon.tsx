import React, { FC } from 'react';
    ...
    export const EarthMinusIcon: FC<IconInterface> = function EarthMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarthMinusIcon ${className}`;
      return (
        <Icon alt="EarthMinus" className={classNames} {...propsRest}>
    ...
    EarthMinusIcon.displayName = 'EarthMinusIcon';
