import React, { FC } from 'react';
    ...
    export const EarthPlusIcon: FC<IconInterface> = function EarthPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarthPlusIcon ${className}`;
      return (
        <Icon alt="EarthPlus" className={classNames} {...propsRest}>
    ...
    EarthPlusIcon.displayName = 'EarthPlusIcon';
