import React, { FC } from 'react';
    ...
    export const EarthRemoveIcon: FC<IconInterface> = function EarthRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EarthRemoveIcon ${className}`;
      return (
        <Icon alt="EarthRemove" className={classNames} {...propsRest}>
    ...
    EarthRemoveIcon.displayName = 'EarthRemoveIcon';
