import React, { FC } from 'react';
    ...
    export const EggEasterIcon: FC<IconInterface> = function EggEasterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EggEasterIcon ${className}`;
      return (
        <Icon alt="EggEaster" className={classNames} {...propsRest}>
