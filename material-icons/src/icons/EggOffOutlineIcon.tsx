import React, { FC } from 'react';
    ...
    export const EggOffOutlineIcon: FC<IconInterface> = function EggOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EggOffOutlineIcon ${className}`;
      return (
        <Icon alt="EggOffOutline" className={classNames} {...propsRest}>
    ...
    EggOffOutlineIcon.displayName = 'EggOffOutlineIcon';
