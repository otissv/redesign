import React, { FC } from 'react';
    ...
    export const ElectricSwitchIcon: FC<IconInterface> = function ElectricSwitchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ElectricSwitchIcon ${className}`;
      return (
        <Icon alt="ElectricSwitch" className={classNames} {...propsRest}>
