import React, { FC } from 'react';
    ...
    export const ElevatorPassengerIcon: FC<IconInterface> = function ElevatorPassengerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ElevatorPassengerIcon ${className}`;
      return (
        <Icon alt="ElevatorPassenger" className={classNames} {...propsRest}>
    ...
    ElevatorPassengerIcon.displayName = 'ElevatorPassengerIcon';
