import React, { FC } from 'react';
    ...
    export const EllipseOutlineIcon: FC<IconInterface> = function EllipseOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EllipseOutlineIcon ${className}`;
      return (
        <Icon alt="EllipseOutline" className={classNames} {...propsRest}>
