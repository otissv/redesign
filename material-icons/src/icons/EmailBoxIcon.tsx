import React, { FC } from 'react';
    ...
    export const EmailBoxIcon: FC<IconInterface> = function EmailBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailBoxIcon ${className}`;
      return (
        <Icon alt="EmailBox" className={classNames} {...propsRest}>
