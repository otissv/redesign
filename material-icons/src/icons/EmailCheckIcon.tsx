import React, { FC } from 'react';
    ...
    export const EmailCheckIcon: FC<IconInterface> = function EmailCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailCheckIcon ${className}`;
      return (
        <Icon alt="EmailCheck" className={classNames} {...propsRest}>
