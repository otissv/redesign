import React, { FC } from 'react';
    ...
    export const EmailEditIcon: FC<IconInterface> = function EmailEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailEditIcon ${className}`;
      return (
        <Icon alt="EmailEdit" className={classNames} {...propsRest}>
