import React, { FC } from 'react';
    ...
    export const EmailEditOutlineIcon: FC<IconInterface> = function EmailEditOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailEditOutlineIcon ${className}`;
      return (
        <Icon alt="EmailEditOutline" className={classNames} {...propsRest}>
