import React, { FC } from 'react';
    ...
    export const EmailMarkAsUnreadIcon: FC<IconInterface> = function EmailMarkAsUnreadIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailMarkAsUnreadIcon ${className}`;
      return (
        <Icon alt="EmailMarkAsUnread" className={classNames} {...propsRest}>
