import React, { FC } from 'react';
    ...
    export const EmailMinusIcon: FC<IconInterface> = function EmailMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailMinusIcon ${className}`;
      return (
        <Icon alt="EmailMinus" className={classNames} {...propsRest}>
