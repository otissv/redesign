import React, { FC } from 'react';
    ...
    export const EmailMultipleOutlineIcon: FC<IconInterface> = function EmailMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="EmailMultipleOutline" className={classNames} {...propsRest}>
