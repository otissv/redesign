import React, { FC } from 'react';
    ...
    export const EmailNewsletterIcon: FC<IconInterface> = function EmailNewsletterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailNewsletterIcon ${className}`;
      return (
        <Icon alt="EmailNewsletter" className={classNames} {...propsRest}>
    ...
    EmailNewsletterIcon.displayName = 'EmailNewsletterIcon';
