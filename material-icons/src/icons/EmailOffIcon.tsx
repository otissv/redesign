import React, { FC } from 'react';
    ...
    export const EmailOffIcon: FC<IconInterface> = function EmailOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailOffIcon ${className}`;
      return (
        <Icon alt="EmailOff" className={classNames} {...propsRest}>
    ...
    EmailOffIcon.displayName = 'EmailOffIcon';
