import React, { FC } from 'react';
    ...
    export const EmailOffOutlineIcon: FC<IconInterface> = function EmailOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailOffOutlineIcon ${className}`;
      return (
        <Icon alt="EmailOffOutline" className={classNames} {...propsRest}>
    ...
    EmailOffOutlineIcon.displayName = 'EmailOffOutlineIcon';
