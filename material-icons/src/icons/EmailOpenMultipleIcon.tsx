import React, { FC } from 'react';
    ...
    export const EmailOpenMultipleIcon: FC<IconInterface> = function EmailOpenMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailOpenMultipleIcon ${className}`;
      return (
        <Icon alt="EmailOpenMultiple" className={classNames} {...propsRest}>
