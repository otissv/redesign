import React, { FC } from 'react';
    ...
    export const EmailPlusIcon: FC<IconInterface> = function EmailPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailPlusIcon ${className}`;
      return (
        <Icon alt="EmailPlus" className={classNames} {...propsRest}>
    ...
    EmailPlusIcon.displayName = 'EmailPlusIcon';
