import React, { FC } from 'react';
    ...
    export const EmailSearchIcon: FC<IconInterface> = function EmailSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailSearchIcon ${className}`;
      return (
        <Icon alt="EmailSearch" className={classNames} {...propsRest}>
