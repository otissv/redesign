import React, { FC } from 'react';
    ...
    export const EmailSearchOutlineIcon: FC<IconInterface> = function EmailSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailSearchOutlineIcon ${className}`;
      return (
        <Icon alt="EmailSearchOutline" className={classNames} {...propsRest}>
