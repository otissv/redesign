import React, { FC } from 'react';
    ...
    export const EmailSyncIcon: FC<IconInterface> = function EmailSyncIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailSyncIcon ${className}`;
      return (
        <Icon alt="EmailSync" className={classNames} {...propsRest}>
    ...
    EmailSyncIcon.displayName = 'EmailSyncIcon';
