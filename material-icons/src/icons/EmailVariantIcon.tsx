import React, { FC } from 'react';
    ...
    export const EmailVariantIcon: FC<IconInterface> = function EmailVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmailVariantIcon ${className}`;
      return (
        <Icon alt="EmailVariant" className={classNames} {...propsRest}>
