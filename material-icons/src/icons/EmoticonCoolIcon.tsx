import React, { FC } from 'react';
    ...
    export const EmoticonCoolIcon: FC<IconInterface> = function EmoticonCoolIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonCoolIcon ${className}`;
      return (
        <Icon alt="EmoticonCool" className={classNames} {...propsRest}>
