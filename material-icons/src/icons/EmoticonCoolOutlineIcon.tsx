import React, { FC } from 'react';
    ...
    export const EmoticonCoolOutlineIcon: FC<IconInterface> = function EmoticonCoolOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonCoolOutlineIcon ${className}`;
      return (
        <Icon alt="EmoticonCoolOutline" className={classNames} {...propsRest}>
    ...
    EmoticonCoolOutlineIcon.displayName = 'EmoticonCoolOutlineIcon';
