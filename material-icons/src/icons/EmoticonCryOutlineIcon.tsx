import React, { FC } from 'react';
    ...
    export const EmoticonCryOutlineIcon: FC<IconInterface> = function EmoticonCryOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonCryOutlineIcon ${className}`;
      return (
        <Icon alt="EmoticonCryOutline" className={classNames} {...propsRest}>
