import React, { FC } from 'react';
    ...
    export const EmoticonDeadIcon: FC<IconInterface> = function EmoticonDeadIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonDeadIcon ${className}`;
      return (
        <Icon alt="EmoticonDead" className={classNames} {...propsRest}>
