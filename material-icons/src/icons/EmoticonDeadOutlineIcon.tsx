import React, { FC } from 'react';
    ...
    export const EmoticonDeadOutlineIcon: FC<IconInterface> = function EmoticonDeadOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonDeadOutlineIcon ${className}`;
      return (
        <Icon alt="EmoticonDeadOutline" className={classNames} {...propsRest}>
