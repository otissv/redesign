import React, { FC } from 'react';
    ...
    export const EmoticonDevilIcon: FC<IconInterface> = function EmoticonDevilIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonDevilIcon ${className}`;
      return (
        <Icon alt="EmoticonDevil" className={classNames} {...propsRest}>
