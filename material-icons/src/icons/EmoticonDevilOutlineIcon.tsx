import React, { FC } from 'react';
    ...
    export const EmoticonDevilOutlineIcon: FC<IconInterface> = function EmoticonDevilOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonDevilOutlineIcon ${className}`;
      return (
        <Icon alt="EmoticonDevilOutline" className={classNames} {...propsRest}>
