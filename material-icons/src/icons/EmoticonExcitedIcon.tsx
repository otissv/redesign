import React, { FC } from 'react';
    ...
    export const EmoticonExcitedIcon: FC<IconInterface> = function EmoticonExcitedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonExcitedIcon ${className}`;
      return (
        <Icon alt="EmoticonExcited" className={classNames} {...propsRest}>
