import React, { FC } from 'react';
    ...
    export const EmoticonExcitedOutlineIcon: FC<IconInterface> = function EmoticonExcitedOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonExcitedOutlineIcon ${className}`;
      return (
        <Icon alt="EmoticonExcitedOutline" className={classNames} {...propsRest}>
    ...
    EmoticonExcitedOutlineIcon.displayName = 'EmoticonExcitedOutlineIcon';
