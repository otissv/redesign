import React, { FC } from 'react';
    ...
    export const EmoticonIcon: FC<IconInterface> = function EmoticonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonIcon ${className}`;
      return (
        <Icon alt="Emoticon" className={classNames} {...propsRest}>
