import React, { FC } from 'react';
    ...
    export const EmoticonKissIcon: FC<IconInterface> = function EmoticonKissIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonKissIcon ${className}`;
      return (
        <Icon alt="EmoticonKiss" className={classNames} {...propsRest}>
