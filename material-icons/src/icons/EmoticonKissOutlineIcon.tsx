import React, { FC } from 'react';
    ...
    export const EmoticonKissOutlineIcon: FC<IconInterface> = function EmoticonKissOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonKissOutlineIcon ${className}`;
      return (
        <Icon alt="EmoticonKissOutline" className={classNames} {...propsRest}>
