import React, { FC } from 'react';
    ...
    export const EmoticonLolIcon: FC<IconInterface> = function EmoticonLolIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonLolIcon ${className}`;
      return (
        <Icon alt="EmoticonLol" className={classNames} {...propsRest}>
    ...
    EmoticonLolIcon.displayName = 'EmoticonLolIcon';
