import React, { FC } from 'react';
    ...
    export const EmoticonTongueIcon: FC<IconInterface> = function EmoticonTongueIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonTongueIcon ${className}`;
      return (
        <Icon alt="EmoticonTongue" className={classNames} {...propsRest}>
    ...
    EmoticonTongueIcon.displayName = 'EmoticonTongueIcon';
