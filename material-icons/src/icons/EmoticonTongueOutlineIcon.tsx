import React, { FC } from 'react';
    ...
    export const EmoticonTongueOutlineIcon: FC<IconInterface> = function EmoticonTongueOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonTongueOutlineIcon ${className}`;
      return (
        <Icon alt="EmoticonTongueOutline" className={classNames} {...propsRest}>
