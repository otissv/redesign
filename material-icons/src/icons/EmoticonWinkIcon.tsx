import React, { FC } from 'react';
    ...
    export const EmoticonWinkIcon: FC<IconInterface> = function EmoticonWinkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EmoticonWinkIcon ${className}`;
      return (
        <Icon alt="EmoticonWink" className={classNames} {...propsRest}>
    ...
    EmoticonWinkIcon.displayName = 'EmoticonWinkIcon';
