import React, { FC } from 'react';
    ...
    export const EngineOffOutlineIcon: FC<IconInterface> = function EngineOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EngineOffOutlineIcon ${className}`;
      return (
        <Icon alt="EngineOffOutline" className={classNames} {...propsRest}>
