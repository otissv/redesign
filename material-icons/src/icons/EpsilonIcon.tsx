import React, { FC } from 'react';
    ...
    export const EpsilonIcon: FC<IconInterface> = function EpsilonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EpsilonIcon ${className}`;
      return (
        <Icon alt="Epsilon" className={classNames} {...propsRest}>
    ...
    EpsilonIcon.displayName = 'EpsilonIcon';
