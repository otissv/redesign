import React, { FC } from 'react';
    ...
    export const EscalatorUpIcon: FC<IconInterface> = function EscalatorUpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EscalatorUpIcon ${className}`;
      return (
        <Icon alt="EscalatorUp" className={classNames} {...propsRest}>
