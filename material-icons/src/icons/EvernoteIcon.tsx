import React, { FC } from 'react';
    ...
    export const EvernoteIcon: FC<IconInterface> = function EvernoteIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EvernoteIcon ${className}`;
      return (
        <Icon alt="Evernote" className={classNames} {...propsRest}>
