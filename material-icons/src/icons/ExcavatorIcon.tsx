import React, { FC } from 'react';
    ...
    export const ExcavatorIcon: FC<IconInterface> = function ExcavatorIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ExcavatorIcon ${className}`;
      return (
        <Icon alt="Excavator" className={classNames} {...propsRest}>
