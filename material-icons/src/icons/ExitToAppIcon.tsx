import React, { FC } from 'react';
    ...
    export const ExitToAppIcon: FC<IconInterface> = function ExitToAppIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ExitToAppIcon ${className}`;
      return (
        <Icon alt="ExitToApp" className={classNames} {...propsRest}>
