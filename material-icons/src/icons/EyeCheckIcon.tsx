import React, { FC } from 'react';
    ...
    export const EyeCheckIcon: FC<IconInterface> = function EyeCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EyeCheckIcon ${className}`;
      return (
        <Icon alt="EyeCheck" className={classNames} {...propsRest}>
