import React, { FC } from 'react';
    ...
    export const EyeCircleIcon: FC<IconInterface> = function EyeCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EyeCircleIcon ${className}`;
      return (
        <Icon alt="EyeCircle" className={classNames} {...propsRest}>
