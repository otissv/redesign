import React, { FC } from 'react';
    ...
    export const EyeCircleOutlineIcon: FC<IconInterface> = function EyeCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EyeCircleOutlineIcon ${className}`;
      return (
        <Icon alt="EyeCircleOutline" className={classNames} {...propsRest}>
