import React, { FC } from 'react';
    ...
    export const EyeMinusOutlineIcon: FC<IconInterface> = function EyeMinusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EyeMinusOutlineIcon ${className}`;
      return (
        <Icon alt="EyeMinusOutline" className={classNames} {...propsRest}>
    ...
    EyeMinusOutlineIcon.displayName = 'EyeMinusOutlineIcon';
