import React, { FC } from 'react';
    ...
    export const EyePlusOutlineIcon: FC<IconInterface> = function EyePlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EyePlusOutlineIcon ${className}`;
      return (
        <Icon alt="EyePlusOutline" className={classNames} {...propsRest}>
