import React, { FC } from 'react';
    ...
    export const EyeSettingsIcon: FC<IconInterface> = function EyeSettingsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EyeSettingsIcon ${className}`;
      return (
        <Icon alt="EyeSettings" className={classNames} {...propsRest}>
    ...
    EyeSettingsIcon.displayName = 'EyeSettingsIcon';
