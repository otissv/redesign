import React, { FC } from 'react';
    ...
    export const EyeSettingsOutlineIcon: FC<IconInterface> = function EyeSettingsOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `EyeSettingsOutlineIcon ${className}`;
      return (
        <Icon alt="EyeSettingsOutline" className={classNames} {...propsRest}>
