import React, { FC } from 'react';
    ...
    export const FaceAgentIcon: FC<IconInterface> = function FaceAgentIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FaceAgentIcon ${className}`;
      return (
        <Icon alt="FaceAgent" className={classNames} {...propsRest}>
