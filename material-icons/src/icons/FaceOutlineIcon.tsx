import React, { FC } from 'react';
    ...
    export const FaceOutlineIcon: FC<IconInterface> = function FaceOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FaceOutlineIcon ${className}`;
      return (
        <Icon alt="FaceOutline" className={classNames} {...propsRest}>
