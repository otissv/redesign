import React, { FC } from 'react';
    ...
    export const FaceProfileIcon: FC<IconInterface> = function FaceProfileIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FaceProfileIcon ${className}`;
      return (
        <Icon alt="FaceProfile" className={classNames} {...propsRest}>
