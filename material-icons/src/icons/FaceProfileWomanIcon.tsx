import React, { FC } from 'react';
    ...
    export const FaceProfileWomanIcon: FC<IconInterface> = function FaceProfileWomanIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FaceProfileWomanIcon ${className}`;
      return (
        <Icon alt="FaceProfileWoman" className={classNames} {...propsRest}>
    ...
    FaceProfileWomanIcon.displayName = 'FaceProfileWomanIcon';
