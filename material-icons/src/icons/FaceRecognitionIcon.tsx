import React, { FC } from 'react';
    ...
    export const FaceRecognitionIcon: FC<IconInterface> = function FaceRecognitionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FaceRecognitionIcon ${className}`;
      return (
        <Icon alt="FaceRecognition" className={classNames} {...propsRest}>
