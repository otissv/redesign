import React, { FC } from 'react';
    ...
    export const FaceWomanIcon: FC<IconInterface> = function FaceWomanIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FaceWomanIcon ${className}`;
      return (
        <Icon alt="FaceWoman" className={classNames} {...propsRest}>
    ...
    FaceWomanIcon.displayName = 'FaceWomanIcon';
