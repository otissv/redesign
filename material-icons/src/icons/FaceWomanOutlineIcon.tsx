import React, { FC } from 'react';
    ...
    export const FaceWomanOutlineIcon: FC<IconInterface> = function FaceWomanOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FaceWomanOutlineIcon ${className}`;
      return (
        <Icon alt="FaceWomanOutline" className={classNames} {...propsRest}>
    ...
    FaceWomanOutlineIcon.displayName = 'FaceWomanOutlineIcon';
