import React, { FC } from 'react';
    ...
    export const FacebookMessengerIcon: FC<IconInterface> = function FacebookMessengerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FacebookMessengerIcon ${className}`;
      return (
        <Icon alt="FacebookMessenger" className={classNames} {...propsRest}>
