import React, { FC } from 'react';
    ...
    export const FacebookWorkplaceIcon: FC<IconInterface> = function FacebookWorkplaceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FacebookWorkplaceIcon ${className}`;
      return (
        <Icon alt="FacebookWorkplace" className={classNames} {...propsRest}>
