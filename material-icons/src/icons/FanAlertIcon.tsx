import React, { FC } from 'react';
    ...
    export const FanAlertIcon: FC<IconInterface> = function FanAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FanAlertIcon ${className}`;
      return (
        <Icon alt="FanAlert" className={classNames} {...propsRest}>
    ...
    FanAlertIcon.displayName = 'FanAlertIcon';
