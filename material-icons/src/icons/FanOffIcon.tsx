import React, { FC } from 'react';
    ...
    export const FanOffIcon: FC<IconInterface> = function FanOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FanOffIcon ${className}`;
      return (
        <Icon alt="FanOff" className={classNames} {...propsRest}>
    ...
    FanOffIcon.displayName = 'FanOffIcon';
