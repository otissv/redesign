import React, { FC } from 'react';
    ...
    export const FastForward10Icon: FC<IconInterface> = function FastForward10Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `FastForward10Icon ${className}`;
      return (
        <Icon alt="FastForward10" className={classNames} {...propsRest}>
