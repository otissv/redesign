import React, { FC } from 'react';
    ...
    export const FastForward5Icon: FC<IconInterface> = function FastForward5Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `FastForward5Icon ${className}`;
      return (
        <Icon alt="FastForward5" className={classNames} {...propsRest}>
    ...
    FastForward5Icon.displayName = 'FastForward5Icon';
