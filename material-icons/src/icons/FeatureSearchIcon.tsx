import React, { FC } from 'react';
    ...
    export const FeatureSearchIcon: FC<IconInterface> = function FeatureSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FeatureSearchIcon ${className}`;
      return (
        <Icon alt="FeatureSearch" className={classNames} {...propsRest}>
