import React, { FC } from 'react';
    ...
    export const FeatureSearchOutlineIcon: FC<IconInterface> = function FeatureSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FeatureSearchOutlineIcon ${className}`;
      return (
        <Icon alt="FeatureSearchOutline" className={classNames} {...propsRest}>
