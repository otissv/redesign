import React, { FC } from 'react';
    ...
    export const FileTableBoxMultipleOutlineIcon: FC<IconInterface> = function FileTableBoxMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FileTableBoxMultipleOutlineIcon ${className}`;
      return (
