import React, { FC } from 'react';
    ...
    export const FilmstripIcon: FC<IconInterface> = function FilmstripIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FilmstripIcon ${className}`;
      return (
        <Icon alt="Filmstrip" className={classNames} {...propsRest}>
