import React, { FC } from 'react';
    ...
    export const FilterMenuOutlineIcon: FC<IconInterface> = function FilterMenuOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FilterMenuOutlineIcon ${className}`;
      return (
        <Icon alt="FilterMenuOutline" className={classNames} {...propsRest}>
    ...
    FilterMenuOutlineIcon.displayName = 'FilterMenuOutlineIcon';
