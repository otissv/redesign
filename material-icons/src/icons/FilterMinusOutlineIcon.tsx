import React, { FC } from 'react';
    ...
    export const FilterMinusOutlineIcon: FC<IconInterface> = function FilterMinusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FilterMinusOutlineIcon ${className}`;
      return (
        <Icon alt="FilterMinusOutline" className={classNames} {...propsRest}>
    ...
    FilterMinusOutlineIcon.displayName = 'FilterMinusOutlineIcon';
