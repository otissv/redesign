import React, { FC } from 'react';
    ...
    export const FilterOffIcon: FC<IconInterface> = function FilterOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FilterOffIcon ${className}`;
      return (
        <Icon alt="FilterOff" className={classNames} {...propsRest}>
