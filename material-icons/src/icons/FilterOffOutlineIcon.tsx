import React, { FC } from 'react';
    ...
    export const FilterOffOutlineIcon: FC<IconInterface> = function FilterOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FilterOffOutlineIcon ${className}`;
      return (
        <Icon alt="FilterOffOutline" className={classNames} {...propsRest}>
    ...
    FilterOffOutlineIcon.displayName = 'FilterOffOutlineIcon';
