import React, { FC } from 'react';
    ...
    export const FilterPlusOutlineIcon: FC<IconInterface> = function FilterPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FilterPlusOutlineIcon ${className}`;
      return (
        <Icon alt="FilterPlusOutline" className={classNames} {...propsRest}>
