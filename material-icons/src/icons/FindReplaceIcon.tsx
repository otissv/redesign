import React, { FC } from 'react';
    ...
    export const FindReplaceIcon: FC<IconInterface> = function FindReplaceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FindReplaceIcon ${className}`;
      return (
        <Icon alt="FindReplace" className={classNames} {...propsRest}>
