import React, { FC } from 'react';
    ...
    export const FireHydrantAlertIcon: FC<IconInterface> = function FireHydrantAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FireHydrantAlertIcon ${className}`;
      return (
        <Icon alt="FireHydrantAlert" className={classNames} {...propsRest}>
    ...
    FireHydrantAlertIcon.displayName = 'FireHydrantAlertIcon';
