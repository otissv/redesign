import React, { FC } from 'react';
    ...
    export const FireHydrantIcon: FC<IconInterface> = function FireHydrantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FireHydrantIcon ${className}`;
      return (
        <Icon alt="FireHydrant" className={classNames} {...propsRest}>
