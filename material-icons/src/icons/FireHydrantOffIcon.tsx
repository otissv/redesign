import React, { FC } from 'react';
    ...
    export const FireHydrantOffIcon: FC<IconInterface> = function FireHydrantOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FireHydrantOffIcon ${className}`;
      return (
        <Icon alt="FireHydrantOff" className={classNames} {...propsRest}>
