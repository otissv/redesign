import React, { FC } from 'react';
    ...
    export const FireTruckIcon: FC<IconInterface> = function FireTruckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FireTruckIcon ${className}`;
      return (
        <Icon alt="FireTruck" className={classNames} {...propsRest}>
