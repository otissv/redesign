import React, { FC } from 'react';
    ...
    export const FirebaseIcon: FC<IconInterface> = function FirebaseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FirebaseIcon ${className}`;
      return (
        <Icon alt="Firebase" className={classNames} {...propsRest}>
