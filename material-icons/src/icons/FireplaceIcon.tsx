import React, { FC } from 'react';
    ...
    export const FireplaceIcon: FC<IconInterface> = function FireplaceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FireplaceIcon ${className}`;
      return (
        <Icon alt="Fireplace" className={classNames} {...propsRest}>
