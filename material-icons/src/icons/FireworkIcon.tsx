import React, { FC } from 'react';
    ...
    export const FireworkIcon: FC<IconInterface> = function FireworkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FireworkIcon ${className}`;
      return (
        <Icon alt="Firework" className={classNames} {...propsRest}>
