import React, { FC } from 'react';
    ...
    export const FitToPageIcon: FC<IconInterface> = function FitToPageIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FitToPageIcon ${className}`;
      return (
        <Icon alt="FitToPage" className={classNames} {...propsRest}>
    ...
    FitToPageIcon.displayName = 'FitToPageIcon';
