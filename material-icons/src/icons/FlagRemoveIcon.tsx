import React, { FC } from 'react';
    ...
    export const FlagRemoveIcon: FC<IconInterface> = function FlagRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlagRemoveIcon ${className}`;
      return (
        <Icon alt="FlagRemove" className={classNames} {...propsRest}>
