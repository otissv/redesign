import React, { FC } from 'react';
    ...
    export const FlashCircleIcon: FC<IconInterface> = function FlashCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlashCircleIcon ${className}`;
      return (
        <Icon alt="FlashCircle" className={classNames} {...propsRest}>
