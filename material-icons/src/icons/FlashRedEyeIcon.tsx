import React, { FC } from 'react';
    ...
    export const FlashRedEyeIcon: FC<IconInterface> = function FlashRedEyeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlashRedEyeIcon ${className}`;
      return (
        <Icon alt="FlashRedEye" className={classNames} {...propsRest}>
