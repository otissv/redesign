import React, { FC } from 'react';
    ...
    export const FlaskEmptyIcon: FC<IconInterface> = function FlaskEmptyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskEmptyIcon ${className}`;
      return (
        <Icon alt="FlaskEmpty" className={classNames} {...propsRest}>
