import React, { FC } from 'react';
    ...
    export const FlaskEmptyMinusIcon: FC<IconInterface> = function FlaskEmptyMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskEmptyMinusIcon ${className}`;
      return (
        <Icon alt="FlaskEmptyMinus" className={classNames} {...propsRest}>
    ...
    FlaskEmptyMinusIcon.displayName = 'FlaskEmptyMinusIcon';
