import React, { FC } from 'react';
    ...
    export const FlaskEmptyOffOutlineIcon: FC<IconInterface> = function FlaskEmptyOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskEmptyOffOutlineIcon ${className}`;
      return (
        <Icon alt="FlaskEmptyOffOutline" className={classNames} {...propsRest}>
    ...
    FlaskEmptyOffOutlineIcon.displayName = 'FlaskEmptyOffOutlineIcon';
