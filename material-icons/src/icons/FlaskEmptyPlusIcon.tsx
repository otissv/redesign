import React, { FC } from 'react';
    ...
    export const FlaskEmptyPlusIcon: FC<IconInterface> = function FlaskEmptyPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskEmptyPlusIcon ${className}`;
      return (
        <Icon alt="FlaskEmptyPlus" className={classNames} {...propsRest}>
    ...
    FlaskEmptyPlusIcon.displayName = 'FlaskEmptyPlusIcon';
