import React, { FC } from 'react';
    ...
    export const FlaskEmptyRemoveIcon: FC<IconInterface> = function FlaskEmptyRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskEmptyRemoveIcon ${className}`;
      return (
        <Icon alt="FlaskEmptyRemove" className={classNames} {...propsRest}>
    ...
    FlaskEmptyRemoveIcon.displayName = 'FlaskEmptyRemoveIcon';
