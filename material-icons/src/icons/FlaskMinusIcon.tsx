import React, { FC } from 'react';
    ...
    export const FlaskMinusIcon: FC<IconInterface> = function FlaskMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskMinusIcon ${className}`;
      return (
        <Icon alt="FlaskMinus" className={classNames} {...propsRest}>
    ...
    FlaskMinusIcon.displayName = 'FlaskMinusIcon';
