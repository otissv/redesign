import React, { FC } from 'react';
    ...
    export const FlaskMinusOutlineIcon: FC<IconInterface> = function FlaskMinusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskMinusOutlineIcon ${className}`;
      return (
        <Icon alt="FlaskMinusOutline" className={classNames} {...propsRest}>
    ...
    FlaskMinusOutlineIcon.displayName = 'FlaskMinusOutlineIcon';
