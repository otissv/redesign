import React, { FC } from 'react';
    ...
    export const FlaskOffIcon: FC<IconInterface> = function FlaskOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskOffIcon ${className}`;
      return (
        <Icon alt="FlaskOff" className={classNames} {...propsRest}>
