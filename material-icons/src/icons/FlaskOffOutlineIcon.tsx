import React, { FC } from 'react';
    ...
    export const FlaskOffOutlineIcon: FC<IconInterface> = function FlaskOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskOffOutlineIcon ${className}`;
      return (
        <Icon alt="FlaskOffOutline" className={classNames} {...propsRest}>
    ...
    FlaskOffOutlineIcon.displayName = 'FlaskOffOutlineIcon';
