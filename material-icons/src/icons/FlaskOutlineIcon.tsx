import React, { FC } from 'react';
    ...
    export const FlaskOutlineIcon: FC<IconInterface> = function FlaskOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskOutlineIcon ${className}`;
      return (
        <Icon alt="FlaskOutline" className={classNames} {...propsRest}>
    ...
    FlaskOutlineIcon.displayName = 'FlaskOutlineIcon';
