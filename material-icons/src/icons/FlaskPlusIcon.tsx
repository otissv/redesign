import React, { FC } from 'react';
    ...
    export const FlaskPlusIcon: FC<IconInterface> = function FlaskPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskPlusIcon ${className}`;
      return (
        <Icon alt="FlaskPlus" className={classNames} {...propsRest}>
    ...
    FlaskPlusIcon.displayName = 'FlaskPlusIcon';
