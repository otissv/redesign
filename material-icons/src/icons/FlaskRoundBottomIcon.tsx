import React, { FC } from 'react';
    ...
    export const FlaskRoundBottomIcon: FC<IconInterface> = function FlaskRoundBottomIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlaskRoundBottomIcon ${className}`;
      return (
        <Icon alt="FlaskRoundBottom" className={classNames} {...propsRest}>
    ...
    FlaskRoundBottomIcon.displayName = 'FlaskRoundBottomIcon';
