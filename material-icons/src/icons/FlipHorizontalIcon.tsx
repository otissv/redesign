import React, { FC } from 'react';
    ...
    export const FlipHorizontalIcon: FC<IconInterface> = function FlipHorizontalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlipHorizontalIcon ${className}`;
      return (
        <Icon alt="FlipHorizontal" className={classNames} {...propsRest}>
