import React, { FC } from 'react';
    ...
    export const FlipVerticalIcon: FC<IconInterface> = function FlipVerticalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlipVerticalIcon ${className}`;
      return (
        <Icon alt="FlipVertical" className={classNames} {...propsRest}>
