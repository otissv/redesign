import React, { FC } from 'react';
    ...
    export const FlowerPoppyIcon: FC<IconInterface> = function FlowerPoppyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlowerPoppyIcon ${className}`;
      return (
        <Icon alt="FlowerPoppy" className={classNames} {...propsRest}>
