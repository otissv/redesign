import React, { FC } from 'react';
    ...
    export const FlowerTulipIcon: FC<IconInterface> = function FlowerTulipIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlowerTulipIcon ${className}`;
      return (
        <Icon alt="FlowerTulip" className={classNames} {...propsRest}>
