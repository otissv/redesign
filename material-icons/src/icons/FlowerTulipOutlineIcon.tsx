import React, { FC } from 'react';
    ...
    export const FlowerTulipOutlineIcon: FC<IconInterface> = function FlowerTulipOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FlowerTulipOutlineIcon ${className}`;
      return (
        <Icon alt="FlowerTulipOutline" className={classNames} {...propsRest}>
