import React, { FC } from 'react';
    ...
    export const FocusAutoIcon: FC<IconInterface> = function FocusAutoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FocusAutoIcon ${className}`;
      return (
        <Icon alt="FocusAuto" className={classNames} {...propsRest}>
    ...
    FocusAutoIcon.displayName = 'FocusAutoIcon';
