import React, { FC } from 'react';
    ...
    export const FocusFieldIcon: FC<IconInterface> = function FocusFieldIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FocusFieldIcon ${className}`;
      return (
        <Icon alt="FocusField" className={classNames} {...propsRest}>
    ...
    FocusFieldIcon.displayName = 'FocusFieldIcon';
