import React, { FC } from 'react';
    ...
    export const FolderAccountIcon: FC<IconInterface> = function FolderAccountIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderAccountIcon ${className}`;
      return (
        <Icon alt="FolderAccount" className={classNames} {...propsRest}>
