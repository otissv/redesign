import React, { FC } from 'react';
    ...
    export const FolderAccountOutlineIcon: FC<IconInterface> = function FolderAccountOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderAccountOutlineIcon ${className}`;
      return (
        <Icon alt="FolderAccountOutline" className={classNames} {...propsRest}>
