import React, { FC } from 'react';
    ...
    export const FolderAlertIcon: FC<IconInterface> = function FolderAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderAlertIcon ${className}`;
      return (
        <Icon alt="FolderAlert" className={classNames} {...propsRest}>
    ...
    FolderAlertIcon.displayName = 'FolderAlertIcon';
