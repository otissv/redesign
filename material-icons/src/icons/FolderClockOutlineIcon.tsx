import React, { FC } from 'react';
    ...
    export const FolderClockOutlineIcon: FC<IconInterface> = function FolderClockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderClockOutlineIcon ${className}`;
      return (
        <Icon alt="FolderClockOutline" className={classNames} {...propsRest}>
