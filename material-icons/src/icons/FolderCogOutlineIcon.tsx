import React, { FC } from 'react';
    ...
    export const FolderCogOutlineIcon: FC<IconInterface> = function FolderCogOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderCogOutlineIcon ${className}`;
      return (
        <Icon alt="FolderCogOutline" className={classNames} {...propsRest}>
    ...
    FolderCogOutlineIcon.displayName = 'FolderCogOutlineIcon';
