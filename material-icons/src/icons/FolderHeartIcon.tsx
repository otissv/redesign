import React, { FC } from 'react';
    ...
    export const FolderHeartIcon: FC<IconInterface> = function FolderHeartIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderHeartIcon ${className}`;
      return (
        <Icon alt="FolderHeart" className={classNames} {...propsRest}>
