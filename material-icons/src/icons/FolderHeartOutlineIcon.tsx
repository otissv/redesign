import React, { FC } from 'react';
    ...
    export const FolderHeartOutlineIcon: FC<IconInterface> = function FolderHeartOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderHeartOutlineIcon ${className}`;
      return (
        <Icon alt="FolderHeartOutline" className={classNames} {...propsRest}>
    ...
    FolderHeartOutlineIcon.displayName = 'FolderHeartOutlineIcon';
