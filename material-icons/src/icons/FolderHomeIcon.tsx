import React, { FC } from 'react';
    ...
    export const FolderHomeIcon: FC<IconInterface> = function FolderHomeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderHomeIcon ${className}`;
      return (
        <Icon alt="FolderHome" className={classNames} {...propsRest}>
