import React, { FC } from 'react';
    ...
    export const FolderInformationIcon: FC<IconInterface> = function FolderInformationIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderInformationIcon ${className}`;
      return (
        <Icon alt="FolderInformation" className={classNames} {...propsRest}>
    ...
    FolderInformationIcon.displayName = 'FolderInformationIcon';
