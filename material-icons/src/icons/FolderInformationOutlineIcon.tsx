import React, { FC } from 'react';
    ...
    export const FolderInformationOutlineIcon: FC<IconInterface> = function FolderInformationOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderInformationOutlineIcon ${className}`;
      return (
        <Icon alt="FolderInformationOutline" className={classNames} {...propsRest}>
    ...
    FolderInformationOutlineIcon.displayName = 'FolderInformationOutlineIcon';
