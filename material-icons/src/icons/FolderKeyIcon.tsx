import React, { FC } from 'react';
    ...
    export const FolderKeyIcon: FC<IconInterface> = function FolderKeyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderKeyIcon ${className}`;
      return (
        <Icon alt="FolderKey" className={classNames} {...propsRest}>
