import React, { FC } from 'react';
    ...
    export const FolderKeyNetworkOutlineIcon: FC<IconInterface> = function FolderKeyNetworkOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderKeyNetworkOutlineIcon ${className}`;
      return (
        <Icon alt="FolderKeyNetworkOutline" className={classNames} {...propsRest}>
