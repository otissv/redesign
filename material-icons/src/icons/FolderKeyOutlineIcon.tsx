import React, { FC } from 'react';
    ...
    export const FolderKeyOutlineIcon: FC<IconInterface> = function FolderKeyOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderKeyOutlineIcon ${className}`;
      return (
        <Icon alt="FolderKeyOutline" className={classNames} {...propsRest}>
    ...
    FolderKeyOutlineIcon.displayName = 'FolderKeyOutlineIcon';
