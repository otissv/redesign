import React, { FC } from 'react';
    ...
    export const FolderMarkerIcon: FC<IconInterface> = function FolderMarkerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderMarkerIcon ${className}`;
      return (
        <Icon alt="FolderMarker" className={classNames} {...propsRest}>
    ...
    FolderMarkerIcon.displayName = 'FolderMarkerIcon';
