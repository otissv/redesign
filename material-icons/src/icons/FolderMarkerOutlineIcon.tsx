import React, { FC } from 'react';
    ...
    export const FolderMarkerOutlineIcon: FC<IconInterface> = function FolderMarkerOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderMarkerOutlineIcon ${className}`;
      return (
        <Icon alt="FolderMarkerOutline" className={classNames} {...propsRest}>
    ...
    FolderMarkerOutlineIcon.displayName = 'FolderMarkerOutlineIcon';
