import React, { FC } from 'react';
    ...
    export const FolderMusicIcon: FC<IconInterface> = function FolderMusicIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderMusicIcon ${className}`;
      return (
        <Icon alt="FolderMusic" className={classNames} {...propsRest}>
