import React, { FC } from 'react';
    ...
    export const FolderNetworkOutlineIcon: FC<IconInterface> = function FolderNetworkOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderNetworkOutlineIcon ${className}`;
      return (
        <Icon alt="FolderNetworkOutline" className={classNames} {...propsRest}>
