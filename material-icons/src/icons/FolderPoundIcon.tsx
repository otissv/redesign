import React, { FC } from 'react';
    ...
    export const FolderPoundIcon: FC<IconInterface> = function FolderPoundIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderPoundIcon ${className}`;
      return (
        <Icon alt="FolderPound" className={classNames} {...propsRest}>
