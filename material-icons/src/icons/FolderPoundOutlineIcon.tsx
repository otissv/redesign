import React, { FC } from 'react';
    ...
    export const FolderPoundOutlineIcon: FC<IconInterface> = function FolderPoundOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderPoundOutlineIcon ${className}`;
      return (
        <Icon alt="FolderPoundOutline" className={classNames} {...propsRest}>
