import React, { FC } from 'react';
    ...
    export const FolderRefreshIcon: FC<IconInterface> = function FolderRefreshIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderRefreshIcon ${className}`;
      return (
        <Icon alt="FolderRefresh" className={classNames} {...propsRest}>
    ...
    FolderRefreshIcon.displayName = 'FolderRefreshIcon';
