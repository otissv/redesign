import React, { FC } from 'react';
    ...
    export const FolderRefreshOutlineIcon: FC<IconInterface> = function FolderRefreshOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderRefreshOutlineIcon ${className}`;
      return (
        <Icon alt="FolderRefreshOutline" className={classNames} {...propsRest}>
    ...
    FolderRefreshOutlineIcon.displayName = 'FolderRefreshOutlineIcon';
