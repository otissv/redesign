import React, { FC } from 'react';
    ...
    export const FolderRemoveIcon: FC<IconInterface> = function FolderRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderRemoveIcon ${className}`;
      return (
        <Icon alt="FolderRemove" className={classNames} {...propsRest}>
