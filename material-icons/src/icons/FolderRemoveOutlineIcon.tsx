import React, { FC } from 'react';
    ...
    export const FolderRemoveOutlineIcon: FC<IconInterface> = function FolderRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="FolderRemoveOutline" className={classNames} {...propsRest}>
