import React, { FC } from 'react';
    ...
    export const FolderSearchIcon: FC<IconInterface> = function FolderSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderSearchIcon ${className}`;
      return (
        <Icon alt="FolderSearch" className={classNames} {...propsRest}>
