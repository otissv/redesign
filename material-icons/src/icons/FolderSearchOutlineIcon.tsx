import React, { FC } from 'react';
    ...
    export const FolderSearchOutlineIcon: FC<IconInterface> = function FolderSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderSearchOutlineIcon ${className}`;
      return (
        <Icon alt="FolderSearchOutline" className={classNames} {...propsRest}>
