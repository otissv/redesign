import React, { FC } from 'react';
    ...
    export const FolderStarMultipleIcon: FC<IconInterface> = function FolderStarMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderStarMultipleIcon ${className}`;
      return (
        <Icon alt="FolderStarMultiple" className={classNames} {...propsRest}>
    ...
    FolderStarMultipleIcon.displayName = 'FolderStarMultipleIcon';
