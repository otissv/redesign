import React, { FC } from 'react';
    ...
    export const FolderSyncIcon: FC<IconInterface> = function FolderSyncIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderSyncIcon ${className}`;
      return (
        <Icon alt="FolderSync" className={classNames} {...propsRest}>
