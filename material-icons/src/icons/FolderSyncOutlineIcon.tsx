import React, { FC } from 'react';
    ...
    export const FolderSyncOutlineIcon: FC<IconInterface> = function FolderSyncOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderSyncOutlineIcon ${className}`;
      return (
        <Icon alt="FolderSyncOutline" className={classNames} {...propsRest}>
    ...
    FolderSyncOutlineIcon.displayName = 'FolderSyncOutlineIcon';
