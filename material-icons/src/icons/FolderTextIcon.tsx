import React, { FC } from 'react';
    ...
    export const FolderTextIcon: FC<IconInterface> = function FolderTextIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FolderTextIcon ${className}`;
      return (
        <Icon alt="FolderText" className={classNames} {...propsRest}>
