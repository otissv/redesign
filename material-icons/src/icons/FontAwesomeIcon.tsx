import React, { FC } from 'react';
    ...
    export const FontAwesomeIcon: FC<IconInterface> = function FontAwesomeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FontAwesomeIcon ${className}`;
      return (
        <Icon alt="FontAwesome" className={classNames} {...propsRest}>
