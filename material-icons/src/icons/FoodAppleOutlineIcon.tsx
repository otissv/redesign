import React, { FC } from 'react';
    ...
    export const FoodAppleOutlineIcon: FC<IconInterface> = function FoodAppleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FoodAppleOutlineIcon ${className}`;
      return (
        <Icon alt="FoodAppleOutline" className={classNames} {...propsRest}>
