import React, { FC } from 'react';
    ...
    export const FoodDrumstickIcon: FC<IconInterface> = function FoodDrumstickIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FoodDrumstickIcon ${className}`;
      return (
        <Icon alt="FoodDrumstick" className={classNames} {...propsRest}>
    ...
    FoodDrumstickIcon.displayName = 'FoodDrumstickIcon';
