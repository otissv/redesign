import React, { FC } from 'react';
    ...
    export const FoodDrumstickOffIcon: FC<IconInterface> = function FoodDrumstickOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FoodDrumstickOffIcon ${className}`;
      return (
        <Icon alt="FoodDrumstickOff" className={classNames} {...propsRest}>
    ...
    FoodDrumstickOffIcon.displayName = 'FoodDrumstickOffIcon';
