import React, { FC } from 'react';
    ...
    export const FoodDrumstickOffOutlineIcon: FC<IconInterface> = function FoodDrumstickOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FoodDrumstickOffOutlineIcon ${className}`;
      return (
        <Icon alt="FoodDrumstickOffOutline" className={classNames} {...propsRest}>
    ...
    FoodDrumstickOffOutlineIcon.displayName = 'FoodDrumstickOffOutlineIcon';
