import React, { FC } from 'react';
    ...
    export const FoodForkDrinkIcon: FC<IconInterface> = function FoodForkDrinkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FoodForkDrinkIcon ${className}`;
      return (
        <Icon alt="FoodForkDrink" className={classNames} {...propsRest}>
