import React, { FC } from 'react';
    ...
    export const FoodOffIcon: FC<IconInterface> = function FoodOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FoodOffIcon ${className}`;
      return (
        <Icon alt="FoodOff" className={classNames} {...propsRest}>
    ...
    FoodOffIcon.displayName = 'FoodOffIcon';
