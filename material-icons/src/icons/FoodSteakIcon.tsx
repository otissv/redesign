import React, { FC } from 'react';
    ...
    export const FoodSteakIcon: FC<IconInterface> = function FoodSteakIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FoodSteakIcon ${className}`;
      return (
        <Icon alt="FoodSteak" className={classNames} {...propsRest}>
    ...
    FoodSteakIcon.displayName = 'FoodSteakIcon';
