import React, { FC } from 'react';
    ...
    export const FoodSteakOffIcon: FC<IconInterface> = function FoodSteakOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FoodSteakOffIcon ${className}`;
      return (
        <Icon alt="FoodSteakOff" className={classNames} {...propsRest}>
    ...
    FoodSteakOffIcon.displayName = 'FoodSteakOffIcon';
