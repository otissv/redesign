import React, { FC } from 'react';
    ...
    export const FoodVariantIcon: FC<IconInterface> = function FoodVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FoodVariantIcon ${className}`;
      return (
        <Icon alt="FoodVariant" className={classNames} {...propsRest}>
