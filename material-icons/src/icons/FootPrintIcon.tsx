import React, { FC } from 'react';
    ...
    export const FootPrintIcon: FC<IconInterface> = function FootPrintIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FootPrintIcon ${className}`;
      return (
        <Icon alt="FootPrint" className={classNames} {...propsRest}>
