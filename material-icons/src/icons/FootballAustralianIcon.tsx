import React, { FC } from 'react';
    ...
    export const FootballAustralianIcon: FC<IconInterface> = function FootballAustralianIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FootballAustralianIcon ${className}`;
      return (
        <Icon alt="FootballAustralian" className={classNames} {...propsRest}>
