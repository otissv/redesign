import React, { FC } from 'react';
    ...
    export const FootballHelmetIcon: FC<IconInterface> = function FootballHelmetIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FootballHelmetIcon ${className}`;
      return (
        <Icon alt="FootballHelmet" className={classNames} {...propsRest}>
