import React, { FC } from 'react';
    ...
    export const FootballIcon: FC<IconInterface> = function FootballIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FootballIcon ${className}`;
      return (
        <Icon alt="Football" className={classNames} {...propsRest}>
