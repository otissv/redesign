import React, { FC } from 'react';
    ...
    export const ForkliftIcon: FC<IconInterface> = function ForkliftIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ForkliftIcon ${className}`;
      return (
        <Icon alt="Forklift" className={classNames} {...propsRest}>
