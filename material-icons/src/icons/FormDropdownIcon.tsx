import React, { FC } from 'react';
    ...
    export const FormDropdownIcon: FC<IconInterface> = function FormDropdownIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormDropdownIcon ${className}`;
      return (
        <Icon alt="FormDropdown" className={classNames} {...propsRest}>
    ...
    FormDropdownIcon.displayName = 'FormDropdownIcon';
