import React, { FC } from 'react';
    ...
    export const FormTextareaIcon: FC<IconInterface> = function FormTextareaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormTextareaIcon ${className}`;
      return (
        <Icon alt="FormTextarea" className={classNames} {...propsRest}>
