import React, { FC } from 'react';
    ...
    export const FormTextboxIcon: FC<IconInterface> = function FormTextboxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormTextboxIcon ${className}`;
      return (
        <Icon alt="FormTextbox" className={classNames} {...propsRest}>
    ...
    FormTextboxIcon.displayName = 'FormTextboxIcon';
