import React, { FC } from 'react';
    ...
    export const FormTextboxLockIcon: FC<IconInterface> = function FormTextboxLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormTextboxLockIcon ${className}`;
      return (
        <Icon alt="FormTextboxLock" className={classNames} {...propsRest}>
    ...
    FormTextboxLockIcon.displayName = 'FormTextboxLockIcon';
