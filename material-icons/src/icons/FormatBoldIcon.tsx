import React, { FC } from 'react';
    ...
    export const FormatBoldIcon: FC<IconInterface> = function FormatBoldIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatBoldIcon ${className}`;
      return (
        <Icon alt="FormatBold" className={classNames} {...propsRest}>
