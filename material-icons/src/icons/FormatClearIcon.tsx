import React, { FC } from 'react';
    ...
    export const FormatClearIcon: FC<IconInterface> = function FormatClearIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatClearIcon ${className}`;
      return (
        <Icon alt="FormatClear" className={classNames} {...propsRest}>
