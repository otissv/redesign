import React, { FC } from 'react';
    ...
    export const FormatColorHighlightIcon: FC<IconInterface> = function FormatColorHighlightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatColorHighlightIcon ${className}`;
      return (
        <Icon alt="FormatColorHighlight" className={classNames} {...propsRest}>
