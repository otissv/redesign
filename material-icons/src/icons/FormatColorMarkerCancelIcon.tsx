import React, { FC } from 'react';
    ...
    export const FormatColorMarkerCancelIcon: FC<IconInterface> = function FormatColorMarkerCancelIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatColorMarkerCancelIcon ${className}`;
      return (
        <Icon alt="FormatColorMarkerCancel" className={classNames} {...propsRest}>
    ...
    FormatColorMarkerCancelIcon.displayName = 'FormatColorMarkerCancelIcon';
