import React, { FC } from 'react';
    ...
    export const FormatHeader2Icon: FC<IconInterface> = function FormatHeader2Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatHeader2Icon ${className}`;
      return (
        <Icon alt="FormatHeader2" className={classNames} {...propsRest}>
