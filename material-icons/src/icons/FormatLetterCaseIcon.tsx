import React, { FC } from 'react';
    ...
    export const FormatLetterCaseIcon: FC<IconInterface> = function FormatLetterCaseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatLetterCaseIcon ${className}`;
      return (
        <Icon alt="FormatLetterCase" className={classNames} {...propsRest}>
    ...
    FormatLetterCaseIcon.displayName = 'FormatLetterCaseIcon';
