import React, { FC } from 'react';
    ...
    export const FormatLetterCaseLowerIcon: FC<IconInterface> = function FormatLetterCaseLowerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatLetterCaseLowerIcon ${className}`;
      return (
        <Icon alt="FormatLetterCaseLower" className={classNames} {...propsRest}>
    ...
    FormatLetterCaseLowerIcon.displayName = 'FormatLetterCaseLowerIcon';
