import React, { FC } from 'react';
    ...
    export const FormatLetterCaseUpperIcon: FC<IconInterface> = function FormatLetterCaseUpperIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatLetterCaseUpperIcon ${className}`;
      return (
        <Icon alt="FormatLetterCaseUpper" className={classNames} {...propsRest}>
    ...
    FormatLetterCaseUpperIcon.displayName = 'FormatLetterCaseUpperIcon';
