import React, { FC } from 'react';
    ...
    export const FormatListBulletedTypeIcon: FC<IconInterface> = function FormatListBulletedTypeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatListBulletedTypeIcon ${className}`;
      return (
        <Icon alt="FormatListBulletedType" className={classNames} {...propsRest}>
