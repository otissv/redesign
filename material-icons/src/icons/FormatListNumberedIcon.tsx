import React, { FC } from 'react';
    ...
    export const FormatListNumberedIcon: FC<IconInterface> = function FormatListNumberedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatListNumberedIcon ${className}`;
      return (
        <Icon alt="FormatListNumbered" className={classNames} {...propsRest}>
