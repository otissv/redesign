import React, { FC } from 'react';
    ...
    export const FormatListNumberedRtlIcon: FC<IconInterface> = function FormatListNumberedRtlIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatListNumberedRtlIcon ${className}`;
      return (
        <Icon alt="FormatListNumberedRtl" className={classNames} {...propsRest}>
