import React, { FC } from 'react';
    ...
    export const FormatSectionIcon: FC<IconInterface> = function FormatSectionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatSectionIcon ${className}`;
      return (
        <Icon alt="FormatSection" className={classNames} {...propsRest}>
