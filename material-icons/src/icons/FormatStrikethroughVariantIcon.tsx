import React, { FC } from 'react';
    ...
    export const FormatStrikethroughVariantIcon: FC<IconInterface> = function FormatStrikethroughVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatStrikethroughVariantIcon ${className}`;
      return (
        <Icon alt="FormatStrikethroughVariant" className={classNames} {...propsRest}>
    ...
    FormatStrikethroughVariantIcon.displayName = 'FormatStrikethroughVariantIcon';
