import React, { FC } from 'react';
    ...
    export const FormatSubscriptIcon: FC<IconInterface> = function FormatSubscriptIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatSubscriptIcon ${className}`;
      return (
        <Icon alt="FormatSubscript" className={classNames} {...propsRest}>
    ...
    FormatSubscriptIcon.displayName = 'FormatSubscriptIcon';
