import React, { FC } from 'react';
    ...
    export const FormatSuperscriptIcon: FC<IconInterface> = function FormatSuperscriptIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatSuperscriptIcon ${className}`;
      return (
        <Icon alt="FormatSuperscript" className={classNames} {...propsRest}>
