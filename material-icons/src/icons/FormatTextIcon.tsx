import React, { FC } from 'react';
    ...
    export const FormatTextIcon: FC<IconInterface> = function FormatTextIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FormatTextIcon ${className}`;
      return (
        <Icon alt="FormatText" className={classNames} {...propsRest}>
    ...
    FormatTextIcon.displayName = 'FormatTextIcon';
