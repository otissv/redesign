import React, { FC } from 'react';
    ...
    export const FountainIcon: FC<IconInterface> = function FountainIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FountainIcon ${className}`;
      return (
        <Icon alt="Fountain" className={classNames} {...propsRest}>
