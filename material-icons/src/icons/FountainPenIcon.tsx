import React, { FC } from 'react';
    ...
    export const FountainPenIcon: FC<IconInterface> = function FountainPenIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FountainPenIcon ${className}`;
      return (
        <Icon alt="FountainPen" className={classNames} {...propsRest}>
