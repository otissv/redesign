import React, { FC } from 'react';
    ...
    export const FountainPenTipIcon: FC<IconInterface> = function FountainPenTipIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FountainPenTipIcon ${className}`;
      return (
        <Icon alt="FountainPenTip" className={classNames} {...propsRest}>
    ...
    FountainPenTipIcon.displayName = 'FountainPenTipIcon';
