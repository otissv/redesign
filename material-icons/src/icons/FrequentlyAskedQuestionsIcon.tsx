import React, { FC } from 'react';
    ...
    export const FrequentlyAskedQuestionsIcon: FC<IconInterface> = function FrequentlyAskedQuestionsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FrequentlyAskedQuestionsIcon ${className}`;
      return (
        <Icon alt="FrequentlyAskedQuestions" className={classNames} {...propsRest}>
