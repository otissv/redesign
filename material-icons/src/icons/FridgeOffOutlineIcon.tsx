import React, { FC } from 'react';
    ...
    export const FridgeOffOutlineIcon: FC<IconInterface> = function FridgeOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FridgeOffOutlineIcon ${className}`;
      return (
        <Icon alt="FridgeOffOutline" className={classNames} {...propsRest}>
    ...
    FridgeOffOutlineIcon.displayName = 'FridgeOffOutlineIcon';
