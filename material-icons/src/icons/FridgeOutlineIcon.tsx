import React, { FC } from 'react';
    ...
    export const FridgeOutlineIcon: FC<IconInterface> = function FridgeOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FridgeOutlineIcon ${className}`;
      return (
        <Icon alt="FridgeOutline" className={classNames} {...propsRest}>
