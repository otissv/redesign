import React, { FC } from 'react';
    ...
    export const FruitCherriesOffIcon: FC<IconInterface> = function FruitCherriesOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FruitCherriesOffIcon ${className}`;
      return (
        <Icon alt="FruitCherriesOff" className={classNames} {...propsRest}>
    ...
    FruitCherriesOffIcon.displayName = 'FruitCherriesOffIcon';
