import React, { FC } from 'react';
    ...
    export const FruitCitrusIcon: FC<IconInterface> = function FruitCitrusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FruitCitrusIcon ${className}`;
      return (
        <Icon alt="FruitCitrus" className={classNames} {...propsRest}>
    ...
    FruitCitrusIcon.displayName = 'FruitCitrusIcon';
