import React, { FC } from 'react';
    ...
    export const FruitCitrusOffIcon: FC<IconInterface> = function FruitCitrusOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FruitCitrusOffIcon ${className}`;
      return (
        <Icon alt="FruitCitrusOff" className={classNames} {...propsRest}>
    ...
    FruitCitrusOffIcon.displayName = 'FruitCitrusOffIcon';
