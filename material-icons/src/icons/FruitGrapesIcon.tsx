import React, { FC } from 'react';
    ...
    export const FruitGrapesIcon: FC<IconInterface> = function FruitGrapesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FruitGrapesIcon ${className}`;
      return (
        <Icon alt="FruitGrapes" className={classNames} {...propsRest}>
    ...
    FruitGrapesIcon.displayName = 'FruitGrapesIcon';
