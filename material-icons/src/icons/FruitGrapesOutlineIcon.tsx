import React, { FC } from 'react';
    ...
    export const FruitGrapesOutlineIcon: FC<IconInterface> = function FruitGrapesOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FruitGrapesOutlineIcon ${className}`;
      return (
        <Icon alt="FruitGrapesOutline" className={classNames} {...propsRest}>
    ...
    FruitGrapesOutlineIcon.displayName = 'FruitGrapesOutlineIcon';
