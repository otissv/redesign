import React, { FC } from 'react';
    ...
    export const FruitPineappleIcon: FC<IconInterface> = function FruitPineappleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FruitPineappleIcon ${className}`;
      return (
        <Icon alt="FruitPineapple" className={classNames} {...propsRest}>
    ...
    FruitPineappleIcon.displayName = 'FruitPineappleIcon';
