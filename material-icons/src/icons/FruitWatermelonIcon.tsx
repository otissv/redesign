import React, { FC } from 'react';
    ...
    export const FruitWatermelonIcon: FC<IconInterface> = function FruitWatermelonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FruitWatermelonIcon ${className}`;
      return (
        <Icon alt="FruitWatermelon" className={classNames} {...propsRest}>
    ...
    FruitWatermelonIcon.displayName = 'FruitWatermelonIcon';
