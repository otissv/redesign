import React, { FC } from 'react';
    ...
    export const FuriganaHorizontalIcon: FC<IconInterface> = function FuriganaHorizontalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FuriganaHorizontalIcon ${className}`;
      return (
        <Icon alt="FuriganaHorizontal" className={classNames} {...propsRest}>
    ...
    FuriganaHorizontalIcon.displayName = 'FuriganaHorizontalIcon';
