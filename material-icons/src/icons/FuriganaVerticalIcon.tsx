import React, { FC } from 'react';
    ...
    export const FuriganaVerticalIcon: FC<IconInterface> = function FuriganaVerticalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FuriganaVerticalIcon ${className}`;
      return (
        <Icon alt="FuriganaVertical" className={classNames} {...propsRest}>
    ...
    FuriganaVerticalIcon.displayName = 'FuriganaVerticalIcon';
