import React, { FC } from 'react';
    ...
    export const FuseOffIcon: FC<IconInterface> = function FuseOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `FuseOffIcon ${className}`;
      return (
        <Icon alt="FuseOff" className={classNames} {...propsRest}>
    ...
    FuseOffIcon.displayName = 'FuseOffIcon';
