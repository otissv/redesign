import React, { FC } from 'react';
    ...
    export const GamepadCircleIcon: FC<IconInterface> = function GamepadCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GamepadCircleIcon ${className}`;
      return (
        <Icon alt="GamepadCircle" className={classNames} {...propsRest}>
