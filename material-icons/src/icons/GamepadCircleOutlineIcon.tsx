import React, { FC } from 'react';
    ...
    export const GamepadCircleOutlineIcon: FC<IconInterface> = function GamepadCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GamepadCircleOutlineIcon ${className}`;
      return (
        <Icon alt="GamepadCircleOutline" className={classNames} {...propsRest}>
