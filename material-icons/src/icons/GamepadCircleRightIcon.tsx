import React, { FC } from 'react';
    ...
    export const GamepadCircleRightIcon: FC<IconInterface> = function GamepadCircleRightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GamepadCircleRightIcon ${className}`;
      return (
        <Icon alt="GamepadCircleRight" className={classNames} {...propsRest}>
    ...
    GamepadCircleRightIcon.displayName = 'GamepadCircleRightIcon';
