import React, { FC } from 'react';
    ...
    export const GamepadVariantOutlineIcon: FC<IconInterface> = function GamepadVariantOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GamepadVariantOutlineIcon ${className}`;
      return (
        <Icon alt="GamepadVariantOutline" className={classNames} {...propsRest}>
