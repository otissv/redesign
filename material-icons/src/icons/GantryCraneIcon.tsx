import React, { FC } from 'react';
    ...
    export const GantryCraneIcon: FC<IconInterface> = function GantryCraneIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GantryCraneIcon ${className}`;
      return (
        <Icon alt="GantryCrane" className={classNames} {...propsRest}>
