import React, { FC } from 'react';
    ...
    export const GasCylinderIcon: FC<IconInterface> = function GasCylinderIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GasCylinderIcon ${className}`;
      return (
        <Icon alt="GasCylinder" className={classNames} {...propsRest}>
