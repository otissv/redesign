import React, { FC } from 'react';
    ...
    export const GasStationOffIcon: FC<IconInterface> = function GasStationOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GasStationOffIcon ${className}`;
      return (
        <Icon alt="GasStationOff" className={classNames} {...propsRest}>
    ...
    GasStationOffIcon.displayName = 'GasStationOffIcon';
