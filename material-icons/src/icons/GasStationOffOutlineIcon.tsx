import React, { FC } from 'react';
    ...
    export const GasStationOffOutlineIcon: FC<IconInterface> = function GasStationOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GasStationOffOutlineIcon ${className}`;
      return (
        <Icon alt="GasStationOffOutline" className={classNames} {...propsRest}>
    ...
    GasStationOffOutlineIcon.displayName = 'GasStationOffOutlineIcon';
