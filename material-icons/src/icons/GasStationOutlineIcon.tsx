import React, { FC } from 'react';
    ...
    export const GasStationOutlineIcon: FC<IconInterface> = function GasStationOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GasStationOutlineIcon ${className}`;
      return (
        <Icon alt="GasStationOutline" className={classNames} {...propsRest}>
