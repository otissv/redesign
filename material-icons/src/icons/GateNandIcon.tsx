import React, { FC } from 'react';
    ...
    export const GateNandIcon: FC<IconInterface> = function GateNandIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GateNandIcon ${className}`;
      return (
        <Icon alt="GateNand" className={classNames} {...propsRest}>
