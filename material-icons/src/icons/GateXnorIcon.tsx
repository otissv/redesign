import React, { FC } from 'react';
    ...
    export const GateXnorIcon: FC<IconInterface> = function GateXnorIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GateXnorIcon ${className}`;
      return (
        <Icon alt="GateXnor" className={classNames} {...propsRest}>
