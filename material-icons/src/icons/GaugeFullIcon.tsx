import React, { FC } from 'react';
    ...
    export const GaugeFullIcon: FC<IconInterface> = function GaugeFullIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GaugeFullIcon ${className}`;
      return (
        <Icon alt="GaugeFull" className={classNames} {...propsRest}>
