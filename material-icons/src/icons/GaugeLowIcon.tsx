import React, { FC } from 'react';
    ...
    export const GaugeLowIcon: FC<IconInterface> = function GaugeLowIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GaugeLowIcon ${className}`;
      return (
        <Icon alt="GaugeLow" className={classNames} {...propsRest}>
