import React, { FC } from 'react';
    ...
    export const GenderMaleIcon: FC<IconInterface> = function GenderMaleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GenderMaleIcon ${className}`;
      return (
        <Icon alt="GenderMale" className={classNames} {...propsRest}>
