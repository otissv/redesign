import React, { FC } from 'react';
    ...
    export const GenderNonBinaryIcon: FC<IconInterface> = function GenderNonBinaryIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GenderNonBinaryIcon ${className}`;
      return (
        <Icon alt="GenderNonBinary" className={classNames} {...propsRest}>
    ...
    GenderNonBinaryIcon.displayName = 'GenderNonBinaryIcon';
