import React, { FC } from 'react';
    ...
    export const GenderTransgenderIcon: FC<IconInterface> = function GenderTransgenderIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GenderTransgenderIcon ${className}`;
      return (
        <Icon alt="GenderTransgender" className={classNames} {...propsRest}>
