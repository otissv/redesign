import React, { FC } from 'react';
    ...
    export const GestureSwipeHorizontalIcon: FC<IconInterface> = function GestureSwipeHorizontalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GestureSwipeHorizontalIcon ${className}`;
      return (
        <Icon alt="GestureSwipeHorizontal" className={classNames} {...propsRest}>
