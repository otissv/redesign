import React, { FC } from 'react';
    ...
    export const GestureSwipeIcon: FC<IconInterface> = function GestureSwipeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GestureSwipeIcon ${className}`;
      return (
        <Icon alt="GestureSwipe" className={classNames} {...propsRest}>
