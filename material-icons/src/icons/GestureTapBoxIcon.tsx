import React, { FC } from 'react';
    ...
    export const GestureTapBoxIcon: FC<IconInterface> = function GestureTapBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GestureTapBoxIcon ${className}`;
      return (
        <Icon alt="GestureTapBox" className={classNames} {...propsRest}>
    ...
    GestureTapBoxIcon.displayName = 'GestureTapBoxIcon';
