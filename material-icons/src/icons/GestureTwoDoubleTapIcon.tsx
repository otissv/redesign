import React, { FC } from 'react';
    ...
    export const GestureTwoDoubleTapIcon: FC<IconInterface> = function GestureTwoDoubleTapIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GestureTwoDoubleTapIcon ${className}`;
      return (
        <Icon alt="GestureTwoDoubleTap" className={classNames} {...propsRest}>
