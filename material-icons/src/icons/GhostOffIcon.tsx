import React, { FC } from 'react';
    ...
    export const GhostOffIcon: FC<IconInterface> = function GhostOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GhostOffIcon ${className}`;
      return (
        <Icon alt="GhostOff" className={classNames} {...propsRest}>
