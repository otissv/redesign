import React, { FC } from 'react';
    ...
    export const GlassFluteIcon: FC<IconInterface> = function GlassFluteIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GlassFluteIcon ${className}`;
      return (
        <Icon alt="GlassFlute" className={classNames} {...propsRest}>
    ...
    GlassFluteIcon.displayName = 'GlassFluteIcon';
