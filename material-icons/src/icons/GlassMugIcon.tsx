import React, { FC } from 'react';
    ...
    export const GlassMugIcon: FC<IconInterface> = function GlassMugIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GlassMugIcon ${className}`;
      return (
        <Icon alt="GlassMug" className={classNames} {...propsRest}>
