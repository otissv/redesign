import React, { FC } from 'react';
    ...
    export const GlassMugVariantIcon: FC<IconInterface> = function GlassMugVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GlassMugVariantIcon ${className}`;
      return (
        <Icon alt="GlassMugVariant" className={classNames} {...propsRest}>
    ...
    GlassMugVariantIcon.displayName = 'GlassMugVariantIcon';
