import React, { FC } from 'react';
    ...
    export const GlassTulipIcon: FC<IconInterface> = function GlassTulipIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GlassTulipIcon ${className}`;
      return (
        <Icon alt="GlassTulip" className={classNames} {...propsRest}>
