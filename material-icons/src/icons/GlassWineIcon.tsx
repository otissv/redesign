import React, { FC } from 'react';
    ...
    export const GlassWineIcon: FC<IconInterface> = function GlassWineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GlassWineIcon ${className}`;
      return (
        <Icon alt="GlassWine" className={classNames} {...propsRest}>
