import React, { FC } from 'react';
    ...
    export const GlobeModelIcon: FC<IconInterface> = function GlobeModelIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GlobeModelIcon ${className}`;
      return (
        <Icon alt="GlobeModel" className={classNames} {...propsRest}>
