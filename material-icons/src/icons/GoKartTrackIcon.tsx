import React, { FC } from 'react';
    ...
    export const GoKartTrackIcon: FC<IconInterface> = function GoKartTrackIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoKartTrackIcon ${className}`;
      return (
        <Icon alt="GoKartTrack" className={classNames} {...propsRest}>
