import React, { FC } from 'react';
    ...
    export const GolfTeeIcon: FC<IconInterface> = function GolfTeeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GolfTeeIcon ${className}`;
      return (
        <Icon alt="GolfTee" className={classNames} {...propsRest}>
    ...
    GolfTeeIcon.displayName = 'GolfTeeIcon';
