import React, { FC } from 'react';
    ...
    export const GoodreadsIcon: FC<IconInterface> = function GoodreadsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoodreadsIcon ${className}`;
      return (
        <Icon alt="Goodreads" className={classNames} {...propsRest}>
