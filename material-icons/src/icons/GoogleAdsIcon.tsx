import React, { FC } from 'react';
    ...
    export const GoogleAdsIcon: FC<IconInterface> = function GoogleAdsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleAdsIcon ${className}`;
      return (
        <Icon alt="GoogleAds" className={classNames} {...propsRest}>
