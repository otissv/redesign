import React, { FC } from 'react';
    ...
    export const GoogleAnalyticsIcon: FC<IconInterface> = function GoogleAnalyticsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleAnalyticsIcon ${className}`;
      return (
        <Icon alt="GoogleAnalytics" className={classNames} {...propsRest}>
