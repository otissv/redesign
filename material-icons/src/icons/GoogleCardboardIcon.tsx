import React, { FC } from 'react';
    ...
    export const GoogleCardboardIcon: FC<IconInterface> = function GoogleCardboardIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleCardboardIcon ${className}`;
      return (
        <Icon alt="GoogleCardboard" className={classNames} {...propsRest}>
