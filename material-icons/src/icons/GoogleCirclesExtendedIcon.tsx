import React, { FC } from 'react';
    ...
    export const GoogleCirclesExtendedIcon: FC<IconInterface> = function GoogleCirclesExtendedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleCirclesExtendedIcon ${className}`;
      return (
        <Icon alt="GoogleCirclesExtended" className={classNames} {...propsRest}>
