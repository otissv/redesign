import React, { FC } from 'react';
    ...
    export const GoogleCirclesGroupIcon: FC<IconInterface> = function GoogleCirclesGroupIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleCirclesGroupIcon ${className}`;
      return (
        <Icon alt="GoogleCirclesGroup" className={classNames} {...propsRest}>
