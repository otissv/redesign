import React, { FC } from 'react';
    ...
    export const GoogleCirclesIcon: FC<IconInterface> = function GoogleCirclesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleCirclesIcon ${className}`;
      return (
        <Icon alt="GoogleCircles" className={classNames} {...propsRest}>
