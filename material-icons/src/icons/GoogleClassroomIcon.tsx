import React, { FC } from 'react';
    ...
    export const GoogleClassroomIcon: FC<IconInterface> = function GoogleClassroomIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleClassroomIcon ${className}`;
      return (
        <Icon alt="GoogleClassroom" className={classNames} {...propsRest}>
