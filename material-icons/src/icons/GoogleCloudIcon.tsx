import React, { FC } from 'react';
    ...
    export const GoogleCloudIcon: FC<IconInterface> = function GoogleCloudIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleCloudIcon ${className}`;
      return (
        <Icon alt="GoogleCloud" className={classNames} {...propsRest}>
