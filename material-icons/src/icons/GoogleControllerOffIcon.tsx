import React, { FC } from 'react';
    ...
    export const GoogleControllerOffIcon: FC<IconInterface> = function GoogleControllerOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleControllerOffIcon ${className}`;
      return (
        <Icon alt="GoogleControllerOff" className={classNames} {...propsRest}>
