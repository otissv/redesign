import React, { FC } from 'react';
    ...
    export const GoogleEarthIcon: FC<IconInterface> = function GoogleEarthIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleEarthIcon ${className}`;
      return (
        <Icon alt="GoogleEarth" className={classNames} {...propsRest}>
    ...
    GoogleEarthIcon.displayName = 'GoogleEarthIcon';
