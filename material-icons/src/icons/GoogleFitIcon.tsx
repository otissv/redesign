import React, { FC } from 'react';
    ...
    export const GoogleFitIcon: FC<IconInterface> = function GoogleFitIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleFitIcon ${className}`;
      return (
        <Icon alt="GoogleFit" className={classNames} {...propsRest}>
