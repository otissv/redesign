import React, { FC } from 'react';
    ...
    export const GoogleGlassIcon: FC<IconInterface> = function GoogleGlassIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleGlassIcon ${className}`;
      return (
        <Icon alt="GoogleGlass" className={classNames} {...propsRest}>
