import React, { FC } from 'react';
    ...
    export const GoogleHomeIcon: FC<IconInterface> = function GoogleHomeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleHomeIcon ${className}`;
      return (
        <Icon alt="GoogleHome" className={classNames} {...propsRest}>
