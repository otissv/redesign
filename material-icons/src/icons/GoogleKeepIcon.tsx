import React, { FC } from 'react';
    ...
    export const GoogleKeepIcon: FC<IconInterface> = function GoogleKeepIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleKeepIcon ${className}`;
      return (
        <Icon alt="GoogleKeep" className={classNames} {...propsRest}>
