import React, { FC } from 'react';
    ...
    export const GoogleMapsIcon: FC<IconInterface> = function GoogleMapsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleMapsIcon ${className}`;
      return (
        <Icon alt="GoogleMaps" className={classNames} {...propsRest}>
