import React, { FC } from 'react';
    ...
    export const GooglePlusIcon: FC<IconInterface> = function GooglePlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GooglePlusIcon ${className}`;
      return (
        <Icon alt="GooglePlus" className={classNames} {...propsRest}>
