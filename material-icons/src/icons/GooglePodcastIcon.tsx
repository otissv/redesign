import React, { FC } from 'react';
    ...
    export const GooglePodcastIcon: FC<IconInterface> = function GooglePodcastIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GooglePodcastIcon ${className}`;
      return (
        <Icon alt="GooglePodcast" className={classNames} {...propsRest}>
