import React, { FC } from 'react';
    ...
    export const GoogleStreetViewIcon: FC<IconInterface> = function GoogleStreetViewIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleStreetViewIcon ${className}`;
      return (
        <Icon alt="GoogleStreetView" className={classNames} {...propsRest}>
