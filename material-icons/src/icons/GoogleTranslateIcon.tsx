import React, { FC } from 'react';
    ...
    export const GoogleTranslateIcon: FC<IconInterface> = function GoogleTranslateIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GoogleTranslateIcon ${className}`;
      return (
        <Icon alt="GoogleTranslate" className={classNames} {...propsRest}>
