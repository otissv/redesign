import React, { FC } from 'react';
    ...
    export const GradientIcon: FC<IconInterface> = function GradientIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GradientIcon ${className}`;
      return (
        <Icon alt="Gradient" className={classNames} {...propsRest}>
