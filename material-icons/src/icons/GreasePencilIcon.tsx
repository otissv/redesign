import React, { FC } from 'react';
    ...
    export const GreasePencilIcon: FC<IconInterface> = function GreasePencilIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GreasePencilIcon ${className}`;
      return (
        <Icon alt="GreasePencil" className={classNames} {...propsRest}>
