import React, { FC } from 'react';
    ...
    export const GridLargeIcon: FC<IconInterface> = function GridLargeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GridLargeIcon ${className}`;
      return (
        <Icon alt="GridLarge" className={classNames} {...propsRest}>
