import React, { FC } from 'react';
    ...
    export const GrillOutlineIcon: FC<IconInterface> = function GrillOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GrillOutlineIcon ${className}`;
      return (
        <Icon alt="GrillOutline" className={classNames} {...propsRest}>
    ...
    GrillOutlineIcon.displayName = 'GrillOutlineIcon';
