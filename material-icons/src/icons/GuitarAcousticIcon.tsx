import React, { FC } from 'react';
    ...
    export const GuitarAcousticIcon: FC<IconInterface> = function GuitarAcousticIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GuitarAcousticIcon ${className}`;
      return (
        <Icon alt="GuitarAcoustic" className={classNames} {...propsRest}>
