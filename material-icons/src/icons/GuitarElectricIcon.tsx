import React, { FC } from 'react';
    ...
    export const GuitarElectricIcon: FC<IconInterface> = function GuitarElectricIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GuitarElectricIcon ${className}`;
      return (
        <Icon alt="GuitarElectric" className={classNames} {...propsRest}>
