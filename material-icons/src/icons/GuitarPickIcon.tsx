import React, { FC } from 'react';
    ...
    export const GuitarPickIcon: FC<IconInterface> = function GuitarPickIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GuitarPickIcon ${className}`;
      return (
        <Icon alt="GuitarPick" className={classNames} {...propsRest}>
