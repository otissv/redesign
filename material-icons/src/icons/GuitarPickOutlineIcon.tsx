import React, { FC } from 'react';
    ...
    export const GuitarPickOutlineIcon: FC<IconInterface> = function GuitarPickOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GuitarPickOutlineIcon ${className}`;
      return (
        <Icon alt="GuitarPickOutline" className={classNames} {...propsRest}>
