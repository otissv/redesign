import React, { FC } from 'react';
    ...
    export const GuyFawkesMaskIcon: FC<IconInterface> = function GuyFawkesMaskIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `GuyFawkesMaskIcon ${className}`;
      return (
        <Icon alt="GuyFawkesMask" className={classNames} {...propsRest}>
