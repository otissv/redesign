import React, { FC } from 'react';
    ...
    export const HairDryerIcon: FC<IconInterface> = function HairDryerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HairDryerIcon ${className}`;
      return (
        <Icon alt="HairDryer" className={classNames} {...propsRest}>
