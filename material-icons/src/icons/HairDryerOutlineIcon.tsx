import React, { FC } from 'react';
    ...
    export const HairDryerOutlineIcon: FC<IconInterface> = function HairDryerOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HairDryerOutlineIcon ${className}`;
      return (
        <Icon alt="HairDryerOutline" className={classNames} {...propsRest}>
    ...
    HairDryerOutlineIcon.displayName = 'HairDryerOutlineIcon';
