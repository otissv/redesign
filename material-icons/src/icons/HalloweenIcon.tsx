import React, { FC } from 'react';
    ...
    export const HalloweenIcon: FC<IconInterface> = function HalloweenIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HalloweenIcon ${className}`;
      return (
        <Icon alt="Halloween" className={classNames} {...propsRest}>
    ...
    HalloweenIcon.displayName = 'HalloweenIcon';
