import React, { FC } from 'react';
    ...
    export const HamburgerIcon: FC<IconInterface> = function HamburgerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HamburgerIcon ${className}`;
      return (
        <Icon alt="Hamburger" className={classNames} {...propsRest}>
