import React, { FC } from 'react';
    ...
    export const HandHeartIcon: FC<IconInterface> = function HandHeartIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandHeartIcon ${className}`;
      return (
        <Icon alt="HandHeart" className={classNames} {...propsRest}>
