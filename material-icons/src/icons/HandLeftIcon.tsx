import React, { FC } from 'react';
    ...
    export const HandLeftIcon: FC<IconInterface> = function HandLeftIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandLeftIcon ${className}`;
      return (
        <Icon alt="HandLeft" className={classNames} {...propsRest}>
