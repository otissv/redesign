import React, { FC } from 'react';
    ...
    export const HandOkayIcon: FC<IconInterface> = function HandOkayIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandOkayIcon ${className}`;
      return (
        <Icon alt="HandOkay" className={classNames} {...propsRest}>
