import React, { FC } from 'react';
    ...
    export const HandPeaceIcon: FC<IconInterface> = function HandPeaceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandPeaceIcon ${className}`;
      return (
        <Icon alt="HandPeace" className={classNames} {...propsRest}>
    ...
    HandPeaceIcon.displayName = 'HandPeaceIcon';
