import React, { FC } from 'react';
    ...
    export const HandPeaceVariantIcon: FC<IconInterface> = function HandPeaceVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandPeaceVariantIcon ${className}`;
      return (
        <Icon alt="HandPeaceVariant" className={classNames} {...propsRest}>
