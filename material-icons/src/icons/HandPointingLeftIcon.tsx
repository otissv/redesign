import React, { FC } from 'react';
    ...
    export const HandPointingLeftIcon: FC<IconInterface> = function HandPointingLeftIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandPointingLeftIcon ${className}`;
      return (
        <Icon alt="HandPointingLeft" className={classNames} {...propsRest}>
