import React, { FC } from 'react';
    ...
    export const HandPointingRightIcon: FC<IconInterface> = function HandPointingRightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandPointingRightIcon ${className}`;
      return (
        <Icon alt="HandPointingRight" className={classNames} {...propsRest}>
