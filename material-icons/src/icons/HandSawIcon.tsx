import React, { FC } from 'react';
    ...
    export const HandSawIcon: FC<IconInterface> = function HandSawIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandSawIcon ${className}`;
      return (
        <Icon alt="HandSaw" className={classNames} {...propsRest}>
    ...
    HandSawIcon.displayName = 'HandSawIcon';
