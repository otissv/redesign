import React, { FC } from 'react';
    ...
    export const HandWaterIcon: FC<IconInterface> = function HandWaterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandWaterIcon ${className}`;
      return (
        <Icon alt="HandWater" className={classNames} {...propsRest}>
    ...
    HandWaterIcon.displayName = 'HandWaterIcon';
