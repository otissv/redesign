import React, { FC } from 'react';
    ...
    export const HandcuffsIcon: FC<IconInterface> = function HandcuffsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandcuffsIcon ${className}`;
      return (
        <Icon alt="Handcuffs" className={classNames} {...propsRest}>
