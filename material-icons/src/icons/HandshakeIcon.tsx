import React, { FC } from 'react';
    ...
    export const HandshakeIcon: FC<IconInterface> = function HandshakeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HandshakeIcon ${className}`;
      return (
        <Icon alt="Handshake" className={classNames} {...propsRest}>
