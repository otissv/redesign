import React, { FC } from 'react';
    ...
    export const HarddiskIcon: FC<IconInterface> = function HarddiskIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HarddiskIcon ${className}`;
      return (
        <Icon alt="Harddisk" className={classNames} {...propsRest}>
