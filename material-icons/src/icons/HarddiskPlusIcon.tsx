import React, { FC } from 'react';
    ...
    export const HarddiskPlusIcon: FC<IconInterface> = function HarddiskPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HarddiskPlusIcon ${className}`;
      return (
        <Icon alt="HarddiskPlus" className={classNames} {...propsRest}>
    ...
    HarddiskPlusIcon.displayName = 'HarddiskPlusIcon';
