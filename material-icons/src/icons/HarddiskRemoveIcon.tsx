import React, { FC } from 'react';
    ...
    export const HarddiskRemoveIcon: FC<IconInterface> = function HarddiskRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HarddiskRemoveIcon ${className}`;
      return (
        <Icon alt="HarddiskRemove" className={classNames} {...propsRest}>
    ...
    HarddiskRemoveIcon.displayName = 'HarddiskRemoveIcon';
