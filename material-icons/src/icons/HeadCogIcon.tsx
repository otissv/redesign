import React, { FC } from 'react';
    ...
    export const HeadCogIcon: FC<IconInterface> = function HeadCogIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadCogIcon ${className}`;
      return (
        <Icon alt="HeadCog" className={classNames} {...propsRest}>
    ...
    HeadCogIcon.displayName = 'HeadCogIcon';
