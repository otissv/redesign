import React, { FC } from 'react';
    ...
    export const HeadCogOutlineIcon: FC<IconInterface> = function HeadCogOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadCogOutlineIcon ${className}`;
      return (
        <Icon alt="HeadCogOutline" className={classNames} {...propsRest}>
    ...
    HeadCogOutlineIcon.displayName = 'HeadCogOutlineIcon';
