import React, { FC } from 'react';
    ...
    export const HeadDotsHorizontalIcon: FC<IconInterface> = function HeadDotsHorizontalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadDotsHorizontalIcon ${className}`;
      return (
        <Icon alt="HeadDotsHorizontal" className={classNames} {...propsRest}>
    ...
    HeadDotsHorizontalIcon.displayName = 'HeadDotsHorizontalIcon';
