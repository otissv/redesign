import React, { FC } from 'react';
    ...
    export const HeadDotsHorizontalOutlineIcon: FC<IconInterface> = function HeadDotsHorizontalOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadDotsHorizontalOutlineIcon ${className}`;
      return (
        <Icon alt="HeadDotsHorizontalOutline" className={classNames} {...propsRest}>
    ...
    HeadDotsHorizontalOutlineIcon.displayName = 'HeadDotsHorizontalOutlineIcon';
