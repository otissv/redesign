import React, { FC } from 'react';
    ...
    export const HeadFlashOutlineIcon: FC<IconInterface> = function HeadFlashOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadFlashOutlineIcon ${className}`;
      return (
        <Icon alt="HeadFlashOutline" className={classNames} {...propsRest}>
    ...
    HeadFlashOutlineIcon.displayName = 'HeadFlashOutlineIcon';
