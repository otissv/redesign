import React, { FC } from 'react';
    ...
    export const HeadHeartIcon: FC<IconInterface> = function HeadHeartIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadHeartIcon ${className}`;
      return (
        <Icon alt="HeadHeart" className={classNames} {...propsRest}>
    ...
    HeadHeartIcon.displayName = 'HeadHeartIcon';
