import React, { FC } from 'react';
    ...
    export const HeadLightbulbOutlineIcon: FC<IconInterface> = function HeadLightbulbOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadLightbulbOutlineIcon ${className}`;
      return (
        <Icon alt="HeadLightbulbOutline" className={classNames} {...propsRest}>
    ...
    HeadLightbulbOutlineIcon.displayName = 'HeadLightbulbOutlineIcon';
