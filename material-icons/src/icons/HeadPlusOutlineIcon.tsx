import React, { FC } from 'react';
    ...
    export const HeadPlusOutlineIcon: FC<IconInterface> = function HeadPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadPlusOutlineIcon ${className}`;
      return (
        <Icon alt="HeadPlusOutline" className={classNames} {...propsRest}>
    ...
    HeadPlusOutlineIcon.displayName = 'HeadPlusOutlineIcon';
