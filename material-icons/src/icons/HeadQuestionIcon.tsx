import React, { FC } from 'react';
    ...
    export const HeadQuestionIcon: FC<IconInterface> = function HeadQuestionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadQuestionIcon ${className}`;
      return (
        <Icon alt="HeadQuestion" className={classNames} {...propsRest}>
    ...
    HeadQuestionIcon.displayName = 'HeadQuestionIcon';
