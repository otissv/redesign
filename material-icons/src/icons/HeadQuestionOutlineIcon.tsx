import React, { FC } from 'react';
    ...
    export const HeadQuestionOutlineIcon: FC<IconInterface> = function HeadQuestionOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadQuestionOutlineIcon ${className}`;
      return (
        <Icon alt="HeadQuestionOutline" className={classNames} {...propsRest}>
    ...
    HeadQuestionOutlineIcon.displayName = 'HeadQuestionOutlineIcon';
