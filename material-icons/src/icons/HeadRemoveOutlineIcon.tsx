import React, { FC } from 'react';
    ...
    export const HeadRemoveOutlineIcon: FC<IconInterface> = function HeadRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="HeadRemoveOutline" className={classNames} {...propsRest}>
    ...
    HeadRemoveOutlineIcon.displayName = 'HeadRemoveOutlineIcon';
