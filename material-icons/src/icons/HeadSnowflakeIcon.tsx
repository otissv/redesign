import React, { FC } from 'react';
    ...
    export const HeadSnowflakeIcon: FC<IconInterface> = function HeadSnowflakeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadSnowflakeIcon ${className}`;
      return (
        <Icon alt="HeadSnowflake" className={classNames} {...propsRest}>
    ...
    HeadSnowflakeIcon.displayName = 'HeadSnowflakeIcon';
