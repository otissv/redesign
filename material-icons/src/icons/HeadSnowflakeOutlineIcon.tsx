import React, { FC } from 'react';
    ...
    export const HeadSnowflakeOutlineIcon: FC<IconInterface> = function HeadSnowflakeOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadSnowflakeOutlineIcon ${className}`;
      return (
        <Icon alt="HeadSnowflakeOutline" className={classNames} {...propsRest}>
    ...
    HeadSnowflakeOutlineIcon.displayName = 'HeadSnowflakeOutlineIcon';
