import React, { FC } from 'react';
    ...
    export const HeadSyncIcon: FC<IconInterface> = function HeadSyncIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadSyncIcon ${className}`;
      return (
        <Icon alt="HeadSync" className={classNames} {...propsRest}>
    ...
    HeadSyncIcon.displayName = 'HeadSyncIcon';
