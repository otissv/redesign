import React, { FC } from 'react';
    ...
    export const HeadSyncOutlineIcon: FC<IconInterface> = function HeadSyncOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadSyncOutlineIcon ${className}`;
      return (
        <Icon alt="HeadSyncOutline" className={classNames} {...propsRest}>
    ...
    HeadSyncOutlineIcon.displayName = 'HeadSyncOutlineIcon';
