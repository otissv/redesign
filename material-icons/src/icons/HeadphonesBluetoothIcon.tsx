import React, { FC } from 'react';
    ...
    export const HeadphonesBluetoothIcon: FC<IconInterface> = function HeadphonesBluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadphonesBluetoothIcon ${className}`;
      return (
        <Icon alt="HeadphonesBluetooth" className={classNames} {...propsRest}>
