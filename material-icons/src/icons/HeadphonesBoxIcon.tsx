import React, { FC } from 'react';
    ...
    export const HeadphonesBoxIcon: FC<IconInterface> = function HeadphonesBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadphonesBoxIcon ${className}`;
      return (
        <Icon alt="HeadphonesBox" className={classNames} {...propsRest}>
