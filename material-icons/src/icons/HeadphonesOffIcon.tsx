import React, { FC } from 'react';
    ...
    export const HeadphonesOffIcon: FC<IconInterface> = function HeadphonesOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeadphonesOffIcon ${className}`;
      return (
        <Icon alt="HeadphonesOff" className={classNames} {...propsRest}>
