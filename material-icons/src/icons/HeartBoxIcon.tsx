import React, { FC } from 'react';
    ...
    export const HeartBoxIcon: FC<IconInterface> = function HeartBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartBoxIcon ${className}`;
      return (
        <Icon alt="HeartBox" className={classNames} {...propsRest}>
    ...
    HeartBoxIcon.displayName = 'HeartBoxIcon';
