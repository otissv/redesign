import React, { FC } from 'react';
    ...
    export const HeartBoxOutlineIcon: FC<IconInterface> = function HeartBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartBoxOutlineIcon ${className}`;
      return (
        <Icon alt="HeartBoxOutline" className={classNames} {...propsRest}>
    ...
    HeartBoxOutlineIcon.displayName = 'HeartBoxOutlineIcon';
