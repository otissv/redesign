import React, { FC } from 'react';
    ...
    export const HeartBrokenIcon: FC<IconInterface> = function HeartBrokenIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartBrokenIcon ${className}`;
      return (
        <Icon alt="HeartBroken" className={classNames} {...propsRest}>
