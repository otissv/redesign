import React, { FC } from 'react';
    ...
    export const HeartBrokenOutlineIcon: FC<IconInterface> = function HeartBrokenOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartBrokenOutlineIcon ${className}`;
      return (
        <Icon alt="HeartBrokenOutline" className={classNames} {...propsRest}>
