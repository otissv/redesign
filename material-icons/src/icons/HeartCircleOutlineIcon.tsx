import React, { FC } from 'react';
    ...
    export const HeartCircleOutlineIcon: FC<IconInterface> = function HeartCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartCircleOutlineIcon ${className}`;
      return (
        <Icon alt="HeartCircleOutline" className={classNames} {...propsRest}>
