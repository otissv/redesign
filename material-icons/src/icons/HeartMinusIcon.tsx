import React, { FC } from 'react';
    ...
    export const HeartMinusIcon: FC<IconInterface> = function HeartMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartMinusIcon ${className}`;
      return (
        <Icon alt="HeartMinus" className={classNames} {...propsRest}>
