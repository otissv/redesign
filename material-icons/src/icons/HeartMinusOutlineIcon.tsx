import React, { FC } from 'react';
    ...
    export const HeartMinusOutlineIcon: FC<IconInterface> = function HeartMinusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartMinusOutlineIcon ${className}`;
      return (
        <Icon alt="HeartMinusOutline" className={classNames} {...propsRest}>
    ...
    HeartMinusOutlineIcon.displayName = 'HeartMinusOutlineIcon';
