import React, { FC } from 'react';
    ...
    export const HeartMultipleIcon: FC<IconInterface> = function HeartMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartMultipleIcon ${className}`;
      return (
        <Icon alt="HeartMultiple" className={classNames} {...propsRest}>
