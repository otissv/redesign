import React, { FC } from 'react';
    ...
    export const HeartOffOutlineIcon: FC<IconInterface> = function HeartOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartOffOutlineIcon ${className}`;
      return (
        <Icon alt="HeartOffOutline" className={classNames} {...propsRest}>
    ...
    HeartOffOutlineIcon.displayName = 'HeartOffOutlineIcon';
