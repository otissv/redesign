import React, { FC } from 'react';
    ...
    export const HeartPlusIcon: FC<IconInterface> = function HeartPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartPlusIcon ${className}`;
      return (
        <Icon alt="HeartPlus" className={classNames} {...propsRest}>
