import React, { FC } from 'react';
    ...
    export const HeartPlusOutlineIcon: FC<IconInterface> = function HeartPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartPlusOutlineIcon ${className}`;
      return (
        <Icon alt="HeartPlusOutline" className={classNames} {...propsRest}>
    ...
    HeartPlusOutlineIcon.displayName = 'HeartPlusOutlineIcon';
