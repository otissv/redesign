import React, { FC } from 'react';
    ...
    export const HeartRemoveOutlineIcon: FC<IconInterface> = function HeartRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HeartRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="HeartRemoveOutline" className={classNames} {...propsRest}>
    ...
    HeartRemoveOutlineIcon.displayName = 'HeartRemoveOutlineIcon';
