import React, { FC } from 'react';
    ...
    export const HelpRhombusIcon: FC<IconInterface> = function HelpRhombusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HelpRhombusIcon ${className}`;
      return (
        <Icon alt="HelpRhombus" className={classNames} {...propsRest}>
    ...
    HelpRhombusIcon.displayName = 'HelpRhombusIcon';
