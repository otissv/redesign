import React, { FC } from 'react';
    ...
    export const HexadecimalIcon: FC<IconInterface> = function HexadecimalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HexadecimalIcon ${className}`;
      return (
        <Icon alt="Hexadecimal" className={classNames} {...propsRest}>
    ...
    HexadecimalIcon.displayName = 'HexadecimalIcon';
