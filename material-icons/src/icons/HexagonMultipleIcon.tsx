import React, { FC } from 'react';
    ...
    export const HexagonMultipleIcon: FC<IconInterface> = function HexagonMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HexagonMultipleIcon ${className}`;
      return (
        <Icon alt="HexagonMultiple" className={classNames} {...propsRest}>
