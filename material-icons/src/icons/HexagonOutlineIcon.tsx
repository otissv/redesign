import React, { FC } from 'react';
    ...
    export const HexagonOutlineIcon: FC<IconInterface> = function HexagonOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HexagonOutlineIcon ${className}`;
      return (
        <Icon alt="HexagonOutline" className={classNames} {...propsRest}>
    ...
    HexagonOutlineIcon.displayName = 'HexagonOutlineIcon';
