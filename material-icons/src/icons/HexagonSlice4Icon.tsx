import React, { FC } from 'react';
    ...
    export const HexagonSlice4Icon: FC<IconInterface> = function HexagonSlice4Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `HexagonSlice4Icon ${className}`;
      return (
        <Icon alt="HexagonSlice4" className={classNames} {...propsRest}>
    ...
    HexagonSlice4Icon.displayName = 'HexagonSlice4Icon';
