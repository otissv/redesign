import React, { FC } from 'react';
    ...
    export const HexagonSlice5Icon: FC<IconInterface> = function HexagonSlice5Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `HexagonSlice5Icon ${className}`;
      return (
        <Icon alt="HexagonSlice5" className={classNames} {...propsRest}>
    ...
    HexagonSlice5Icon.displayName = 'HexagonSlice5Icon';
