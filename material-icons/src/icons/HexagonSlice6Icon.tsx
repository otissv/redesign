import React, { FC } from 'react';
    ...
    export const HexagonSlice6Icon: FC<IconInterface> = function HexagonSlice6Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `HexagonSlice6Icon ${className}`;
      return (
        <Icon alt="HexagonSlice6" className={classNames} {...propsRest}>
    ...
    HexagonSlice6Icon.displayName = 'HexagonSlice6Icon';
