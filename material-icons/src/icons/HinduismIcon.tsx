import React, { FC } from 'react';
    ...
    export const HinduismIcon: FC<IconInterface> = function HinduismIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HinduismIcon ${className}`;
      return (
        <Icon alt="Hinduism" className={classNames} {...propsRest}>
