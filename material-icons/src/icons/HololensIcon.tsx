import React, { FC } from 'react';
    ...
    export const HololensIcon: FC<IconInterface> = function HololensIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HololensIcon ${className}`;
      return (
        <Icon alt="Hololens" className={classNames} {...propsRest}>
    ...
    HololensIcon.displayName = 'HololensIcon';
