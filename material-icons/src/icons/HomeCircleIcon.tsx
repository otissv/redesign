import React, { FC } from 'react';
    ...
    export const HomeCircleIcon: FC<IconInterface> = function HomeCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HomeCircleIcon ${className}`;
      return (
        <Icon alt="HomeCircle" className={classNames} {...propsRest}>
