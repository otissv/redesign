import React, { FC } from 'react';
    ...
    export const HomeEditIcon: FC<IconInterface> = function HomeEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HomeEditIcon ${className}`;
      return (
        <Icon alt="HomeEdit" className={classNames} {...propsRest}>
    ...
    HomeEditIcon.displayName = 'HomeEditIcon';
