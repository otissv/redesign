import React, { FC } from 'react';
    ...
    export const HomeEditOutlineIcon: FC<IconInterface> = function HomeEditOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HomeEditOutlineIcon ${className}`;
      return (
        <Icon alt="HomeEditOutline" className={classNames} {...propsRest}>
    ...
    HomeEditOutlineIcon.displayName = 'HomeEditOutlineIcon';
