import React, { FC } from 'react';
    ...
    export const HomeFloodIcon: FC<IconInterface> = function HomeFloodIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HomeFloodIcon ${className}`;
      return (
        <Icon alt="HomeFlood" className={classNames} {...propsRest}>
    ...
    HomeFloodIcon.displayName = 'HomeFloodIcon';
