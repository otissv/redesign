import React, { FC } from 'react';
    ...
    export const HomeHeartIcon: FC<IconInterface> = function HomeHeartIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HomeHeartIcon ${className}`;
      return (
        <Icon alt="HomeHeart" className={classNames} {...propsRest}>
