import React, { FC } from 'react';
    ...
    export const HomeMapMarkerIcon: FC<IconInterface> = function HomeMapMarkerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HomeMapMarkerIcon ${className}`;
      return (
        <Icon alt="HomeMapMarker" className={classNames} {...propsRest}>
