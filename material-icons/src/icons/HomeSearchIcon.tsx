import React, { FC } from 'react';
    ...
    export const HomeSearchIcon: FC<IconInterface> = function HomeSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HomeSearchIcon ${className}`;
      return (
        <Icon alt="HomeSearch" className={classNames} {...propsRest}>
    ...
    HomeSearchIcon.displayName = 'HomeSearchIcon';
