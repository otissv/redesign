import React, { FC } from 'react';
    ...
    export const HorseshoeIcon: FC<IconInterface> = function HorseshoeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HorseshoeIcon ${className}`;
      return (
        <Icon alt="Horseshoe" className={classNames} {...propsRest}>
