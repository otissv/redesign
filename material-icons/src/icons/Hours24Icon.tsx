import React, { FC } from 'react';
    ...
    export const Hours24Icon: FC<IconInterface> = function Hours24Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `Hours24Icon ${className}`;
      return (
        <Icon alt="Hours24" className={classNames} {...propsRest}>
    ...
    Hours24Icon.displayName = 'Hours24Icon';
