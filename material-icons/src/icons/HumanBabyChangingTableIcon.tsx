import React, { FC } from 'react';
    ...
    export const HumanBabyChangingTableIcon: FC<IconInterface> = function HumanBabyChangingTableIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumanBabyChangingTableIcon ${className}`;
      return (
        <Icon alt="HumanBabyChangingTable" className={classNames} {...propsRest}>
    ...
    HumanBabyChangingTableIcon.displayName = 'HumanBabyChangingTableIcon';
