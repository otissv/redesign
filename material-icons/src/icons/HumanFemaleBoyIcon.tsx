import React, { FC } from 'react';
    ...
    export const HumanFemaleBoyIcon: FC<IconInterface> = function HumanFemaleBoyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumanFemaleBoyIcon ${className}`;
      return (
        <Icon alt="HumanFemaleBoy" className={classNames} {...propsRest}>
