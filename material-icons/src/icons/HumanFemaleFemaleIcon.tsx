import React, { FC } from 'react';
    ...
    export const HumanFemaleFemaleIcon: FC<IconInterface> = function HumanFemaleFemaleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumanFemaleFemaleIcon ${className}`;
      return (
        <Icon alt="HumanFemaleFemale" className={classNames} {...propsRest}>
