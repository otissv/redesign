import React, { FC } from 'react';
    ...
    export const HumanFemaleGirlIcon: FC<IconInterface> = function HumanFemaleGirlIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumanFemaleGirlIcon ${className}`;
      return (
        <Icon alt="HumanFemaleGirl" className={classNames} {...propsRest}>
    ...
    HumanFemaleGirlIcon.displayName = 'HumanFemaleGirlIcon';
