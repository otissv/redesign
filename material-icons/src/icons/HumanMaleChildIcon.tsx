import React, { FC } from 'react';
    ...
    export const HumanMaleChildIcon: FC<IconInterface> = function HumanMaleChildIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumanMaleChildIcon ${className}`;
      return (
        <Icon alt="HumanMaleChild" className={classNames} {...propsRest}>
    ...
    HumanMaleChildIcon.displayName = 'HumanMaleChildIcon';
