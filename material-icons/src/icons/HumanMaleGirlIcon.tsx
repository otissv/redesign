import React, { FC } from 'react';
    ...
    export const HumanMaleGirlIcon: FC<IconInterface> = function HumanMaleGirlIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumanMaleGirlIcon ${className}`;
      return (
        <Icon alt="HumanMaleGirl" className={classNames} {...propsRest}>
    ...
    HumanMaleGirlIcon.displayName = 'HumanMaleGirlIcon';
