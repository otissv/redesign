import React, { FC } from 'react';
    ...
    export const HumanMaleHeightVariantIcon: FC<IconInterface> = function HumanMaleHeightVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumanMaleHeightVariantIcon ${className}`;
      return (
        <Icon alt="HumanMaleHeightVariant" className={classNames} {...propsRest}>
