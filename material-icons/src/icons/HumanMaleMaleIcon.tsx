import React, { FC } from 'react';
    ...
    export const HumanMaleMaleIcon: FC<IconInterface> = function HumanMaleMaleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumanMaleMaleIcon ${className}`;
      return (
        <Icon alt="HumanMaleMale" className={classNames} {...propsRest}>
