import React, { FC } from 'react';
    ...
    export const HumanWheelchairIcon: FC<IconInterface> = function HumanWheelchairIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumanWheelchairIcon ${className}`;
      return (
        <Icon alt="HumanWheelchair" className={classNames} {...propsRest}>
    ...
    HumanWheelchairIcon.displayName = 'HumanWheelchairIcon';
