import React, { FC } from 'react';
    ...
    export const HumbleBundleIcon: FC<IconInterface> = function HumbleBundleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HumbleBundleIcon ${className}`;
      return (
        <Icon alt="HumbleBundle" className={classNames} {...propsRest}>
