import React, { FC } from 'react';
    ...
    export const HydraulicOilTemperatureIcon: FC<IconInterface> = function HydraulicOilTemperatureIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HydraulicOilTemperatureIcon ${className}`;
      return (
        <Icon alt="HydraulicOilTemperature" className={classNames} {...propsRest}>
    ...
    HydraulicOilTemperatureIcon.displayName = 'HydraulicOilTemperatureIcon';
