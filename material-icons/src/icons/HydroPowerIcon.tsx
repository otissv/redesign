import React, { FC } from 'react';
    ...
    export const HydroPowerIcon: FC<IconInterface> = function HydroPowerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `HydroPowerIcon ${className}`;
      return (
        <Icon alt="HydroPower" className={classNames} {...propsRest}>
