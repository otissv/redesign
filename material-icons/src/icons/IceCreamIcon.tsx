import React, { FC } from 'react';
    ...
    export const IceCreamIcon: FC<IconInterface> = function IceCreamIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IceCreamIcon ${className}`;
      return (
        <Icon alt="IceCream" className={classNames} {...propsRest}>
