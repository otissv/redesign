import React, { FC } from 'react';
    ...
    export const IceCreamOffIcon: FC<IconInterface> = function IceCreamOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IceCreamOffIcon ${className}`;
      return (
        <Icon alt="IceCreamOff" className={classNames} {...propsRest}>
    ...
    IceCreamOffIcon.displayName = 'IceCreamOffIcon';
