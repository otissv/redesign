import React, { FC } from 'react';
    ...
    export const IcePopIcon: FC<IconInterface> = function IcePopIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IcePopIcon ${className}`;
      return (
        <Icon alt="IcePop" className={classNames} {...propsRest}>
    ...
    IcePopIcon.displayName = 'IcePopIcon';
