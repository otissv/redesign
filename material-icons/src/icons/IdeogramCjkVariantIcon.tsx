import React, { FC } from 'react';
    ...
    export const IdeogramCjkVariantIcon: FC<IconInterface> = function IdeogramCjkVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IdeogramCjkVariantIcon ${className}`;
      return (
        <Icon alt="IdeogramCjkVariant" className={classNames} {...propsRest}>
    ...
    IdeogramCjkVariantIcon.displayName = 'IdeogramCjkVariantIcon';
