import React, { FC } from 'react';
    ...
    export const IframeBracesIcon: FC<IconInterface> = function IframeBracesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IframeBracesIcon ${className}`;
      return (
        <Icon alt="IframeBraces" className={classNames} {...propsRest}>
    ...
    IframeBracesIcon.displayName = 'IframeBracesIcon';
