import React, { FC } from 'react';
    ...
    export const IframeBracesOutlineIcon: FC<IconInterface> = function IframeBracesOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IframeBracesOutlineIcon ${className}`;
      return (
        <Icon alt="IframeBracesOutline" className={classNames} {...propsRest}>
    ...
    IframeBracesOutlineIcon.displayName = 'IframeBracesOutlineIcon';
