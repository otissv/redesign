import React, { FC } from 'react';
    ...
    export const IframeParenthesesIcon: FC<IconInterface> = function IframeParenthesesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IframeParenthesesIcon ${className}`;
      return (
        <Icon alt="IframeParentheses" className={classNames} {...propsRest}>
    ...
    IframeParenthesesIcon.displayName = 'IframeParenthesesIcon';
