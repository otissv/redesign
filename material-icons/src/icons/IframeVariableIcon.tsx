import React, { FC } from 'react';
    ...
    export const IframeVariableIcon: FC<IconInterface> = function IframeVariableIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IframeVariableIcon ${className}`;
      return (
        <Icon alt="IframeVariable" className={classNames} {...propsRest}>
    ...
    IframeVariableIcon.displayName = 'IframeVariableIcon';
