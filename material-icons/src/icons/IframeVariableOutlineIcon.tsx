import React, { FC } from 'react';
    ...
    export const IframeVariableOutlineIcon: FC<IconInterface> = function IframeVariableOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IframeVariableOutlineIcon ${className}`;
      return (
        <Icon alt="IframeVariableOutline" className={classNames} {...propsRest}>
    ...
    IframeVariableOutlineIcon.displayName = 'IframeVariableOutlineIcon';
