import React, { FC } from 'react';
    ...
    export const ImageAutoAdjustIcon: FC<IconInterface> = function ImageAutoAdjustIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageAutoAdjustIcon ${className}`;
      return (
        <Icon alt="ImageAutoAdjust" className={classNames} {...propsRest}>
    ...
    ImageAutoAdjustIcon.displayName = 'ImageAutoAdjustIcon';
