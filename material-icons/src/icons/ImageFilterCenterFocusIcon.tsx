import React, { FC } from 'react';
    ...
    export const ImageFilterCenterFocusIcon: FC<IconInterface> = function ImageFilterCenterFocusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageFilterCenterFocusIcon ${className}`;
      return (
        <Icon alt="ImageFilterCenterFocus" className={classNames} {...propsRest}>
