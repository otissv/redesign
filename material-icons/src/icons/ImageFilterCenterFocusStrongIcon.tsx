import React, { FC } from 'react';
    ...
    export const ImageFilterCenterFocusStrongIcon: FC<IconInterface> = function ImageFilterCenterFocusStrongIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageFilterCenterFocusStrongIcon ${className}`;
      return (
        <Icon alt="ImageFilterCenterFocusStrong" className={classNames} {...propsRest}>
