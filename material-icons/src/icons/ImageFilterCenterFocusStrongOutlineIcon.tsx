import React, { FC } from 'react';
    ...
    export const ImageFilterCenterFocusStrongOutlineIcon: FC<IconInterface> = function ImageFilterCenterFocusStrongOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageFilterCenterFocusStrongOutlineIcon ${className}`;
      return (
        <Icon alt="ImageFilterCenterFocusStrongOutline" className={classNames} {...propsRest}>
