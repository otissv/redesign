import React, { FC } from 'react';
    ...
    export const ImageFilterDramaIcon: FC<IconInterface> = function ImageFilterDramaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageFilterDramaIcon ${className}`;
      return (
        <Icon alt="ImageFilterDrama" className={classNames} {...propsRest}>
