import React, { FC } from 'react';
    ...
    export const ImageFilterVintageIcon: FC<IconInterface> = function ImageFilterVintageIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageFilterVintageIcon ${className}`;
      return (
        <Icon alt="ImageFilterVintage" className={classNames} {...propsRest}>
