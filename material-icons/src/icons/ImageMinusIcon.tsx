import React, { FC } from 'react';
    ...
    export const ImageMinusIcon: FC<IconInterface> = function ImageMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageMinusIcon ${className}`;
      return (
        <Icon alt="ImageMinus" className={classNames} {...propsRest}>
