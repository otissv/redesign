import React, { FC } from 'react';
    ...
    export const ImageMoveIcon: FC<IconInterface> = function ImageMoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageMoveIcon ${className}`;
      return (
        <Icon alt="ImageMove" className={classNames} {...propsRest}>
