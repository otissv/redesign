import React, { FC } from 'react';
    ...
    export const ImageOffIcon: FC<IconInterface> = function ImageOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageOffIcon ${className}`;
      return (
        <Icon alt="ImageOff" className={classNames} {...propsRest}>
