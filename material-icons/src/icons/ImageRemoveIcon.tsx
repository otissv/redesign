import React, { FC } from 'react';
    ...
    export const ImageRemoveIcon: FC<IconInterface> = function ImageRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageRemoveIcon ${className}`;
      return (
        <Icon alt="ImageRemove" className={classNames} {...propsRest}>
