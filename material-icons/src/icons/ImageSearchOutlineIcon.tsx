import React, { FC } from 'react';
    ...
    export const ImageSearchOutlineIcon: FC<IconInterface> = function ImageSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageSearchOutlineIcon ${className}`;
      return (
        <Icon alt="ImageSearchOutline" className={classNames} {...propsRest}>
