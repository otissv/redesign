import React, { FC } from 'react';
    ...
    export const ImageSizeSelectLargeIcon: FC<IconInterface> = function ImageSizeSelectLargeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageSizeSelectLargeIcon ${className}`;
      return (
        <Icon alt="ImageSizeSelectLarge" className={classNames} {...propsRest}>
