import React, { FC } from 'react';
    ...
    export const ImageSizeSelectSmallIcon: FC<IconInterface> = function ImageSizeSelectSmallIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ImageSizeSelectSmallIcon ${className}`;
      return (
        <Icon alt="ImageSizeSelectSmall" className={classNames} {...propsRest}>
