import React, { FC } from 'react';
    ...
    export const InboxArrowUpIcon: FC<IconInterface> = function InboxArrowUpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `InboxArrowUpIcon ${className}`;
      return (
        <Icon alt="InboxArrowUp" className={classNames} {...propsRest}>
