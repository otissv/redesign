import React, { FC } from 'react';
    ...
    export const InboxFullIcon: FC<IconInterface> = function InboxFullIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `InboxFullIcon ${className}`;
      return (
        <Icon alt="InboxFull" className={classNames} {...propsRest}>
    ...
    InboxFullIcon.displayName = 'InboxFullIcon';
