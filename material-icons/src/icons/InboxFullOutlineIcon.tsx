import React, { FC } from 'react';
    ...
    export const InboxFullOutlineIcon: FC<IconInterface> = function InboxFullOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `InboxFullOutlineIcon ${className}`;
      return (
        <Icon alt="InboxFullOutline" className={classNames} {...propsRest}>
    ...
    InboxFullOutlineIcon.displayName = 'InboxFullOutlineIcon';
