import React, { FC } from 'react';
    ...
    export const InboxMultipleOutlineIcon: FC<IconInterface> = function InboxMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `InboxMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="InboxMultipleOutline" className={classNames} {...propsRest}>
