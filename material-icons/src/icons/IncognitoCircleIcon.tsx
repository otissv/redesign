import React, { FC } from 'react';
    ...
    export const IncognitoCircleIcon: FC<IconInterface> = function IncognitoCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IncognitoCircleIcon ${className}`;
      return (
        <Icon alt="IncognitoCircle" className={classNames} {...propsRest}>
    ...
    IncognitoCircleIcon.displayName = 'IncognitoCircleIcon';
