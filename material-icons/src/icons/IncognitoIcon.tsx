import React, { FC } from 'react';
    ...
    export const IncognitoIcon: FC<IconInterface> = function IncognitoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IncognitoIcon ${className}`;
      return (
        <Icon alt="Incognito" className={classNames} {...propsRest}>
