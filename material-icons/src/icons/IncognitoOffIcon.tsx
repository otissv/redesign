import React, { FC } from 'react';
    ...
    export const IncognitoOffIcon: FC<IconInterface> = function IncognitoOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IncognitoOffIcon ${className}`;
      return (
        <Icon alt="IncognitoOff" className={classNames} {...propsRest}>
    ...
    IncognitoOffIcon.displayName = 'IncognitoOffIcon';
