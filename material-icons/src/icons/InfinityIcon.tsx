import React, { FC } from 'react';
    ...
    export const InfinityIcon: FC<IconInterface> = function InfinityIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `InfinityIcon ${className}`;
      return (
        <Icon alt="Infinity" className={classNames} {...propsRest}>
