import React, { FC } from 'react';
    ...
    export const InformationVariantIcon: FC<IconInterface> = function InformationVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `InformationVariantIcon ${className}`;
      return (
        <Icon alt="InformationVariant" className={classNames} {...propsRest}>
