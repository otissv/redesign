import React, { FC } from 'react';
    ...
    export const InvertColorsIcon: FC<IconInterface> = function InvertColorsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `InvertColorsIcon ${className}`;
      return (
        <Icon alt="InvertColors" className={classNames} {...propsRest}>
