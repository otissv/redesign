import React, { FC } from 'react';
    ...
    export const IobrokerIcon: FC<IconInterface> = function IobrokerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IobrokerIcon ${className}`;
      return (
        <Icon alt="Iobroker" className={classNames} {...propsRest}>
    ...
    IobrokerIcon.displayName = 'IobrokerIcon';
