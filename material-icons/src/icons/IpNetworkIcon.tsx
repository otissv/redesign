import React, { FC } from 'react';
    ...
    export const IpNetworkIcon: FC<IconInterface> = function IpNetworkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IpNetworkIcon ${className}`;
      return (
        <Icon alt="IpNetwork" className={classNames} {...propsRest}>
    ...
    IpNetworkIcon.displayName = 'IpNetworkIcon';
