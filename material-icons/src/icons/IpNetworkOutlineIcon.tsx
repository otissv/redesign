import React, { FC } from 'react';
    ...
    export const IpNetworkOutlineIcon: FC<IconInterface> = function IpNetworkOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IpNetworkOutlineIcon ${className}`;
      return (
        <Icon alt="IpNetworkOutline" className={classNames} {...propsRest}>
