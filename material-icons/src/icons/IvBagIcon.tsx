import React, { FC } from 'react';
    ...
    export const IvBagIcon: FC<IconInterface> = function IvBagIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `IvBagIcon ${className}`;
      return (
        <Icon alt="IvBag" className={classNames} {...propsRest}>
    ...
    IvBagIcon.displayName = 'IvBagIcon';
