import React, { FC } from 'react';
    ...
    export const JellyfishIcon: FC<IconInterface> = function JellyfishIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `JellyfishIcon ${className}`;
      return (
        <Icon alt="Jellyfish" className={classNames} {...propsRest}>
    ...
    JellyfishIcon.displayName = 'JellyfishIcon';
