import React, { FC } from 'react';
    ...
    export const JellyfishOutlineIcon: FC<IconInterface> = function JellyfishOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `JellyfishOutlineIcon ${className}`;
      return (
        <Icon alt="JellyfishOutline" className={classNames} {...propsRest}>
