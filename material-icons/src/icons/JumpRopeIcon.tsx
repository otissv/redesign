import React, { FC } from 'react';
    ...
    export const JumpRopeIcon: FC<IconInterface> = function JumpRopeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `JumpRopeIcon ${className}`;
      return (
        <Icon alt="JumpRope" className={classNames} {...propsRest}>
    ...
    JumpRopeIcon.displayName = 'JumpRopeIcon';
