import React, { FC } from 'react';
    ...
    export const KettleAlertIcon: FC<IconInterface> = function KettleAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KettleAlertIcon ${className}`;
      return (
        <Icon alt="KettleAlert" className={classNames} {...propsRest}>
    ...
    KettleAlertIcon.displayName = 'KettleAlertIcon';
