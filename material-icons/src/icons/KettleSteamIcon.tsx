import React, { FC } from 'react';
    ...
    export const KettleSteamIcon: FC<IconInterface> = function KettleSteamIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KettleSteamIcon ${className}`;
      return (
        <Icon alt="KettleSteam" className={classNames} {...propsRest}>
    ...
    KettleSteamIcon.displayName = 'KettleSteamIcon';
