import React, { FC } from 'react';
    ...
    export const KettleSteamOutlineIcon: FC<IconInterface> = function KettleSteamOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KettleSteamOutlineIcon ${className}`;
      return (
        <Icon alt="KettleSteamOutline" className={classNames} {...propsRest}>
    ...
    KettleSteamOutlineIcon.displayName = 'KettleSteamOutlineIcon';
