import React, { FC } from 'react';
    ...
    export const KettlebellIcon: FC<IconInterface> = function KettlebellIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KettlebellIcon ${className}`;
      return (
        <Icon alt="Kettlebell" className={classNames} {...propsRest}>
