import React, { FC } from 'react';
    ...
    export const KeyChangeIcon: FC<IconInterface> = function KeyChangeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KeyChangeIcon ${className}`;
      return (
        <Icon alt="KeyChange" className={classNames} {...propsRest}>
