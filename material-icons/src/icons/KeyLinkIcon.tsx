import React, { FC } from 'react';
    ...
    export const KeyLinkIcon: FC<IconInterface> = function KeyLinkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KeyLinkIcon ${className}`;
      return (
        <Icon alt="KeyLink" className={classNames} {...propsRest}>
    ...
    KeyLinkIcon.displayName = 'KeyLinkIcon';
