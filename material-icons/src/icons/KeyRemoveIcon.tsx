import React, { FC } from 'react';
    ...
    export const KeyRemoveIcon: FC<IconInterface> = function KeyRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KeyRemoveIcon ${className}`;
      return (
        <Icon alt="KeyRemove" className={classNames} {...propsRest}>
    ...
    KeyRemoveIcon.displayName = 'KeyRemoveIcon';
