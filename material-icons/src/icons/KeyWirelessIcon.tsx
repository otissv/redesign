import React, { FC } from 'react';
    ...
    export const KeyWirelessIcon: FC<IconInterface> = function KeyWirelessIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KeyWirelessIcon ${className}`;
      return (
        <Icon alt="KeyWireless" className={classNames} {...propsRest}>
    ...
    KeyWirelessIcon.displayName = 'KeyWirelessIcon';
