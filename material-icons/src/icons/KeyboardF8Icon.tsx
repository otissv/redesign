import React, { FC } from 'react';
    ...
    export const KeyboardF8Icon: FC<IconInterface> = function KeyboardF8Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `KeyboardF8Icon ${className}`;
      return (
        <Icon alt="KeyboardF8" className={classNames} {...propsRest}>
    ...
    KeyboardF8Icon.displayName = 'KeyboardF8Icon';
