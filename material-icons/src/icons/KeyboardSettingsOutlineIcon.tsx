import React, { FC } from 'react';
    ...
    export const KeyboardSettingsOutlineIcon: FC<IconInterface> = function KeyboardSettingsOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KeyboardSettingsOutlineIcon ${className}`;
      return (
        <Icon alt="KeyboardSettingsOutline" className={classNames} {...propsRest}>
