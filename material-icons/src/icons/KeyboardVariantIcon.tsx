import React, { FC } from 'react';
    ...
    export const KeyboardVariantIcon: FC<IconInterface> = function KeyboardVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KeyboardVariantIcon ${className}`;
      return (
        <Icon alt="KeyboardVariant" className={classNames} {...propsRest}>
