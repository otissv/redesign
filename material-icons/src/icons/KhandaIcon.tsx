import React, { FC } from 'react';
    ...
    export const KhandaIcon: FC<IconInterface> = function KhandaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KhandaIcon ${className}`;
      return (
        <Icon alt="Khanda" className={classNames} {...propsRest}>
    ...
    KhandaIcon.displayName = 'KhandaIcon';
