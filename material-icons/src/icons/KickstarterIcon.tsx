import React, { FC } from 'react';
    ...
    export const KickstarterIcon: FC<IconInterface> = function KickstarterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `KickstarterIcon ${className}`;
      return (
        <Icon alt="Kickstarter" className={classNames} {...propsRest}>
