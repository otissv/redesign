import React, { FC } from 'react';
    ...
    export const LabelOffIcon: FC<IconInterface> = function LabelOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LabelOffIcon ${className}`;
      return (
        <Icon alt="LabelOff" className={classNames} {...propsRest}>
