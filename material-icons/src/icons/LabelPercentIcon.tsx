import React, { FC } from 'react';
    ...
    export const LabelPercentIcon: FC<IconInterface> = function LabelPercentIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LabelPercentIcon ${className}`;
      return (
        <Icon alt="LabelPercent" className={classNames} {...propsRest}>
    ...
    LabelPercentIcon.displayName = 'LabelPercentIcon';
