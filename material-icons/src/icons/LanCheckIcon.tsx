import React, { FC } from 'react';
    ...
    export const LanCheckIcon: FC<IconInterface> = function LanCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanCheckIcon ${className}`;
      return (
        <Icon alt="LanCheck" className={classNames} {...propsRest}>
    ...
    LanCheckIcon.displayName = 'LanCheckIcon';
