import React, { FC } from 'react';
    ...
    export const LanConnectIcon: FC<IconInterface> = function LanConnectIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanConnectIcon ${className}`;
      return (
        <Icon alt="LanConnect" className={classNames} {...propsRest}>
    ...
    LanConnectIcon.displayName = 'LanConnectIcon';
