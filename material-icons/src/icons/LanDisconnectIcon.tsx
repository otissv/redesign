import React, { FC } from 'react';
    ...
    export const LanDisconnectIcon: FC<IconInterface> = function LanDisconnectIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanDisconnectIcon ${className}`;
      return (
        <Icon alt="LanDisconnect" className={classNames} {...propsRest}>
    ...
    LanDisconnectIcon.displayName = 'LanDisconnectIcon';
