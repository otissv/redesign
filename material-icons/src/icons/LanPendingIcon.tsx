import React, { FC } from 'react';
    ...
    export const LanPendingIcon: FC<IconInterface> = function LanPendingIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanPendingIcon ${className}`;
      return (
        <Icon alt="LanPending" className={classNames} {...propsRest}>
    ...
    LanPendingIcon.displayName = 'LanPendingIcon';
