import React, { FC } from 'react';
    ...
    export const LanguageCIcon: FC<IconInterface> = function LanguageCIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguageCIcon ${className}`;
      return (
        <Icon alt="LanguageC" className={classNames} {...propsRest}>
