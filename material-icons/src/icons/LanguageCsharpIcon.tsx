import React, { FC } from 'react';
    ...
    export const LanguageCsharpIcon: FC<IconInterface> = function LanguageCsharpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguageCsharpIcon ${className}`;
      return (
        <Icon alt="LanguageCsharp" className={classNames} {...propsRest}>
