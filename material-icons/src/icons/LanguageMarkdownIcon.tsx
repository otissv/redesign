import React, { FC } from 'react';
    ...
    export const LanguageMarkdownIcon: FC<IconInterface> = function LanguageMarkdownIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguageMarkdownIcon ${className}`;
      return (
        <Icon alt="LanguageMarkdown" className={classNames} {...propsRest}>
    ...
    LanguageMarkdownIcon.displayName = 'LanguageMarkdownIcon';
