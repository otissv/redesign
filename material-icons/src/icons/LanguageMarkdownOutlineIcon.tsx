import React, { FC } from 'react';
    ...
    export const LanguageMarkdownOutlineIcon: FC<IconInterface> = function LanguageMarkdownOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguageMarkdownOutlineIcon ${className}`;
      return (
        <Icon alt="LanguageMarkdownOutline" className={classNames} {...propsRest}>
    ...
    LanguageMarkdownOutlineIcon.displayName = 'LanguageMarkdownOutlineIcon';
