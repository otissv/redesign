import React, { FC } from 'react';
    ...
    export const LanguagePhpIcon: FC<IconInterface> = function LanguagePhpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguagePhpIcon ${className}`;
      return (
        <Icon alt="LanguagePhp" className={classNames} {...propsRest}>
    ...
    LanguagePhpIcon.displayName = 'LanguagePhpIcon';
