import React, { FC } from 'react';
    ...
    export const LanguagePythonIcon: FC<IconInterface> = function LanguagePythonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguagePythonIcon ${className}`;
      return (
        <Icon alt="LanguagePython" className={classNames} {...propsRest}>
