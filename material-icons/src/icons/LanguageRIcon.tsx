import React, { FC } from 'react';
    ...
    export const LanguageRIcon: FC<IconInterface> = function LanguageRIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguageRIcon ${className}`;
      return (
        <Icon alt="LanguageR" className={classNames} {...propsRest}>
