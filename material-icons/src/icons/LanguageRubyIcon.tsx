import React, { FC } from 'react';
    ...
    export const LanguageRubyIcon: FC<IconInterface> = function LanguageRubyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguageRubyIcon ${className}`;
      return (
        <Icon alt="LanguageRuby" className={classNames} {...propsRest}>
    ...
    LanguageRubyIcon.displayName = 'LanguageRubyIcon';
