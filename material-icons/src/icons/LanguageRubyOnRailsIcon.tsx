import React, { FC } from 'react';
    ...
    export const LanguageRubyOnRailsIcon: FC<IconInterface> = function LanguageRubyOnRailsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguageRubyOnRailsIcon ${className}`;
      return (
        <Icon alt="LanguageRubyOnRails" className={classNames} {...propsRest}>
