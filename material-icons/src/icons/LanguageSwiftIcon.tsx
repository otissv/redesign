import React, { FC } from 'react';
    ...
    export const LanguageSwiftIcon: FC<IconInterface> = function LanguageSwiftIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LanguageSwiftIcon ${className}`;
      return (
        <Icon alt="LanguageSwift" className={classNames} {...propsRest}>
