import React, { FC } from 'react';
    ...
    export const LaptopOffIcon: FC<IconInterface> = function LaptopOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LaptopOffIcon ${className}`;
      return (
        <Icon alt="LaptopOff" className={classNames} {...propsRest}>
