import React, { FC } from 'react';
    ...
    export const LaserPointerIcon: FC<IconInterface> = function LaserPointerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LaserPointerIcon ${className}`;
      return (
        <Icon alt="LaserPointer" className={classNames} {...propsRest}>
    ...
    LaserPointerIcon.displayName = 'LaserPointerIcon';
