import React, { FC } from 'react';
    ...
    export const LatitudeIcon: FC<IconInterface> = function LatitudeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LatitudeIcon ${className}`;
      return (
        <Icon alt="Latitude" className={classNames} {...propsRest}>
