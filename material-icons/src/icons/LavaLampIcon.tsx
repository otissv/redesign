import React, { FC } from 'react';
    ...
    export const LavaLampIcon: FC<IconInterface> = function LavaLampIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LavaLampIcon ${className}`;
      return (
        <Icon alt="LavaLamp" className={classNames} {...propsRest}>
