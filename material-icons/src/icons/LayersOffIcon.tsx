import React, { FC } from 'react';
    ...
    export const LayersOffIcon: FC<IconInterface> = function LayersOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LayersOffIcon ${className}`;
      return (
        <Icon alt="LayersOff" className={classNames} {...propsRest}>
