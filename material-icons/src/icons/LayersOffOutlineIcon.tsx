import React, { FC } from 'react';
    ...
    export const LayersOffOutlineIcon: FC<IconInterface> = function LayersOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LayersOffOutlineIcon ${className}`;
      return (
        <Icon alt="LayersOffOutline" className={classNames} {...propsRest}>
