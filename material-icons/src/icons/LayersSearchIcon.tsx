import React, { FC } from 'react';
    ...
    export const LayersSearchIcon: FC<IconInterface> = function LayersSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LayersSearchIcon ${className}`;
      return (
        <Icon alt="LayersSearch" className={classNames} {...propsRest}>
    ...
    LayersSearchIcon.displayName = 'LayersSearchIcon';
