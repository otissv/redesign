import React, { FC } from 'react';
    ...
    export const LayersSearchOutlineIcon: FC<IconInterface> = function LayersSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LayersSearchOutlineIcon ${className}`;
      return (
        <Icon alt="LayersSearchOutline" className={classNames} {...propsRest}>
    ...
    LayersSearchOutlineIcon.displayName = 'LayersSearchOutlineIcon';
