import React, { FC } from 'react';
    ...
    export const LeadPencilIcon: FC<IconInterface> = function LeadPencilIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LeadPencilIcon ${className}`;
      return (
        <Icon alt="LeadPencil" className={classNames} {...propsRest}>
    ...
    LeadPencilIcon.displayName = 'LeadPencilIcon';
