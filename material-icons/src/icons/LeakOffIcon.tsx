import React, { FC } from 'react';
    ...
    export const LeakOffIcon: FC<IconInterface> = function LeakOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LeakOffIcon ${className}`;
      return (
        <Icon alt="LeakOff" className={classNames} {...propsRest}>
    ...
    LeakOffIcon.displayName = 'LeakOffIcon';
