import React, { FC } from 'react';
    ...
    export const LedStripVariantIcon: FC<IconInterface> = function LedStripVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LedStripVariantIcon ${className}`;
      return (
        <Icon alt="LedStripVariant" className={classNames} {...propsRest}>
    ...
    LedStripVariantIcon.displayName = 'LedStripVariantIcon';
