import React, { FC } from 'react';
    ...
    export const LeekIcon: FC<IconInterface> = function LeekIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LeekIcon ${className}`;
      return (
        <Icon alt="Leek" className={classNames} {...propsRest}>
