import React, { FC } from 'react';
    ...
    export const LifebuoyIcon: FC<IconInterface> = function LifebuoyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LifebuoyIcon ${className}`;
      return (
        <Icon alt="Lifebuoy" className={classNames} {...propsRest}>
