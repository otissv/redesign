import React, { FC } from 'react';
    ...
    export const LightbulbCflIcon: FC<IconInterface> = function LightbulbCflIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbCflIcon ${className}`;
      return (
        <Icon alt="LightbulbCfl" className={classNames} {...propsRest}>
    ...
    LightbulbCflIcon.displayName = 'LightbulbCflIcon';
