import React, { FC } from 'react';
    ...
    export const LightbulbCflOffIcon: FC<IconInterface> = function LightbulbCflOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbCflOffIcon ${className}`;
      return (
        <Icon alt="LightbulbCflOff" className={classNames} {...propsRest}>
    ...
    LightbulbCflOffIcon.displayName = 'LightbulbCflOffIcon';
