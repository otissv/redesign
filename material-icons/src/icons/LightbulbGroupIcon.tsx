import React, { FC } from 'react';
    ...
    export const LightbulbGroupIcon: FC<IconInterface> = function LightbulbGroupIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbGroupIcon ${className}`;
      return (
        <Icon alt="LightbulbGroup" className={classNames} {...propsRest}>
    ...
    LightbulbGroupIcon.displayName = 'LightbulbGroupIcon';
