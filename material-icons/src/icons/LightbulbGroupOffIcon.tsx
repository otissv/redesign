import React, { FC } from 'react';
    ...
    export const LightbulbGroupOffIcon: FC<IconInterface> = function LightbulbGroupOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbGroupOffIcon ${className}`;
      return (
        <Icon alt="LightbulbGroupOff" className={classNames} {...propsRest}>
    ...
    LightbulbGroupOffIcon.displayName = 'LightbulbGroupOffIcon';
