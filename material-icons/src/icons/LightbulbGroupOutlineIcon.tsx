import React, { FC } from 'react';
    ...
    export const LightbulbGroupOutlineIcon: FC<IconInterface> = function LightbulbGroupOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbGroupOutlineIcon ${className}`;
      return (
        <Icon alt="LightbulbGroupOutline" className={classNames} {...propsRest}>
    ...
    LightbulbGroupOutlineIcon.displayName = 'LightbulbGroupOutlineIcon';
