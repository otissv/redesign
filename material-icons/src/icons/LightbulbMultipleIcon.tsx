import React, { FC } from 'react';
    ...
    export const LightbulbMultipleIcon: FC<IconInterface> = function LightbulbMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbMultipleIcon ${className}`;
      return (
        <Icon alt="LightbulbMultiple" className={classNames} {...propsRest}>
    ...
    LightbulbMultipleIcon.displayName = 'LightbulbMultipleIcon';
