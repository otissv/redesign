import React, { FC } from 'react';
    ...
    export const LightbulbMultipleOffOutlineIcon: FC<IconInterface> = function LightbulbMultipleOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbMultipleOffOutlineIcon ${className}`;
      return (
        <Icon alt="LightbulbMultipleOffOutline" className={classNames} {...propsRest}>
    ...
    LightbulbMultipleOffOutlineIcon.displayName = 'LightbulbMultipleOffOutlineIcon';
