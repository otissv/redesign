import React, { FC } from 'react';
    ...
    export const LightbulbMultipleOutlineIcon: FC<IconInterface> = function LightbulbMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="LightbulbMultipleOutline" className={classNames} {...propsRest}>
    ...
    LightbulbMultipleOutlineIcon.displayName = 'LightbulbMultipleOutlineIcon';
