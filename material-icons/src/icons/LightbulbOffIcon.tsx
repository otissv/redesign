import React, { FC } from 'react';
    ...
    export const LightbulbOffIcon: FC<IconInterface> = function LightbulbOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbOffIcon ${className}`;
      return (
        <Icon alt="LightbulbOff" className={classNames} {...propsRest}>
