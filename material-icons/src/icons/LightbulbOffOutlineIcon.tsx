import React, { FC } from 'react';
    ...
    export const LightbulbOffOutlineIcon: FC<IconInterface> = function LightbulbOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbOffOutlineIcon ${className}`;
      return (
        <Icon alt="LightbulbOffOutline" className={classNames} {...propsRest}>
