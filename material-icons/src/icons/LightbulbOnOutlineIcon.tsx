import React, { FC } from 'react';
    ...
    export const LightbulbOnOutlineIcon: FC<IconInterface> = function LightbulbOnOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbOnOutlineIcon ${className}`;
      return (
        <Icon alt="LightbulbOnOutline" className={classNames} {...propsRest}>
