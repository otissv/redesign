import React, { FC } from 'react';
    ...
    export const LightbulbOutlineIcon: FC<IconInterface> = function LightbulbOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LightbulbOutlineIcon ${className}`;
      return (
        <Icon alt="LightbulbOutline" className={classNames} {...propsRest}>
