import React, { FC } from 'react';
    ...
    export const LingerieIcon: FC<IconInterface> = function LingerieIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LingerieIcon ${className}`;
      return (
        <Icon alt="Lingerie" className={classNames} {...propsRest}>
    ...
    LingerieIcon.displayName = 'LingerieIcon';
