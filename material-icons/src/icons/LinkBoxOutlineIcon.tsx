import React, { FC } from 'react';
    ...
    export const LinkBoxOutlineIcon: FC<IconInterface> = function LinkBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LinkBoxOutlineIcon ${className}`;
      return (
        <Icon alt="LinkBoxOutline" className={classNames} {...propsRest}>
    ...
    LinkBoxOutlineIcon.displayName = 'LinkBoxOutlineIcon';
