import React, { FC } from 'react';
    ...
    export const LinkBoxVariantIcon: FC<IconInterface> = function LinkBoxVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LinkBoxVariantIcon ${className}`;
      return (
        <Icon alt="LinkBoxVariant" className={classNames} {...propsRest}>
