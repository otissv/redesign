import React, { FC } from 'react';
    ...
    export const LinkBoxVariantOutlineIcon: FC<IconInterface> = function LinkBoxVariantOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LinkBoxVariantOutlineIcon ${className}`;
      return (
        <Icon alt="LinkBoxVariantOutline" className={classNames} {...propsRest}>
    ...
    LinkBoxVariantOutlineIcon.displayName = 'LinkBoxVariantOutlineIcon';
