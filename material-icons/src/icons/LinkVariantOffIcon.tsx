import React, { FC } from 'react';
    ...
    export const LinkVariantOffIcon: FC<IconInterface> = function LinkVariantOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LinkVariantOffIcon ${className}`;
      return (
        <Icon alt="LinkVariantOff" className={classNames} {...propsRest}>
    ...
    LinkVariantOffIcon.displayName = 'LinkVariantOffIcon';
