import React, { FC } from 'react';
    ...
    export const LinuxMintIcon: FC<IconInterface> = function LinuxMintIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LinuxMintIcon ${className}`;
      return (
        <Icon alt="LinuxMint" className={classNames} {...propsRest}>
