import React, { FC } from 'react';
    ...
    export const LitecoinIcon: FC<IconInterface> = function LitecoinIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LitecoinIcon ${className}`;
      return (
        <Icon alt="Litecoin" className={classNames} {...propsRest}>
