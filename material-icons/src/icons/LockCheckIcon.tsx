import React, { FC } from 'react';
    ...
    export const LockCheckIcon: FC<IconInterface> = function LockCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LockCheckIcon ${className}`;
      return (
        <Icon alt="LockCheck" className={classNames} {...propsRest}>
    ...
    LockCheckIcon.displayName = 'LockCheckIcon';
