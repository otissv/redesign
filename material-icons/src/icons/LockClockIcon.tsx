import React, { FC } from 'react';
    ...
    export const LockClockIcon: FC<IconInterface> = function LockClockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LockClockIcon ${className}`;
      return (
        <Icon alt="LockClock" className={classNames} {...propsRest}>
