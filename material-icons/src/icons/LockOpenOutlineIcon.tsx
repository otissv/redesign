import React, { FC } from 'react';
    ...
    export const LockOpenOutlineIcon: FC<IconInterface> = function LockOpenOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LockOpenOutlineIcon ${className}`;
      return (
        <Icon alt="LockOpenOutline" className={classNames} {...propsRest}>
