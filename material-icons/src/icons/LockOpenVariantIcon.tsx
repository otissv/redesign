import React, { FC } from 'react';
    ...
    export const LockOpenVariantIcon: FC<IconInterface> = function LockOpenVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LockOpenVariantIcon ${className}`;
      return (
        <Icon alt="LockOpenVariant" className={classNames} {...propsRest}>
    ...
    LockOpenVariantIcon.displayName = 'LockOpenVariantIcon';
