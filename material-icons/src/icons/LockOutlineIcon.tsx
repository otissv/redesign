import React, { FC } from 'react';
    ...
    export const LockOutlineIcon: FC<IconInterface> = function LockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LockOutlineIcon ${className}`;
      return (
        <Icon alt="LockOutline" className={classNames} {...propsRest}>
