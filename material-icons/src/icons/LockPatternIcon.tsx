import React, { FC } from 'react';
    ...
    export const LockPatternIcon: FC<IconInterface> = function LockPatternIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LockPatternIcon ${className}`;
      return (
        <Icon alt="LockPattern" className={classNames} {...propsRest}>
