import React, { FC } from 'react';
    ...
    export const LockResetIcon: FC<IconInterface> = function LockResetIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LockResetIcon ${className}`;
      return (
        <Icon alt="LockReset" className={classNames} {...propsRest}>
