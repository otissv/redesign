import React, { FC } from 'react';
    ...
    export const LockSmartIcon: FC<IconInterface> = function LockSmartIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LockSmartIcon ${className}`;
      return (
        <Icon alt="LockSmart" className={classNames} {...propsRest}>
