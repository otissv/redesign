import React, { FC } from 'react';
    ...
    export const LockerMultipleIcon: FC<IconInterface> = function LockerMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `LockerMultipleIcon ${className}`;
      return (
        <Icon alt="LockerMultiple" className={classNames} {...propsRest}>
