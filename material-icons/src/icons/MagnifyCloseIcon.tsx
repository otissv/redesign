import React, { FC } from 'react';
    ...
    export const MagnifyCloseIcon: FC<IconInterface> = function MagnifyCloseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MagnifyCloseIcon ${className}`;
      return (
        <Icon alt="MagnifyClose" className={classNames} {...propsRest}>
