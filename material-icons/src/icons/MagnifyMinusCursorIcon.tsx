import React, { FC } from 'react';
    ...
    export const MagnifyMinusCursorIcon: FC<IconInterface> = function MagnifyMinusCursorIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MagnifyMinusCursorIcon ${className}`;
      return (
        <Icon alt="MagnifyMinusCursor" className={classNames} {...propsRest}>
