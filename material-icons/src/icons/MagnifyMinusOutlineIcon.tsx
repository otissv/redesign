import React, { FC } from 'react';
    ...
    export const MagnifyMinusOutlineIcon: FC<IconInterface> = function MagnifyMinusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MagnifyMinusOutlineIcon ${className}`;
      return (
        <Icon alt="MagnifyMinusOutline" className={classNames} {...propsRest}>
    ...
    MagnifyMinusOutlineIcon.displayName = 'MagnifyMinusOutlineIcon';
