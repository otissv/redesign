import React, { FC } from 'react';
    ...
    export const MapCheckIcon: FC<IconInterface> = function MapCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapCheckIcon ${className}`;
      return (
        <Icon alt="MapCheck" className={classNames} {...propsRest}>
