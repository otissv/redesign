import React, { FC } from 'react';
    ...
    export const MapCheckOutlineIcon: FC<IconInterface> = function MapCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapCheckOutlineIcon ${className}`;
      return (
        <Icon alt="MapCheckOutline" className={classNames} {...propsRest}>
