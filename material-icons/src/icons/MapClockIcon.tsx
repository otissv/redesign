import React, { FC } from 'react';
    ...
    export const MapClockIcon: FC<IconInterface> = function MapClockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapClockIcon ${className}`;
      return (
        <Icon alt="MapClock" className={classNames} {...propsRest}>
