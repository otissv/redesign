import React, { FC } from 'react';
    ...
    export const MapClockOutlineIcon: FC<IconInterface> = function MapClockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapClockOutlineIcon ${className}`;
      return (
        <Icon alt="MapClockOutline" className={classNames} {...propsRest}>
