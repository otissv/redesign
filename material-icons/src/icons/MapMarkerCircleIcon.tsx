import React, { FC } from 'react';
    ...
    export const MapMarkerCircleIcon: FC<IconInterface> = function MapMarkerCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapMarkerCircleIcon ${className}`;
      return (
        <Icon alt="MapMarkerCircle" className={classNames} {...propsRest}>
    ...
    MapMarkerCircleIcon.displayName = 'MapMarkerCircleIcon';
