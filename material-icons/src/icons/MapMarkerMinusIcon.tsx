import React, { FC } from 'react';
    ...
    export const MapMarkerMinusIcon: FC<IconInterface> = function MapMarkerMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapMarkerMinusIcon ${className}`;
      return (
        <Icon alt="MapMarkerMinus" className={classNames} {...propsRest}>
