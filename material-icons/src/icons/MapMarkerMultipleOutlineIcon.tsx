import React, { FC } from 'react';
    ...
    export const MapMarkerMultipleOutlineIcon: FC<IconInterface> = function MapMarkerMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapMarkerMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="MapMarkerMultipleOutline" className={classNames} {...propsRest}>
    ...
    MapMarkerMultipleOutlineIcon.displayName = 'MapMarkerMultipleOutlineIcon';
