import React, { FC } from 'react';
    ...
    export const MapMarkerOffOutlineIcon: FC<IconInterface> = function MapMarkerOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapMarkerOffOutlineIcon ${className}`;
      return (
        <Icon alt="MapMarkerOffOutline" className={classNames} {...propsRest}>
    ...
    MapMarkerOffOutlineIcon.displayName = 'MapMarkerOffOutlineIcon';
