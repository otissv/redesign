import React, { FC } from 'react';
    ...
    export const MapMarkerPlusOutlineIcon: FC<IconInterface> = function MapMarkerPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapMarkerPlusOutlineIcon ${className}`;
      return (
        <Icon alt="MapMarkerPlusOutline" className={classNames} {...propsRest}>
    ...
    MapMarkerPlusOutlineIcon.displayName = 'MapMarkerPlusOutlineIcon';
