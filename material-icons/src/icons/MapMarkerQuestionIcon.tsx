import React, { FC } from 'react';
    ...
    export const MapMarkerQuestionIcon: FC<IconInterface> = function MapMarkerQuestionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapMarkerQuestionIcon ${className}`;
      return (
        <Icon alt="MapMarkerQuestion" className={classNames} {...propsRest}>
