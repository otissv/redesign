import React, { FC } from 'react';
    ...
    export const MapMarkerQuestionOutlineIcon: FC<IconInterface> = function MapMarkerQuestionOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapMarkerQuestionOutlineIcon ${className}`;
      return (
        <Icon alt="MapMarkerQuestionOutline" className={classNames} {...propsRest}>
