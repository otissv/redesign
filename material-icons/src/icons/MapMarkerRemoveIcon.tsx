import React, { FC } from 'react';
    ...
    export const MapMarkerRemoveIcon: FC<IconInterface> = function MapMarkerRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapMarkerRemoveIcon ${className}`;
      return (
        <Icon alt="MapMarkerRemove" className={classNames} {...propsRest}>
