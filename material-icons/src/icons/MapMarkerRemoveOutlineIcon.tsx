import React, { FC } from 'react';
    ...
    export const MapMarkerRemoveOutlineIcon: FC<IconInterface> = function MapMarkerRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MapMarkerRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="MapMarkerRemoveOutline" className={classNames} {...propsRest}>
    ...
    MapMarkerRemoveOutlineIcon.displayName = 'MapMarkerRemoveOutlineIcon';
