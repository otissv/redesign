import React, { FC } from 'react';
    ...
    export const MarkerCancelIcon: FC<IconInterface> = function MarkerCancelIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MarkerCancelIcon ${className}`;
      return (
        <Icon alt="MarkerCancel" className={classNames} {...propsRest}>
