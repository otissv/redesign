import React, { FC } from 'react';
    ...
    export const MastodonIcon: FC<IconInterface> = function MastodonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MastodonIcon ${className}`;
      return (
        <Icon alt="Mastodon" className={classNames} {...propsRest}>
