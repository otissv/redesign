import React, { FC } from 'react';
    ...
    export const MaterialDesignIcon: FC<IconInterface> = function MaterialDesignIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MaterialDesignIcon ${className}`;
      return (
        <Icon alt="MaterialDesign" className={classNames} {...propsRest}>
