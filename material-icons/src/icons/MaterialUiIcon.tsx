import React, { FC } from 'react';
    ...
    export const MaterialUiIcon: FC<IconInterface> = function MaterialUiIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MaterialUiIcon ${className}`;
      return (
        <Icon alt="MaterialUi" className={classNames} {...propsRest}>
