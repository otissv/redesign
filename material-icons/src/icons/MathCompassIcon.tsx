import React, { FC } from 'react';
    ...
    export const MathCompassIcon: FC<IconInterface> = function MathCompassIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MathCompassIcon ${className}`;
      return (
        <Icon alt="MathCompass" className={classNames} {...propsRest}>
