import React, { FC } from 'react';
    ...
    export const MathIntegralBoxIcon: FC<IconInterface> = function MathIntegralBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MathIntegralBoxIcon ${className}`;
      return (
        <Icon alt="MathIntegralBox" className={classNames} {...propsRest}>
    ...
    MathIntegralBoxIcon.displayName = 'MathIntegralBoxIcon';
