import React, { FC } from 'react';
    ...
    export const MathIntegralIcon: FC<IconInterface> = function MathIntegralIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MathIntegralIcon ${className}`;
      return (
        <Icon alt="MathIntegral" className={classNames} {...propsRest}>
    ...
    MathIntegralIcon.displayName = 'MathIntegralIcon';
