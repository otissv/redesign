import React, { FC } from 'react';
    ...
    export const MedalOutlineIcon: FC<IconInterface> = function MedalOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MedalOutlineIcon ${className}`;
      return (
        <Icon alt="MedalOutline" className={classNames} {...propsRest}>
    ...
    MedalOutlineIcon.displayName = 'MedalOutlineIcon';
