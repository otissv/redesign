import React, { FC } from 'react';
    ...
    export const MessageBulletedOffIcon: FC<IconInterface> = function MessageBulletedOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MessageBulletedOffIcon ${className}`;
      return (
        <Icon alt="MessageBulletedOff" className={classNames} {...propsRest}>
