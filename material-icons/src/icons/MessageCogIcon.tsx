import React, { FC } from 'react';
    ...
    export const MessageCogIcon: FC<IconInterface> = function MessageCogIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MessageCogIcon ${className}`;
      return (
        <Icon alt="MessageCog" className={classNames} {...propsRest}>
    ...
    MessageCogIcon.displayName = 'MessageCogIcon';
