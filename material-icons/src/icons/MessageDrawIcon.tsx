import React, { FC } from 'react';
    ...
    export const MessageDrawIcon: FC<IconInterface> = function MessageDrawIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MessageDrawIcon ${className}`;
      return (
        <Icon alt="MessageDraw" className={classNames} {...propsRest}>
    ...
    MessageDrawIcon.displayName = 'MessageDrawIcon';
