import React, { FC } from 'react';
    ...
    export const MessageTextClockIcon: FC<IconInterface> = function MessageTextClockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MessageTextClockIcon ${className}`;
      return (
        <Icon alt="MessageTextClock" className={classNames} {...propsRest}>
    ...
    MessageTextClockIcon.displayName = 'MessageTextClockIcon';
