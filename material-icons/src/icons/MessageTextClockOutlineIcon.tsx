import React, { FC } from 'react';
    ...
    export const MessageTextClockOutlineIcon: FC<IconInterface> = function MessageTextClockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MessageTextClockOutlineIcon ${className}`;
      return (
        <Icon alt="MessageTextClockOutline" className={classNames} {...propsRest}>
    ...
    MessageTextClockOutlineIcon.displayName = 'MessageTextClockOutlineIcon';
