import React, { FC } from 'react';
    ...
    export const MetronomeIcon: FC<IconInterface> = function MetronomeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MetronomeIcon ${className}`;
      return (
        <Icon alt="Metronome" className={classNames} {...propsRest}>
