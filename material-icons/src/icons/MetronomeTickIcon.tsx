import React, { FC } from 'react';
    ...
    export const MetronomeTickIcon: FC<IconInterface> = function MetronomeTickIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MetronomeTickIcon ${className}`;
      return (
        <Icon alt="MetronomeTick" className={classNames} {...propsRest}>
    ...
    MetronomeTickIcon.displayName = 'MetronomeTickIcon';
