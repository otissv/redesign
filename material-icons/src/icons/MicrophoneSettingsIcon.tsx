import React, { FC } from 'react';
    ...
    export const MicrophoneSettingsIcon: FC<IconInterface> = function MicrophoneSettingsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrophoneSettingsIcon ${className}`;
      return (
        <Icon alt="MicrophoneSettings" className={classNames} {...propsRest}>
