import React, { FC } from 'react';
    ...
    export const MicrophoneVariantIcon: FC<IconInterface> = function MicrophoneVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrophoneVariantIcon ${className}`;
      return (
        <Icon alt="MicrophoneVariant" className={classNames} {...propsRest}>
