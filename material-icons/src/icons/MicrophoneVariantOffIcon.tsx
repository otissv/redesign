import React, { FC } from 'react';
    ...
    export const MicrophoneVariantOffIcon: FC<IconInterface> = function MicrophoneVariantOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrophoneVariantOffIcon ${className}`;
      return (
        <Icon alt="MicrophoneVariantOff" className={classNames} {...propsRest}>
