import React, { FC } from 'react';
    ...
    export const MicrosoftExcelIcon: FC<IconInterface> = function MicrosoftExcelIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrosoftExcelIcon ${className}`;
      return (
        <Icon alt="MicrosoftExcel" className={classNames} {...propsRest}>
