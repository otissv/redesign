import React, { FC } from 'react';
    ...
    export const MicrosoftPowerpointIcon: FC<IconInterface> = function MicrosoftPowerpointIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrosoftPowerpointIcon ${className}`;
      return (
        <Icon alt="MicrosoftPowerpoint" className={classNames} {...propsRest}>
