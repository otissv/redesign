import React, { FC } from 'react';
    ...
    export const MicrosoftVisualStudioCodeIcon: FC<IconInterface> = function MicrosoftVisualStudioCodeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrosoftVisualStudioCodeIcon ${className}`;
      return (
        <Icon alt="MicrosoftVisualStudioCode" className={classNames} {...propsRest}>
    ...
    MicrosoftVisualStudioCodeIcon.displayName = 'MicrosoftVisualStudioCodeIcon';
