import React, { FC } from 'react';
    ...
    export const MicrosoftWordIcon: FC<IconInterface> = function MicrosoftWordIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrosoftWordIcon ${className}`;
      return (
        <Icon alt="MicrosoftWord" className={classNames} {...propsRest}>
