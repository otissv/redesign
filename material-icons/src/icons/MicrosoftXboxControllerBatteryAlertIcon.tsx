import React, { FC } from 'react';
    ...
    export const MicrosoftXboxControllerBatteryAlertIcon: FC<IconInterface> = function MicrosoftXboxControllerBatteryAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrosoftXboxControllerBatteryAlertIcon ${className}`;
      return (
        <Icon alt="MicrosoftXboxControllerBatteryAlert" className={classNames} {...propsRest}>
    ...
    MicrosoftXboxControllerBatteryAlertIcon.displayName = 'MicrosoftXboxControllerBatteryAlertIcon';
