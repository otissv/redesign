import React, { FC } from 'react';
    ...
    export const MicrosoftXboxControllerBatteryUnknownIcon: FC<IconInterface> = function MicrosoftXboxControllerBatteryUnknownIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrosoftXboxControllerBatteryUnknownIcon ${className}`;
      return (
        <Icon alt="MicrosoftXboxControllerBatteryUnknown" className={classNames} {...propsRest}>
    ...
    MicrosoftXboxControllerBatteryUnknownIcon.displayName = 'MicrosoftXboxControllerBatteryUnknownIcon';
