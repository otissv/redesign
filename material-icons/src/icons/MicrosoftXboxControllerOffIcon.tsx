import React, { FC } from 'react';
    ...
    export const MicrosoftXboxControllerOffIcon: FC<IconInterface> = function MicrosoftXboxControllerOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MicrosoftXboxControllerOffIcon ${className}`;
      return (
        <Icon alt="MicrosoftXboxControllerOff" className={classNames} {...propsRest}>
    ...
    MicrosoftXboxControllerOffIcon.displayName = 'MicrosoftXboxControllerOffIcon';
