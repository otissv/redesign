import React, { FC } from 'react';
    ...
    export const MidiPortIcon: FC<IconInterface> = function MidiPortIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MidiPortIcon ${className}`;
      return (
        <Icon alt="MidiPort" className={classNames} {...propsRest}>
