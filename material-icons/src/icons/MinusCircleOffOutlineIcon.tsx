import React, { FC } from 'react';
    ...
    export const MinusCircleOffOutlineIcon: FC<IconInterface> = function MinusCircleOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MinusCircleOffOutlineIcon ${className}`;
      return (
        <Icon alt="MinusCircleOffOutline" className={classNames} {...propsRest}>
    ...
    MinusCircleOffOutlineIcon.displayName = 'MinusCircleOffOutlineIcon';
