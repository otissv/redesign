import React, { FC } from 'react';
    ...
    export const MoleculeIcon: FC<IconInterface> = function MoleculeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MoleculeIcon ${className}`;
      return (
        <Icon alt="Molecule" className={classNames} {...propsRest}>
