import React, { FC } from 'react';
    ...
    export const MonitorCellphoneIcon: FC<IconInterface> = function MonitorCellphoneIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MonitorCellphoneIcon ${className}`;
      return (
        <Icon alt="MonitorCellphone" className={classNames} {...propsRest}>
