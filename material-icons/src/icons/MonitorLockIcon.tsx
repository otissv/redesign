import React, { FC } from 'react';
    ...
    export const MonitorLockIcon: FC<IconInterface> = function MonitorLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MonitorLockIcon ${className}`;
      return (
        <Icon alt="MonitorLock" className={classNames} {...propsRest}>
