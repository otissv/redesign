import React, { FC } from 'react';
    ...
    export const MonitorSpeakerIcon: FC<IconInterface> = function MonitorSpeakerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MonitorSpeakerIcon ${className}`;
      return (
        <Icon alt="MonitorSpeaker" className={classNames} {...propsRest}>
