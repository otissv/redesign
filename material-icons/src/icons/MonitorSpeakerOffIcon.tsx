import React, { FC } from 'react';
    ...
    export const MonitorSpeakerOffIcon: FC<IconInterface> = function MonitorSpeakerOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MonitorSpeakerOffIcon ${className}`;
      return (
        <Icon alt="MonitorSpeakerOff" className={classNames} {...propsRest}>
    ...
    MonitorSpeakerOffIcon.displayName = 'MonitorSpeakerOffIcon';
