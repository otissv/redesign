import React, { FC } from 'react';
    ...
    export const MopedIcon: FC<IconInterface> = function MopedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MopedIcon ${className}`;
      return (
        <Icon alt="Moped" className={classNames} {...propsRest}>
    ...
    MopedIcon.displayName = 'MopedIcon';
