import React, { FC } from 'react';
    ...
    export const MotherHeartIcon: FC<IconInterface> = function MotherHeartIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MotherHeartIcon ${className}`;
      return (
        <Icon alt="MotherHeart" className={classNames} {...propsRest}>
    ...
    MotherHeartIcon.displayName = 'MotherHeartIcon';
