import React, { FC } from 'react';
    ...
    export const MotorbikeIcon: FC<IconInterface> = function MotorbikeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MotorbikeIcon ${className}`;
      return (
        <Icon alt="Motorbike" className={classNames} {...propsRest}>
