import React, { FC } from 'react';
    ...
    export const MouseBluetoothIcon: FC<IconInterface> = function MouseBluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MouseBluetoothIcon ${className}`;
      return (
        <Icon alt="MouseBluetooth" className={classNames} {...propsRest}>
