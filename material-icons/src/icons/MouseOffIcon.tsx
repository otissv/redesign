import React, { FC } from 'react';
    ...
    export const MouseOffIcon: FC<IconInterface> = function MouseOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MouseOffIcon ${className}`;
      return (
        <Icon alt="MouseOff" className={classNames} {...propsRest}>
