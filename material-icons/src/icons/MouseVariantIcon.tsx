import React, { FC } from 'react';
    ...
    export const MouseVariantIcon: FC<IconInterface> = function MouseVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MouseVariantIcon ${className}`;
      return (
        <Icon alt="MouseVariant" className={classNames} {...propsRest}>
