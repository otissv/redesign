import React, { FC } from 'react';
    ...
    export const MouseVariantOffIcon: FC<IconInterface> = function MouseVariantOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MouseVariantOffIcon ${className}`;
      return (
        <Icon alt="MouseVariantOff" className={classNames} {...propsRest}>
