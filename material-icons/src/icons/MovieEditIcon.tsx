import React, { FC } from 'react';
    ...
    export const MovieEditIcon: FC<IconInterface> = function MovieEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MovieEditIcon ${className}`;
      return (
        <Icon alt="MovieEdit" className={classNames} {...propsRest}>
    ...
    MovieEditIcon.displayName = 'MovieEditIcon';
