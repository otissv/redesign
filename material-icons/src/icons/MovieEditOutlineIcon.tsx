import React, { FC } from 'react';
    ...
    export const MovieEditOutlineIcon: FC<IconInterface> = function MovieEditOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MovieEditOutlineIcon ${className}`;
      return (
        <Icon alt="MovieEditOutline" className={classNames} {...propsRest}>
    ...
    MovieEditOutlineIcon.displayName = 'MovieEditOutlineIcon';
