import React, { FC } from 'react';
    ...
    export const MovieFilterIcon: FC<IconInterface> = function MovieFilterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MovieFilterIcon ${className}`;
      return (
        <Icon alt="MovieFilter" className={classNames} {...propsRest}>
