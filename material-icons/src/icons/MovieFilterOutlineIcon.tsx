import React, { FC } from 'react';
    ...
    export const MovieFilterOutlineIcon: FC<IconInterface> = function MovieFilterOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MovieFilterOutlineIcon ${className}`;
      return (
        <Icon alt="MovieFilterOutline" className={classNames} {...propsRest}>
    ...
    MovieFilterOutlineIcon.displayName = 'MovieFilterOutlineIcon';
