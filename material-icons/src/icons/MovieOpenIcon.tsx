import React, { FC } from 'react';
    ...
    export const MovieOpenIcon: FC<IconInterface> = function MovieOpenIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MovieOpenIcon ${className}`;
      return (
        <Icon alt="MovieOpen" className={classNames} {...propsRest}>
    ...
    MovieOpenIcon.displayName = 'MovieOpenIcon';
