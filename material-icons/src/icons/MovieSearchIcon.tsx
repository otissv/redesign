import React, { FC } from 'react';
    ...
    export const MovieSearchIcon: FC<IconInterface> = function MovieSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MovieSearchIcon ${className}`;
      return (
        <Icon alt="MovieSearch" className={classNames} {...propsRest}>
    ...
    MovieSearchIcon.displayName = 'MovieSearchIcon';
