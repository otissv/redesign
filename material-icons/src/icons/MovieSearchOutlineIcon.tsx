import React, { FC } from 'react';
    ...
    export const MovieSearchOutlineIcon: FC<IconInterface> = function MovieSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MovieSearchOutlineIcon ${className}`;
      return (
        <Icon alt="MovieSearchOutline" className={classNames} {...propsRest}>
    ...
    MovieSearchOutlineIcon.displayName = 'MovieSearchOutlineIcon';
