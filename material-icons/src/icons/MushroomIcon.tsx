import React, { FC } from 'react';
    ...
    export const MushroomIcon: FC<IconInterface> = function MushroomIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MushroomIcon ${className}`;
      return (
        <Icon alt="Mushroom" className={classNames} {...propsRest}>
