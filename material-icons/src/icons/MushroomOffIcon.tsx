import React, { FC } from 'react';
    ...
    export const MushroomOffIcon: FC<IconInterface> = function MushroomOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MushroomOffIcon ${className}`;
      return (
        <Icon alt="MushroomOff" className={classNames} {...propsRest}>
    ...
    MushroomOffIcon.displayName = 'MushroomOffIcon';
