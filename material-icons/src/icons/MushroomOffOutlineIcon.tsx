import React, { FC } from 'react';
    ...
    export const MushroomOffOutlineIcon: FC<IconInterface> = function MushroomOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MushroomOffOutlineIcon ${className}`;
      return (
        <Icon alt="MushroomOffOutline" className={classNames} {...propsRest}>
    ...
    MushroomOffOutlineIcon.displayName = 'MushroomOffOutlineIcon';
