import React, { FC } from 'react';
    ...
    export const MushroomOutlineIcon: FC<IconInterface> = function MushroomOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MushroomOutlineIcon ${className}`;
      return (
        <Icon alt="MushroomOutline" className={classNames} {...propsRest}>
