import React, { FC } from 'react';
    ...
    export const MusicAccidentalDoubleFlatIcon: FC<IconInterface> = function MusicAccidentalDoubleFlatIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MusicAccidentalDoubleFlatIcon ${className}`;
      return (
        <Icon alt="MusicAccidentalDoubleFlat" className={classNames} {...propsRest}>
    ...
    MusicAccidentalDoubleFlatIcon.displayName = 'MusicAccidentalDoubleFlatIcon';
