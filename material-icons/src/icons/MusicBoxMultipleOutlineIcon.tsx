import React, { FC } from 'react';
    ...
    export const MusicBoxMultipleOutlineIcon: FC<IconInterface> = function MusicBoxMultipleOutlineIcon({
      ...
      const classNames =  `MusicBoxMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="MusicBoxMultipleOutline" className={classNames} {...propsRest}>
    ...
    MusicBoxMultipleOutlineIcon.displayName = 'MusicBoxMultipleOutlineIcon';
