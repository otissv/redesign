import React, { FC } from 'react';
    ...
    export const MusicClefTrebleIcon: FC<IconInterface> = function MusicClefTrebleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MusicClefTrebleIcon ${className}`;
      return (
        <Icon alt="MusicClefTreble" className={classNames} {...propsRest}>
    ...
    MusicClefTrebleIcon.displayName = 'MusicClefTrebleIcon';
