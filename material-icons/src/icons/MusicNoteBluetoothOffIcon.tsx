import React, { FC } from 'react';
    ...
    export const MusicNoteBluetoothOffIcon: FC<IconInterface> = function MusicNoteBluetoothOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MusicNoteBluetoothOffIcon ${className}`;
      return (
        <Icon alt="MusicNoteBluetoothOff" className={classNames} {...propsRest}>
