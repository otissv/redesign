import React, { FC } from 'react';
    ...
    export const MusicOffIcon: FC<IconInterface> = function MusicOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MusicOffIcon ${className}`;
      return (
        <Icon alt="MusicOff" className={classNames} {...propsRest}>
