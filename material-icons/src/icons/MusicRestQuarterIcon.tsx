import React, { FC } from 'react';
    ...
    export const MusicRestQuarterIcon: FC<IconInterface> = function MusicRestQuarterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `MusicRestQuarterIcon ${className}`;
      return (
        <Icon alt="MusicRestQuarter" className={classNames} {...propsRest}>
    ...
    MusicRestQuarterIcon.displayName = 'MusicRestQuarterIcon';
