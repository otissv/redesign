import React, { FC } from 'react';
    ...
    export const NativescriptIcon: FC<IconInterface> = function NativescriptIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NativescriptIcon ${className}`;
      return (
        <Icon alt="Nativescript" className={classNames} {...propsRest}>
