import React, { FC } from 'react';
    ...
    export const NaturePeopleIcon: FC<IconInterface> = function NaturePeopleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NaturePeopleIcon ${className}`;
      return (
        <Icon alt="NaturePeople" className={classNames} {...propsRest}>
