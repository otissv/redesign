import React, { FC } from 'react';
    ...
    export const NecklaceIcon: FC<IconInterface> = function NecklaceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NecklaceIcon ${className}`;
      return (
        <Icon alt="Necklace" className={classNames} {...propsRest}>
