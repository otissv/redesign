import React, { FC } from 'react';
    ...
    export const NetworkOffIcon: FC<IconInterface> = function NetworkOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NetworkOffIcon ${className}`;
      return (
        <Icon alt="NetworkOff" className={classNames} {...propsRest}>
