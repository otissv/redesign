import React, { FC } from 'react';
    ...
    export const NetworkOffOutlineIcon: FC<IconInterface> = function NetworkOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NetworkOffOutlineIcon ${className}`;
      return (
        <Icon alt="NetworkOffOutline" className={classNames} {...propsRest}>
