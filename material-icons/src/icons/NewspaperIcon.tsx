import React, { FC } from 'react';
    ...
    export const NewspaperIcon: FC<IconInterface> = function NewspaperIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NewspaperIcon ${className}`;
      return (
        <Icon alt="Newspaper" className={classNames} {...propsRest}>
