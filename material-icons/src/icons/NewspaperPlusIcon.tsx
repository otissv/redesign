import React, { FC } from 'react';
    ...
    export const NewspaperPlusIcon: FC<IconInterface> = function NewspaperPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NewspaperPlusIcon ${className}`;
      return (
        <Icon alt="NewspaperPlus" className={classNames} {...propsRest}>
