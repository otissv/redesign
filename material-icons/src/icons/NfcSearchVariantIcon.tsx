import React, { FC } from 'react';
    ...
    export const NfcSearchVariantIcon: FC<IconInterface> = function NfcSearchVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NfcSearchVariantIcon ${className}`;
      return (
        <Icon alt="NfcSearchVariant" className={classNames} {...propsRest}>
