import React, { FC } from 'react';
    ...
    export const NfcTapIcon: FC<IconInterface> = function NfcTapIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NfcTapIcon ${className}`;
      return (
        <Icon alt="NfcTap" className={classNames} {...propsRest}>
    ...
    NfcTapIcon.displayName = 'NfcTapIcon';
