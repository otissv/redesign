import React, { FC } from 'react';
    ...
    export const NfcVariantIcon: FC<IconInterface> = function NfcVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NfcVariantIcon ${className}`;
      return (
        <Icon alt="NfcVariant" className={classNames} {...propsRest}>
