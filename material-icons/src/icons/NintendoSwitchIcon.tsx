import React, { FC } from 'react';
    ...
    export const NintendoSwitchIcon: FC<IconInterface> = function NintendoSwitchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NintendoSwitchIcon ${className}`;
      return (
        <Icon alt="NintendoSwitch" className={classNames} {...propsRest}>
