import React, { FC } from 'react';
    ...
    export const NintendoWiiIcon: FC<IconInterface> = function NintendoWiiIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NintendoWiiIcon ${className}`;
      return (
        <Icon alt="NintendoWii" className={classNames} {...propsRest}>
    ...
    NintendoWiiIcon.displayName = 'NintendoWiiIcon';
