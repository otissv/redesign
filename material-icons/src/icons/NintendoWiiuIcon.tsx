import React, { FC } from 'react';
    ...
    export const NintendoWiiuIcon: FC<IconInterface> = function NintendoWiiuIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NintendoWiiuIcon ${className}`;
      return (
        <Icon alt="NintendoWiiu" className={classNames} {...propsRest}>
    ...
    NintendoWiiuIcon.displayName = 'NintendoWiiuIcon';
