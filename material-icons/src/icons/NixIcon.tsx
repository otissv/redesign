import React, { FC } from 'react';
    ...
    export const NixIcon: FC<IconInterface> = function NixIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `NixIcon ${className}`;
      return (
        <Icon alt="Nix" className={classNames} {...propsRest}>
