import React, { FC } from 'react';
    ...
    export const Numeric0BoxMultipleIcon: FC<IconInterface> = function Numeric0BoxMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric0BoxMultipleIcon ${className}`;
      return (
        <Icon alt="Numeric0BoxMultiple" className={classNames} {...propsRest}>
