import React, { FC } from 'react';
    ...
    export const Numeric10CircleOutlineIcon: FC<IconInterface> = function Numeric10CircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric10CircleOutlineIcon ${className}`;
      return (
        <Icon alt="Numeric10CircleOutline" className={classNames} {...propsRest}>
    ...
    Numeric10CircleOutlineIcon.displayName = 'Numeric10CircleOutlineIcon';
