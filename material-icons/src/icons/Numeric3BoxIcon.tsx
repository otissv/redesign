import React, { FC } from 'react';
    ...
    export const Numeric3BoxIcon: FC<IconInterface> = function Numeric3BoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric3BoxIcon ${className}`;
      return (
        <Icon alt="Numeric3Box" className={classNames} {...propsRest}>
    ...
    Numeric3BoxIcon.displayName = 'Numeric3BoxIcon';
