import React, { FC } from 'react';
    ...
    export const Numeric8BoxIcon: FC<IconInterface> = function Numeric8BoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric8BoxIcon ${className}`;
      return (
        <Icon alt="Numeric8Box" className={classNames} {...propsRest}>
    ...
    Numeric8BoxIcon.displayName = 'Numeric8BoxIcon';
