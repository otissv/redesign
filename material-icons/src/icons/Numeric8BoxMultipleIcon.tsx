import React, { FC } from 'react';
    ...
    export const Numeric8BoxMultipleIcon: FC<IconInterface> = function Numeric8BoxMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric8BoxMultipleIcon ${className}`;
      return (
        <Icon alt="Numeric8BoxMultiple" className={classNames} {...propsRest}>
