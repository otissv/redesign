import React, { FC } from 'react';
    ...
    export const Numeric8BoxMultipleOutlineIcon: FC<IconInterface> = function Numeric8BoxMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric8BoxMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="Numeric8BoxMultipleOutline" className={classNames} {...propsRest}>
