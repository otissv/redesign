import React, { FC } from 'react';
    ...
    export const Numeric8CircleIcon: FC<IconInterface> = function Numeric8CircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric8CircleIcon ${className}`;
      return (
        <Icon alt="Numeric8Circle" className={classNames} {...propsRest}>
    ...
    Numeric8CircleIcon.displayName = 'Numeric8CircleIcon';
