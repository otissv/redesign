import React, { FC } from 'react';
    ...
    export const Numeric8CircleOutlineIcon: FC<IconInterface> = function Numeric8CircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric8CircleOutlineIcon ${className}`;
      return (
        <Icon alt="Numeric8CircleOutline" className={classNames} {...propsRest}>
    ...
    Numeric8CircleOutlineIcon.displayName = 'Numeric8CircleOutlineIcon';
