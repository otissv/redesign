import React, { FC } from 'react';
    ...
    export const Numeric8Icon: FC<IconInterface> = function Numeric8Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric8Icon ${className}`;
      return (
        <Icon alt="Numeric8" className={classNames} {...propsRest}>
