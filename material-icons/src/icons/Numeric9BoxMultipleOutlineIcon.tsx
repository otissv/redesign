import React, { FC } from 'react';
    ...
    export const Numeric9BoxMultipleOutlineIcon: FC<IconInterface> = function Numeric9BoxMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric9BoxMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="Numeric9BoxMultipleOutline" className={classNames} {...propsRest}>
