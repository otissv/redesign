import React, { FC } from 'react';
    ...
    export const Numeric9PlusBoxMultipleOutlineIcon: FC<IconInterface> = function Numeric9PlusBoxMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric9PlusBoxMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="Numeric9PlusBoxMultipleOutline" className={classNames} {...propsRest}>
