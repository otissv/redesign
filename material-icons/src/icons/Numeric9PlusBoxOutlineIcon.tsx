import React, { FC } from 'react';
    ...
    export const Numeric9PlusBoxOutlineIcon: FC<IconInterface> = function Numeric9PlusBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Numeric9PlusBoxOutlineIcon ${className}`;
      return (
        <Icon alt="Numeric9PlusBoxOutline" className={classNames} {...propsRest}>
