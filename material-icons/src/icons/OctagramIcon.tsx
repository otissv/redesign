import React, { FC } from 'react';
    ...
    export const OctagramIcon: FC<IconInterface> = function OctagramIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OctagramIcon ${className}`;
      return (
        <Icon alt="Octagram" className={classNames} {...propsRest}>
