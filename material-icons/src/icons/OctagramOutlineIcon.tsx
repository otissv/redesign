import React, { FC } from 'react';
    ...
    export const OctagramOutlineIcon: FC<IconInterface> = function OctagramOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OctagramOutlineIcon ${className}`;
      return (
        <Icon alt="OctagramOutline" className={classNames} {...propsRest}>
    ...
    OctagramOutlineIcon.displayName = 'OctagramOutlineIcon';
