import React, { FC } from 'react';
    ...
    export const OdnoklassnikiIcon: FC<IconInterface> = function OdnoklassnikiIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OdnoklassnikiIcon ${className}`;
      return (
        <Icon alt="Odnoklassniki" className={classNames} {...propsRest}>
