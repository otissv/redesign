import React, { FC } from 'react';
    ...
    export const OilLevelIcon: FC<IconInterface> = function OilLevelIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OilLevelIcon ${className}`;
      return (
        <Icon alt="OilLevel" className={classNames} {...propsRest}>
    ...
    OilLevelIcon.displayName = 'OilLevelIcon';
