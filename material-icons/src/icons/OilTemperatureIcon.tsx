import React, { FC } from 'react';
    ...
    export const OilTemperatureIcon: FC<IconInterface> = function OilTemperatureIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OilTemperatureIcon ${className}`;
      return (
        <Icon alt="OilTemperature" className={classNames} {...propsRest}>
