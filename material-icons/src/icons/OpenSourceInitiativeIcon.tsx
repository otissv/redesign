import React, { FC } from 'react';
    ...
    export const OpenSourceInitiativeIcon: FC<IconInterface> = function OpenSourceInitiativeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OpenSourceInitiativeIcon ${className}`;
      return (
        <Icon alt="OpenSourceInitiative" className={classNames} {...propsRest}>
