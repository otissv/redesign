import React, { FC } from 'react';
    ...
    export const OrderBoolAscendingVariantIcon: FC<IconInterface> = function OrderBoolAscendingVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OrderBoolAscendingVariantIcon ${className}`;
      return (
        <Icon alt="OrderBoolAscendingVariant" className={classNames} {...propsRest}>
    ...
    OrderBoolAscendingVariantIcon.displayName = 'OrderBoolAscendingVariantIcon';
