import React, { FC } from 'react';
    ...
    export const OrnamentIcon: FC<IconInterface> = function OrnamentIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OrnamentIcon ${className}`;
      return (
        <Icon alt="Ornament" className={classNames} {...propsRest}>
