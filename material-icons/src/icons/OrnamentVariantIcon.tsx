import React, { FC } from 'react';
    ...
    export const OrnamentVariantIcon: FC<IconInterface> = function OrnamentVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OrnamentVariantIcon ${className}`;
      return (
        <Icon alt="OrnamentVariant" className={classNames} {...propsRest}>
