import React, { FC } from 'react';
    ...
    export const OutdoorLampIcon: FC<IconInterface> = function OutdoorLampIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OutdoorLampIcon ${className}`;
      return (
        <Icon alt="OutdoorLamp" className={classNames} {...propsRest}>
    ...
    OutdoorLampIcon.displayName = 'OutdoorLampIcon';
