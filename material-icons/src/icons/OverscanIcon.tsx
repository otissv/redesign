import React, { FC } from 'react';
    ...
    export const OverscanIcon: FC<IconInterface> = function OverscanIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `OverscanIcon ${className}`;
      return (
        <Icon alt="Overscan" className={classNames} {...propsRest}>
    ...
    OverscanIcon.displayName = 'OverscanIcon';
