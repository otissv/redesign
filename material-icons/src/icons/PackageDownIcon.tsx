import React, { FC } from 'react';
    ...
    export const PackageDownIcon: FC<IconInterface> = function PackageDownIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PackageDownIcon ${className}`;
      return (
        <Icon alt="PackageDown" className={classNames} {...propsRest}>
