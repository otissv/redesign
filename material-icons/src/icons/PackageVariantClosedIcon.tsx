import React, { FC } from 'react';
    ...
    export const PackageVariantClosedIcon: FC<IconInterface> = function PackageVariantClosedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PackageVariantClosedIcon ${className}`;
      return (
        <Icon alt="PackageVariantClosed" className={classNames} {...propsRest}>
    ...
    PackageVariantClosedIcon.displayName = 'PackageVariantClosedIcon';
