import React, { FC } from 'react';
    ...
    export const PageNextOutlineIcon: FC<IconInterface> = function PageNextOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PageNextOutlineIcon ${className}`;
      return (
        <Icon alt="PageNextOutline" className={classNames} {...propsRest}>
