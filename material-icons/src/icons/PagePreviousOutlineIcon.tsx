import React, { FC } from 'react';
    ...
    export const PagePreviousOutlineIcon: FC<IconInterface> = function PagePreviousOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PagePreviousOutlineIcon ${className}`;
      return (
        <Icon alt="PagePreviousOutline" className={classNames} {...propsRest}>
