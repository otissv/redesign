import React, { FC } from 'react';
    ...
    export const PailIcon: FC<IconInterface> = function PailIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PailIcon ${className}`;
      return (
        <Icon alt="Pail" className={classNames} {...propsRest}>
