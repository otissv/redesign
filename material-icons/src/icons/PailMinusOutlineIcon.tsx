import React, { FC } from 'react';
    ...
    export const PailMinusOutlineIcon: FC<IconInterface> = function PailMinusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PailMinusOutlineIcon ${className}`;
      return (
        <Icon alt="PailMinusOutline" className={classNames} {...propsRest}>
    ...
    PailMinusOutlineIcon.displayName = 'PailMinusOutlineIcon';
