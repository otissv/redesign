import React, { FC } from 'react';
    ...
    export const PailOffOutlineIcon: FC<IconInterface> = function PailOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PailOffOutlineIcon ${className}`;
      return (
        <Icon alt="PailOffOutline" className={classNames} {...propsRest}>
    ...
    PailOffOutlineIcon.displayName = 'PailOffOutlineIcon';
