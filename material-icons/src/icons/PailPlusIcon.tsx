import React, { FC } from 'react';
    ...
    export const PailPlusIcon: FC<IconInterface> = function PailPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PailPlusIcon ${className}`;
      return (
        <Icon alt="PailPlus" className={classNames} {...propsRest}>
    ...
    PailPlusIcon.displayName = 'PailPlusIcon';
