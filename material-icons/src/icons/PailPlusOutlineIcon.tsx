import React, { FC } from 'react';
    ...
    export const PailPlusOutlineIcon: FC<IconInterface> = function PailPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PailPlusOutlineIcon ${className}`;
      return (
        <Icon alt="PailPlusOutline" className={classNames} {...propsRest}>
    ...
    PailPlusOutlineIcon.displayName = 'PailPlusOutlineIcon';
