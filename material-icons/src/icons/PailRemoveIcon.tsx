import React, { FC } from 'react';
    ...
    export const PailRemoveIcon: FC<IconInterface> = function PailRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PailRemoveIcon ${className}`;
      return (
        <Icon alt="PailRemove" className={classNames} {...propsRest}>
    ...
    PailRemoveIcon.displayName = 'PailRemoveIcon';
