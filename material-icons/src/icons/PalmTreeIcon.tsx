import React, { FC } from 'react';
    ...
    export const PalmTreeIcon: FC<IconInterface> = function PalmTreeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PalmTreeIcon ${className}`;
      return (
        <Icon alt="PalmTree" className={classNames} {...propsRest}>
