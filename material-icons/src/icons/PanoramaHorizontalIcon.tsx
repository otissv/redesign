import React, { FC } from 'react';
    ...
    export const PanoramaHorizontalIcon: FC<IconInterface> = function PanoramaHorizontalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PanoramaHorizontalIcon ${className}`;
      return (
        <Icon alt="PanoramaHorizontal" className={classNames} {...propsRest}>
