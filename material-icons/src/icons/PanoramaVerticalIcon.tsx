import React, { FC } from 'react';
    ...
    export const PanoramaVerticalIcon: FC<IconInterface> = function PanoramaVerticalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PanoramaVerticalIcon ${className}`;
      return (
        <Icon alt="PanoramaVertical" className={classNames} {...propsRest}>
