import React, { FC } from 'react';
    ...
    export const PanoramaWideAngleIcon: FC<IconInterface> = function PanoramaWideAngleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PanoramaWideAngleIcon ${className}`;
      return (
        <Icon alt="PanoramaWideAngle" className={classNames} {...propsRest}>
