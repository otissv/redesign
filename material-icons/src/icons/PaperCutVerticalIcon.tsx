import React, { FC } from 'react';
    ...
    export const PaperCutVerticalIcon: FC<IconInterface> = function PaperCutVerticalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PaperCutVerticalIcon ${className}`;
      return (
        <Icon alt="PaperCutVertical" className={classNames} {...propsRest}>
