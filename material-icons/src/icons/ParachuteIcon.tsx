import React, { FC } from 'react';
    ...
    export const ParachuteIcon: FC<IconInterface> = function ParachuteIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ParachuteIcon ${className}`;
      return (
        <Icon alt="Parachute" className={classNames} {...propsRest}>
