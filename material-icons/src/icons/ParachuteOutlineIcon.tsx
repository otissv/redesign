import React, { FC } from 'react';
    ...
    export const ParachuteOutlineIcon: FC<IconInterface> = function ParachuteOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ParachuteOutlineIcon ${className}`;
      return (
        <Icon alt="ParachuteOutline" className={classNames} {...propsRest}>
