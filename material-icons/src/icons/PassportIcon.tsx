import React, { FC } from 'react';
    ...
    export const PassportIcon: FC<IconInterface> = function PassportIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PassportIcon ${className}`;
      return (
        <Icon alt="Passport" className={classNames} {...propsRest}>
