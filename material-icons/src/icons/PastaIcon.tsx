import React, { FC } from 'react';
    ...
    export const PastaIcon: FC<IconInterface> = function PastaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PastaIcon ${className}`;
      return (
        <Icon alt="Pasta" className={classNames} {...propsRest}>
    ...
    PastaIcon.displayName = 'PastaIcon';
