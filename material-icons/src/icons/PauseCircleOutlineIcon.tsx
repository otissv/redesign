import React, { FC } from 'react';
    ...
    export const PauseCircleOutlineIcon: FC<IconInterface> = function PauseCircleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PauseCircleOutlineIcon ${className}`;
      return (
        <Icon alt="PauseCircleOutline" className={classNames} {...propsRest}>
