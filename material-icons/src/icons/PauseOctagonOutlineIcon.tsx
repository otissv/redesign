import React, { FC } from 'react';
    ...
    export const PauseOctagonOutlineIcon: FC<IconInterface> = function PauseOctagonOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PauseOctagonOutlineIcon ${className}`;
      return (
        <Icon alt="PauseOctagonOutline" className={classNames} {...propsRest}>
