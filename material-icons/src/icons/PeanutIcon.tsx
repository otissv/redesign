import React, { FC } from 'react';
    ...
    export const PeanutIcon: FC<IconInterface> = function PeanutIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PeanutIcon ${className}`;
      return (
        <Icon alt="Peanut" className={classNames} {...propsRest}>
    ...
    PeanutIcon.displayName = 'PeanutIcon';
