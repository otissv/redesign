import React, { FC } from 'react';
    ...
    export const PeanutOffIcon: FC<IconInterface> = function PeanutOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PeanutOffIcon ${className}`;
      return (
        <Icon alt="PeanutOff" className={classNames} {...propsRest}>
    ...
    PeanutOffIcon.displayName = 'PeanutOffIcon';
