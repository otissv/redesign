import React, { FC } from 'react';
    ...
    export const PeanutOffOutlineIcon: FC<IconInterface> = function PeanutOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PeanutOffOutlineIcon ${className}`;
      return (
        <Icon alt="PeanutOffOutline" className={classNames} {...propsRest}>
    ...
    PeanutOffOutlineIcon.displayName = 'PeanutOffOutlineIcon';
