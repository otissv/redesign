import React, { FC } from 'react';
    ...
    export const PeanutOutlineIcon: FC<IconInterface> = function PeanutOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PeanutOutlineIcon ${className}`;
      return (
        <Icon alt="PeanutOutline" className={classNames} {...propsRest}>
    ...
    PeanutOutlineIcon.displayName = 'PeanutOutlineIcon';
