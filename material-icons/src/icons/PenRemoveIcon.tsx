import React, { FC } from 'react';
    ...
    export const PenRemoveIcon: FC<IconInterface> = function PenRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PenRemoveIcon ${className}`;
      return (
        <Icon alt="PenRemove" className={classNames} {...propsRest}>
    ...
    PenRemoveIcon.displayName = 'PenRemoveIcon';
