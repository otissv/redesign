import React, { FC } from 'react';
    ...
    export const PencilBoxMultipleIcon: FC<IconInterface> = function PencilBoxMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PencilBoxMultipleIcon ${className}`;
      return (
        <Icon alt="PencilBoxMultiple" className={classNames} {...propsRest}>
    ...
    PencilBoxMultipleIcon.displayName = 'PencilBoxMultipleIcon';
