import React, { FC } from 'react';
    ...
    export const PencilBoxOutlineIcon: FC<IconInterface> = function PencilBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PencilBoxOutlineIcon ${className}`;
      return (
        <Icon alt="PencilBoxOutline" className={classNames} {...propsRest}>
