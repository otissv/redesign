import React, { FC } from 'react';
    ...
    export const PencilCircleIcon: FC<IconInterface> = function PencilCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PencilCircleIcon ${className}`;
      return (
        <Icon alt="PencilCircle" className={classNames} {...propsRest}>
