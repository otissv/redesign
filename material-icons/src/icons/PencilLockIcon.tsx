import React, { FC } from 'react';
    ...
    export const PencilLockIcon: FC<IconInterface> = function PencilLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PencilLockIcon ${className}`;
      return (
        <Icon alt="PencilLock" className={classNames} {...propsRest}>
