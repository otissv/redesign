import React, { FC } from 'react';
    ...
    export const PencilLockOutlineIcon: FC<IconInterface> = function PencilLockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PencilLockOutlineIcon ${className}`;
      return (
        <Icon alt="PencilLockOutline" className={classNames} {...propsRest}>
