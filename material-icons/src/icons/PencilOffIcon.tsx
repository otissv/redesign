import React, { FC } from 'react';
    ...
    export const PencilOffIcon: FC<IconInterface> = function PencilOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PencilOffIcon ${className}`;
      return (
        <Icon alt="PencilOff" className={classNames} {...propsRest}>
