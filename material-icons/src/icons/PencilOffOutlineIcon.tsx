import React, { FC } from 'react';
    ...
    export const PencilOffOutlineIcon: FC<IconInterface> = function PencilOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PencilOffOutlineIcon ${className}`;
      return (
        <Icon alt="PencilOffOutline" className={classNames} {...propsRest}>
