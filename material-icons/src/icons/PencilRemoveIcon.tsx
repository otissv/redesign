import React, { FC } from 'react';
    ...
    export const PencilRemoveIcon: FC<IconInterface> = function PencilRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PencilRemoveIcon ${className}`;
      return (
        <Icon alt="PencilRemove" className={classNames} {...propsRest}>
    ...
    PencilRemoveIcon.displayName = 'PencilRemoveIcon';
