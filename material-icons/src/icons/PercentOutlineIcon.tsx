import React, { FC } from 'react';
    ...
    export const PercentOutlineIcon: FC<IconInterface> = function PercentOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PercentOutlineIcon ${className}`;
      return (
        <Icon alt="PercentOutline" className={classNames} {...propsRest}>
    ...
    PercentOutlineIcon.displayName = 'PercentOutlineIcon';
