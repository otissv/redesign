import React, { FC } from 'react';
    ...
    export const PeriodicTableIcon: FC<IconInterface> = function PeriodicTableIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PeriodicTableIcon ${className}`;
      return (
        <Icon alt="PeriodicTable" className={classNames} {...propsRest}>
