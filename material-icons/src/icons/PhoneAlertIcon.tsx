import React, { FC } from 'react';
    ...
    export const PhoneAlertIcon: FC<IconInterface> = function PhoneAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneAlertIcon ${className}`;
      return (
        <Icon alt="PhoneAlert" className={classNames} {...propsRest}>
    ...
    PhoneAlertIcon.displayName = 'PhoneAlertIcon';
