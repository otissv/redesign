import React, { FC } from 'react';
    ...
    export const PhoneBluetoothIcon: FC<IconInterface> = function PhoneBluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneBluetoothIcon ${className}`;
      return (
        <Icon alt="PhoneBluetooth" className={classNames} {...propsRest}>
