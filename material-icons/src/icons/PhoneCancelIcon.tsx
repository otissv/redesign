import React, { FC } from 'react';
    ...
    export const PhoneCancelIcon: FC<IconInterface> = function PhoneCancelIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneCancelIcon ${className}`;
      return (
        <Icon alt="PhoneCancel" className={classNames} {...propsRest}>
    ...
    PhoneCancelIcon.displayName = 'PhoneCancelIcon';
