import React, { FC } from 'react';
    ...
    export const PhoneCancelOutlineIcon: FC<IconInterface> = function PhoneCancelOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneCancelOutlineIcon ${className}`;
      return (
        <Icon alt="PhoneCancelOutline" className={classNames} {...propsRest}>
    ...
    PhoneCancelOutlineIcon.displayName = 'PhoneCancelOutlineIcon';
