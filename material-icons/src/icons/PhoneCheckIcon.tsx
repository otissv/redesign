import React, { FC } from 'react';
    ...
    export const PhoneCheckIcon: FC<IconInterface> = function PhoneCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneCheckIcon ${className}`;
      return (
        <Icon alt="PhoneCheck" className={classNames} {...propsRest}>
