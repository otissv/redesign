import React, { FC } from 'react';
    ...
    export const PhoneCheckOutlineIcon: FC<IconInterface> = function PhoneCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneCheckOutlineIcon ${className}`;
      return (
        <Icon alt="PhoneCheckOutline" className={classNames} {...propsRest}>
    ...
    PhoneCheckOutlineIcon.displayName = 'PhoneCheckOutlineIcon';
