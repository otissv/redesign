import React, { FC } from 'react';
    ...
    export const PhoneClassicOffIcon: FC<IconInterface> = function PhoneClassicOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneClassicOffIcon ${className}`;
      return (
        <Icon alt="PhoneClassicOff" className={classNames} {...propsRest}>
    ...
    PhoneClassicOffIcon.displayName = 'PhoneClassicOffIcon';
