import React, { FC } from 'react';
    ...
    export const PhoneIncomingIcon: FC<IconInterface> = function PhoneIncomingIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneIncomingIcon ${className}`;
      return (
        <Icon alt="PhoneIncoming" className={classNames} {...propsRest}>
