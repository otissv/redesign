import React, { FC } from 'react';
    ...
    export const PhoneLockIcon: FC<IconInterface> = function PhoneLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneLockIcon ${className}`;
      return (
        <Icon alt="PhoneLock" className={classNames} {...propsRest}>
