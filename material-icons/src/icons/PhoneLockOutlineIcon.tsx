import React, { FC } from 'react';
    ...
    export const PhoneLockOutlineIcon: FC<IconInterface> = function PhoneLockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneLockOutlineIcon ${className}`;
      return (
        <Icon alt="PhoneLockOutline" className={classNames} {...propsRest}>
    ...
    PhoneLockOutlineIcon.displayName = 'PhoneLockOutlineIcon';
