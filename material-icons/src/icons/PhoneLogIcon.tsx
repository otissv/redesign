import React, { FC } from 'react';
    ...
    export const PhoneLogIcon: FC<IconInterface> = function PhoneLogIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneLogIcon ${className}`;
      return (
        <Icon alt="PhoneLog" className={classNames} {...propsRest}>
    ...
    PhoneLogIcon.displayName = 'PhoneLogIcon';
