import React, { FC } from 'react';
    ...
    export const PhoneMessageIcon: FC<IconInterface> = function PhoneMessageIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneMessageIcon ${className}`;
      return (
        <Icon alt="PhoneMessage" className={classNames} {...propsRest}>
