import React, { FC } from 'react';
    ...
    export const PhoneMessageOutlineIcon: FC<IconInterface> = function PhoneMessageOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneMessageOutlineIcon ${className}`;
      return (
        <Icon alt="PhoneMessageOutline" className={classNames} {...propsRest}>
    ...
    PhoneMessageOutlineIcon.displayName = 'PhoneMessageOutlineIcon';
