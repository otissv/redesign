import React, { FC } from 'react';
    ...
    export const PhoneMissedIcon: FC<IconInterface> = function PhoneMissedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneMissedIcon ${className}`;
      return (
        <Icon alt="PhoneMissed" className={classNames} {...propsRest}>
