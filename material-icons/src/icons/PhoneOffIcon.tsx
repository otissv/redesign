import React, { FC } from 'react';
    ...
    export const PhoneOffIcon: FC<IconInterface> = function PhoneOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneOffIcon ${className}`;
      return (
        <Icon alt="PhoneOff" className={classNames} {...propsRest}>
