import React, { FC } from 'react';
    ...
    export const PhoneOffOutlineIcon: FC<IconInterface> = function PhoneOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneOffOutlineIcon ${className}`;
      return (
        <Icon alt="PhoneOffOutline" className={classNames} {...propsRest}>
    ...
    PhoneOffOutlineIcon.displayName = 'PhoneOffOutlineIcon';
