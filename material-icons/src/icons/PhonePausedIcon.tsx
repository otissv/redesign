import React, { FC } from 'react';
    ...
    export const PhonePausedIcon: FC<IconInterface> = function PhonePausedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhonePausedIcon ${className}`;
      return (
        <Icon alt="PhonePaused" className={classNames} {...propsRest}>
