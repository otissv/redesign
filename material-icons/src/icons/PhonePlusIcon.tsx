import React, { FC } from 'react';
    ...
    export const PhonePlusIcon: FC<IconInterface> = function PhonePlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhonePlusIcon ${className}`;
      return (
        <Icon alt="PhonePlus" className={classNames} {...propsRest}>
