import React, { FC } from 'react';
    ...
    export const PhoneReturnIcon: FC<IconInterface> = function PhoneReturnIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneReturnIcon ${className}`;
      return (
        <Icon alt="PhoneReturn" className={classNames} {...propsRest}>
