import React, { FC } from 'react';
    ...
    export const PhoneRingIcon: FC<IconInterface> = function PhoneRingIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PhoneRingIcon ${className}`;
      return (
        <Icon alt="PhoneRing" className={classNames} {...propsRest}>
    ...
    PhoneRingIcon.displayName = 'PhoneRingIcon';
