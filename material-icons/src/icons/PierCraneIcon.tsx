import React, { FC } from 'react';
    ...
    export const PierCraneIcon: FC<IconInterface> = function PierCraneIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PierCraneIcon ${className}`;
      return (
        <Icon alt="PierCrane" className={classNames} {...propsRest}>
