import React, { FC } from 'react';
    ...
    export const PiggyBankIcon: FC<IconInterface> = function PiggyBankIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PiggyBankIcon ${className}`;
      return (
        <Icon alt="PiggyBank" className={classNames} {...propsRest}>
