import React, { FC } from 'react';
    ...
    export const PineTreeFireIcon: FC<IconInterface> = function PineTreeFireIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PineTreeFireIcon ${className}`;
      return (
        <Icon alt="PineTreeFire" className={classNames} {...propsRest}>
    ...
    PineTreeFireIcon.displayName = 'PineTreeFireIcon';
