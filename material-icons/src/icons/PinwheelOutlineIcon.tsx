import React, { FC } from 'react';
    ...
    export const PinwheelOutlineIcon: FC<IconInterface> = function PinwheelOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PinwheelOutlineIcon ${className}`;
      return (
        <Icon alt="PinwheelOutline" className={classNames} {...propsRest}>
