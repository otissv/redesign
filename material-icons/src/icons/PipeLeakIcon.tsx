import React, { FC } from 'react';
    ...
    export const PipeLeakIcon: FC<IconInterface> = function PipeLeakIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PipeLeakIcon ${className}`;
      return (
        <Icon alt="PipeLeak" className={classNames} {...propsRest}>
