import React, { FC } from 'react';
    ...
    export const PirateIcon: FC<IconInterface> = function PirateIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PirateIcon ${className}`;
      return (
        <Icon alt="Pirate" className={classNames} {...propsRest}>
    ...
    PirateIcon.displayName = 'PirateIcon';
