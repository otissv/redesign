import React, { FC } from 'react';
    ...
    export const PlaySpeedIcon: FC<IconInterface> = function PlaySpeedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PlaySpeedIcon ${className}`;
      return (
        <Icon alt="PlaySpeed" className={classNames} {...propsRest}>
    ...
    PlaySpeedIcon.displayName = 'PlaySpeedIcon';
