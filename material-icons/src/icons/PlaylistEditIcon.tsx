import React, { FC } from 'react';
    ...
    export const PlaylistEditIcon: FC<IconInterface> = function PlaylistEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PlaylistEditIcon ${className}`;
      return (
        <Icon alt="PlaylistEdit" className={classNames} {...propsRest}>
    ...
    PlaylistEditIcon.displayName = 'PlaylistEditIcon';
