import React, { FC } from 'react';
    ...
    export const PlaylistMusicIcon: FC<IconInterface> = function PlaylistMusicIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PlaylistMusicIcon ${className}`;
      return (
        <Icon alt="PlaylistMusic" className={classNames} {...propsRest}>
