import React, { FC } from 'react';
    ...
    export const PlaylistMusicOutlineIcon: FC<IconInterface> = function PlaylistMusicOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PlaylistMusicOutlineIcon ${className}`;
      return (
        <Icon alt="PlaylistMusicOutline" className={classNames} {...propsRest}>
