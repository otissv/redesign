import React, { FC } from 'react';
    ...
    export const PlaylistStarIcon: FC<IconInterface> = function PlaylistStarIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PlaylistStarIcon ${className}`;
      return (
        <Icon alt="PlaylistStar" className={classNames} {...propsRest}>
