import React, { FC } from 'react';
    ...
    export const PokeballIcon: FC<IconInterface> = function PokeballIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PokeballIcon ${className}`;
      return (
        <Icon alt="Pokeball" className={classNames} {...propsRest}>
