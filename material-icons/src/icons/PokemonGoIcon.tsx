import React, { FC } from 'react';
    ...
    export const PokemonGoIcon: FC<IconInterface> = function PokemonGoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PokemonGoIcon ${className}`;
      return (
        <Icon alt="PokemonGo" className={classNames} {...propsRest}>
