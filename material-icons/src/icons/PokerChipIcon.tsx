import React, { FC } from 'react';
    ...
    export const PokerChipIcon: FC<IconInterface> = function PokerChipIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PokerChipIcon ${className}`;
      return (
        <Icon alt="PokerChip" className={classNames} {...propsRest}>
