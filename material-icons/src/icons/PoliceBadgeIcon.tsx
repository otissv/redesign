import React, { FC } from 'react';
    ...
    export const PoliceBadgeIcon: FC<IconInterface> = function PoliceBadgeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PoliceBadgeIcon ${className}`;
      return (
        <Icon alt="PoliceBadge" className={classNames} {...propsRest}>
