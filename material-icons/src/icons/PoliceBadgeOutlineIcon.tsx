import React, { FC } from 'react';
    ...
    export const PoliceBadgeOutlineIcon: FC<IconInterface> = function PoliceBadgeOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PoliceBadgeOutlineIcon ${className}`;
      return (
        <Icon alt="PoliceBadgeOutline" className={classNames} {...propsRest}>
    ...
    PoliceBadgeOutlineIcon.displayName = 'PoliceBadgeOutlineIcon';
