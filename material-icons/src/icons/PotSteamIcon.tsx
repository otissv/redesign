import React, { FC } from 'react';
    ...
    export const PotSteamIcon: FC<IconInterface> = function PotSteamIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PotSteamIcon ${className}`;
      return (
        <Icon alt="PotSteam" className={classNames} {...propsRest}>
    ...
    PotSteamIcon.displayName = 'PotSteamIcon';
