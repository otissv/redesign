import React, { FC } from 'react';
    ...
    export const PoundBoxOutlineIcon: FC<IconInterface> = function PoundBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PoundBoxOutlineIcon ${className}`;
      return (
        <Icon alt="PoundBoxOutline" className={classNames} {...propsRest}>
    ...
    PoundBoxOutlineIcon.displayName = 'PoundBoxOutlineIcon';
