import React, { FC } from 'react';
    ...
    export const PowerPlugOffOutlineIcon: FC<IconInterface> = function PowerPlugOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowerPlugOffOutlineIcon ${className}`;
      return (
        <Icon alt="PowerPlugOffOutline" className={classNames} {...propsRest}>
    ...
    PowerPlugOffOutlineIcon.displayName = 'PowerPlugOffOutlineIcon';
