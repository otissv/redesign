import React, { FC } from 'react';
    ...
    export const PowerSettingsIcon: FC<IconInterface> = function PowerSettingsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowerSettingsIcon ${className}`;
      return (
        <Icon alt="PowerSettings" className={classNames} {...propsRest}>
