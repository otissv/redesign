import React, { FC } from 'react';
    ...
    export const PowerSocketAuIcon: FC<IconInterface> = function PowerSocketAuIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowerSocketAuIcon ${className}`;
      return (
        <Icon alt="PowerSocketAu" className={classNames} {...propsRest}>
    ...
    PowerSocketAuIcon.displayName = 'PowerSocketAuIcon';
