import React, { FC } from 'react';
    ...
    export const PowerSocketDeIcon: FC<IconInterface> = function PowerSocketDeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowerSocketDeIcon ${className}`;
      return (
        <Icon alt="PowerSocketDe" className={classNames} {...propsRest}>
    ...
    PowerSocketDeIcon.displayName = 'PowerSocketDeIcon';
