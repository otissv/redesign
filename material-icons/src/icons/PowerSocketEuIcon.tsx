import React, { FC } from 'react';
    ...
    export const PowerSocketEuIcon: FC<IconInterface> = function PowerSocketEuIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowerSocketEuIcon ${className}`;
      return (
        <Icon alt="PowerSocketEu" className={classNames} {...propsRest}>
