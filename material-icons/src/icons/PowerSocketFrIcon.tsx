import React, { FC } from 'react';
    ...
    export const PowerSocketFrIcon: FC<IconInterface> = function PowerSocketFrIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowerSocketFrIcon ${className}`;
      return (
        <Icon alt="PowerSocketFr" className={classNames} {...propsRest}>
    ...
    PowerSocketFrIcon.displayName = 'PowerSocketFrIcon';
