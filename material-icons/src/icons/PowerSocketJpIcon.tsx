import React, { FC } from 'react';
    ...
    export const PowerSocketJpIcon: FC<IconInterface> = function PowerSocketJpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowerSocketJpIcon ${className}`;
      return (
        <Icon alt="PowerSocketJp" className={classNames} {...propsRest}>
    ...
    PowerSocketJpIcon.displayName = 'PowerSocketJpIcon';
