import React, { FC } from 'react';
    ...
    export const PowerSocketUsIcon: FC<IconInterface> = function PowerSocketUsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowerSocketUsIcon ${className}`;
      return (
        <Icon alt="PowerSocketUs" className={classNames} {...propsRest}>
