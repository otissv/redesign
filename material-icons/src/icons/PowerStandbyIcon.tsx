import React, { FC } from 'react';
    ...
    export const PowerStandbyIcon: FC<IconInterface> = function PowerStandbyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowerStandbyIcon ${className}`;
      return (
        <Icon alt="PowerStandby" className={classNames} {...propsRest}>
    ...
    PowerStandbyIcon.displayName = 'PowerStandbyIcon';
