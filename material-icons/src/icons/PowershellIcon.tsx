import React, { FC } from 'react';
    ...
    export const PowershellIcon: FC<IconInterface> = function PowershellIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PowershellIcon ${className}`;
      return (
        <Icon alt="Powershell" className={classNames} {...propsRest}>
