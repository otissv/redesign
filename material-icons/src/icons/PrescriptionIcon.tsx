import React, { FC } from 'react';
    ...
    export const PrescriptionIcon: FC<IconInterface> = function PrescriptionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PrescriptionIcon ${className}`;
      return (
        <Icon alt="Prescription" className={classNames} {...propsRest}>
