import React, { FC } from 'react';
    ...
    export const PresentationPlayIcon: FC<IconInterface> = function PresentationPlayIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PresentationPlayIcon ${className}`;
      return (
        <Icon alt="PresentationPlay" className={classNames} {...propsRest}>
    ...
    PresentationPlayIcon.displayName = 'PresentationPlayIcon';
