import React, { FC } from 'react';
    ...
    export const Printer3DIcon: FC<IconInterface> = function Printer3DIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Printer3DIcon ${className}`;
      return (
        <Icon alt="Printer3D" className={classNames} {...propsRest}>
