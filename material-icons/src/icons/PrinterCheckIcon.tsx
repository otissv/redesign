import React, { FC } from 'react';
    ...
    export const PrinterCheckIcon: FC<IconInterface> = function PrinterCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PrinterCheckIcon ${className}`;
      return (
        <Icon alt="PrinterCheck" className={classNames} {...propsRest}>
