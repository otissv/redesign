import React, { FC } from 'react';
    ...
    export const PrinterEyeIcon: FC<IconInterface> = function PrinterEyeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PrinterEyeIcon ${className}`;
      return (
        <Icon alt="PrinterEye" className={classNames} {...propsRest}>
    ...
    PrinterEyeIcon.displayName = 'PrinterEyeIcon';
