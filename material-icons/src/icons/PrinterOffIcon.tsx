import React, { FC } from 'react';
    ...
    export const PrinterOffIcon: FC<IconInterface> = function PrinterOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PrinterOffIcon ${className}`;
      return (
        <Icon alt="PrinterOff" className={classNames} {...propsRest}>
