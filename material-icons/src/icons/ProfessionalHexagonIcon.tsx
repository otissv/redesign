import React, { FC } from 'react';
    ...
    export const ProfessionalHexagonIcon: FC<IconInterface> = function ProfessionalHexagonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ProfessionalHexagonIcon ${className}`;
      return (
        <Icon alt="ProfessionalHexagon" className={classNames} {...propsRest}>
