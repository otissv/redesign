import React, { FC } from 'react';
    ...
    export const ProgressAlertIcon: FC<IconInterface> = function ProgressAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ProgressAlertIcon ${className}`;
      return (
        <Icon alt="ProgressAlert" className={classNames} {...propsRest}>
    ...
    ProgressAlertIcon.displayName = 'ProgressAlertIcon';
