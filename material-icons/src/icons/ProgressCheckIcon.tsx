import React, { FC } from 'react';
    ...
    export const ProgressCheckIcon: FC<IconInterface> = function ProgressCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ProgressCheckIcon ${className}`;
      return (
        <Icon alt="ProgressCheck" className={classNames} {...propsRest}>
