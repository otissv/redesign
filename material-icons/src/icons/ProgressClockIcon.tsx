import React, { FC } from 'react';
    ...
    export const ProgressClockIcon: FC<IconInterface> = function ProgressClockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ProgressClockIcon ${className}`;
      return (
        <Icon alt="ProgressClock" className={classNames} {...propsRest}>
    ...
    ProgressClockIcon.displayName = 'ProgressClockIcon';
