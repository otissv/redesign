import React, { FC } from 'react';
    ...
    export const ProgressCloseIcon: FC<IconInterface> = function ProgressCloseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ProgressCloseIcon ${className}`;
      return (
        <Icon alt="ProgressClose" className={classNames} {...propsRest}>
    ...
    ProgressCloseIcon.displayName = 'ProgressCloseIcon';
