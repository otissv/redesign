import React, { FC } from 'react';
    ...
    export const ProgressUploadIcon: FC<IconInterface> = function ProgressUploadIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ProgressUploadIcon ${className}`;
      return (
        <Icon alt="ProgressUpload" className={classNames} {...propsRest}>
