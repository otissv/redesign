import React, { FC } from 'react';
    ...
    export const ProgressWrenchIcon: FC<IconInterface> = function ProgressWrenchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ProgressWrenchIcon ${className}`;
      return (
        <Icon alt="ProgressWrench" className={classNames} {...propsRest}>
    ...
    ProgressWrenchIcon.displayName = 'ProgressWrenchIcon';
