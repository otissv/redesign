import React, { FC } from 'react';
    ...
    export const ProjectorIcon: FC<IconInterface> = function ProjectorIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ProjectorIcon ${className}`;
      return (
        <Icon alt="Projector" className={classNames} {...propsRest}>
