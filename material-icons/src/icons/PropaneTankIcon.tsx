import React, { FC } from 'react';
    ...
    export const PropaneTankIcon: FC<IconInterface> = function PropaneTankIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PropaneTankIcon ${className}`;
      return (
        <Icon alt="PropaneTank" className={classNames} {...propsRest}>
