import React, { FC } from 'react';
    ...
    export const PropaneTankOutlineIcon: FC<IconInterface> = function PropaneTankOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PropaneTankOutlineIcon ${className}`;
      return (
        <Icon alt="PropaneTankOutline" className={classNames} {...propsRest}>
    ...
    PropaneTankOutlineIcon.displayName = 'PropaneTankOutlineIcon';
