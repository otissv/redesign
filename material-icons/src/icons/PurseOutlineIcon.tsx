import React, { FC } from 'react';
    ...
    export const PurseOutlineIcon: FC<IconInterface> = function PurseOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PurseOutlineIcon ${className}`;
      return (
        <Icon alt="PurseOutline" className={classNames} {...propsRest}>
