import React, { FC } from 'react';
    ...
    export const PuzzleCheckIcon: FC<IconInterface> = function PuzzleCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleCheckIcon ${className}`;
      return (
        <Icon alt="PuzzleCheck" className={classNames} {...propsRest}>
    ...
    PuzzleCheckIcon.displayName = 'PuzzleCheckIcon';
