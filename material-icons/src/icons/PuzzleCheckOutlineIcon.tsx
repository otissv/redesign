import React, { FC } from 'react';
    ...
    export const PuzzleCheckOutlineIcon: FC<IconInterface> = function PuzzleCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleCheckOutlineIcon ${className}`;
      return (
        <Icon alt="PuzzleCheckOutline" className={classNames} {...propsRest}>
    ...
    PuzzleCheckOutlineIcon.displayName = 'PuzzleCheckOutlineIcon';
