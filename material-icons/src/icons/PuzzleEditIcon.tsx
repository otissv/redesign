import React, { FC } from 'react';
    ...
    export const PuzzleEditIcon: FC<IconInterface> = function PuzzleEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleEditIcon ${className}`;
      return (
        <Icon alt="PuzzleEdit" className={classNames} {...propsRest}>
    ...
    PuzzleEditIcon.displayName = 'PuzzleEditIcon';
