import React, { FC } from 'react';
    ...
    export const PuzzleEditOutlineIcon: FC<IconInterface> = function PuzzleEditOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleEditOutlineIcon ${className}`;
      return (
        <Icon alt="PuzzleEditOutline" className={classNames} {...propsRest}>
    ...
    PuzzleEditOutlineIcon.displayName = 'PuzzleEditOutlineIcon';
