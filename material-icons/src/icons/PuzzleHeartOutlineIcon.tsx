import React, { FC } from 'react';
    ...
    export const PuzzleHeartOutlineIcon: FC<IconInterface> = function PuzzleHeartOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleHeartOutlineIcon ${className}`;
      return (
        <Icon alt="PuzzleHeartOutline" className={classNames} {...propsRest}>
    ...
    PuzzleHeartOutlineIcon.displayName = 'PuzzleHeartOutlineIcon';
