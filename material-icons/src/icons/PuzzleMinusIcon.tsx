import React, { FC } from 'react';
    ...
    export const PuzzleMinusIcon: FC<IconInterface> = function PuzzleMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleMinusIcon ${className}`;
      return (
        <Icon alt="PuzzleMinus" className={classNames} {...propsRest}>
    ...
    PuzzleMinusIcon.displayName = 'PuzzleMinusIcon';
