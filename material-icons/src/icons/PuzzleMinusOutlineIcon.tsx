import React, { FC } from 'react';
    ...
    export const PuzzleMinusOutlineIcon: FC<IconInterface> = function PuzzleMinusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleMinusOutlineIcon ${className}`;
      return (
        <Icon alt="PuzzleMinusOutline" className={classNames} {...propsRest}>
    ...
    PuzzleMinusOutlineIcon.displayName = 'PuzzleMinusOutlineIcon';
