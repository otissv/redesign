import React, { FC } from 'react';
    ...
    export const PuzzleOutlineIcon: FC<IconInterface> = function PuzzleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleOutlineIcon ${className}`;
      return (
        <Icon alt="PuzzleOutline" className={classNames} {...propsRest}>
