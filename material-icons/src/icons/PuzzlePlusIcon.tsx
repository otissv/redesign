import React, { FC } from 'react';
    ...
    export const PuzzlePlusIcon: FC<IconInterface> = function PuzzlePlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzlePlusIcon ${className}`;
      return (
        <Icon alt="PuzzlePlus" className={classNames} {...propsRest}>
    ...
    PuzzlePlusIcon.displayName = 'PuzzlePlusIcon';
