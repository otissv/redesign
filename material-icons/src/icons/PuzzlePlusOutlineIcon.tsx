import React, { FC } from 'react';
    ...
    export const PuzzlePlusOutlineIcon: FC<IconInterface> = function PuzzlePlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzlePlusOutlineIcon ${className}`;
      return (
        <Icon alt="PuzzlePlusOutline" className={classNames} {...propsRest}>
    ...
    PuzzlePlusOutlineIcon.displayName = 'PuzzlePlusOutlineIcon';
