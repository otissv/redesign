import React, { FC } from 'react';
    ...
    export const PuzzleRemoveIcon: FC<IconInterface> = function PuzzleRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleRemoveIcon ${className}`;
      return (
        <Icon alt="PuzzleRemove" className={classNames} {...propsRest}>
    ...
    PuzzleRemoveIcon.displayName = 'PuzzleRemoveIcon';
