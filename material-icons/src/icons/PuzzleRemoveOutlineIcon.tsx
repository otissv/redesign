import React, { FC } from 'react';
    ...
    export const PuzzleRemoveOutlineIcon: FC<IconInterface> = function PuzzleRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="PuzzleRemoveOutline" className={classNames} {...propsRest}>
    ...
    PuzzleRemoveOutlineIcon.displayName = 'PuzzleRemoveOutlineIcon';
