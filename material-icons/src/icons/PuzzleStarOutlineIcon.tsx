import React, { FC } from 'react';
    ...
    export const PuzzleStarOutlineIcon: FC<IconInterface> = function PuzzleStarOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `PuzzleStarOutlineIcon ${className}`;
      return (
        <Icon alt="PuzzleStarOutline" className={classNames} {...propsRest}>
    ...
    PuzzleStarOutlineIcon.displayName = 'PuzzleStarOutlineIcon';
