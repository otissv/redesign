import React, { FC } from 'react';
    ...
    export const QqchatIcon: FC<IconInterface> = function QqchatIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `QqchatIcon ${className}`;
      return (
        <Icon alt="Qqchat" className={classNames} {...propsRest}>
    ...
    QqchatIcon.displayName = 'QqchatIcon';
