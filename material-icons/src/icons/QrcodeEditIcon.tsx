import React, { FC } from 'react';
    ...
    export const QrcodeEditIcon: FC<IconInterface> = function QrcodeEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `QrcodeEditIcon ${className}`;
      return (
        <Icon alt="QrcodeEdit" className={classNames} {...propsRest}>
