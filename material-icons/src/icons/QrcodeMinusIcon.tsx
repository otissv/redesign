import React, { FC } from 'react';
    ...
    export const QrcodeMinusIcon: FC<IconInterface> = function QrcodeMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `QrcodeMinusIcon ${className}`;
      return (
        <Icon alt="QrcodeMinus" className={classNames} {...propsRest}>
    ...
    QrcodeMinusIcon.displayName = 'QrcodeMinusIcon';
