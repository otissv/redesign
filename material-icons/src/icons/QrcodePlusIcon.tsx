import React, { FC } from 'react';
    ...
    export const QrcodePlusIcon: FC<IconInterface> = function QrcodePlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `QrcodePlusIcon ${className}`;
      return (
        <Icon alt="QrcodePlus" className={classNames} {...propsRest}>
    ...
    QrcodePlusIcon.displayName = 'QrcodePlusIcon';
