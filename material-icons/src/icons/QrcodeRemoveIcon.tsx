import React, { FC } from 'react';
    ...
    export const QrcodeRemoveIcon: FC<IconInterface> = function QrcodeRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `QrcodeRemoveIcon ${className}`;
      return (
        <Icon alt="QrcodeRemove" className={classNames} {...propsRest}>
    ...
    QrcodeRemoveIcon.displayName = 'QrcodeRemoveIcon';
