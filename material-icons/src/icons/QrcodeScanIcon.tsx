import React, { FC } from 'react';
    ...
    export const QrcodeScanIcon: FC<IconInterface> = function QrcodeScanIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `QrcodeScanIcon ${className}`;
      return (
        <Icon alt="QrcodeScan" className={classNames} {...propsRest}>
