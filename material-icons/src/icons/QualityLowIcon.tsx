import React, { FC } from 'react';
    ...
    export const QualityLowIcon: FC<IconInterface> = function QualityLowIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `QualityLowIcon ${className}`;
      return (
        <Icon alt="QualityLow" className={classNames} {...propsRest}>
