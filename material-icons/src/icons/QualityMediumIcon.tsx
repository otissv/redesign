import React, { FC } from 'react';
    ...
    export const QualityMediumIcon: FC<IconInterface> = function QualityMediumIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `QualityMediumIcon ${className}`;
      return (
        <Icon alt="QualityMedium" className={classNames} {...propsRest}>
