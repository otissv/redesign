import React, { FC } from 'react';
    ...
    export const RacingHelmetIcon: FC<IconInterface> = function RacingHelmetIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RacingHelmetIcon ${className}`;
      return (
        <Icon alt="RacingHelmet" className={classNames} {...propsRest}>
