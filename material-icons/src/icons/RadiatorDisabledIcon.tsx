import React, { FC } from 'react';
    ...
    export const RadiatorDisabledIcon: FC<IconInterface> = function RadiatorDisabledIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RadiatorDisabledIcon ${className}`;
      return (
        <Icon alt="RadiatorDisabled" className={classNames} {...propsRest}>
