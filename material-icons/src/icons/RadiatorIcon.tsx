import React, { FC } from 'react';
    ...
    export const RadiatorIcon: FC<IconInterface> = function RadiatorIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RadiatorIcon ${className}`;
      return (
        <Icon alt="Radiator" className={classNames} {...propsRest}>
