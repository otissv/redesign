import React, { FC } from 'react';
    ...
    export const RadiatorOffIcon: FC<IconInterface> = function RadiatorOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RadiatorOffIcon ${className}`;
      return (
        <Icon alt="RadiatorOff" className={classNames} {...propsRest}>
