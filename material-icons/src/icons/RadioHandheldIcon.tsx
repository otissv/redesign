import React, { FC } from 'react';
    ...
    export const RadioHandheldIcon: FC<IconInterface> = function RadioHandheldIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RadioHandheldIcon ${className}`;
      return (
        <Icon alt="RadioHandheld" className={classNames} {...propsRest}>
