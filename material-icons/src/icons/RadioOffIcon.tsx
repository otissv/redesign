import React, { FC } from 'react';
    ...
    export const RadioOffIcon: FC<IconInterface> = function RadioOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RadioOffIcon ${className}`;
      return (
        <Icon alt="RadioOff" className={classNames} {...propsRest}>
