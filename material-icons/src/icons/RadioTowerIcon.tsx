import React, { FC } from 'react';
    ...
    export const RadioTowerIcon: FC<IconInterface> = function RadioTowerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RadioTowerIcon ${className}`;
      return (
        <Icon alt="RadioTower" className={classNames} {...propsRest}>
