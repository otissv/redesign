import React, { FC } from 'react';
    ...
    export const RadioactiveIcon: FC<IconInterface> = function RadioactiveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RadioactiveIcon ${className}`;
      return (
        <Icon alt="Radioactive" className={classNames} {...propsRest}>
