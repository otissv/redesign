import React, { FC } from 'react';
    ...
    export const RadioactiveOffIcon: FC<IconInterface> = function RadioactiveOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RadioactiveOffIcon ${className}`;
      return (
        <Icon alt="RadioactiveOff" className={classNames} {...propsRest}>
