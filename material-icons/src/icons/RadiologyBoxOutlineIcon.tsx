import React, { FC } from 'react';
    ...
    export const RadiologyBoxOutlineIcon: FC<IconInterface> = function RadiologyBoxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RadiologyBoxOutlineIcon ${className}`;
      return (
        <Icon alt="RadiologyBoxOutline" className={classNames} {...propsRest}>
    ...
    RadiologyBoxOutlineIcon.displayName = 'RadiologyBoxOutlineIcon';
