import React, { FC } from 'react';
    ...
    export const RailroadLightIcon: FC<IconInterface> = function RailroadLightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RailroadLightIcon ${className}`;
      return (
        <Icon alt="RailroadLight" className={classNames} {...propsRest}>
