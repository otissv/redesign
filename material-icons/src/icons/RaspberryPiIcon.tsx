import React, { FC } from 'react';
    ...
    export const RaspberryPiIcon: FC<IconInterface> = function RaspberryPiIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RaspberryPiIcon ${className}`;
      return (
        <Icon alt="RaspberryPi" className={classNames} {...propsRest}>
