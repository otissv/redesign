import React, { FC } from 'react';
    ...
    export const RayEndArrowIcon: FC<IconInterface> = function RayEndArrowIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RayEndArrowIcon ${className}`;
      return (
        <Icon alt="RayEndArrow" className={classNames} {...propsRest}>
