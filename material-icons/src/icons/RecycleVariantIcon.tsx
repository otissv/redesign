import React, { FC } from 'react';
    ...
    export const RecycleVariantIcon: FC<IconInterface> = function RecycleVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RecycleVariantIcon ${className}`;
      return (
        <Icon alt="RecycleVariant" className={classNames} {...propsRest}>
    ...
    RecycleVariantIcon.displayName = 'RecycleVariantIcon';
