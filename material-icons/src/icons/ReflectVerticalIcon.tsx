import React, { FC } from 'react';
    ...
    export const ReflectVerticalIcon: FC<IconInterface> = function ReflectVerticalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ReflectVerticalIcon ${className}`;
      return (
        <Icon alt="ReflectVertical" className={classNames} {...propsRest}>
