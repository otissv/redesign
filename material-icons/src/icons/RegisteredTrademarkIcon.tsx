import React, { FC } from 'react';
    ...
    export const RegisteredTrademarkIcon: FC<IconInterface> = function RegisteredTrademarkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RegisteredTrademarkIcon ${className}`;
      return (
        <Icon alt="RegisteredTrademark" className={classNames} {...propsRest}>
