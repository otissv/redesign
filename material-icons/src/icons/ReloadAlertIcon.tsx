import React, { FC } from 'react';
    ...
    export const ReloadAlertIcon: FC<IconInterface> = function ReloadAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ReloadAlertIcon ${className}`;
      return (
        <Icon alt="ReloadAlert" className={classNames} {...propsRest}>
    ...
    ReloadAlertIcon.displayName = 'ReloadAlertIcon';
