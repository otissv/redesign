import React, { FC } from 'react';
    ...
    export const RemoteOffIcon: FC<IconInterface> = function RemoteOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RemoteOffIcon ${className}`;
      return (
        <Icon alt="RemoteOff" className={classNames} {...propsRest}>
