import React, { FC } from 'react';
    ...
    export const RemoteTvIcon: FC<IconInterface> = function RemoteTvIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RemoteTvIcon ${className}`;
      return (
        <Icon alt="RemoteTv" className={classNames} {...propsRest}>
    ...
    RemoteTvIcon.displayName = 'RemoteTvIcon';
