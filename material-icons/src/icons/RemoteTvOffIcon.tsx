import React, { FC } from 'react';
    ...
    export const RemoteTvOffIcon: FC<IconInterface> = function RemoteTvOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RemoteTvOffIcon ${className}`;
      return (
        <Icon alt="RemoteTvOff" className={classNames} {...propsRest}>
