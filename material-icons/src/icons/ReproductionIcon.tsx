import React, { FC } from 'react';
    ...
    export const ReproductionIcon: FC<IconInterface> = function ReproductionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ReproductionIcon ${className}`;
      return (
        <Icon alt="Reproduction" className={classNames} {...propsRest}>
