import React, { FC } from 'react';
    ...
    export const ResistorNodesIcon: FC<IconInterface> = function ResistorNodesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ResistorNodesIcon ${className}`;
      return (
        <Icon alt="ResistorNodes" className={classNames} {...propsRest}>
