import React, { FC } from 'react';
    ...
    export const ResponsiveIcon: FC<IconInterface> = function ResponsiveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ResponsiveIcon ${className}`;
      return (
        <Icon alt="Responsive" className={classNames} {...propsRest}>
