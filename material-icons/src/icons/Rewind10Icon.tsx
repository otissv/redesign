import React, { FC } from 'react';
    ...
    export const Rewind10Icon: FC<IconInterface> = function Rewind10Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `Rewind10Icon ${className}`;
      return (
        <Icon alt="Rewind10" className={classNames} {...propsRest}>
