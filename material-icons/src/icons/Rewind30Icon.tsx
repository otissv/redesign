import React, { FC } from 'react';
    ...
    export const Rewind30Icon: FC<IconInterface> = function Rewind30Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `Rewind30Icon ${className}`;
      return (
        <Icon alt="Rewind30" className={classNames} {...propsRest}>
