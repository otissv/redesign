import React, { FC } from 'react';
    ...
    export const Rewind5Icon: FC<IconInterface> = function Rewind5Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `Rewind5Icon ${className}`;
      return (
        <Icon alt="Rewind5" className={classNames} {...propsRest}>
    ...
    Rewind5Icon.displayName = 'Rewind5Icon';
