import React, { FC } from 'react';
    ...
    export const RhombusSplitOutlineIcon: FC<IconInterface> = function RhombusSplitOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RhombusSplitOutlineIcon ${className}`;
      return (
        <Icon alt="RhombusSplitOutline" className={classNames} {...propsRest}>
    ...
    RhombusSplitOutlineIcon.displayName = 'RhombusSplitOutlineIcon';
