import React, { FC } from 'react';
    ...
    export const RoadVariantIcon: FC<IconInterface> = function RoadVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RoadVariantIcon ${className}`;
      return (
        <Icon alt="RoadVariant" className={classNames} {...propsRest}>
    ...
    RoadVariantIcon.displayName = 'RoadVariantIcon';
