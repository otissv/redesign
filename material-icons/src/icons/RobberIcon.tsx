import React, { FC } from 'react';
    ...
    export const RobberIcon: FC<IconInterface> = function RobberIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RobberIcon ${className}`;
      return (
        <Icon alt="Robber" className={classNames} {...propsRest}>
    ...
    RobberIcon.displayName = 'RobberIcon';
