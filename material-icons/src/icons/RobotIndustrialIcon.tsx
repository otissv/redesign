import React, { FC } from 'react';
    ...
    export const RobotIndustrialIcon: FC<IconInterface> = function RobotIndustrialIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RobotIndustrialIcon ${className}`;
      return (
        <Icon alt="RobotIndustrial" className={classNames} {...propsRest}>
