import React, { FC } from 'react';
    ...
    export const RobotMowerOutlineIcon: FC<IconInterface> = function RobotMowerOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RobotMowerOutlineIcon ${className}`;
      return (
        <Icon alt="RobotMowerOutline" className={classNames} {...propsRest}>
    ...
    RobotMowerOutlineIcon.displayName = 'RobotMowerOutlineIcon';
