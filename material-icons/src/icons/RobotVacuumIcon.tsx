import React, { FC } from 'react';
    ...
    export const RobotVacuumIcon: FC<IconInterface> = function RobotVacuumIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RobotVacuumIcon ${className}`;
      return (
        <Icon alt="RobotVacuum" className={classNames} {...propsRest}>
