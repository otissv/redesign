import React, { FC } from 'react';
    ...
    export const RobotVacuumVariantIcon: FC<IconInterface> = function RobotVacuumVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RobotVacuumVariantIcon ${className}`;
      return (
        <Icon alt="RobotVacuumVariant" className={classNames} {...propsRest}>
