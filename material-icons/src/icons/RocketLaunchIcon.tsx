import React, { FC } from 'react';
    ...
    export const RocketLaunchIcon: FC<IconInterface> = function RocketLaunchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RocketLaunchIcon ${className}`;
      return (
        <Icon alt="RocketLaunch" className={classNames} {...propsRest}>
