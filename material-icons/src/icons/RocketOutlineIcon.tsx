import React, { FC } from 'react';
    ...
    export const RocketOutlineIcon: FC<IconInterface> = function RocketOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RocketOutlineIcon ${className}`;
      return (
        <Icon alt="RocketOutline" className={classNames} {...propsRest}>
