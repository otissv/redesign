import React, { FC } from 'react';
    ...
    export const RodentIcon: FC<IconInterface> = function RodentIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RodentIcon ${className}`;
      return (
        <Icon alt="Rodent" className={classNames} {...propsRest}>
    ...
    RodentIcon.displayName = 'RodentIcon';
