import React, { FC } from 'react';
    ...
    export const RollerSkateOffIcon: FC<IconInterface> = function RollerSkateOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RollerSkateOffIcon ${className}`;
      return (
        <Icon alt="RollerSkateOff" className={classNames} {...propsRest}>
    ...
    RollerSkateOffIcon.displayName = 'RollerSkateOffIcon';
