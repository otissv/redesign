import React, { FC } from 'react';
    ...
    export const RollupjsIcon: FC<IconInterface> = function RollupjsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RollupjsIcon ${className}`;
      return (
        <Icon alt="Rollupjs" className={classNames} {...propsRest}>
