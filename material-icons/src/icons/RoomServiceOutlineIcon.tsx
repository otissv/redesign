import React, { FC } from 'react';
    ...
    export const RoomServiceOutlineIcon: FC<IconInterface> = function RoomServiceOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RoomServiceOutlineIcon ${className}`;
      return (
        <Icon alt="RoomServiceOutline" className={classNames} {...propsRest}>
