import React, { FC } from 'react';
    ...
    export const Rotate3DVariantIcon: FC<IconInterface> = function Rotate3DVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Rotate3DVariantIcon ${className}`;
      return (
        <Icon alt="Rotate3DVariant" className={classNames} {...propsRest}>
    ...
    Rotate3DVariantIcon.displayName = 'Rotate3DVariantIcon';
