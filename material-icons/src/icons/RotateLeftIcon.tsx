import React, { FC } from 'react';
    ...
    export const RotateLeftIcon: FC<IconInterface> = function RotateLeftIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RotateLeftIcon ${className}`;
      return (
        <Icon alt="RotateLeft" className={classNames} {...propsRest}>
