import React, { FC } from 'react';
    ...
    export const RotateOrbitIcon: FC<IconInterface> = function RotateOrbitIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RotateOrbitIcon ${className}`;
      return (
        <Icon alt="RotateOrbit" className={classNames} {...propsRest}>
