import React, { FC } from 'react';
    ...
    export const RotateRightIcon: FC<IconInterface> = function RotateRightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RotateRightIcon ${className}`;
      return (
        <Icon alt="RotateRight" className={classNames} {...propsRest}>
