import React, { FC } from 'react';
    ...
    export const RotateRightVariantIcon: FC<IconInterface> = function RotateRightVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RotateRightVariantIcon ${className}`;
      return (
        <Icon alt="RotateRightVariant" className={classNames} {...propsRest}>
