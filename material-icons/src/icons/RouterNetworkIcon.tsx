import React, { FC } from 'react';
    ...
    export const RouterNetworkIcon: FC<IconInterface> = function RouterNetworkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RouterNetworkIcon ${className}`;
      return (
        <Icon alt="RouterNetwork" className={classNames} {...propsRest}>
    ...
    RouterNetworkIcon.displayName = 'RouterNetworkIcon';
