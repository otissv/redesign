import React, { FC } from 'react';
    ...
    export const RouterWirelessIcon: FC<IconInterface> = function RouterWirelessIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RouterWirelessIcon ${className}`;
      return (
        <Icon alt="RouterWireless" className={classNames} {...propsRest}>
