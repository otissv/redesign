import React, { FC } from 'react';
    ...
    export const RouterWirelessSettingsIcon: FC<IconInterface> = function RouterWirelessSettingsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RouterWirelessSettingsIcon ${className}`;
      return (
        <Icon alt="RouterWirelessSettings" className={classNames} {...propsRest}>
