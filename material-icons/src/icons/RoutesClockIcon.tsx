import React, { FC } from 'react';
    ...
    export const RoutesClockIcon: FC<IconInterface> = function RoutesClockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RoutesClockIcon ${className}`;
      return (
        <Icon alt="RoutesClock" className={classNames} {...propsRest}>
    ...
    RoutesClockIcon.displayName = 'RoutesClockIcon';
