import React, { FC } from 'react';
    ...
    export const RssBoxIcon: FC<IconInterface> = function RssBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RssBoxIcon ${className}`;
      return (
        <Icon alt="RssBox" className={classNames} {...propsRest}>
    ...
    RssBoxIcon.displayName = 'RssBoxIcon';
