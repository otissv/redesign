import React, { FC } from 'react';
    ...
    export const RugIcon: FC<IconInterface> = function RugIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RugIcon ${className}`;
      return (
        <Icon alt="Rug" className={classNames} {...propsRest}>
