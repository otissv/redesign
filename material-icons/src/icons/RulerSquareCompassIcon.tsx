import React, { FC } from 'react';
    ...
    export const RulerSquareCompassIcon: FC<IconInterface> = function RulerSquareCompassIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `RulerSquareCompassIcon ${className}`;
      return (
        <Icon alt="RulerSquareCompass" className={classNames} {...propsRest}>
    ...
    RulerSquareCompassIcon.displayName = 'RulerSquareCompassIcon';
