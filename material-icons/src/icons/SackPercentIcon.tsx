import React, { FC } from 'react';
    ...
    export const SackPercentIcon: FC<IconInterface> = function SackPercentIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SackPercentIcon ${className}`;
      return (
        <Icon alt="SackPercent" className={classNames} {...propsRest}>
