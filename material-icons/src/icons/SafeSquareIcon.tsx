import React, { FC } from 'react';
    ...
    export const SafeSquareIcon: FC<IconInterface> = function SafeSquareIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SafeSquareIcon ${className}`;
      return (
        <Icon alt="SafeSquare" className={classNames} {...propsRest}>
    ...
    SafeSquareIcon.displayName = 'SafeSquareIcon';
