import React, { FC } from 'react';
    ...
    export const SafeSquareOutlineIcon: FC<IconInterface> = function SafeSquareOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SafeSquareOutlineIcon ${className}`;
      return (
        <Icon alt="SafeSquareOutline" className={classNames} {...propsRest}>
    ...
    SafeSquareOutlineIcon.displayName = 'SafeSquareOutlineIcon';
