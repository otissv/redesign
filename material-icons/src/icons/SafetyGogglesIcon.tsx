import React, { FC } from 'react';
    ...
    export const SafetyGogglesIcon: FC<IconInterface> = function SafetyGogglesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SafetyGogglesIcon ${className}`;
      return (
        <Icon alt="SafetyGoggles" className={classNames} {...propsRest}>
