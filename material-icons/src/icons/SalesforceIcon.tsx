import React, { FC } from 'react';
    ...
    export const SalesforceIcon: FC<IconInterface> = function SalesforceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SalesforceIcon ${className}`;
      return (
        <Icon alt="Salesforce" className={classNames} {...propsRest}>
