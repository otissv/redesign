import React, { FC } from 'react';
    ...
    export const SatelliteUplinkIcon: FC<IconInterface> = function SatelliteUplinkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SatelliteUplinkIcon ${className}`;
      return (
        <Icon alt="SatelliteUplink" className={classNames} {...propsRest}>
