import React, { FC } from 'react';
    ...
    export const SatelliteVariantIcon: FC<IconInterface> = function SatelliteVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SatelliteVariantIcon ${className}`;
      return (
        <Icon alt="SatelliteVariant" className={classNames} {...propsRest}>
