import React, { FC } from 'react';
    ...
    export const SawBladeIcon: FC<IconInterface> = function SawBladeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SawBladeIcon ${className}`;
      return (
        <Icon alt="SawBlade" className={classNames} {...propsRest}>
