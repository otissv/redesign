import React, { FC } from 'react';
    ...
    export const ScaleOffIcon: FC<IconInterface> = function ScaleOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScaleOffIcon ${className}`;
      return (
        <Icon alt="ScaleOff" className={classNames} {...propsRest}>
    ...
    ScaleOffIcon.displayName = 'ScaleOffIcon';
