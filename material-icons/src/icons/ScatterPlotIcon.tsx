import React, { FC } from 'react';
    ...
    export const ScatterPlotIcon: FC<IconInterface> = function ScatterPlotIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScatterPlotIcon ${className}`;
      return (
        <Icon alt="ScatterPlot" className={classNames} {...propsRest}>
