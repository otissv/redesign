import React, { FC } from 'react';
    ...
    export const ScatterPlotOutlineIcon: FC<IconInterface> = function ScatterPlotOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScatterPlotOutlineIcon ${className}`;
      return (
        <Icon alt="ScatterPlotOutline" className={classNames} {...propsRest}>
