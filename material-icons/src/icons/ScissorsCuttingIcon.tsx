import React, { FC } from 'react';
    ...
    export const ScissorsCuttingIcon: FC<IconInterface> = function ScissorsCuttingIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScissorsCuttingIcon ${className}`;
      return (
        <Icon alt="ScissorsCutting" className={classNames} {...propsRest}>
