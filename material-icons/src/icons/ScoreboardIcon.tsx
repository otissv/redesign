import React, { FC } from 'react';
    ...
    export const ScoreboardIcon: FC<IconInterface> = function ScoreboardIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScoreboardIcon ${className}`;
      return (
        <Icon alt="Scoreboard" className={classNames} {...propsRest}>
