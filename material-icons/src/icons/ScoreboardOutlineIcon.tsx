import React, { FC } from 'react';
    ...
    export const ScoreboardOutlineIcon: FC<IconInterface> = function ScoreboardOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScoreboardOutlineIcon ${className}`;
      return (
        <Icon alt="ScoreboardOutline" className={classNames} {...propsRest}>
    ...
    ScoreboardOutlineIcon.displayName = 'ScoreboardOutlineIcon';
