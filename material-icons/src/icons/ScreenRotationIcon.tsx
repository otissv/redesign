import React, { FC } from 'react';
    ...
    export const ScreenRotationIcon: FC<IconInterface> = function ScreenRotationIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScreenRotationIcon ${className}`;
      return (
        <Icon alt="ScreenRotation" className={classNames} {...propsRest}>
