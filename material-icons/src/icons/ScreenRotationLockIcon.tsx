import React, { FC } from 'react';
    ...
    export const ScreenRotationLockIcon: FC<IconInterface> = function ScreenRotationLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScreenRotationLockIcon ${className}`;
      return (
        <Icon alt="ScreenRotationLock" className={classNames} {...propsRest}>
    ...
    ScreenRotationLockIcon.displayName = 'ScreenRotationLockIcon';
