import React, { FC } from 'react';
    ...
    export const ScrewFlatTopIcon: FC<IconInterface> = function ScrewFlatTopIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScrewFlatTopIcon ${className}`;
      return (
        <Icon alt="ScrewFlatTop" className={classNames} {...propsRest}>
