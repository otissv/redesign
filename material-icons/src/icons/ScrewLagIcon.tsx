import React, { FC } from 'react';
    ...
    export const ScrewLagIcon: FC<IconInterface> = function ScrewLagIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScrewLagIcon ${className}`;
      return (
        <Icon alt="ScrewLag" className={classNames} {...propsRest}>
