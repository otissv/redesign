import React, { FC } from 'react';
    ...
    export const ScrewMachineFlatTopIcon: FC<IconInterface> = function ScrewMachineFlatTopIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScrewMachineFlatTopIcon ${className}`;
      return (
        <Icon alt="ScrewMachineFlatTop" className={classNames} {...propsRest}>
