import React, { FC } from 'react';
    ...
    export const ScrewdriverIcon: FC<IconInterface> = function ScrewdriverIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScrewdriverIcon ${className}`;
      return (
        <Icon alt="Screwdriver" className={classNames} {...propsRest}>
