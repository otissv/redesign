import React, { FC } from 'react';
    ...
    export const ScriptTextOutlineIcon: FC<IconInterface> = function ScriptTextOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ScriptTextOutlineIcon ${className}`;
      return (
        <Icon alt="ScriptTextOutline" className={classNames} {...propsRest}>
