import React, { FC } from 'react';
    ...
    export const SeatFlatAngledIcon: FC<IconInterface> = function SeatFlatAngledIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SeatFlatAngledIcon ${className}`;
      return (
        <Icon alt="SeatFlatAngled" className={classNames} {...propsRest}>
