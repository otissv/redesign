import React, { FC } from 'react';
    ...
    export const SeatLegroomNormalIcon: FC<IconInterface> = function SeatLegroomNormalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SeatLegroomNormalIcon ${className}`;
      return (
        <Icon alt="SeatLegroomNormal" className={classNames} {...propsRest}>
