import React, { FC } from 'react';
    ...
    export const SeatReclineExtraIcon: FC<IconInterface> = function SeatReclineExtraIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SeatReclineExtraIcon ${className}`;
      return (
        <Icon alt="SeatReclineExtra" className={classNames} {...propsRest}>
