import React, { FC } from 'react';
    ...
    export const SeatReclineNormalIcon: FC<IconInterface> = function SeatReclineNormalIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SeatReclineNormalIcon ${className}`;
      return (
        <Icon alt="SeatReclineNormal" className={classNames} {...propsRest}>
