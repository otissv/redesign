import React, { FC } from 'react';
    ...
    export const SeatbeltIcon: FC<IconInterface> = function SeatbeltIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SeatbeltIcon ${className}`;
      return (
        <Icon alt="Seatbelt" className={classNames} {...propsRest}>
