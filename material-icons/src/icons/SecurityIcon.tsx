import React, { FC } from 'react';
    ...
    export const SecurityIcon: FC<IconInterface> = function SecurityIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SecurityIcon ${className}`;
      return (
        <Icon alt="Security" className={classNames} {...propsRest}>
