import React, { FC } from 'react';
    ...
    export const SecurityNetworkIcon: FC<IconInterface> = function SecurityNetworkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SecurityNetworkIcon ${className}`;
      return (
        <Icon alt="SecurityNetwork" className={classNames} {...propsRest}>
