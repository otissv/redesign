import React, { FC } from 'react';
    ...
    export const SeedOffIcon: FC<IconInterface> = function SeedOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SeedOffIcon ${className}`;
      return (
        <Icon alt="SeedOff" className={classNames} {...propsRest}>
    ...
    SeedOffIcon.displayName = 'SeedOffIcon';
