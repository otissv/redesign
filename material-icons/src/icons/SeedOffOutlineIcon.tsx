import React, { FC } from 'react';
    ...
    export const SeedOffOutlineIcon: FC<IconInterface> = function SeedOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SeedOffOutlineIcon ${className}`;
      return (
        <Icon alt="SeedOffOutline" className={classNames} {...propsRest}>
    ...
    SeedOffOutlineIcon.displayName = 'SeedOffOutlineIcon';
