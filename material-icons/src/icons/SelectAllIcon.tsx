import React, { FC } from 'react';
    ...
    export const SelectAllIcon: FC<IconInterface> = function SelectAllIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectAllIcon ${className}`;
      return (
        <Icon alt="SelectAll" className={classNames} {...propsRest}>
