import React, { FC } from 'react';
    ...
    export const SelectCompareIcon: FC<IconInterface> = function SelectCompareIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectCompareIcon ${className}`;
      return (
        <Icon alt="SelectCompare" className={classNames} {...propsRest}>
    ...
    SelectCompareIcon.displayName = 'SelectCompareIcon';
