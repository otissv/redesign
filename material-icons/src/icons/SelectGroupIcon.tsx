import React, { FC } from 'react';
    ...
    export const SelectGroupIcon: FC<IconInterface> = function SelectGroupIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectGroupIcon ${className}`;
      return (
        <Icon alt="SelectGroup" className={classNames} {...propsRest}>
    ...
    SelectGroupIcon.displayName = 'SelectGroupIcon';
