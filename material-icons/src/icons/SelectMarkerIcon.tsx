import React, { FC } from 'react';
    ...
    export const SelectMarkerIcon: FC<IconInterface> = function SelectMarkerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectMarkerIcon ${className}`;
      return (
        <Icon alt="SelectMarker" className={classNames} {...propsRest}>
    ...
    SelectMarkerIcon.displayName = 'SelectMarkerIcon';
