import React, { FC } from 'react';
    ...
    export const SelectMultipleMarkerIcon: FC<IconInterface> = function SelectMultipleMarkerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectMultipleMarkerIcon ${className}`;
      return (
        <Icon alt="SelectMultipleMarker" className={classNames} {...propsRest}>
    ...
    SelectMultipleMarkerIcon.displayName = 'SelectMultipleMarkerIcon';
