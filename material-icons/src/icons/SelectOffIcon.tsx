import React, { FC } from 'react';
    ...
    export const SelectOffIcon: FC<IconInterface> = function SelectOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectOffIcon ${className}`;
      return (
        <Icon alt="SelectOff" className={classNames} {...propsRest}>
    ...
    SelectOffIcon.displayName = 'SelectOffIcon';
