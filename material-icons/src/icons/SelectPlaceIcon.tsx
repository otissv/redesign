import React, { FC } from 'react';
    ...
    export const SelectPlaceIcon: FC<IconInterface> = function SelectPlaceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectPlaceIcon ${className}`;
      return (
        <Icon alt="SelectPlace" className={classNames} {...propsRest}>
    ...
    SelectPlaceIcon.displayName = 'SelectPlaceIcon';
