import React, { FC } from 'react';
    ...
    export const SelectionEllipseArrowInsideIcon: FC<IconInterface> = function SelectionEllipseArrowInsideIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectionEllipseArrowInsideIcon ${className}`;
      return (
        <Icon alt="SelectionEllipseArrowInside" className={classNames} {...propsRest}>
