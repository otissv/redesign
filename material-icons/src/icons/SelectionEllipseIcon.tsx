import React, { FC } from 'react';
    ...
    export const SelectionEllipseIcon: FC<IconInterface> = function SelectionEllipseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectionEllipseIcon ${className}`;
      return (
        <Icon alt="SelectionEllipse" className={classNames} {...propsRest}>
