import React, { FC } from 'react';
    ...
    export const SelectionIcon: FC<IconInterface> = function SelectionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectionIcon ${className}`;
      return (
        <Icon alt="Selection" className={classNames} {...propsRest}>
