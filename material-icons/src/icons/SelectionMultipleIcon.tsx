import React, { FC } from 'react';
    ...
    export const SelectionMultipleIcon: FC<IconInterface> = function SelectionMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectionMultipleIcon ${className}`;
      return (
        <Icon alt="SelectionMultiple" className={classNames} {...propsRest}>
    ...
    SelectionMultipleIcon.displayName = 'SelectionMultipleIcon';
