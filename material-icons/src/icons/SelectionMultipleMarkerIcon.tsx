import React, { FC } from 'react';
    ...
    export const SelectionMultipleMarkerIcon: FC<IconInterface> = function SelectionMultipleMarkerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectionMultipleMarkerIcon ${className}`;
      return (
        <Icon alt="SelectionMultipleMarker" className={classNames} {...propsRest}>
    ...
    SelectionMultipleMarkerIcon.displayName = 'SelectionMultipleMarkerIcon';
