import React, { FC } from 'react';
    ...
    export const SelectionOffIcon: FC<IconInterface> = function SelectionOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectionOffIcon ${className}`;
      return (
        <Icon alt="SelectionOff" className={classNames} {...propsRest}>
