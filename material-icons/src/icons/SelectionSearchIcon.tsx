import React, { FC } from 'react';
    ...
    export const SelectionSearchIcon: FC<IconInterface> = function SelectionSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SelectionSearchIcon ${className}`;
      return (
        <Icon alt="SelectionSearch" className={classNames} {...propsRest}>
    ...
    SelectionSearchIcon.displayName = 'SelectionSearchIcon';
