import React, { FC } from 'react';
    ...
    export const SendLockOutlineIcon: FC<IconInterface> = function SendLockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SendLockOutlineIcon ${className}`;
      return (
        <Icon alt="SendLockOutline" className={classNames} {...propsRest}>
    ...
    SendLockOutlineIcon.displayName = 'SendLockOutlineIcon';
