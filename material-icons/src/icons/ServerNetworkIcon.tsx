import React, { FC } from 'react';
    ...
    export const ServerNetworkIcon: FC<IconInterface> = function ServerNetworkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ServerNetworkIcon ${className}`;
      return (
        <Icon alt="ServerNetwork" className={classNames} {...propsRest}>
    ...
    ServerNetworkIcon.displayName = 'ServerNetworkIcon';
