import React, { FC } from 'react';
    ...
    export const ServerNetworkOffIcon: FC<IconInterface> = function ServerNetworkOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ServerNetworkOffIcon ${className}`;
      return (
        <Icon alt="ServerNetworkOff" className={classNames} {...propsRest}>
