import React, { FC } from 'react';
    ...
    export const ServerOffIcon: FC<IconInterface> = function ServerOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ServerOffIcon ${className}`;
      return (
        <Icon alt="ServerOff" className={classNames} {...propsRest}>
