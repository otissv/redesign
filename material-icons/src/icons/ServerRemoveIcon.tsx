import React, { FC } from 'react';
    ...
    export const ServerRemoveIcon: FC<IconInterface> = function ServerRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ServerRemoveIcon ${className}`;
      return (
        <Icon alt="ServerRemove" className={classNames} {...propsRest}>
    ...
    ServerRemoveIcon.displayName = 'ServerRemoveIcon';
