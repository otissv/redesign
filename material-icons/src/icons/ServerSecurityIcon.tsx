import React, { FC } from 'react';
    ...
    export const ServerSecurityIcon: FC<IconInterface> = function ServerSecurityIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ServerSecurityIcon ${className}`;
      return (
        <Icon alt="ServerSecurity" className={classNames} {...propsRest}>
