import React, { FC } from 'react';
    ...
    export const SetCenterIcon: FC<IconInterface> = function SetCenterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SetCenterIcon ${className}`;
      return (
        <Icon alt="SetCenter" className={classNames} {...propsRest}>
    ...
    SetCenterIcon.displayName = 'SetCenterIcon';
