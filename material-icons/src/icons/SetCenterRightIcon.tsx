import React, { FC } from 'react';
    ...
    export const SetCenterRightIcon: FC<IconInterface> = function SetCenterRightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SetCenterRightIcon ${className}`;
      return (
        <Icon alt="SetCenterRight" className={classNames} {...propsRest}>
    ...
    SetCenterRightIcon.displayName = 'SetCenterRightIcon';
