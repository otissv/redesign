import React, { FC } from 'react';
    ...
    export const SetLeftCenterIcon: FC<IconInterface> = function SetLeftCenterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SetLeftCenterIcon ${className}`;
      return (
        <Icon alt="SetLeftCenter" className={classNames} {...propsRest}>
