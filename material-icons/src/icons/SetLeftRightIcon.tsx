import React, { FC } from 'react';
    ...
    export const SetLeftRightIcon: FC<IconInterface> = function SetLeftRightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SetLeftRightIcon ${className}`;
      return (
        <Icon alt="SetLeftRight" className={classNames} {...propsRest}>
