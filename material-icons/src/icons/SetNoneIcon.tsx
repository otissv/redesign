import React, { FC } from 'react';
    ...
    export const SetNoneIcon: FC<IconInterface> = function SetNoneIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SetNoneIcon ${className}`;
      return (
        <Icon alt="SetNone" className={classNames} {...propsRest}>
    ...
    SetNoneIcon.displayName = 'SetNoneIcon';
