import React, { FC } from 'react';
    ...
    export const SetRightIcon: FC<IconInterface> = function SetRightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SetRightIcon ${className}`;
      return (
        <Icon alt="SetRight" className={classNames} {...propsRest}>
