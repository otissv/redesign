import React, { FC } from 'react';
    ...
    export const SetTopBoxIcon: FC<IconInterface> = function SetTopBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SetTopBoxIcon ${className}`;
      return (
        <Icon alt="SetTopBox" className={classNames} {...propsRest}>
