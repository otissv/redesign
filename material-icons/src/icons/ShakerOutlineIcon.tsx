import React, { FC } from 'react';
    ...
    export const ShakerOutlineIcon: FC<IconInterface> = function ShakerOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShakerOutlineIcon ${className}`;
      return (
        <Icon alt="ShakerOutline" className={classNames} {...propsRest}>
    ...
    ShakerOutlineIcon.displayName = 'ShakerOutlineIcon';
