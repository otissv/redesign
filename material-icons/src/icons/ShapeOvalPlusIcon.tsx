import React, { FC } from 'react';
    ...
    export const ShapeOvalPlusIcon: FC<IconInterface> = function ShapeOvalPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShapeOvalPlusIcon ${className}`;
      return (
        <Icon alt="ShapeOvalPlus" className={classNames} {...propsRest}>
    ...
    ShapeOvalPlusIcon.displayName = 'ShapeOvalPlusIcon';
