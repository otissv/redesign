import React, { FC } from 'react';
    ...
    export const ShareOffOutlineIcon: FC<IconInterface> = function ShareOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShareOffOutlineIcon ${className}`;
      return (
        <Icon alt="ShareOffOutline" className={classNames} {...propsRest}>
