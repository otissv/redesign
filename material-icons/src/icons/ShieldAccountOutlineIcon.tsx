import React, { FC } from 'react';
    ...
    export const ShieldAccountOutlineIcon: FC<IconInterface> = function ShieldAccountOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldAccountOutlineIcon ${className}`;
      return (
        <Icon alt="ShieldAccountOutline" className={classNames} {...propsRest}>
