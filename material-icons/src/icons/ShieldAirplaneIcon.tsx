import React, { FC } from 'react';
    ...
    export const ShieldAirplaneIcon: FC<IconInterface> = function ShieldAirplaneIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldAirplaneIcon ${className}`;
      return (
        <Icon alt="ShieldAirplane" className={classNames} {...propsRest}>
    ...
    ShieldAirplaneIcon.displayName = 'ShieldAirplaneIcon';
