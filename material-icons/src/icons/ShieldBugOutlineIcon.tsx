import React, { FC } from 'react';
    ...
    export const ShieldBugOutlineIcon: FC<IconInterface> = function ShieldBugOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldBugOutlineIcon ${className}`;
      return (
        <Icon alt="ShieldBugOutline" className={classNames} {...propsRest}>
    ...
    ShieldBugOutlineIcon.displayName = 'ShieldBugOutlineIcon';
