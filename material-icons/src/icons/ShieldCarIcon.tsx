import React, { FC } from 'react';
    ...
    export const ShieldCarIcon: FC<IconInterface> = function ShieldCarIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldCarIcon ${className}`;
      return (
        <Icon alt="ShieldCar" className={classNames} {...propsRest}>
    ...
    ShieldCarIcon.displayName = 'ShieldCarIcon';
