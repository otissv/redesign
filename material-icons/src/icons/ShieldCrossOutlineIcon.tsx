import React, { FC } from 'react';
    ...
    export const ShieldCrossOutlineIcon: FC<IconInterface> = function ShieldCrossOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldCrossOutlineIcon ${className}`;
      return (
        <Icon alt="ShieldCrossOutline" className={classNames} {...propsRest}>
