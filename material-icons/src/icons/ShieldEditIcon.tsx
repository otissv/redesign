import React, { FC } from 'react';
    ...
    export const ShieldEditIcon: FC<IconInterface> = function ShieldEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldEditIcon ${className}`;
      return (
        <Icon alt="ShieldEdit" className={classNames} {...propsRest}>
    ...
    ShieldEditIcon.displayName = 'ShieldEditIcon';
