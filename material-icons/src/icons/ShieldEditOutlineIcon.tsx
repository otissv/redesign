import React, { FC } from 'react';
    ...
    export const ShieldEditOutlineIcon: FC<IconInterface> = function ShieldEditOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldEditOutlineIcon ${className}`;
      return (
        <Icon alt="ShieldEditOutline" className={classNames} {...propsRest}>
    ...
    ShieldEditOutlineIcon.displayName = 'ShieldEditOutlineIcon';
