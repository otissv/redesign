import React, { FC } from 'react';
    ...
    export const ShieldLinkVariantIcon: FC<IconInterface> = function ShieldLinkVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldLinkVariantIcon ${className}`;
      return (
        <Icon alt="ShieldLinkVariant" className={classNames} {...propsRest}>
    ...
    ShieldLinkVariantIcon.displayName = 'ShieldLinkVariantIcon';
