import React, { FC } from 'react';
    ...
    export const ShieldLinkVariantOutlineIcon: FC<IconInterface> = function ShieldLinkVariantOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldLinkVariantOutlineIcon ${className}`;
      return (
        <Icon alt="ShieldLinkVariantOutline" className={classNames} {...propsRest}>
    ...
    ShieldLinkVariantOutlineIcon.displayName = 'ShieldLinkVariantOutlineIcon';
