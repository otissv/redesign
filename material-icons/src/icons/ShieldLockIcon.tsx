import React, { FC } from 'react';
    ...
    export const ShieldLockIcon: FC<IconInterface> = function ShieldLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldLockIcon ${className}`;
      return (
        <Icon alt="ShieldLock" className={classNames} {...propsRest}>
