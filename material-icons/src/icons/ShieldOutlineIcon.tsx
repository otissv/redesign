import React, { FC } from 'react';
    ...
    export const ShieldOutlineIcon: FC<IconInterface> = function ShieldOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldOutlineIcon ${className}`;
      return (
        <Icon alt="ShieldOutline" className={classNames} {...propsRest}>
