import React, { FC } from 'react';
    ...
    export const ShieldPlusIcon: FC<IconInterface> = function ShieldPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldPlusIcon ${className}`;
      return (
        <Icon alt="ShieldPlus" className={classNames} {...propsRest}>
