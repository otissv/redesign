import React, { FC } from 'react';
    ...
    export const ShieldRemoveIcon: FC<IconInterface> = function ShieldRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldRemoveIcon ${className}`;
      return (
        <Icon alt="ShieldRemove" className={classNames} {...propsRest}>
