import React, { FC } from 'react';
    ...
    export const ShieldRemoveOutlineIcon: FC<IconInterface> = function ShieldRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="ShieldRemoveOutline" className={classNames} {...propsRest}>
