import React, { FC } from 'react';
    ...
    export const ShieldStarIcon: FC<IconInterface> = function ShieldStarIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldStarIcon ${className}`;
      return (
        <Icon alt="ShieldStar" className={classNames} {...propsRest}>
