import React, { FC } from 'react';
    ...
    export const ShieldSunIcon: FC<IconInterface> = function ShieldSunIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldSunIcon ${className}`;
      return (
        <Icon alt="ShieldSun" className={classNames} {...propsRest}>
    ...
    ShieldSunIcon.displayName = 'ShieldSunIcon';
