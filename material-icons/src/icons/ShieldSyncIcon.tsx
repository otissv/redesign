import React, { FC } from 'react';
    ...
    export const ShieldSyncIcon: FC<IconInterface> = function ShieldSyncIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldSyncIcon ${className}`;
      return (
        <Icon alt="ShieldSync" className={classNames} {...propsRest}>
    ...
    ShieldSyncIcon.displayName = 'ShieldSyncIcon';
