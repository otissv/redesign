import React, { FC } from 'react';
    ...
    export const ShieldSyncOutlineIcon: FC<IconInterface> = function ShieldSyncOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShieldSyncOutlineIcon ${className}`;
      return (
        <Icon alt="ShieldSyncOutline" className={classNames} {...propsRest}>
    ...
    ShieldSyncOutlineIcon.displayName = 'ShieldSyncOutlineIcon';
