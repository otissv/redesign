import React, { FC } from 'react';
    ...
    export const ShoePrintIcon: FC<IconInterface> = function ShoePrintIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShoePrintIcon ${className}`;
      return (
        <Icon alt="ShoePrint" className={classNames} {...propsRest}>
