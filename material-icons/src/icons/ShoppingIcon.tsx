import React, { FC } from 'react';
    ...
    export const ShoppingIcon: FC<IconInterface> = function ShoppingIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShoppingIcon ${className}`;
      return (
        <Icon alt="Shopping" className={classNames} {...propsRest}>
