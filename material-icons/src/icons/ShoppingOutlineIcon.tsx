import React, { FC } from 'react';
    ...
    export const ShoppingOutlineIcon: FC<IconInterface> = function ShoppingOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShoppingOutlineIcon ${className}`;
      return (
        <Icon alt="ShoppingOutline" className={classNames} {...propsRest}>
    ...
    ShoppingOutlineIcon.displayName = 'ShoppingOutlineIcon';
