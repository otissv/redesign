import React, { FC } from 'react';
    ...
    export const ShoppingSearchIcon: FC<IconInterface> = function ShoppingSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShoppingSearchIcon ${className}`;
      return (
        <Icon alt="ShoppingSearch" className={classNames} {...propsRest}>
    ...
    ShoppingSearchIcon.displayName = 'ShoppingSearchIcon';
