import React, { FC } from 'react';
    ...
    export const ShovelOffIcon: FC<IconInterface> = function ShovelOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShovelOffIcon ${className}`;
      return (
        <Icon alt="ShovelOff" className={classNames} {...propsRest}>
