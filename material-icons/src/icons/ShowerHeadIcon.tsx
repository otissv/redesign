import React, { FC } from 'react';
    ...
    export const ShowerHeadIcon: FC<IconInterface> = function ShowerHeadIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ShowerHeadIcon ${className}`;
      return (
        <Icon alt="ShowerHead" className={classNames} {...propsRest}>
