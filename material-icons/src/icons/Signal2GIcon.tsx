import React, { FC } from 'react';
    ...
    export const Signal2GIcon: FC<IconInterface> = function Signal2GIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Signal2GIcon ${className}`;
      return (
        <Icon alt="Signal2G" className={classNames} {...propsRest}>
