import React, { FC } from 'react';
    ...
    export const SignatureFreehandIcon: FC<IconInterface> = function SignatureFreehandIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SignatureFreehandIcon ${className}`;
      return (
        <Icon alt="SignatureFreehand" className={classNames} {...propsRest}>
