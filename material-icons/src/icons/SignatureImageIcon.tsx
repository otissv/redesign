import React, { FC } from 'react';
    ...
    export const SignatureImageIcon: FC<IconInterface> = function SignatureImageIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SignatureImageIcon ${className}`;
      return (
        <Icon alt="SignatureImage" className={classNames} {...propsRest}>
