import React, { FC } from 'react';
    ...
    export const SignatureTextIcon: FC<IconInterface> = function SignatureTextIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SignatureTextIcon ${className}`;
      return (
        <Icon alt="SignatureText" className={classNames} {...propsRest}>
