import React, { FC } from 'react';
    ...
    export const SilverwareCleanIcon: FC<IconInterface> = function SilverwareCleanIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SilverwareCleanIcon ${className}`;
      return (
        <Icon alt="SilverwareClean" className={classNames} {...propsRest}>
    ...
    SilverwareCleanIcon.displayName = 'SilverwareCleanIcon';
