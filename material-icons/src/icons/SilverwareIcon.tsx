import React, { FC } from 'react';
    ...
    export const SilverwareIcon: FC<IconInterface> = function SilverwareIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SilverwareIcon ${className}`;
      return (
        <Icon alt="Silverware" className={classNames} {...propsRest}>
