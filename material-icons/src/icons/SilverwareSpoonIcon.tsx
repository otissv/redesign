import React, { FC } from 'react';
    ...
    export const SilverwareSpoonIcon: FC<IconInterface> = function SilverwareSpoonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SilverwareSpoonIcon ${className}`;
      return (
        <Icon alt="SilverwareSpoon" className={classNames} {...propsRest}>
