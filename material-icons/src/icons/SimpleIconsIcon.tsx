import React, { FC } from 'react';
    ...
    export const SimpleIconsIcon: FC<IconInterface> = function SimpleIconsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SimpleIconsIcon ${className}`;
      return (
        <Icon alt="SimpleIcons" className={classNames} {...propsRest}>
    ...
    SimpleIconsIcon.displayName = 'SimpleIconsIcon';
