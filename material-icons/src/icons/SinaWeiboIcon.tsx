import React, { FC } from 'react';
    ...
    export const SinaWeiboIcon: FC<IconInterface> = function SinaWeiboIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SinaWeiboIcon ${className}`;
      return (
        <Icon alt="SinaWeibo" className={classNames} {...propsRest}>
