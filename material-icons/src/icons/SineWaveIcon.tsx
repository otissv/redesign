import React, { FC } from 'react';
    ...
    export const SineWaveIcon: FC<IconInterface> = function SineWaveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SineWaveIcon ${className}`;
      return (
        <Icon alt="SineWave" className={classNames} {...propsRest}>
    ...
    SineWaveIcon.displayName = 'SineWaveIcon';
