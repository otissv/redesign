import React, { FC } from 'react';
    ...
    export const SizeXsIcon: FC<IconInterface> = function SizeXsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SizeXsIcon ${className}`;
      return (
        <Icon alt="SizeXs" className={classNames} {...propsRest}>
    ...
    SizeXsIcon.displayName = 'SizeXsIcon';
