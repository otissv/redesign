import React, { FC } from 'react';
    ...
    export const SkateIcon: FC<IconInterface> = function SkateIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SkateIcon ${className}`;
      return (
        <Icon alt="Skate" className={classNames} {...propsRest}>
    ...
    SkateIcon.displayName = 'SkateIcon';
