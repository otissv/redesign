import React, { FC } from 'react';
    ...
    export const SkateboardIcon: FC<IconInterface> = function SkateboardIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SkateboardIcon ${className}`;
      return (
        <Icon alt="Skateboard" className={classNames} {...propsRest}>
    ...
    SkateboardIcon.displayName = 'SkateboardIcon';
