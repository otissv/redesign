import React, { FC } from 'react';
    ...
    export const SkiWaterIcon: FC<IconInterface> = function SkiWaterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SkiWaterIcon ${className}`;
      return (
        <Icon alt="SkiWater" className={classNames} {...propsRest}>
    ...
    SkiWaterIcon.displayName = 'SkiWaterIcon';
