import React, { FC } from 'react';
    ...
    export const SkullCrossbonesIcon: FC<IconInterface> = function SkullCrossbonesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SkullCrossbonesIcon ${className}`;
      return (
        <Icon alt="SkullCrossbones" className={classNames} {...propsRest}>
