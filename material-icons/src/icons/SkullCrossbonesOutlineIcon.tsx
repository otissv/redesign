import React, { FC } from 'react';
    ...
    export const SkullCrossbonesOutlineIcon: FC<IconInterface> = function SkullCrossbonesOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SkullCrossbonesOutlineIcon ${className}`;
      return (
        <Icon alt="SkullCrossbonesOutline" className={classNames} {...propsRest}>
    ...
    SkullCrossbonesOutlineIcon.displayName = 'SkullCrossbonesOutlineIcon';
