import React, { FC } from 'react';
    ...
    export const SkullOutlineIcon: FC<IconInterface> = function SkullOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SkullOutlineIcon ${className}`;
      return (
        <Icon alt="SkullOutline" className={classNames} {...propsRest}>
