import React, { FC } from 'react';
    ...
    export const SkullScanIcon: FC<IconInterface> = function SkullScanIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SkullScanIcon ${className}`;
      return (
        <Icon alt="SkullScan" className={classNames} {...propsRest}>
    ...
    SkullScanIcon.displayName = 'SkullScanIcon';
