import React, { FC } from 'react';
    ...
    export const SkullScanOutlineIcon: FC<IconInterface> = function SkullScanOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SkullScanOutlineIcon ${className}`;
      return (
        <Icon alt="SkullScanOutline" className={classNames} {...propsRest}>
    ...
    SkullScanOutlineIcon.displayName = 'SkullScanOutlineIcon';
