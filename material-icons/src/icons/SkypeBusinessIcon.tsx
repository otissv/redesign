import React, { FC } from 'react';
    ...
    export const SkypeBusinessIcon: FC<IconInterface> = function SkypeBusinessIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SkypeBusinessIcon ${className}`;
      return (
        <Icon alt="SkypeBusiness" className={classNames} {...propsRest}>
