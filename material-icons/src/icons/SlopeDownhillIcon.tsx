import React, { FC } from 'react';
    ...
    export const SlopeDownhillIcon: FC<IconInterface> = function SlopeDownhillIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SlopeDownhillIcon ${className}`;
      return (
        <Icon alt="SlopeDownhill" className={classNames} {...propsRest}>
    ...
    SlopeDownhillIcon.displayName = 'SlopeDownhillIcon';
