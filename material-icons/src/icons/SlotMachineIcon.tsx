import React, { FC } from 'react';
    ...
    export const SlotMachineIcon: FC<IconInterface> = function SlotMachineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SlotMachineIcon ${className}`;
      return (
        <Icon alt="SlotMachine" className={classNames} {...propsRest}>
    ...
    SlotMachineIcon.displayName = 'SlotMachineIcon';
