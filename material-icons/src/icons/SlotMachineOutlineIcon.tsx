import React, { FC } from 'react';
    ...
    export const SlotMachineOutlineIcon: FC<IconInterface> = function SlotMachineOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SlotMachineOutlineIcon ${className}`;
      return (
        <Icon alt="SlotMachineOutline" className={classNames} {...propsRest}>
    ...
    SlotMachineOutlineIcon.displayName = 'SlotMachineOutlineIcon';
