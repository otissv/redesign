import React, { FC } from 'react';
    ...
    export const SmartCardOutlineIcon: FC<IconInterface> = function SmartCardOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SmartCardOutlineIcon ${className}`;
      return (
        <Icon alt="SmartCardOutline" className={classNames} {...propsRest}>
    ...
    SmartCardOutlineIcon.displayName = 'SmartCardOutlineIcon';
