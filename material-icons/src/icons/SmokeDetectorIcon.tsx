import React, { FC } from 'react';
    ...
    export const SmokeDetectorIcon: FC<IconInterface> = function SmokeDetectorIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SmokeDetectorIcon ${className}`;
      return (
        <Icon alt="SmokeDetector" className={classNames} {...propsRest}>
