import React, { FC } from 'react';
    ...
    export const SmokingOffIcon: FC<IconInterface> = function SmokingOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SmokingOffIcon ${className}`;
      return (
        <Icon alt="SmokingOff" className={classNames} {...propsRest}>
