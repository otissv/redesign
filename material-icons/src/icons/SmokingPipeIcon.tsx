import React, { FC } from 'react';
    ...
    export const SmokingPipeIcon: FC<IconInterface> = function SmokingPipeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SmokingPipeIcon ${className}`;
      return (
        <Icon alt="SmokingPipe" className={classNames} {...propsRest}>
    ...
    SmokingPipeIcon.displayName = 'SmokingPipeIcon';
