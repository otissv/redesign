import React, { FC } from 'react';
    ...
    export const SmokingPipeOffIcon: FC<IconInterface> = function SmokingPipeOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SmokingPipeOffIcon ${className}`;
      return (
        <Icon alt="SmokingPipeOff" className={classNames} {...propsRest}>
    ...
    SmokingPipeOffIcon.displayName = 'SmokingPipeOffIcon';
