import React, { FC } from 'react';
    ...
    export const SnowboardIcon: FC<IconInterface> = function SnowboardIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SnowboardIcon ${className}`;
      return (
        <Icon alt="Snowboard" className={classNames} {...propsRest}>
    ...
    SnowboardIcon.displayName = 'SnowboardIcon';
