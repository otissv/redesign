import React, { FC } from 'react';
    ...
    export const SnowflakeIcon: FC<IconInterface> = function SnowflakeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SnowflakeIcon ${className}`;
      return (
        <Icon alt="Snowflake" className={classNames} {...propsRest}>
