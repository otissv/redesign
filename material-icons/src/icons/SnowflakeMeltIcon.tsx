import React, { FC } from 'react';
    ...
    export const SnowflakeMeltIcon: FC<IconInterface> = function SnowflakeMeltIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SnowflakeMeltIcon ${className}`;
      return (
        <Icon alt="SnowflakeMelt" className={classNames} {...propsRest}>
    ...
    SnowflakeMeltIcon.displayName = 'SnowflakeMeltIcon';
