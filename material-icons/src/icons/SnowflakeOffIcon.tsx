import React, { FC } from 'react';
    ...
    export const SnowflakeOffIcon: FC<IconInterface> = function SnowflakeOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SnowflakeOffIcon ${className}`;
      return (
        <Icon alt="SnowflakeOff" className={classNames} {...propsRest}>
