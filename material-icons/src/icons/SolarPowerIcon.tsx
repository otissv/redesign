import React, { FC } from 'react';
    ...
    export const SolarPowerIcon: FC<IconInterface> = function SolarPowerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SolarPowerIcon ${className}`;
      return (
        <Icon alt="SolarPower" className={classNames} {...propsRest}>
