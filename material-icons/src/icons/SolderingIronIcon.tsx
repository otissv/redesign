import React, { FC } from 'react';
    ...
    export const SolderingIronIcon: FC<IconInterface> = function SolderingIronIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SolderingIronIcon ${className}`;
      return (
        <Icon alt="SolderingIron" className={classNames} {...propsRest}>
    ...
    SolderingIronIcon.displayName = 'SolderingIronIcon';
