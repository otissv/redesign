import React, { FC } from 'react';
    ...
    export const SortAlphabeticalVariantIcon: FC<IconInterface> = function SortAlphabeticalVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SortAlphabeticalVariantIcon ${className}`;
      return (
        <Icon alt="SortAlphabeticalVariant" className={classNames} {...propsRest}>
    ...
    SortAlphabeticalVariantIcon.displayName = 'SortAlphabeticalVariantIcon';
