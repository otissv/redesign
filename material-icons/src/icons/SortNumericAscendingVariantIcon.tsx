import React, { FC } from 'react';
    ...
    export const SortNumericAscendingVariantIcon: FC<IconInterface> = function SortNumericAscendingVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SortNumericAscendingVariantIcon ${className}`;
      return (
        <Icon alt="SortNumericAscendingVariant" className={classNames} {...propsRest}>
    ...
    SortNumericAscendingVariantIcon.displayName = 'SortNumericAscendingVariantIcon';
