import React, { FC } from 'react';
    ...
    export const SortNumericDescendingVariantIcon: FC<IconInterface> = function SortNumericDescendingVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SortNumericDescendingVariantIcon ${className}`;
      return (
        <Icon alt="SortNumericDescendingVariant" className={classNames} {...propsRest}>
    ...
    SortNumericDescendingVariantIcon.displayName = 'SortNumericDescendingVariantIcon';
