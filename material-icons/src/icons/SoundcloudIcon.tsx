import React, { FC } from 'react';
    ...
    export const SoundcloudIcon: FC<IconInterface> = function SoundcloudIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SoundcloudIcon ${className}`;
      return (
        <Icon alt="Soundcloud" className={classNames} {...propsRest}>
