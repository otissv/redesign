import React, { FC } from 'react';
    ...
    export const SourceBranchCheckIcon: FC<IconInterface> = function SourceBranchCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SourceBranchCheckIcon ${className}`;
      return (
        <Icon alt="SourceBranchCheck" className={classNames} {...propsRest}>
    ...
    SourceBranchCheckIcon.displayName = 'SourceBranchCheckIcon';
