import React, { FC } from 'react';
    ...
    export const SourceBranchIcon: FC<IconInterface> = function SourceBranchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SourceBranchIcon ${className}`;
      return (
        <Icon alt="SourceBranch" className={classNames} {...propsRest}>
