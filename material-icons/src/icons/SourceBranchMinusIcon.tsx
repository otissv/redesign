import React, { FC } from 'react';
    ...
    export const SourceBranchMinusIcon: FC<IconInterface> = function SourceBranchMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SourceBranchMinusIcon ${className}`;
      return (
        <Icon alt="SourceBranchMinus" className={classNames} {...propsRest}>
    ...
    SourceBranchMinusIcon.displayName = 'SourceBranchMinusIcon';
