import React, { FC } from 'react';
    ...
    export const SourceBranchPlusIcon: FC<IconInterface> = function SourceBranchPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SourceBranchPlusIcon ${className}`;
      return (
        <Icon alt="SourceBranchPlus" className={classNames} {...propsRest}>
    ...
    SourceBranchPlusIcon.displayName = 'SourceBranchPlusIcon';
