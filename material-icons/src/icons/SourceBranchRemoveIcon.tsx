import React, { FC } from 'react';
    ...
    export const SourceBranchRemoveIcon: FC<IconInterface> = function SourceBranchRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SourceBranchRemoveIcon ${className}`;
      return (
        <Icon alt="SourceBranchRemove" className={classNames} {...propsRest}>
    ...
    SourceBranchRemoveIcon.displayName = 'SourceBranchRemoveIcon';
