import React, { FC } from 'react';
    ...
    export const SourceBranchSyncIcon: FC<IconInterface> = function SourceBranchSyncIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SourceBranchSyncIcon ${className}`;
      return (
        <Icon alt="SourceBranchSync" className={classNames} {...propsRest}>
    ...
    SourceBranchSyncIcon.displayName = 'SourceBranchSyncIcon';
