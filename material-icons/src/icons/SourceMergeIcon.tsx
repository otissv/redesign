import React, { FC } from 'react';
    ...
    export const SourceMergeIcon: FC<IconInterface> = function SourceMergeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SourceMergeIcon ${className}`;
      return (
        <Icon alt="SourceMerge" className={classNames} {...propsRest}>
