import React, { FC } from 'react';
    ...
    export const SourceRepositoryIcon: FC<IconInterface> = function SourceRepositoryIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SourceRepositoryIcon ${className}`;
      return (
        <Icon alt="SourceRepository" className={classNames} {...propsRest}>
