import React, { FC } from 'react';
    ...
    export const SoySauceIcon: FC<IconInterface> = function SoySauceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SoySauceIcon ${className}`;
      return (
        <Icon alt="SoySauce" className={classNames} {...propsRest}>
