import React, { FC } from 'react';
    ...
    export const SoySauceOffIcon: FC<IconInterface> = function SoySauceOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SoySauceOffIcon ${className}`;
      return (
        <Icon alt="SoySauceOff" className={classNames} {...propsRest}>
    ...
    SoySauceOffIcon.displayName = 'SoySauceOffIcon';
