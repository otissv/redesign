import React, { FC } from 'react';
    ...
    export const SpaOutlineIcon: FC<IconInterface> = function SpaOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpaOutlineIcon ${className}`;
      return (
        <Icon alt="SpaOutline" className={classNames} {...propsRest}>
