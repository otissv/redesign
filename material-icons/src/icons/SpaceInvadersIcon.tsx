import React, { FC } from 'react';
    ...
    export const SpaceInvadersIcon: FC<IconInterface> = function SpaceInvadersIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpaceInvadersIcon ${className}`;
      return (
        <Icon alt="SpaceInvaders" className={classNames} {...propsRest}>
