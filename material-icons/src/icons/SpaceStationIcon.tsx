import React, { FC } from 'react';
    ...
    export const SpaceStationIcon: FC<IconInterface> = function SpaceStationIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpaceStationIcon ${className}`;
      return (
        <Icon alt="SpaceStation" className={classNames} {...propsRest}>
    ...
    SpaceStationIcon.displayName = 'SpaceStationIcon';
