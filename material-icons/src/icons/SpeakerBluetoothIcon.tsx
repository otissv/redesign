import React, { FC } from 'react';
    ...
    export const SpeakerBluetoothIcon: FC<IconInterface> = function SpeakerBluetoothIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpeakerBluetoothIcon ${className}`;
      return (
        <Icon alt="SpeakerBluetooth" className={classNames} {...propsRest}>
