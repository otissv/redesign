import React, { FC } from 'react';
    ...
    export const SpeakerOffIcon: FC<IconInterface> = function SpeakerOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpeakerOffIcon ${className}`;
      return (
        <Icon alt="SpeakerOff" className={classNames} {...propsRest}>
