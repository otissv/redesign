import React, { FC } from 'react';
    ...
    export const SpeakerWirelessIcon: FC<IconInterface> = function SpeakerWirelessIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpeakerWirelessIcon ${className}`;
      return (
        <Icon alt="SpeakerWireless" className={classNames} {...propsRest}>
