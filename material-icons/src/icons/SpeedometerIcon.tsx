import React, { FC } from 'react';
    ...
    export const SpeedometerIcon: FC<IconInterface> = function SpeedometerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpeedometerIcon ${className}`;
      return (
        <Icon alt="Speedometer" className={classNames} {...propsRest}>
