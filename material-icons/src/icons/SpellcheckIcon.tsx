import React, { FC } from 'react';
    ...
    export const SpellcheckIcon: FC<IconInterface> = function SpellcheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpellcheckIcon ${className}`;
      return (
        <Icon alt="Spellcheck" className={classNames} {...propsRest}>
