import React, { FC } from 'react';
    ...
    export const SpiderIcon: FC<IconInterface> = function SpiderIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpiderIcon ${className}`;
      return (
        <Icon alt="Spider" className={classNames} {...propsRest}>
    ...
    SpiderIcon.displayName = 'SpiderIcon';
