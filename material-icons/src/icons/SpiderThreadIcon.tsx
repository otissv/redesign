import React, { FC } from 'react';
    ...
    export const SpiderThreadIcon: FC<IconInterface> = function SpiderThreadIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpiderThreadIcon ${className}`;
      return (
        <Icon alt="SpiderThread" className={classNames} {...propsRest}>
    ...
    SpiderThreadIcon.displayName = 'SpiderThreadIcon';
