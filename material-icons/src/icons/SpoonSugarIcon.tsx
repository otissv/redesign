import React, { FC } from 'react';
    ...
    export const SpoonSugarIcon: FC<IconInterface> = function SpoonSugarIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpoonSugarIcon ${className}`;
      return (
        <Icon alt="SpoonSugar" className={classNames} {...propsRest}>
    ...
    SpoonSugarIcon.displayName = 'SpoonSugarIcon';
