import React, { FC } from 'react';
    ...
    export const SpotlightBeamIcon: FC<IconInterface> = function SpotlightBeamIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpotlightBeamIcon ${className}`;
      return (
        <Icon alt="SpotlightBeam" className={classNames} {...propsRest}>
