import React, { FC } from 'react';
    ...
    export const SpotlightIcon: FC<IconInterface> = function SpotlightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SpotlightIcon ${className}`;
      return (
        <Icon alt="Spotlight" className={classNames} {...propsRest}>
