import React, { FC } from 'react';
    ...
    export const SprinklerVariantIcon: FC<IconInterface> = function SprinklerVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SprinklerVariantIcon ${className}`;
      return (
        <Icon alt="SprinklerVariant" className={classNames} {...propsRest}>
    ...
    SprinklerVariantIcon.displayName = 'SprinklerVariantIcon';
