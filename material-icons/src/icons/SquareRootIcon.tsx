import React, { FC } from 'react';
    ...
    export const SquareRootIcon: FC<IconInterface> = function SquareRootIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SquareRootIcon ${className}`;
      return (
        <Icon alt="SquareRoot" className={classNames} {...propsRest}>
