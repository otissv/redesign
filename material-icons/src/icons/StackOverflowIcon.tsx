import React, { FC } from 'react';
    ...
    export const StackOverflowIcon: FC<IconInterface> = function StackOverflowIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StackOverflowIcon ${className}`;
      return (
        <Icon alt="StackOverflow" className={classNames} {...propsRest}>
