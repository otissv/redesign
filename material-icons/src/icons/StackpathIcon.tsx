import React, { FC } from 'react';
    ...
    export const StackpathIcon: FC<IconInterface> = function StackpathIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StackpathIcon ${className}`;
      return (
        <Icon alt="Stackpath" className={classNames} {...propsRest}>
    ...
    StackpathIcon.displayName = 'StackpathIcon';
