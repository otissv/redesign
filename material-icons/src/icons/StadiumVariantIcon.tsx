import React, { FC } from 'react';
    ...
    export const StadiumVariantIcon: FC<IconInterface> = function StadiumVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StadiumVariantIcon ${className}`;
      return (
        <Icon alt="StadiumVariant" className={classNames} {...propsRest}>
    ...
    StadiumVariantIcon.displayName = 'StadiumVariantIcon';
