import React, { FC } from 'react';
    ...
    export const StarBoxMultipleIcon: FC<IconInterface> = function StarBoxMultipleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StarBoxMultipleIcon ${className}`;
      return (
        <Icon alt="StarBoxMultiple" className={classNames} {...propsRest}>
    ...
    StarBoxMultipleIcon.displayName = 'StarBoxMultipleIcon';
