import React, { FC } from 'react';
    ...
    export const StateMachineIcon: FC<IconInterface> = function StateMachineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StateMachineIcon ${className}`;
      return (
        <Icon alt="StateMachine" className={classNames} {...propsRest}>
    ...
    StateMachineIcon.displayName = 'StateMachineIcon';
