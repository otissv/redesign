import React, { FC } from 'react';
    ...
    export const SteeringOffIcon: FC<IconInterface> = function SteeringOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SteeringOffIcon ${className}`;
      return (
        <Icon alt="SteeringOff" className={classNames} {...propsRest}>
    ...
    SteeringOffIcon.displayName = 'SteeringOffIcon';
