import React, { FC } from 'react';
    ...
    export const StethoscopeIcon: FC<IconInterface> = function StethoscopeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StethoscopeIcon ${className}`;
      return (
        <Icon alt="Stethoscope" className={classNames} {...propsRest}>
