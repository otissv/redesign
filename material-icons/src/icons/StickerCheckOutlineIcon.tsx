import React, { FC } from 'react';
    ...
    export const StickerCheckOutlineIcon: FC<IconInterface> = function StickerCheckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StickerCheckOutlineIcon ${className}`;
      return (
        <Icon alt="StickerCheckOutline" className={classNames} {...propsRest}>
    ...
    StickerCheckOutlineIcon.displayName = 'StickerCheckOutlineIcon';
