import React, { FC } from 'react';
    ...
    export const StickerEmojiIcon: FC<IconInterface> = function StickerEmojiIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StickerEmojiIcon ${className}`;
      return (
        <Icon alt="StickerEmoji" className={classNames} {...propsRest}>
