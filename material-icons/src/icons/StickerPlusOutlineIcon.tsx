import React, { FC } from 'react';
    ...
    export const StickerPlusOutlineIcon: FC<IconInterface> = function StickerPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StickerPlusOutlineIcon ${className}`;
      return (
        <Icon alt="StickerPlusOutline" className={classNames} {...propsRest}>
    ...
    StickerPlusOutlineIcon.displayName = 'StickerPlusOutlineIcon';
