import React, { FC } from 'react';
    ...
    export const StickerRemoveIcon: FC<IconInterface> = function StickerRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StickerRemoveIcon ${className}`;
      return (
        <Icon alt="StickerRemove" className={classNames} {...propsRest}>
    ...
    StickerRemoveIcon.displayName = 'StickerRemoveIcon';
