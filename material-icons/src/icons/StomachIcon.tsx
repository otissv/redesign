import React, { FC } from 'react';
    ...
    export const StomachIcon: FC<IconInterface> = function StomachIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StomachIcon ${className}`;
      return (
        <Icon alt="Stomach" className={classNames} {...propsRest}>
    ...
    StomachIcon.displayName = 'StomachIcon';
