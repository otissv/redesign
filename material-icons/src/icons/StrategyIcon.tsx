import React, { FC } from 'react';
    ...
    export const StrategyIcon: FC<IconInterface> = function StrategyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StrategyIcon ${className}`;
      return (
        <Icon alt="Strategy" className={classNames} {...propsRest}>
