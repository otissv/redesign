import React, { FC } from 'react';
    ...
    export const StretchToPageOutlineIcon: FC<IconInterface> = function StretchToPageOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StretchToPageOutlineIcon ${className}`;
      return (
        <Icon alt="StretchToPageOutline" className={classNames} {...propsRest}>
    ...
    StretchToPageOutlineIcon.displayName = 'StretchToPageOutlineIcon';
