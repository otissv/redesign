import React, { FC } from 'react';
    ...
    export const StringLightsIcon: FC<IconInterface> = function StringLightsIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StringLightsIcon ${className}`;
      return (
        <Icon alt="StringLights" className={classNames} {...propsRest}>
    ...
    StringLightsIcon.displayName = 'StringLightsIcon';
