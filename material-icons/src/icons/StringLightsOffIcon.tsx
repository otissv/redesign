import React, { FC } from 'react';
    ...
    export const StringLightsOffIcon: FC<IconInterface> = function StringLightsOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `StringLightsOffIcon ${className}`;
      return (
        <Icon alt="StringLightsOff" className={classNames} {...propsRest}>
    ...
    StringLightsOffIcon.displayName = 'StringLightsOffIcon';
