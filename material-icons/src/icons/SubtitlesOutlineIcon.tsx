import React, { FC } from 'react';
    ...
    export const SubtitlesOutlineIcon: FC<IconInterface> = function SubtitlesOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SubtitlesOutlineIcon ${className}`;
      return (
        <Icon alt="SubtitlesOutline" className={classNames} {...propsRest}>
