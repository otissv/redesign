import React, { FC } from 'react';
    ...
    export const SubwayVariantIcon: FC<IconInterface> = function SubwayVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SubwayVariantIcon ${className}`;
      return (
        <Icon alt="SubwayVariant" className={classNames} {...propsRest}>
    ...
    SubwayVariantIcon.displayName = 'SubwayVariantIcon';
