import React, { FC } from 'react';
    ...
    export const SunglassesIcon: FC<IconInterface> = function SunglassesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SunglassesIcon ${className}`;
      return (
        <Icon alt="Sunglasses" className={classNames} {...propsRest}>
