import React, { FC } from 'react';
    ...
    export const SurroundSoundIcon: FC<IconInterface> = function SurroundSoundIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SurroundSoundIcon ${className}`;
      return (
        <Icon alt="SurroundSound" className={classNames} {...propsRest}>
