import React, { FC } from 'react';
    ...
    export const SwapHorizontalVariantIcon: FC<IconInterface> = function SwapHorizontalVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SwapHorizontalVariantIcon ${className}`;
      return (
        <Icon alt="SwapHorizontalVariant" className={classNames} {...propsRest}>
