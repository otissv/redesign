import React, { FC } from 'react';
    ...
    export const SwapVerticalCircleIcon: FC<IconInterface> = function SwapVerticalCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SwapVerticalCircleIcon ${className}`;
      return (
        <Icon alt="SwapVerticalCircle" className={classNames} {...propsRest}>
