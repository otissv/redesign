import React, { FC } from 'react';
    ...
    export const SyllabaryHiraganaIcon: FC<IconInterface> = function SyllabaryHiraganaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SyllabaryHiraganaIcon ${className}`;
      return (
        <Icon alt="SyllabaryHiragana" className={classNames} {...propsRest}>
    ...
    SyllabaryHiraganaIcon.displayName = 'SyllabaryHiraganaIcon';
