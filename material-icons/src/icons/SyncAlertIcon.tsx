import React, { FC } from 'react';
    ...
    export const SyncAlertIcon: FC<IconInterface> = function SyncAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `SyncAlertIcon ${className}`;
      return (
        <Icon alt="SyncAlert" className={classNames} {...propsRest}>
