import React, { FC } from 'react';
    ...
    export const TagFacesIcon: FC<IconInterface> = function TagFacesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagFacesIcon ${className}`;
      return (
        <Icon alt="TagFaces" className={classNames} {...propsRest}>
