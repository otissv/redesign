import React, { FC } from 'react';
    ...
    export const TagHeartIcon: FC<IconInterface> = function TagHeartIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagHeartIcon ${className}`;
      return (
        <Icon alt="TagHeart" className={classNames} {...propsRest}>
