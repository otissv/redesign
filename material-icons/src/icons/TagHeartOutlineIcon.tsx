import React, { FC } from 'react';
    ...
    export const TagHeartOutlineIcon: FC<IconInterface> = function TagHeartOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagHeartOutlineIcon ${className}`;
      return (
        <Icon alt="TagHeartOutline" className={classNames} {...propsRest}>
