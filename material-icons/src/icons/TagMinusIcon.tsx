import React, { FC } from 'react';
    ...
    export const TagMinusIcon: FC<IconInterface> = function TagMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagMinusIcon ${className}`;
      return (
        <Icon alt="TagMinus" className={classNames} {...propsRest}>
