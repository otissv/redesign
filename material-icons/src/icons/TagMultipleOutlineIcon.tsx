import React, { FC } from 'react';
    ...
    export const TagMultipleOutlineIcon: FC<IconInterface> = function TagMultipleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagMultipleOutlineIcon ${className}`;
      return (
        <Icon alt="TagMultipleOutline" className={classNames} {...propsRest}>
    ...
    TagMultipleOutlineIcon.displayName = 'TagMultipleOutlineIcon';
