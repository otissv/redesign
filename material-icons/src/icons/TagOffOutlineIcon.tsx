import React, { FC } from 'react';
    ...
    export const TagOffOutlineIcon: FC<IconInterface> = function TagOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagOffOutlineIcon ${className}`;
      return (
        <Icon alt="TagOffOutline" className={classNames} {...propsRest}>
    ...
    TagOffOutlineIcon.displayName = 'TagOffOutlineIcon';
