import React, { FC } from 'react';
    ...
    export const TagOutlineIcon: FC<IconInterface> = function TagOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagOutlineIcon ${className}`;
      return (
        <Icon alt="TagOutline" className={classNames} {...propsRest}>
