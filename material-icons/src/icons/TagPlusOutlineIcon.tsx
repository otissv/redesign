import React, { FC } from 'react';
    ...
    export const TagPlusOutlineIcon: FC<IconInterface> = function TagPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagPlusOutlineIcon ${className}`;
      return (
        <Icon alt="TagPlusOutline" className={classNames} {...propsRest}>
    ...
    TagPlusOutlineIcon.displayName = 'TagPlusOutlineIcon';
