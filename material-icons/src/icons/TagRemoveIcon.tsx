import React, { FC } from 'react';
    ...
    export const TagRemoveIcon: FC<IconInterface> = function TagRemoveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagRemoveIcon ${className}`;
      return (
        <Icon alt="TagRemove" className={classNames} {...propsRest}>
    ...
    TagRemoveIcon.displayName = 'TagRemoveIcon';
