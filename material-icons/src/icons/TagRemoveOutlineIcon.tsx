import React, { FC } from 'react';
    ...
    export const TagRemoveOutlineIcon: FC<IconInterface> = function TagRemoveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagRemoveOutlineIcon ${className}`;
      return (
        <Icon alt="TagRemoveOutline" className={classNames} {...propsRest}>
    ...
    TagRemoveOutlineIcon.displayName = 'TagRemoveOutlineIcon';
