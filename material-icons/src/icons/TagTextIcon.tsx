import React, { FC } from 'react';
    ...
    export const TagTextIcon: FC<IconInterface> = function TagTextIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagTextIcon ${className}`;
      return (
        <Icon alt="TagText" className={classNames} {...propsRest}>
    ...
    TagTextIcon.displayName = 'TagTextIcon';
