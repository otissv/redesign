import React, { FC } from 'react';
    ...
    export const TagTextOutlineIcon: FC<IconInterface> = function TagTextOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TagTextOutlineIcon ${className}`;
      return (
        <Icon alt="TagTextOutline" className={classNames} {...propsRest}>
