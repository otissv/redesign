import React, { FC } from 'react';
    ...
    export const TailwindIcon: FC<IconInterface> = function TailwindIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TailwindIcon ${className}`;
      return (
        <Icon alt="Tailwind" className={classNames} {...propsRest}>
