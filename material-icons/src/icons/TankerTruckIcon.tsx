import React, { FC } from 'react';
    ...
    export const TankerTruckIcon: FC<IconInterface> = function TankerTruckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TankerTruckIcon ${className}`;
      return (
        <Icon alt="TankerTruck" className={classNames} {...propsRest}>
