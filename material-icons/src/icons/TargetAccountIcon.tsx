import React, { FC } from 'react';
    ...
    export const TargetAccountIcon: FC<IconInterface> = function TargetAccountIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TargetAccountIcon ${className}`;
      return (
        <Icon alt="TargetAccount" className={classNames} {...propsRest}>
