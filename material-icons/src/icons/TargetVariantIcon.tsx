import React, { FC } from 'react';
    ...
    export const TargetVariantIcon: FC<IconInterface> = function TargetVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TargetVariantIcon ${className}`;
      return (
        <Icon alt="TargetVariant" className={classNames} {...propsRest}>
    ...
    TargetVariantIcon.displayName = 'TargetVariantIcon';
