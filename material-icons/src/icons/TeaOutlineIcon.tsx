import React, { FC } from 'react';
    ...
    export const TeaOutlineIcon: FC<IconInterface> = function TeaOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TeaOutlineIcon ${className}`;
      return (
        <Icon alt="TeaOutline" className={classNames} {...propsRest}>
