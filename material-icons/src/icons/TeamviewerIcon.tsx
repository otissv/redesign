import React, { FC } from 'react';
    ...
    export const TeamviewerIcon: FC<IconInterface> = function TeamviewerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TeamviewerIcon ${className}`;
      return (
        <Icon alt="Teamviewer" className={classNames} {...propsRest}>
