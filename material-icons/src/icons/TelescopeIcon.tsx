import React, { FC } from 'react';
    ...
    export const TelescopeIcon: FC<IconInterface> = function TelescopeIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TelescopeIcon ${className}`;
      return (
        <Icon alt="Telescope" className={classNames} {...propsRest}>
