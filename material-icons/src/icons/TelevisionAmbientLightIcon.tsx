import React, { FC } from 'react';
    ...
    export const TelevisionAmbientLightIcon: FC<IconInterface> = function TelevisionAmbientLightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TelevisionAmbientLightIcon ${className}`;
      return (
        <Icon alt="TelevisionAmbientLight" className={classNames} {...propsRest}>
    ...
    TelevisionAmbientLightIcon.displayName = 'TelevisionAmbientLightIcon';
