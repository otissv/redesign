import React, { FC } from 'react';
    ...
    export const TelevisionClassicOffIcon: FC<IconInterface> = function TelevisionClassicOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TelevisionClassicOffIcon ${className}`;
      return (
        <Icon alt="TelevisionClassicOff" className={classNames} {...propsRest}>
