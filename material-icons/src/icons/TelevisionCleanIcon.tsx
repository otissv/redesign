import React, { FC } from 'react';
    ...
    export const TelevisionCleanIcon: FC<IconInterface> = function TelevisionCleanIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TelevisionCleanIcon ${className}`;
      return (
        <Icon alt="TelevisionClean" className={classNames} {...propsRest}>
    ...
    TelevisionCleanIcon.displayName = 'TelevisionCleanIcon';
