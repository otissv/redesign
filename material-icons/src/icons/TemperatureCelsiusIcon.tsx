import React, { FC } from 'react';
    ...
    export const TemperatureCelsiusIcon: FC<IconInterface> = function TemperatureCelsiusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TemperatureCelsiusIcon ${className}`;
      return (
        <Icon alt="TemperatureCelsius" className={classNames} {...propsRest}>
    ...
    TemperatureCelsiusIcon.displayName = 'TemperatureCelsiusIcon';
