import React, { FC } from 'react';
    ...
    export const TennisBallIcon: FC<IconInterface> = function TennisBallIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TennisBallIcon ${className}`;
      return (
        <Icon alt="TennisBall" className={classNames} {...propsRest}>
