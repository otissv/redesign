import React, { FC } from 'react';
    ...
    export const TextBoxCheckIcon: FC<IconInterface> = function TextBoxCheckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TextBoxCheckIcon ${className}`;
      return (
        <Icon alt="TextBoxCheck" className={classNames} {...propsRest}>
    ...
    TextBoxCheckIcon.displayName = 'TextBoxCheckIcon';
