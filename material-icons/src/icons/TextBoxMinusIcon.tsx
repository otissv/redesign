import React, { FC } from 'react';
    ...
    export const TextBoxMinusIcon: FC<IconInterface> = function TextBoxMinusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TextBoxMinusIcon ${className}`;
      return (
        <Icon alt="TextBoxMinus" className={classNames} {...propsRest}>
    ...
    TextBoxMinusIcon.displayName = 'TextBoxMinusIcon';
