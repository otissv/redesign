import React, { FC } from 'react';
    ...
    export const TextBoxPlusIcon: FC<IconInterface> = function TextBoxPlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TextBoxPlusIcon ${className}`;
      return (
        <Icon alt="TextBoxPlus" className={classNames} {...propsRest}>
    ...
    TextBoxPlusIcon.displayName = 'TextBoxPlusIcon';
