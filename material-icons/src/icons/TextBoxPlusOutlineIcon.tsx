import React, { FC } from 'react';
    ...
    export const TextBoxPlusOutlineIcon: FC<IconInterface> = function TextBoxPlusOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TextBoxPlusOutlineIcon ${className}`;
      return (
        <Icon alt="TextBoxPlusOutline" className={classNames} {...propsRest}>
    ...
    TextBoxPlusOutlineIcon.displayName = 'TextBoxPlusOutlineIcon';
