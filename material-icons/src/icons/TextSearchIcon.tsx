import React, { FC } from 'react';
    ...
    export const TextSearchIcon: FC<IconInterface> = function TextSearchIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TextSearchIcon ${className}`;
      return (
        <Icon alt="TextSearch" className={classNames} {...propsRest}>
