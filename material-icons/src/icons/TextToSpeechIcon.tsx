import React, { FC } from 'react';
    ...
    export const TextToSpeechIcon: FC<IconInterface> = function TextToSpeechIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TextToSpeechIcon ${className}`;
      return (
        <Icon alt="TextToSpeech" className={classNames} {...propsRest}>
