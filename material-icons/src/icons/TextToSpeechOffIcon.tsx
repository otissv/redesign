import React, { FC } from 'react';
    ...
    export const TextToSpeechOffIcon: FC<IconInterface> = function TextToSpeechOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TextToSpeechOffIcon ${className}`;
      return (
        <Icon alt="TextToSpeechOff" className={classNames} {...propsRest}>
