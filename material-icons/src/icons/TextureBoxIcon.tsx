import React, { FC } from 'react';
    ...
    export const TextureBoxIcon: FC<IconInterface> = function TextureBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TextureBoxIcon ${className}`;
      return (
        <Icon alt="TextureBox" className={classNames} {...propsRest}>
    ...
    TextureBoxIcon.displayName = 'TextureBoxIcon';
