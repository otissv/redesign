import React, { FC } from 'react';
    ...
    export const ThermometerLinesIcon: FC<IconInterface> = function ThermometerLinesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ThermometerLinesIcon ${className}`;
      return (
        <Icon alt="ThermometerLines" className={classNames} {...propsRest}>
