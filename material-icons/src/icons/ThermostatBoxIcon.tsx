import React, { FC } from 'react';
    ...
    export const ThermostatBoxIcon: FC<IconInterface> = function ThermostatBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ThermostatBoxIcon ${className}`;
      return (
        <Icon alt="ThermostatBox" className={classNames} {...propsRest}>
