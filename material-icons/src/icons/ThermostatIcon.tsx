import React, { FC } from 'react';
    ...
    export const ThermostatIcon: FC<IconInterface> = function ThermostatIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ThermostatIcon ${className}`;
      return (
        <Icon alt="Thermostat" className={classNames} {...propsRest}>
