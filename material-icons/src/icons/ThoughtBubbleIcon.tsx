import React, { FC } from 'react';
    ...
    export const ThoughtBubbleIcon: FC<IconInterface> = function ThoughtBubbleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ThoughtBubbleIcon ${className}`;
      return (
        <Icon alt="ThoughtBubble" className={classNames} {...propsRest}>
