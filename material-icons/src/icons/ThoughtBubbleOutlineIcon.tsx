import React, { FC } from 'react';
    ...
    export const ThoughtBubbleOutlineIcon: FC<IconInterface> = function ThoughtBubbleOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ThoughtBubbleOutlineIcon ${className}`;
      return (
        <Icon alt="ThoughtBubbleOutline" className={classNames} {...propsRest}>
    ...
    ThoughtBubbleOutlineIcon.displayName = 'ThoughtBubbleOutlineIcon';
