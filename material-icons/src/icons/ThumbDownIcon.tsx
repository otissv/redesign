import React, { FC } from 'react';
    ...
    export const ThumbDownIcon: FC<IconInterface> = function ThumbDownIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ThumbDownIcon ${className}`;
      return (
        <Icon alt="ThumbDown" className={classNames} {...propsRest}>
