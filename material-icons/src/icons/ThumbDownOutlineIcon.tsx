import React, { FC } from 'react';
    ...
    export const ThumbDownOutlineIcon: FC<IconInterface> = function ThumbDownOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ThumbDownOutlineIcon ${className}`;
      return (
        <Icon alt="ThumbDownOutline" className={classNames} {...propsRest}>
