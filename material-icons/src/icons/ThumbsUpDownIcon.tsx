import React, { FC } from 'react';
    ...
    export const ThumbsUpDownIcon: FC<IconInterface> = function ThumbsUpDownIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ThumbsUpDownIcon ${className}`;
      return (
        <Icon alt="ThumbsUpDown" className={classNames} {...propsRest}>
