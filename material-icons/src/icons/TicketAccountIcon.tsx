import React, { FC } from 'react';
    ...
    export const TicketAccountIcon: FC<IconInterface> = function TicketAccountIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TicketAccountIcon ${className}`;
      return (
        <Icon alt="TicketAccount" className={classNames} {...propsRest}>
