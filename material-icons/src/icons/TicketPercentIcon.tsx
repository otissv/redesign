import React, { FC } from 'react';
    ...
    export const TicketPercentIcon: FC<IconInterface> = function TicketPercentIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TicketPercentIcon ${className}`;
      return (
        <Icon alt="TicketPercent" className={classNames} {...propsRest}>
