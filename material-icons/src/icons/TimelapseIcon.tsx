import React, { FC } from 'react';
    ...
    export const TimelapseIcon: FC<IconInterface> = function TimelapseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TimelapseIcon ${className}`;
      return (
        <Icon alt="Timelapse" className={classNames} {...propsRest}>
