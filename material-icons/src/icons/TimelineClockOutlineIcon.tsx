import React, { FC } from 'react';
    ...
    export const TimelineClockOutlineIcon: FC<IconInterface> = function TimelineClockOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TimelineClockOutlineIcon ${className}`;
      return (
        <Icon alt="TimelineClockOutline" className={classNames} {...propsRest}>
    ...
    TimelineClockOutlineIcon.displayName = 'TimelineClockOutlineIcon';
