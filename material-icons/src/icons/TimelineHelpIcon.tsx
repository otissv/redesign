import React, { FC } from 'react';
    ...
    export const TimelineHelpIcon: FC<IconInterface> = function TimelineHelpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TimelineHelpIcon ${className}`;
      return (
        <Icon alt="TimelineHelp" className={classNames} {...propsRest}>
    ...
    TimelineHelpIcon.displayName = 'TimelineHelpIcon';
