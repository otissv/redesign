import React, { FC } from 'react';
    ...
    export const TimelineHelpOutlineIcon: FC<IconInterface> = function TimelineHelpOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TimelineHelpOutlineIcon ${className}`;
      return (
        <Icon alt="TimelineHelpOutline" className={classNames} {...propsRest}>
    ...
    TimelineHelpOutlineIcon.displayName = 'TimelineHelpOutlineIcon';
