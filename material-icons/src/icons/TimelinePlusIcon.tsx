import React, { FC } from 'react';
    ...
    export const TimelinePlusIcon: FC<IconInterface> = function TimelinePlusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TimelinePlusIcon ${className}`;
      return (
        <Icon alt="TimelinePlus" className={classNames} {...propsRest}>
    ...
    TimelinePlusIcon.displayName = 'TimelinePlusIcon';
