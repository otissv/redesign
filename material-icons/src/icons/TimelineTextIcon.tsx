import React, { FC } from 'react';
    ...
    export const TimelineTextIcon: FC<IconInterface> = function TimelineTextIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TimelineTextIcon ${className}`;
      return (
        <Icon alt="TimelineText" className={classNames} {...propsRest}>
