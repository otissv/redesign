import React, { FC } from 'react';
    ...
    export const TimerOffOutlineIcon: FC<IconInterface> = function TimerOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TimerOffOutlineIcon ${className}`;
      return (
        <Icon alt="TimerOffOutline" className={classNames} {...propsRest}>
    ...
    TimerOffOutlineIcon.displayName = 'TimerOffOutlineIcon';
