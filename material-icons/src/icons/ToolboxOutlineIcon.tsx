import React, { FC } from 'react';
    ...
    export const ToolboxOutlineIcon: FC<IconInterface> = function ToolboxOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ToolboxOutlineIcon ${className}`;
      return (
        <Icon alt="ToolboxOutline" className={classNames} {...propsRest}>
