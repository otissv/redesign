import React, { FC } from 'react';
    ...
    export const ToothOutlineIcon: FC<IconInterface> = function ToothOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ToothOutlineIcon ${className}`;
      return (
        <Icon alt="ToothOutline" className={classNames} {...propsRest}>
