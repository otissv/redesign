import React, { FC } from 'react';
    ...
    export const ToothbrushElectricIcon: FC<IconInterface> = function ToothbrushElectricIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ToothbrushElectricIcon ${className}`;
      return (
        <Icon alt="ToothbrushElectric" className={classNames} {...propsRest}>
    ...
    ToothbrushElectricIcon.displayName = 'ToothbrushElectricIcon';
