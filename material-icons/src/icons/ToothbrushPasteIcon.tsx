import React, { FC } from 'react';
    ...
    export const ToothbrushPasteIcon: FC<IconInterface> = function ToothbrushPasteIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ToothbrushPasteIcon ${className}`;
      return (
        <Icon alt="ToothbrushPaste" className={classNames} {...propsRest}>
    ...
    ToothbrushPasteIcon.displayName = 'ToothbrushPasteIcon';
