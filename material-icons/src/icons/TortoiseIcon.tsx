import React, { FC } from 'react';
    ...
    export const TortoiseIcon: FC<IconInterface> = function TortoiseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TortoiseIcon ${className}`;
      return (
        <Icon alt="Tortoise" className={classNames} {...propsRest}>
