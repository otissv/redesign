import React, { FC } from 'react';
    ...
    export const TowTruckIcon: FC<IconInterface> = function TowTruckIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TowTruckIcon ${className}`;
      return (
        <Icon alt="TowTruck" className={classNames} {...propsRest}>
