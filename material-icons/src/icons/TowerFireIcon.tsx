import React, { FC } from 'react';
    ...
    export const TowerFireIcon: FC<IconInterface> = function TowerFireIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TowerFireIcon ${className}`;
      return (
        <Icon alt="TowerFire" className={classNames} {...propsRest}>
    ...
    TowerFireIcon.displayName = 'TowerFireIcon';
