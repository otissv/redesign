import React, { FC } from 'react';
    ...
    export const ToyBrickMarkerIcon: FC<IconInterface> = function ToyBrickMarkerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ToyBrickMarkerIcon ${className}`;
      return (
        <Icon alt="ToyBrickMarker" className={classNames} {...propsRest}>
    ...
    ToyBrickMarkerIcon.displayName = 'ToyBrickMarkerIcon';
