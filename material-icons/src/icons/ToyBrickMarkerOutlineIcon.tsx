import React, { FC } from 'react';
    ...
    export const ToyBrickMarkerOutlineIcon: FC<IconInterface> = function ToyBrickMarkerOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ToyBrickMarkerOutlineIcon ${className}`;
      return (
        <Icon alt="ToyBrickMarkerOutline" className={classNames} {...propsRest}>
    ...
    ToyBrickMarkerOutlineIcon.displayName = 'ToyBrickMarkerOutlineIcon';
