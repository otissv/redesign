import React, { FC } from 'react';
    ...
    export const ToyBrickSearchOutlineIcon: FC<IconInterface> = function ToyBrickSearchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ToyBrickSearchOutlineIcon ${className}`;
      return (
        <Icon alt="ToyBrickSearchOutline" className={classNames} {...propsRest}>
    ...
    ToyBrickSearchOutlineIcon.displayName = 'ToyBrickSearchOutlineIcon';
