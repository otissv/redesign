import React, { FC } from 'react';
    ...
    export const TrackpadLockIcon: FC<IconInterface> = function TrackpadLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TrackpadLockIcon ${className}`;
      return (
        <Icon alt="TrackpadLock" className={classNames} {...propsRest}>
