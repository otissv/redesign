import React, { FC } from 'react';
    ...
    export const TractorVariantIcon: FC<IconInterface> = function TractorVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TractorVariantIcon ${className}`;
      return (
        <Icon alt="TractorVariant" className={classNames} {...propsRest}>
    ...
    TractorVariantIcon.displayName = 'TractorVariantIcon';
