import React, { FC } from 'react';
    ...
    export const TrademarkIcon: FC<IconInterface> = function TrademarkIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TrademarkIcon ${className}`;
      return (
        <Icon alt="Trademark" className={classNames} {...propsRest}>
