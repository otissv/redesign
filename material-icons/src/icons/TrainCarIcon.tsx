import React, { FC } from 'react';
    ...
    export const TrainCarIcon: FC<IconInterface> = function TrainCarIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TrainCarIcon ${className}`;
      return (
        <Icon alt="TrainCar" className={classNames} {...propsRest}>
