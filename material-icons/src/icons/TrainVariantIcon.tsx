import React, { FC } from 'react';
    ...
    export const TrainVariantIcon: FC<IconInterface> = function TrainVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TrainVariantIcon ${className}`;
      return (
        <Icon alt="TrainVariant" className={classNames} {...propsRest}>
