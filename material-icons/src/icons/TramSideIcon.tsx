import React, { FC } from 'react';
    ...
    export const TramSideIcon: FC<IconInterface> = function TramSideIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TramSideIcon ${className}`;
      return (
        <Icon alt="TramSide" className={classNames} {...propsRest}>
    ...
    TramSideIcon.displayName = 'TramSideIcon';
