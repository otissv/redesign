import React, { FC } from 'react';
    ...
    export const TransitConnectionIcon: FC<IconInterface> = function TransitConnectionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TransitConnectionIcon ${className}`;
      return (
        <Icon alt="TransitConnection" className={classNames} {...propsRest}>
