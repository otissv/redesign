import React, { FC } from 'react';
    ...
    export const TransitConnectionVariantIcon: FC<IconInterface> = function TransitConnectionVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TransitConnectionVariantIcon ${className}`;
      return (
        <Icon alt="TransitConnectionVariant" className={classNames} {...propsRest}>
