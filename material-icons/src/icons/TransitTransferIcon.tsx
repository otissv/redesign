import React, { FC } from 'react';
    ...
    export const TransitTransferIcon: FC<IconInterface> = function TransitTransferIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TransitTransferIcon ${className}`;
      return (
        <Icon alt="TransitTransfer" className={classNames} {...propsRest}>
    ...
    TransitTransferIcon.displayName = 'TransitTransferIcon';
