import React, { FC } from 'react';
    ...
    export const TransitionIcon: FC<IconInterface> = function TransitionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TransitionIcon ${className}`;
      return (
        <Icon alt="Transition" className={classNames} {...propsRest}>
