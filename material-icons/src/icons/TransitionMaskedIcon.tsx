import React, { FC } from 'react';
    ...
    export const TransitionMaskedIcon: FC<IconInterface> = function TransitionMaskedIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TransitionMaskedIcon ${className}`;
      return (
        <Icon alt="TransitionMasked" className={classNames} {...propsRest}>
