import React, { FC } from 'react';
    ...
    export const TranslateOffIcon: FC<IconInterface> = function TranslateOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TranslateOffIcon ${className}`;
      return (
        <Icon alt="TranslateOff" className={classNames} {...propsRest}>
