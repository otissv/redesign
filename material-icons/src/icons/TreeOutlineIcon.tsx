import React, { FC } from 'react';
    ...
    export const TreeOutlineIcon: FC<IconInterface> = function TreeOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TreeOutlineIcon ${className}`;
      return (
        <Icon alt="TreeOutline" className={classNames} {...propsRest}>
