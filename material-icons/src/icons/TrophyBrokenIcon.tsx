import React, { FC } from 'react';
    ...
    export const TrophyBrokenIcon: FC<IconInterface> = function TrophyBrokenIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TrophyBrokenIcon ${className}`;
      return (
        <Icon alt="TrophyBroken" className={classNames} {...propsRest}>
