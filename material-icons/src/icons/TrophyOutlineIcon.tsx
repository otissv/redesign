import React, { FC } from 'react';
    ...
    export const TrophyOutlineIcon: FC<IconInterface> = function TrophyOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TrophyOutlineIcon ${className}`;
      return (
        <Icon alt="TrophyOutline" className={classNames} {...propsRest}>
    ...
    TrophyOutlineIcon.displayName = 'TrophyOutlineIcon';
