import React, { FC } from 'react';
    ...
    export const TruckFastIcon: FC<IconInterface> = function TruckFastIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TruckFastIcon ${className}`;
      return (
        <Icon alt="TruckFast" className={classNames} {...propsRest}>
