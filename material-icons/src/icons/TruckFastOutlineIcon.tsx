import React, { FC } from 'react';
    ...
    export const TruckFastOutlineIcon: FC<IconInterface> = function TruckFastOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TruckFastOutlineIcon ${className}`;
      return (
        <Icon alt="TruckFastOutline" className={classNames} {...propsRest}>
    ...
    TruckFastOutlineIcon.displayName = 'TruckFastOutlineIcon';
