import React, { FC } from 'react';
    ...
    export const TruckOutlineIcon: FC<IconInterface> = function TruckOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TruckOutlineIcon ${className}`;
      return (
        <Icon alt="TruckOutline" className={classNames} {...propsRest}>
    ...
    TruckOutlineIcon.displayName = 'TruckOutlineIcon';
