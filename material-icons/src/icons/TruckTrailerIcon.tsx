import React, { FC } from 'react';
    ...
    export const TruckTrailerIcon: FC<IconInterface> = function TruckTrailerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TruckTrailerIcon ${className}`;
      return (
        <Icon alt="TruckTrailer" className={classNames} {...propsRest}>
