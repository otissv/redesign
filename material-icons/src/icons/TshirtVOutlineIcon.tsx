import React, { FC } from 'react';
    ...
    export const TshirtVOutlineIcon: FC<IconInterface> = function TshirtVOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TshirtVOutlineIcon ${className}`;
      return (
        <Icon alt="TshirtVOutline" className={classNames} {...propsRest}>
    ...
    TshirtVOutlineIcon.displayName = 'TshirtVOutlineIcon';
