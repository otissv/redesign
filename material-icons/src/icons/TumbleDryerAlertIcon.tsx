import React, { FC } from 'react';
    ...
    export const TumbleDryerAlertIcon: FC<IconInterface> = function TumbleDryerAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TumbleDryerAlertIcon ${className}`;
      return (
        <Icon alt="TumbleDryerAlert" className={classNames} {...propsRest}>
    ...
    TumbleDryerAlertIcon.displayName = 'TumbleDryerAlertIcon';
