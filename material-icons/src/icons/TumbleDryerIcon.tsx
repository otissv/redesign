import React, { FC } from 'react';
    ...
    export const TumbleDryerIcon: FC<IconInterface> = function TumbleDryerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TumbleDryerIcon ${className}`;
      return (
        <Icon alt="TumbleDryer" className={classNames} {...propsRest}>
