import React, { FC } from 'react';
    ...
    export const TumbleDryerOffIcon: FC<IconInterface> = function TumbleDryerOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TumbleDryerOffIcon ${className}`;
      return (
        <Icon alt="TumbleDryerOff" className={classNames} {...propsRest}>
    ...
    TumbleDryerOffIcon.displayName = 'TumbleDryerOffIcon';
