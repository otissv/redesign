import React, { FC } from 'react';
    ...
    export const TurnstileOutlineIcon: FC<IconInterface> = function TurnstileOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TurnstileOutlineIcon ${className}`;
      return (
        <Icon alt="TurnstileOutline" className={classNames} {...propsRest}>
