import React, { FC } from 'react';
    ...
    export const TwoFactorAuthenticationIcon: FC<IconInterface> = function TwoFactorAuthenticationIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TwoFactorAuthenticationIcon ${className}`;
      return (
        <Icon alt="TwoFactorAuthentication" className={classNames} {...propsRest}>
