import React, { FC } from 'react';
    ...
    export const TypewriterIcon: FC<IconInterface> = function TypewriterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `TypewriterIcon ${className}`;
      return (
        <Icon alt="Typewriter" className={classNames} {...propsRest}>
