import React, { FC } from 'react';
    ...
    export const UmbracoIcon: FC<IconInterface> = function UmbracoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `UmbracoIcon ${className}`;
      return (
        <Icon alt="Umbraco" className={classNames} {...propsRest}>
    ...
    UmbracoIcon.displayName = 'UmbracoIcon';
