import React, { FC } from 'react';
    ...
    export const UndoVariantIcon: FC<IconInterface> = function UndoVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `UndoVariantIcon ${className}`;
      return (
        <Icon alt="UndoVariant" className={classNames} {...propsRest}>
