import React, { FC } from 'react';
    ...
    export const UntappdIcon: FC<IconInterface> = function UntappdIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `UntappdIcon ${className}`;
      return (
        <Icon alt="Untappd" className={classNames} {...propsRest}>
    ...
    UntappdIcon.displayName = 'UntappdIcon';
