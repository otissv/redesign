import React, { FC } from 'react';
    ...
    export const UploadLockIcon: FC<IconInterface> = function UploadLockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `UploadLockIcon ${className}`;
      return (
        <Icon alt="UploadLock" className={classNames} {...propsRest}>
    ...
    UploadLockIcon.displayName = 'UploadLockIcon';
