import React, { FC } from 'react';
    ...
    export const UsbFlashDriveIcon: FC<IconInterface> = function UsbFlashDriveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `UsbFlashDriveIcon ${className}`;
      return (
        <Icon alt="UsbFlashDrive" className={classNames} {...propsRest}>
