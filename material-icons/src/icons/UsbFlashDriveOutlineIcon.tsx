import React, { FC } from 'react';
    ...
    export const UsbFlashDriveOutlineIcon: FC<IconInterface> = function UsbFlashDriveOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `UsbFlashDriveOutlineIcon ${className}`;
      return (
        <Icon alt="UsbFlashDriveOutline" className={classNames} {...propsRest}>
    ...
    UsbFlashDriveOutlineIcon.displayName = 'UsbFlashDriveOutlineIcon';
