import React, { FC } from 'react';
    ...
    export const VanPassengerIcon: FC<IconInterface> = function VanPassengerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VanPassengerIcon ${className}`;
      return (
        <Icon alt="VanPassenger" className={classNames} {...propsRest}>
