import React, { FC } from 'react';
    ...
    export const VanityLightIcon: FC<IconInterface> = function VanityLightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VanityLightIcon ${className}`;
      return (
        <Icon alt="VanityLight" className={classNames} {...propsRest}>
    ...
    VanityLightIcon.displayName = 'VanityLightIcon';
