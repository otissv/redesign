import React, { FC } from 'react';
    ...
    export const VariableBoxIcon: FC<IconInterface> = function VariableBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VariableBoxIcon ${className}`;
      return (
        <Icon alt="VariableBox" className={classNames} {...propsRest}>
    ...
    VariableBoxIcon.displayName = 'VariableBoxIcon';
