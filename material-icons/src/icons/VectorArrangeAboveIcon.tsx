import React, { FC } from 'react';
    ...
    export const VectorArrangeAboveIcon: FC<IconInterface> = function VectorArrangeAboveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorArrangeAboveIcon ${className}`;
      return (
        <Icon alt="VectorArrangeAbove" className={classNames} {...propsRest}>
