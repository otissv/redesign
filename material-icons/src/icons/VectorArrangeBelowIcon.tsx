import React, { FC } from 'react';
    ...
    export const VectorArrangeBelowIcon: FC<IconInterface> = function VectorArrangeBelowIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorArrangeBelowIcon ${className}`;
      return (
        <Icon alt="VectorArrangeBelow" className={classNames} {...propsRest}>
