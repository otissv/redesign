import React, { FC } from 'react';
    ...
    export const VectorBezierIcon: FC<IconInterface> = function VectorBezierIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorBezierIcon ${className}`;
      return (
        <Icon alt="VectorBezier" className={classNames} {...propsRest}>
