import React, { FC } from 'react';
    ...
    export const VectorCircleIcon: FC<IconInterface> = function VectorCircleIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorCircleIcon ${className}`;
      return (
        <Icon alt="VectorCircle" className={classNames} {...propsRest}>
