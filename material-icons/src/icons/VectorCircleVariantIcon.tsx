import React, { FC } from 'react';
    ...
    export const VectorCircleVariantIcon: FC<IconInterface> = function VectorCircleVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorCircleVariantIcon ${className}`;
      return (
        <Icon alt="VectorCircleVariant" className={classNames} {...propsRest}>
