import React, { FC } from 'react';
    ...
    export const VectorCombineIcon: FC<IconInterface> = function VectorCombineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorCombineIcon ${className}`;
      return (
        <Icon alt="VectorCombine" className={classNames} {...propsRest}>
    ...
    VectorCombineIcon.displayName = 'VectorCombineIcon';
