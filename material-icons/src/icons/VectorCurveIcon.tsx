import React, { FC } from 'react';
    ...
    export const VectorCurveIcon: FC<IconInterface> = function VectorCurveIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorCurveIcon ${className}`;
      return (
        <Icon alt="VectorCurve" className={classNames} {...propsRest}>
