import React, { FC } from 'react';
    ...
    export const VectorDifferenceAbIcon: FC<IconInterface> = function VectorDifferenceAbIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorDifferenceAbIcon ${className}`;
      return (
        <Icon alt="VectorDifferenceAb" className={classNames} {...propsRest}>
