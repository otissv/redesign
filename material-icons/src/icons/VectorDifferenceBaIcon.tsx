import React, { FC } from 'react';
    ...
    export const VectorDifferenceBaIcon: FC<IconInterface> = function VectorDifferenceBaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorDifferenceBaIcon ${className}`;
      return (
        <Icon alt="VectorDifferenceBa" className={classNames} {...propsRest}>
