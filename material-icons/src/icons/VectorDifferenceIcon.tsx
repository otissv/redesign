import React, { FC } from 'react';
    ...
    export const VectorDifferenceIcon: FC<IconInterface> = function VectorDifferenceIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorDifferenceIcon ${className}`;
      return (
        <Icon alt="VectorDifference" className={classNames} {...propsRest}>
    ...
    VectorDifferenceIcon.displayName = 'VectorDifferenceIcon';
