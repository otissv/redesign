import React, { FC } from 'react';
    ...
    export const VectorEllipseIcon: FC<IconInterface> = function VectorEllipseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorEllipseIcon ${className}`;
      return (
        <Icon alt="VectorEllipse" className={classNames} {...propsRest}>
