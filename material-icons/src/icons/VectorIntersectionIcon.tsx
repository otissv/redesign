import React, { FC } from 'react';
    ...
    export const VectorIntersectionIcon: FC<IconInterface> = function VectorIntersectionIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorIntersectionIcon ${className}`;
      return (
        <Icon alt="VectorIntersection" className={classNames} {...propsRest}>
