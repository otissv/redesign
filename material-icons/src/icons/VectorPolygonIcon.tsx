import React, { FC } from 'react';
    ...
    export const VectorPolygonIcon: FC<IconInterface> = function VectorPolygonIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorPolygonIcon ${className}`;
      return (
        <Icon alt="VectorPolygon" className={classNames} {...propsRest}>
