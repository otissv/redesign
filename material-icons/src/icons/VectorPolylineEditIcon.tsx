import React, { FC } from 'react';
    ...
    export const VectorPolylineEditIcon: FC<IconInterface> = function VectorPolylineEditIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VectorPolylineEditIcon ${className}`;
      return (
        <Icon alt="VectorPolylineEdit" className={classNames} {...propsRest}>
    ...
    VectorPolylineEditIcon.displayName = 'VectorPolylineEditIcon';
