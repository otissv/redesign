import React, { FC } from 'react';
    ...
    export const VibrateOffIcon: FC<IconInterface> = function VibrateOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VibrateOffIcon ${className}`;
      return (
        <Icon alt="VibrateOff" className={classNames} {...propsRest}>
