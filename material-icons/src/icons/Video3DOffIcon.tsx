import React, { FC } from 'react';
    ...
    export const Video3DOffIcon: FC<IconInterface> = function Video3DOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `Video3DOffIcon ${className}`;
      return (
        <Icon alt="Video3DOff" className={classNames} {...propsRest}>
    ...
    Video3DOffIcon.displayName = 'Video3DOffIcon';
