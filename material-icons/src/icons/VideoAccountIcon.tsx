import React, { FC } from 'react';
    ...
    export const VideoAccountIcon: FC<IconInterface> = function VideoAccountIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoAccountIcon ${className}`;
      return (
        <Icon alt="VideoAccount" className={classNames} {...propsRest}>
