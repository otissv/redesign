import React, { FC } from 'react';
    ...
    export const VideoBoxOffIcon: FC<IconInterface> = function VideoBoxOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoBoxOffIcon ${className}`;
      return (
        <Icon alt="VideoBoxOff" className={classNames} {...propsRest}>
    ...
    VideoBoxOffIcon.displayName = 'VideoBoxOffIcon';
