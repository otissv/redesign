import React, { FC } from 'react';
    ...
    export const VideoImageIcon: FC<IconInterface> = function VideoImageIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoImageIcon ${className}`;
      return (
        <Icon alt="VideoImage" className={classNames} {...propsRest}>
