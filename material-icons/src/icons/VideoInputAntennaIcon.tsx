import React, { FC } from 'react';
    ...
    export const VideoInputAntennaIcon: FC<IconInterface> = function VideoInputAntennaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoInputAntennaIcon ${className}`;
      return (
        <Icon alt="VideoInputAntenna" className={classNames} {...propsRest}>
