import React, { FC } from 'react';
    ...
    export const VideoInputComponentIcon: FC<IconInterface> = function VideoInputComponentIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoInputComponentIcon ${className}`;
      return (
        <Icon alt="VideoInputComponent" className={classNames} {...propsRest}>
