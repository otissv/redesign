import React, { FC } from 'react';
    ...
    export const VideoInputSvideoIcon: FC<IconInterface> = function VideoInputSvideoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoInputSvideoIcon ${className}`;
      return (
        <Icon alt="VideoInputSvideo" className={classNames} {...propsRest}>
