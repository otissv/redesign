import React, { FC } from 'react';
    ...
    export const VideoOffOutlineIcon: FC<IconInterface> = function VideoOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoOffOutlineIcon ${className}`;
      return (
        <Icon alt="VideoOffOutline" className={classNames} {...propsRest}>
