import React, { FC } from 'react';
    ...
    export const VideoVintageIcon: FC<IconInterface> = function VideoVintageIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoVintageIcon ${className}`;
      return (
        <Icon alt="VideoVintage" className={classNames} {...propsRest}>
