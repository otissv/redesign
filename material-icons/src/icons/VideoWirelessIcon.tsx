import React, { FC } from 'react';
    ...
    export const VideoWirelessIcon: FC<IconInterface> = function VideoWirelessIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoWirelessIcon ${className}`;
      return (
        <Icon alt="VideoWireless" className={classNames} {...propsRest}>
    ...
    VideoWirelessIcon.displayName = 'VideoWirelessIcon';
