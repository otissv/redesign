import React, { FC } from 'react';
    ...
    export const VideoWirelessOutlineIcon: FC<IconInterface> = function VideoWirelessOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VideoWirelessOutlineIcon ${className}`;
      return (
        <Icon alt="VideoWirelessOutline" className={classNames} {...propsRest}>
