import React, { FC } from 'react';
    ...
    export const ViewAgendaIcon: FC<IconInterface> = function ViewAgendaIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ViewAgendaIcon ${className}`;
      return (
        <Icon alt="ViewAgenda" className={classNames} {...propsRest}>
