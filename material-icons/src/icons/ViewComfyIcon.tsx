import React, { FC } from 'react';
    ...
    export const ViewComfyIcon: FC<IconInterface> = function ViewComfyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ViewComfyIcon ${className}`;
      return (
        <Icon alt="ViewComfy" className={classNames} {...propsRest}>
