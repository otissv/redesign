import React, { FC } from 'react';
    ...
    export const ViewComfyOutlineIcon: FC<IconInterface> = function ViewComfyOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ViewComfyOutlineIcon ${className}`;
      return (
        <Icon alt="ViewComfyOutline" className={classNames} {...propsRest}>
    ...
    ViewComfyOutlineIcon.displayName = 'ViewComfyOutlineIcon';
