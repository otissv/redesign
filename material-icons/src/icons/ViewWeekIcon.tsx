import React, { FC } from 'react';
    ...
    export const ViewWeekIcon: FC<IconInterface> = function ViewWeekIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ViewWeekIcon ${className}`;
      return (
        <Icon alt="ViewWeek" className={classNames} {...propsRest}>
