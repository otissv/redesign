import React, { FC } from 'react';
    ...
    export const VirtualRealityIcon: FC<IconInterface> = function VirtualRealityIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VirtualRealityIcon ${className}`;
      return (
        <Icon alt="VirtualReality" className={classNames} {...propsRest}>
