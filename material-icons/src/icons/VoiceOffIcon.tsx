import React, { FC } from 'react';
    ...
    export const VoiceOffIcon: FC<IconInterface> = function VoiceOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VoiceOffIcon ${className}`;
      return (
        <Icon alt="VoiceOff" className={classNames} {...propsRest}>
