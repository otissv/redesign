import React, { FC } from 'react';
    ...
    export const VoteOutlineIcon: FC<IconInterface> = function VoteOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `VoteOutlineIcon ${className}`;
      return (
        <Icon alt="VoteOutline" className={classNames} {...propsRest}>
