import React, { FC } from 'react';
    ...
    export const WalletTravelIcon: FC<IconInterface> = function WalletTravelIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WalletTravelIcon ${className}`;
      return (
        <Icon alt="WalletTravel" className={classNames} {...propsRest}>
