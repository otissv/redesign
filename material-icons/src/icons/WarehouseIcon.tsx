import React, { FC } from 'react';
    ...
    export const WarehouseIcon: FC<IconInterface> = function WarehouseIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WarehouseIcon ${className}`;
      return (
        <Icon alt="Warehouse" className={classNames} {...propsRest}>
