import React, { FC } from 'react';
    ...
    export const WashingMachineAlertIcon: FC<IconInterface> = function WashingMachineAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WashingMachineAlertIcon ${className}`;
      return (
        <Icon alt="WashingMachineAlert" className={classNames} {...propsRest}>
    ...
    WashingMachineAlertIcon.displayName = 'WashingMachineAlertIcon';
