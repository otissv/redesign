import React, { FC } from 'react';
    ...
    export const WashingMachineOffIcon: FC<IconInterface> = function WashingMachineOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WashingMachineOffIcon ${className}`;
      return (
        <Icon alt="WashingMachineOff" className={classNames} {...propsRest}>
    ...
    WashingMachineOffIcon.displayName = 'WashingMachineOffIcon';
