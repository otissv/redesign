import React, { FC } from 'react';
    ...
    export const WatchExportIcon: FC<IconInterface> = function WatchExportIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WatchExportIcon ${className}`;
      return (
        <Icon alt="WatchExport" className={classNames} {...propsRest}>
