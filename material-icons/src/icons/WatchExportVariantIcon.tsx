import React, { FC } from 'react';
    ...
    export const WatchExportVariantIcon: FC<IconInterface> = function WatchExportVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WatchExportVariantIcon ${className}`;
      return (
        <Icon alt="WatchExportVariant" className={classNames} {...propsRest}>
