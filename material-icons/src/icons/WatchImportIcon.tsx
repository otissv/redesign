import React, { FC } from 'react';
    ...
    export const WatchImportIcon: FC<IconInterface> = function WatchImportIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WatchImportIcon ${className}`;
      return (
        <Icon alt="WatchImport" className={classNames} {...propsRest}>
