import React, { FC } from 'react';
    ...
    export const WatchVibrateIcon: FC<IconInterface> = function WatchVibrateIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WatchVibrateIcon ${className}`;
      return (
        <Icon alt="WatchVibrate" className={classNames} {...propsRest}>
