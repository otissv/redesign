import React, { FC } from 'react';
    ...
    export const WatchVibrateOffIcon: FC<IconInterface> = function WatchVibrateOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WatchVibrateOffIcon ${className}`;
      return (
        <Icon alt="WatchVibrateOff" className={classNames} {...propsRest}>
