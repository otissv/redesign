import React, { FC } from 'react';
    ...
    export const WaterOutlineIcon: FC<IconInterface> = function WaterOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WaterOutlineIcon ${className}`;
      return (
        <Icon alt="WaterOutline" className={classNames} {...propsRest}>
    ...
    WaterOutlineIcon.displayName = 'WaterOutlineIcon';
