import React, { FC } from 'react';
    ...
    export const WaterPercentIcon: FC<IconInterface> = function WaterPercentIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WaterPercentIcon ${className}`;
      return (
        <Icon alt="WaterPercent" className={classNames} {...propsRest}>
