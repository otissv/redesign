import React, { FC } from 'react';
    ...
    export const WaterPoloIcon: FC<IconInterface> = function WaterPoloIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WaterPoloIcon ${className}`;
      return (
        <Icon alt="WaterPolo" className={classNames} {...propsRest}>
