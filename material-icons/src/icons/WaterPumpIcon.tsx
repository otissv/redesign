import React, { FC } from 'react';
    ...
    export const WaterPumpIcon: FC<IconInterface> = function WaterPumpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WaterPumpIcon ${className}`;
      return (
        <Icon alt="WaterPump" className={classNames} {...propsRest}>
