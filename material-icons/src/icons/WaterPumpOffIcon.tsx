import React, { FC } from 'react';
    ...
    export const WaterPumpOffIcon: FC<IconInterface> = function WaterPumpOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WaterPumpOffIcon ${className}`;
      return (
        <Icon alt="WaterPumpOff" className={classNames} {...propsRest}>
    ...
    WaterPumpOffIcon.displayName = 'WaterPumpOffIcon';
