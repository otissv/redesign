import React, { FC } from 'react';
    ...
    export const WaterWellOutlineIcon: FC<IconInterface> = function WaterWellOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WaterWellOutlineIcon ${className}`;
      return (
        <Icon alt="WaterWellOutline" className={classNames} {...propsRest}>
    ...
    WaterWellOutlineIcon.displayName = 'WaterWellOutlineIcon';
