import React, { FC } from 'react';
    ...
    export const WateringCanOutlineIcon: FC<IconInterface> = function WateringCanOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WateringCanOutlineIcon ${className}`;
      return (
        <Icon alt="WateringCanOutline" className={classNames} {...propsRest}>
    ...
    WateringCanOutlineIcon.displayName = 'WateringCanOutlineIcon';
