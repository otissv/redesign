import React, { FC } from 'react';
    ...
    export const WaveformIcon: FC<IconInterface> = function WaveformIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WaveformIcon ${className}`;
      return (
        <Icon alt="Waveform" className={classNames} {...propsRest}>
