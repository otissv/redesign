import React, { FC } from 'react';
    ...
    export const WeatherCloudyAlertIcon: FC<IconInterface> = function WeatherCloudyAlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherCloudyAlertIcon ${className}`;
      return (
        <Icon alt="WeatherCloudyAlert" className={classNames} {...propsRest}>
