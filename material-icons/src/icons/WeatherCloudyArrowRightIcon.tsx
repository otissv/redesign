import React, { FC } from 'react';
    ...
    export const WeatherCloudyArrowRightIcon: FC<IconInterface> = function WeatherCloudyArrowRightIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherCloudyArrowRightIcon ${className}`;
      return (
        <Icon alt="WeatherCloudyArrowRight" className={classNames} {...propsRest}>
