import React, { FC } from 'react';
    ...
    export const WeatherFogIcon: FC<IconInterface> = function WeatherFogIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherFogIcon ${className}`;
      return (
        <Icon alt="WeatherFog" className={classNames} {...propsRest}>
