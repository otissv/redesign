import React, { FC } from 'react';
    ...
    export const WeatherHailIcon: FC<IconInterface> = function WeatherHailIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherHailIcon ${className}`;
      return (
        <Icon alt="WeatherHail" className={classNames} {...propsRest}>
