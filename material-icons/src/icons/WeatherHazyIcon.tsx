import React, { FC } from 'react';
    ...
    export const WeatherHazyIcon: FC<IconInterface> = function WeatherHazyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherHazyIcon ${className}`;
      return (
        <Icon alt="WeatherHazy" className={classNames} {...propsRest}>
