import React, { FC } from 'react';
    ...
    export const WeatherLightningIcon: FC<IconInterface> = function WeatherLightningIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherLightningIcon ${className}`;
      return (
        <Icon alt="WeatherLightning" className={classNames} {...propsRest}>
