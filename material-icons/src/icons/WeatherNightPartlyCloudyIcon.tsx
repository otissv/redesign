import React, { FC } from 'react';
    ...
    export const WeatherNightPartlyCloudyIcon: FC<IconInterface> = function WeatherNightPartlyCloudyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherNightPartlyCloudyIcon ${className}`;
      return (
        <Icon alt="WeatherNightPartlyCloudy" className={classNames} {...propsRest}>
