import React, { FC } from 'react';
    ...
    export const WeatherPartlyLightningIcon: FC<IconInterface> = function WeatherPartlyLightningIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherPartlyLightningIcon ${className}`;
      return (
        <Icon alt="WeatherPartlyLightning" className={classNames} {...propsRest}>
