import React, { FC } from 'react';
    ...
    export const WeatherPartlyRainyIcon: FC<IconInterface> = function WeatherPartlyRainyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherPartlyRainyIcon ${className}`;
      return (
        <Icon alt="WeatherPartlyRainy" className={classNames} {...propsRest}>
