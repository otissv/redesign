import React, { FC } from 'react';
    ...
    export const WeatherSnowyRainyIcon: FC<IconInterface> = function WeatherSnowyRainyIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherSnowyRainyIcon ${className}`;
      return (
        <Icon alt="WeatherSnowyRainy" className={classNames} {...propsRest}>
