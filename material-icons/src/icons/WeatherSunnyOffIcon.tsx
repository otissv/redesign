import React, { FC } from 'react';
    ...
    export const WeatherSunnyOffIcon: FC<IconInterface> = function WeatherSunnyOffIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherSunnyOffIcon ${className}`;
      return (
        <Icon alt="WeatherSunnyOff" className={classNames} {...propsRest}>
    ...
    WeatherSunnyOffIcon.displayName = 'WeatherSunnyOffIcon';
