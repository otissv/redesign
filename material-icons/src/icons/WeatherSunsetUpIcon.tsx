import React, { FC } from 'react';
    ...
    export const WeatherSunsetUpIcon: FC<IconInterface> = function WeatherSunsetUpIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherSunsetUpIcon ${className}`;
      return (
        <Icon alt="WeatherSunsetUp" className={classNames} {...propsRest}>
    ...
    WeatherSunsetUpIcon.displayName = 'WeatherSunsetUpIcon';
