import React, { FC } from 'react';
    ...
    export const WeatherWindyVariantIcon: FC<IconInterface> = function WeatherWindyVariantIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeatherWindyVariantIcon ${className}`;
      return (
        <Icon alt="WeatherWindyVariant" className={classNames} {...propsRest}>
