import React, { FC } from 'react';
    ...
    export const WebBoxIcon: FC<IconInterface> = function WebBoxIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WebBoxIcon ${className}`;
      return (
        <Icon alt="WebBox" className={classNames} {...propsRest}>
    ...
    WebBoxIcon.displayName = 'WebBoxIcon';
