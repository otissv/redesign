import React, { FC } from 'react';
    ...
    export const WebClockIcon: FC<IconInterface> = function WebClockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WebClockIcon ${className}`;
      return (
        <Icon alt="WebClock" className={classNames} {...propsRest}>
    ...
    WebClockIcon.displayName = 'WebClockIcon';
