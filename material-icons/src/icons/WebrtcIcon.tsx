import React, { FC } from 'react';
    ...
    export const WebrtcIcon: FC<IconInterface> = function WebrtcIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WebrtcIcon ${className}`;
      return (
        <Icon alt="Webrtc" className={classNames} {...propsRest}>
    ...
    WebrtcIcon.displayName = 'WebrtcIcon';
