import React, { FC } from 'react';
    ...
    export const WeightGramIcon: FC<IconInterface> = function WeightGramIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeightGramIcon ${className}`;
      return (
        <Icon alt="WeightGram" className={classNames} {...propsRest}>
