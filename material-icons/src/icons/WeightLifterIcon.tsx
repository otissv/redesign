import React, { FC } from 'react';
    ...
    export const WeightLifterIcon: FC<IconInterface> = function WeightLifterIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WeightLifterIcon ${className}`;
      return (
        <Icon alt="WeightLifter" className={classNames} {...propsRest}>
    ...
    WeightLifterIcon.displayName = 'WeightLifterIcon';
