import React, { FC } from 'react';
    ...
    export const WhiteBalanceAutoIcon: FC<IconInterface> = function WhiteBalanceAutoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WhiteBalanceAutoIcon ${className}`;
      return (
        <Icon alt="WhiteBalanceAuto" className={classNames} {...propsRest}>
