import React, { FC } from 'react';
    ...
    export const WhiteBalanceIncandescentIcon: FC<IconInterface> = function WhiteBalanceIncandescentIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WhiteBalanceIncandescentIcon ${className}`;
      return (
        <Icon alt="WhiteBalanceIncandescent" className={classNames} {...propsRest}>
