import React, { FC } from 'react';
    ...
    export const WifiStarIcon: FC<IconInterface> = function WifiStarIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WifiStarIcon ${className}`;
      return (
        <Icon alt="WifiStar" className={classNames} {...propsRest}>
