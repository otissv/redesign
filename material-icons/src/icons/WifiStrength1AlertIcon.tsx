import React, { FC } from 'react';
    ...
    export const WifiStrength1AlertIcon: FC<IconInterface> = function WifiStrength1AlertIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WifiStrength1AlertIcon ${className}`;
      return (
        <Icon alt="WifiStrength1Alert" className={classNames} {...propsRest}>
