import React, { FC } from 'react';
    ...
    export const WifiStrength1Icon: FC<IconInterface> = function WifiStrength1Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `WifiStrength1Icon ${className}`;
      return (
        <Icon alt="WifiStrength1" className={classNames} {...propsRest}>
    ...
    WifiStrength1Icon.displayName = 'WifiStrength1Icon';
