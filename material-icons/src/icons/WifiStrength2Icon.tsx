import React, { FC } from 'react';
    ...
    export const WifiStrength2Icon: FC<IconInterface> = function WifiStrength2Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `WifiStrength2Icon ${className}`;
      return (
        <Icon alt="WifiStrength2" className={classNames} {...propsRest}>
