import React, { FC } from 'react';
    ...
    export const WifiStrength3Icon: FC<IconInterface> = function WifiStrength3Icon({
      className,
      ...propsRest
    }) {
      const classNames =  `WifiStrength3Icon ${className}`;
      return (
        <Icon alt="WifiStrength3" className={classNames} {...propsRest}>
    ...
    WifiStrength3Icon.displayName = 'WifiStrength3Icon';
