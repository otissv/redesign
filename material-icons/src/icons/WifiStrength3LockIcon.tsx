import React, { FC } from 'react';
    ...
    export const WifiStrength3LockIcon: FC<IconInterface> = function WifiStrength3LockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WifiStrength3LockIcon ${className}`;
      return (
        <Icon alt="WifiStrength3Lock" className={classNames} {...propsRest}>
