import React, { FC } from 'react';
    ...
    export const WifiStrength4LockIcon: FC<IconInterface> = function WifiStrength4LockIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WifiStrength4LockIcon ${className}`;
      return (
        <Icon alt="WifiStrength4Lock" className={classNames} {...propsRest}>
