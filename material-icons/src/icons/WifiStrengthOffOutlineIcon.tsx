import React, { FC } from 'react';
    ...
    export const WifiStrengthOffOutlineIcon: FC<IconInterface> = function WifiStrengthOffOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WifiStrengthOffOutlineIcon ${className}`;
      return (
        <Icon alt="WifiStrengthOffOutline" className={classNames} {...propsRest}>
    ...
    WifiStrengthOffOutlineIcon.displayName = 'WifiStrengthOffOutlineIcon';
