import React, { FC } from 'react';
    ...
    export const WindTurbineIcon: FC<IconInterface> = function WindTurbineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WindTurbineIcon ${className}`;
      return (
        <Icon alt="WindTurbine" className={classNames} {...propsRest}>
