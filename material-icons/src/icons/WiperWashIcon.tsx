import React, { FC } from 'react';
    ...
    export const WiperWashIcon: FC<IconInterface> = function WiperWashIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WiperWashIcon ${className}`;
      return (
        <Icon alt="WiperWash" className={classNames} {...propsRest}>
