import React, { FC } from 'react';
    ...
    export const WizardHatIcon: FC<IconInterface> = function WizardHatIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WizardHatIcon ${className}`;
      return (
        <Icon alt="WizardHat" className={classNames} {...propsRest}>
    ...
    WizardHatIcon.displayName = 'WizardHatIcon';
