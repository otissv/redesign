import React, { FC } from 'react';
    ...
    export const WrenchOutlineIcon: FC<IconInterface> = function WrenchOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `WrenchOutlineIcon ${className}`;
      return (
        <Icon alt="WrenchOutline" className={classNames} {...propsRest}>
