import React, { FC } from 'react';
    ...
    export const XamarinOutlineIcon: FC<IconInterface> = function XamarinOutlineIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `XamarinOutlineIcon ${className}`;
      return (
        <Icon alt="XamarinOutline" className={classNames} {...propsRest}>
