import React, { FC } from 'react';
    ...
    export const YoutubeStudioIcon: FC<IconInterface> = function YoutubeStudioIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `YoutubeStudioIcon ${className}`;
      return (
        <Icon alt="YoutubeStudio" className={classNames} {...propsRest}>
    ...
    YoutubeStudioIcon.displayName = 'YoutubeStudioIcon';
