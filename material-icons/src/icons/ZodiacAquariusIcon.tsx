import React, { FC } from 'react';
    ...
    export const ZodiacAquariusIcon: FC<IconInterface> = function ZodiacAquariusIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ZodiacAquariusIcon ${className}`;
      return (
        <Icon alt="ZodiacAquarius" className={classNames} {...propsRest}>
