import React, { FC } from 'react';
    ...
    export const ZodiacAriesIcon: FC<IconInterface> = function ZodiacAriesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ZodiacAriesIcon ${className}`;
      return (
        <Icon alt="ZodiacAries" className={classNames} {...propsRest}>
