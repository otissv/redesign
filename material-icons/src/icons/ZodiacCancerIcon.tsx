import React, { FC } from 'react';
    ...
    export const ZodiacCancerIcon: FC<IconInterface> = function ZodiacCancerIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ZodiacCancerIcon ${className}`;
      return (
        <Icon alt="ZodiacCancer" className={classNames} {...propsRest}>
