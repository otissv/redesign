import React, { FC } from 'react';
    ...
    export const ZodiacCapricornIcon: FC<IconInterface> = function ZodiacCapricornIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ZodiacCapricornIcon ${className}`;
      return (
        <Icon alt="ZodiacCapricorn" className={classNames} {...propsRest}>
