import React, { FC } from 'react';
    ...
    export const ZodiacLeoIcon: FC<IconInterface> = function ZodiacLeoIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ZodiacLeoIcon ${className}`;
      return (
        <Icon alt="ZodiacLeo" className={classNames} {...propsRest}>
