import React, { FC } from 'react';
    ...
    export const ZodiacPiscesIcon: FC<IconInterface> = function ZodiacPiscesIcon({
      className,
      ...propsRest
    }) {
      const classNames =  `ZodiacPiscesIcon ${className}`;
      return (
        <Icon alt="ZodiacPisces" className={classNames} {...propsRest}>
