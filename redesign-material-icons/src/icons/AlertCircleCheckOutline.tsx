...
export const AlertCircleCheckOutlineIcon: FC<IconsInterface> = function AlertCircleCheckOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `AlertCircleCheckOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="AlertCircleCheckOutline" className={classNames} {...propsRest}>
...
AlertCircleCheckOutlineIcon.displayName = 'AlertCircleCheckOutlineIcon';  
