...
export const AlertDecagramIcon: FC<IconsInterface> = function AlertDecagramIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `AlertDecagramIcon ${className}`, [className]);

  return (
    <Icon alt="AlertDecagram" className={classNames} {...propsRest}>
...
AlertDecagramIcon.displayName = 'AlertDecagramIcon';  
