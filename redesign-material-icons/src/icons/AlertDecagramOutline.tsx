...
export const AlertDecagramOutlineIcon: FC<IconsInterface> = function AlertDecagramOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `AlertDecagramOutlineIcon ${className}`, [className]);
