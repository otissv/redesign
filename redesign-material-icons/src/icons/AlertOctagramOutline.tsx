...
export const AlertOctagramOutlineIcon: FC<IconsInterface> = function AlertOctagramOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `AlertOctagramOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="AlertOctagramOutline" className={classNames} {...propsRest}>
...
AlertOctagramOutlineIcon.displayName = 'AlertOctagramOutlineIcon';  
