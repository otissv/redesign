...
export const AlertRemoveIcon: FC<IconsInterface> = function AlertRemoveIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `AlertRemoveIcon ${className}`, [className]);

  return (
    <Icon alt="AlertRemove" className={classNames} {...propsRest}>
...
AlertRemoveIcon.displayName = 'AlertRemoveIcon';  
