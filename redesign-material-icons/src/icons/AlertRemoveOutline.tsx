...
export const AlertRemoveOutlineIcon: FC<IconsInterface> = function AlertRemoveOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `AlertRemoveOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="AlertRemoveOutline" className={classNames} {...propsRest}>
...
AlertRemoveOutlineIcon.displayName = 'AlertRemoveOutlineIcon';  
