...
export const AlertRhombusOutlineIcon: FC<IconsInterface> = function AlertRhombusOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `AlertRhombusOutlineIcon ${className}`, [className]);
