...
export const CodeBracesBoxIcon: FC<IconsInterface> = function CodeBracesBoxIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `CodeBracesBoxIcon ${className}`, [className]);

  return (
    <Icon alt="CodeBracesBox" className={classNames} {...propsRest}>
...
CodeBracesBoxIcon.displayName = 'CodeBracesBoxIcon';  
