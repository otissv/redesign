...
export const CodeGreaterThanOrEqualIcon: FC<IconsInterface> = function CodeGreaterThanOrEqualIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `CodeGreaterThanOrEqualIcon ${className}`, [className]);
