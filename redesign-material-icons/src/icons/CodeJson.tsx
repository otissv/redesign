...
export const CodeJsonIcon: FC<IconsInterface> = function CodeJsonIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `CodeJsonIcon ${className}`, [className]);

  return (
    <Icon alt="CodeJson" className={classNames} {...propsRest}>
...
CodeJsonIcon.displayName = 'CodeJsonIcon';  
