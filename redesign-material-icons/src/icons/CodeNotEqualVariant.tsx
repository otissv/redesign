...
export const CodeNotEqualVariantIcon: FC<IconsInterface> = function CodeNotEqualVariantIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `CodeNotEqualVariantIcon ${className}`, [className]);
