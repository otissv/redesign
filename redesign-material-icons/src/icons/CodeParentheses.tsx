...
export const CodeParenthesesIcon: FC<IconsInterface> = function CodeParenthesesIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `CodeParenthesesIcon ${className}`, [className]);

  return (
    <Icon alt="CodeParentheses" className={classNames} {...propsRest}>
