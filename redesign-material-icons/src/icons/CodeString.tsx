...
export const CodeStringIcon: FC<IconsInterface> = function CodeStringIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `CodeStringIcon ${className}`, [className]);

  return (
    <Icon alt="CodeString" className={classNames} {...propsRest}>
