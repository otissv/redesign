...
export const ContentSaveAlertOutlineIcon: FC<IconsInterface> = function ContentSaveAlertOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `ContentSaveAlertOutlineIcon ${className}`, [className]);
