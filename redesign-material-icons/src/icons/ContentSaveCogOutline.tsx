...
export const ContentSaveCogOutlineIcon: FC<IconsInterface> = function ContentSaveCogOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `ContentSaveCogOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="ContentSaveCogOutline" className={classNames} {...propsRest}>
...
ContentSaveCogOutlineIcon.displayName = 'ContentSaveCogOutlineIcon';  
