...
export const ContentSaveEditOutlineIcon: FC<IconsInterface> = function ContentSaveEditOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `ContentSaveEditOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="ContentSaveEditOutline" className={classNames} {...propsRest}>
