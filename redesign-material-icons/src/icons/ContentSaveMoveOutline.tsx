...
export const ContentSaveMoveOutlineIcon: FC<IconsInterface> = function ContentSaveMoveOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `ContentSaveMoveOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="ContentSaveMoveOutline" className={classNames} {...propsRest}>
