...
export const ContentSaveOutlineIcon: FC<IconsInterface> = function ContentSaveOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `ContentSaveOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="ContentSaveOutline" className={classNames} {...propsRest}>
