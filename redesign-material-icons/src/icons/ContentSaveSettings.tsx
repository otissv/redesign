...
export const ContentSaveSettingsIcon: FC<IconsInterface> = function ContentSaveSettingsIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `ContentSaveSettingsIcon ${className}`, [className]);
