...
export const ContentSaveSettingsOutlineIcon: FC<IconsInterface> = function ContentSaveSettingsOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `ContentSaveSettingsOutlineIcon ${className}`, [className]);
