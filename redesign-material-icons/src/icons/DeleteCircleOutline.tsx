...
export const DeleteCircleOutlineIcon: FC<IconsInterface> = function DeleteCircleOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `DeleteCircleOutlineIcon ${className}`, [className]);
