...
export const DeleteOffOutlineIcon: FC<IconsInterface> = function DeleteOffOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `DeleteOffOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="DeleteOffOutline" className={classNames} {...propsRest}>
...
DeleteOffOutlineIcon.displayName = 'DeleteOffOutlineIcon';  
