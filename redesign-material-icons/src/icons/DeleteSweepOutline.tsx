...
export const DeleteSweepOutlineIcon: FC<IconsInterface> = function DeleteSweepOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `DeleteSweepOutlineIcon ${className}`, [className]);
