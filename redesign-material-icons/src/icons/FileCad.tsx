...
export const FileCadIcon: FC<IconsInterface> = function FileCadIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileCadIcon ${className}`, [className]);

  return (
    <Icon alt="FileCad" className={classNames} {...propsRest}>
