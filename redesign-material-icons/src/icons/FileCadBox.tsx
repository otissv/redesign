...
export const FileCadBoxIcon: FC<IconsInterface> = function FileCadBoxIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileCadBoxIcon ${className}`, [className]);

  return (
    <Icon alt="FileCadBox" className={classNames} {...propsRest}>
