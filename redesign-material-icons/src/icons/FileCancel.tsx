...
export const FileCancelIcon: FC<IconsInterface> = function FileCancelIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileCancelIcon ${className}`, [className]);

  return (
    <Icon alt="FileCancel" className={classNames} {...propsRest}>
