...
export const FileCancelOutlineIcon: FC<IconsInterface> = function FileCancelOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileCancelOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileCancelOutline" className={classNames} {...propsRest}>
