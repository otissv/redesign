...
export const FileCertificateOutlineIcon: FC<IconsInterface> = function FileCertificateOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileCertificateOutlineIcon ${className}`, [className]);
