...
export const FileCloudOutlineIcon: FC<IconsInterface> = function FileCloudOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileCloudOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileCloudOutline" className={classNames} {...propsRest}>
...
FileCloudOutlineIcon.displayName = 'FileCloudOutlineIcon';  
