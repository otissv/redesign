...
export const FileCogOutlineIcon: FC<IconsInterface> = function FileCogOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileCogOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileCogOutline" className={classNames} {...propsRest}>
...
FileCogOutlineIcon.displayName = 'FileCogOutlineIcon';  
