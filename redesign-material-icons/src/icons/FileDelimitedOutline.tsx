...
export const FileDelimitedOutlineIcon: FC<IconsInterface> = function FileDelimitedOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileDelimitedOutlineIcon ${className}`, [className]);
