...
export const FileDocumentEditOutlineIcon: FC<IconsInterface> = function FileDocumentEditOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileDocumentEditOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileDocumentEditOutline" className={classNames} {...propsRest}>
...
FileDocumentEditOutlineIcon.displayName = 'FileDocumentEditOutlineIcon';  
