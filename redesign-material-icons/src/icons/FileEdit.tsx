...
export const FileEditIcon: FC<IconsInterface> = function FileEditIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileEditIcon ${className}`, [className]);

  return (
    <Icon alt="FileEdit" className={classNames} {...propsRest}>
