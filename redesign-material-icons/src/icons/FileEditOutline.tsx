...
export const FileEditOutlineIcon: FC<IconsInterface> = function FileEditOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileEditOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileEditOutline" className={classNames} {...propsRest}>
...
FileEditOutlineIcon.displayName = 'FileEditOutlineIcon';  
