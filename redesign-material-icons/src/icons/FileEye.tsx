...
export const FileEyeIcon: FC<IconsInterface> = function FileEyeIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileEyeIcon ${className}`, [className]);

  return (
    <Icon alt="FileEye" className={classNames} {...propsRest}>
