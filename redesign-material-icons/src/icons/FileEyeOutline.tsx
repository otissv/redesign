...
export const FileEyeOutlineIcon: FC<IconsInterface> = function FileEyeOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileEyeOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileEyeOutline" className={classNames} {...propsRest}>
