...
export const FileFindOutlineIcon: FC<IconsInterface> = function FileFindOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileFindOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileFindOutline" className={classNames} {...propsRest}>
