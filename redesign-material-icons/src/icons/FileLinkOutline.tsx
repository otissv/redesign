...
export const FileLinkOutlineIcon: FC<IconsInterface> = function FileLinkOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileLinkOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileLinkOutline" className={classNames} {...propsRest}>
...
FileLinkOutlineIcon.displayName = 'FileLinkOutlineIcon';  
