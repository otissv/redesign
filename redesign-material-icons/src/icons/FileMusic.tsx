...
export const FileMusicIcon: FC<IconsInterface> = function FileMusicIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileMusicIcon ${className}`, [className]);

  return (
    <Icon alt="FileMusic" className={classNames} {...propsRest}>
