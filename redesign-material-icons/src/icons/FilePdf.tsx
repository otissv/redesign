...
export const FilePdfIcon: FC<IconsInterface> = function FilePdfIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FilePdfIcon ${className}`, [className]);

  return (
    <Icon alt="FilePdf" className={classNames} {...propsRest}>
