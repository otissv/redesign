...
export const FilePdfBoxIcon: FC<IconsInterface> = function FilePdfBoxIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FilePdfBoxIcon ${className}`, [className]);

  return (
    <Icon alt="FilePdfBox" className={classNames} {...propsRest}>
