...
export const FilePercentOutlineIcon: FC<IconsInterface> = function FilePercentOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FilePercentOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FilePercentOutline" className={classNames} {...propsRest}>
...
FilePercentOutlineIcon.displayName = 'FilePercentOutlineIcon';  
