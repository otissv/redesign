...
export const FilePhoneOutlineIcon: FC<IconsInterface> = function FilePhoneOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FilePhoneOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FilePhoneOutline" className={classNames} {...propsRest}>
...
FilePhoneOutlineIcon.displayName = 'FilePhoneOutlineIcon';  
