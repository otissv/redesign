...
export const FilePowerpointIcon: FC<IconsInterface> = function FilePowerpointIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FilePowerpointIcon ${className}`, [className]);

  return (
    <Icon alt="FilePowerpoint" className={classNames} {...propsRest}>
