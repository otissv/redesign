...
export const FilePowerpointOutlineIcon: FC<IconsInterface> = function FilePowerpointOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FilePowerpointOutlineIcon ${className}`, [className]);
