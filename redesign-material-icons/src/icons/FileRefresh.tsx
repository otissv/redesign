...
export const FileRefreshIcon: FC<IconsInterface> = function FileRefreshIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileRefreshIcon ${className}`, [className]);

  return (
    <Icon alt="FileRefresh" className={classNames} {...propsRest}>
...
FileRefreshIcon.displayName = 'FileRefreshIcon';  
