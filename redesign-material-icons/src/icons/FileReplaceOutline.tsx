...
export const FileReplaceOutlineIcon: FC<IconsInterface> = function FileReplaceOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileReplaceOutlineIcon ${className}`, [className]);
