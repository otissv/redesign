...
export const FileRestoreOutlineIcon: FC<IconsInterface> = function FileRestoreOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileRestoreOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileRestoreOutline" className={classNames} {...propsRest}>
...
FileRestoreOutlineIcon.displayName = 'FileRestoreOutlineIcon';  
