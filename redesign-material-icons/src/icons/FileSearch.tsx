...
export const FileSearchIcon: FC<IconsInterface> = function FileSearchIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileSearchIcon ${className}`, [className]);

  return (
    <Icon alt="FileSearch" className={classNames} {...propsRest}>
