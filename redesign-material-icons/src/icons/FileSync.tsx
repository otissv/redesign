...
export const FileSyncIcon: FC<IconsInterface> = function FileSyncIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileSyncIcon ${className}`, [className]);

  return (
    <Icon alt="FileSync" className={classNames} {...propsRest}>
