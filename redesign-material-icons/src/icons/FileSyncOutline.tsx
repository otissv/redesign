...
export const FileSyncOutlineIcon: FC<IconsInterface> = function FileSyncOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileSyncOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="FileSyncOutline" className={classNames} {...propsRest}>
...
FileSyncOutlineIcon.displayName = 'FileSyncOutlineIcon';  
