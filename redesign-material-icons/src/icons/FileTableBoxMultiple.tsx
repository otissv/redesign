...
export const FileTableBoxMultipleIcon: FC<IconsInterface> = function FileTableBoxMultipleIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileTableBoxMultipleIcon ${className}`, [className]);
