...
export const FileWordIcon: FC<IconsInterface> = function FileWordIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `FileWordIcon ${className}`, [className]);

  return (
    <Icon alt="FileWord" className={classNames} {...propsRest}>
