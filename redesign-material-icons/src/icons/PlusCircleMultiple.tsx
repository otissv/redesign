...
export const PlusCircleMultipleIcon: FC<IconsInterface> = function PlusCircleMultipleIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `PlusCircleMultipleIcon ${className}`, [className]);
