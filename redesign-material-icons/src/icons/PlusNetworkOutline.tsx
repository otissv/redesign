...
export const PlusNetworkOutlineIcon: FC<IconsInterface> = function PlusNetworkOutlineIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `PlusNetworkOutlineIcon ${className}`, [className]);

  return (
    <Icon alt="PlusNetworkOutline" className={classNames} {...propsRest}>
