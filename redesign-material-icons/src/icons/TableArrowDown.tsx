...
export const TableArrowDownIcon: FC<IconsInterface> = function TableArrowDownIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableArrowDownIcon ${className}`, [className]);

  return (
    <Icon alt="TableArrowDown" className={classNames} {...propsRest}>
...
TableArrowDownIcon.displayName = 'TableArrowDownIcon';  
