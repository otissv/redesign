...
export const TableArrowLeftIcon: FC<IconsInterface> = function TableArrowLeftIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableArrowLeftIcon ${className}`, [className]);

  return (
    <Icon alt="TableArrowLeft" className={classNames} {...propsRest}>
...
TableArrowLeftIcon.displayName = 'TableArrowLeftIcon';  
