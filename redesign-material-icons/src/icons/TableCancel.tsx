...
export const TableCancelIcon: FC<IconsInterface> = function TableCancelIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableCancelIcon ${className}`, [className]);

  return (
    <Icon alt="TableCancel" className={classNames} {...propsRest}>
...
TableCancelIcon.displayName = 'TableCancelIcon';  
