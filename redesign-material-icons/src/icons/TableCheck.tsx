...
export const TableCheckIcon: FC<IconsInterface> = function TableCheckIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableCheckIcon ${className}`, [className]);

  return (
    <Icon alt="TableCheck" className={classNames} {...propsRest}>
...
TableCheckIcon.displayName = 'TableCheckIcon';  
