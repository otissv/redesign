...
export const TableClockIcon: FC<IconsInterface> = function TableClockIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableClockIcon ${className}`, [className]);

  return (
    <Icon alt="TableClock" className={classNames} {...propsRest}>
