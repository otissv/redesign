...
export const TableColumnPlusBeforeIcon: FC<IconsInterface> = function TableColumnPlusBeforeIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableColumnPlusBeforeIcon ${className}`, [className]);
