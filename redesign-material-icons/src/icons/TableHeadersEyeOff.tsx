...
export const TableHeadersEyeOffIcon: FC<IconsInterface> = function TableHeadersEyeOffIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableHeadersEyeOffIcon ${className}`, [className]);

  return (
    <Icon alt="TableHeadersEyeOff" className={classNames} {...propsRest}>
...
TableHeadersEyeOffIcon.displayName = 'TableHeadersEyeOffIcon';  
