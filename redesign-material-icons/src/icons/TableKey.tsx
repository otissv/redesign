...
export const TableKeyIcon: FC<IconsInterface> = function TableKeyIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableKeyIcon ${className}`, [className]);

  return (
    <Icon alt="TableKey" className={classNames} {...propsRest}>
...
TableKeyIcon.displayName = 'TableKeyIcon';  
