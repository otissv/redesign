...
export const TableRefreshIcon: FC<IconsInterface> = function TableRefreshIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableRefreshIcon ${className}`, [className]);

  return (
    <Icon alt="TableRefresh" className={classNames} {...propsRest}>
...
TableRefreshIcon.displayName = 'TableRefreshIcon';  
