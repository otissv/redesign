...
export const TableRowPlusBeforeIcon: FC<IconsInterface> = function TableRowPlusBeforeIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableRowPlusBeforeIcon ${className}`, [className]);
