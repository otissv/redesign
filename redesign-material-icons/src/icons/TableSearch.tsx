...
export const TableSearchIcon: FC<IconsInterface> = function TableSearchIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableSearchIcon ${className}`, [className]);

  return (
    <Icon alt="TableSearch" className={classNames} {...propsRest}>
