...
export const TableSyncIcon: FC<IconsInterface> = function TableSyncIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableSyncIcon ${className}`, [className]);

  return (
    <Icon alt="TableSync" className={classNames} {...propsRest}>
...
TableSyncIcon.displayName = 'TableSyncIcon';  
