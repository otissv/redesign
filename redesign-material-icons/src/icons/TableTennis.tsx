...
export const TableTennisIcon: FC<IconsInterface> = function TableTennisIcon({
  className,
  ...propsRest
}) {

  const classNames = useMemo(() => `TableTennisIcon ${className}`, [className]);

  return (
    <Icon alt="TableTennis" className={classNames} {...propsRest}>
