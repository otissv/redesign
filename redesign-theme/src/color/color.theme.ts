...
>(theme?: P): T {
  ...
  const colors: ColorInterface = {
    ...
    default: _swatches[`${color['disabled']}_400`],
    default2: _swatches[`${color['disabled']}_500`],
    default_050: _swatches[`${color['disabled']}_050`],
    default_100: _swatches[`${color['disabled']}_100`],
    default_200: _swatches[`${color['disabled']}_200`],
    default_300: _swatches[`${color['disabled']}_300`],
    default_400: _swatches[`${color['disabled']}_400`],
    default_500: _swatches[`${color['disabled']}_500`],
    default_600: _swatches[`${color['disabled']}_600`],
    default_700: _swatches[`${color['disabled']}_700`],
    default_800: _swatches[`${color['disabled']}_800`],
    default_900: _swatches[`${color['disabled']}_900`],

    grey: _swatches[`${color['grey']}_400`],
    ...
    active: _swatches[`${color['active']}_400`],
    ...
    accent: _swatches[`${color['accent']}_400`],
    ...
    action: _swatches[`${color['action']}_400`],
    ...
    danger: _swatches[`${color['danger']}_400`],
    ...
    error: _swatches[`${color['error']}_400`],
    ...
    warning: _swatches[`${color['warning']}_400`],
    ...
    success: _swatches[`${color['success']}_400`],
    ...
    disabled: _swatches[`${color['disabled']}_400`],
