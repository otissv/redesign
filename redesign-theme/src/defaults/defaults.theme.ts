...
import { UtilityInterface } from '../utility';
...
export const utilityThemeDefaults: UtilityInterface = {
  ...
  border: (_value: string) => ({ border: '' }),
  borderBottom: (_value: string) => ({ borderBottom: '' }),
  borderLeft: (_value: string) => ({ borderLeft: '' }),
  borderRight: (_value: string) => ({ borderRight: '' }),
  borderTop: (_value: string) => ({ borderTop: '' }),
  borderY: (_value: string) => ({ borderTop: '', borderBottom: '' }),
  borderX: (_value: string) => ({ borderRight: '', borderLeft: '' }),
  b: (_value: string) => ({ border: '' }),
  bb: (_value: string) => ({ borderBottom: '' }),
  bl: (_value: string) => ({ borderLeft: '' }),
  br: (_value: string) => ({ borderRight: '' }),
  bt: (_value: string) => ({ borderTop: '' }),
  by: (_value: string) => ({ borderTop: '', borderBottom: '' }),
  bx: (_value: string) => ({ borderRight: '', borderLeft: '' }),
  radius: (_value: string) => ({
    borderRadius: '',
  }),
  borderBottomRadius: (_value: string) => ({ borderBottomRadius: '' }),
  borderLeftRadius: (_value: string) => ({ borderLeftRadius: '' }),
  borderRightRadius: (_value: string) => ({ borderRightRadius: '' }),
  borderTopRadius: (_value: string) => ({ borderTopRadius: '' }),
  borderYRadius: (_value: string) => ({
    borderTopRadius: '',
    borderBottomRadius: '',
  }),
  borderXRadius: (_value: string) => ({
    borderRightRadius: '',
    borderLeftRadius: '',
  }),
  r: (_value: string) => ({
  ...
  rb: (_value: string) => ({ borderBottomRadius: '' }),
  rl: (_value: string) => ({ borderLeftRadius: '' }),
  rr: (_value: string) => ({ borderRightRadius: '' }),
  rt: (_value: string) => ({ borderTopRadius: '' }),
  ry: (_value: string) => ({
    borderTopRadius: '',
    borderBottomRadius: '',
  }),
  ...
  flexGrow: (_value: string) => ({ flexGrow: '' }),
  order: (_value: string) => ({ order: '' }),
  display: (_value: string) => ({ display: '' }),
  f: (_value: string) => ({ flex: '' }),
  fg: (_value: string) => ({ flexGrow: '' }),
  o: (_value: string) => ({ order: '' }),
  d: (_value: string) => ({ display: '' }),

  widthSize: (_value: string) => ({ width: '' }),
  w: (_value: string) => ({ width: '' }),
};
