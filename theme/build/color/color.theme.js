...
function colorTheme(theme) {
    ...
    var colors = tslib_1.__assign(tslib_1.__assign({ black: '#000', white: '#fff', transparent: 'rgba(0, 0, 0, 0)', outline: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.outline) || '#006dea', text: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.text) || _swatches[color['text']], textInvert: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.textInvert) || _swatches[color['textInvert']], linkText: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkText) || '#4ea1f3', linkTextHover: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkTextHover) || '#4ea1f3', linkTextActive: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkTextActive) || '#4ea1f3', linkTextFocus: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkTextFocus) || '#4ea1f3', linkTextVisited: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkTextVisited) || '#4ea1f3', linkBackground: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkBackground) || '#4ea1f3', linkBackgroundHover: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkBackgroundHover) || '#4ea1f3', linkBackgroundActive: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkBackgroundActive) || '#4ea1f3', linkBackgroundFocus: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkBackgroundFocus) || '#4ea1f3', linkBackgroundVisited: (colorDefaults === null || colorDefaults === void 0 ? void 0 : colorDefaults.linkBackgroundVisited) || '#4ea1f3', background: getColor({
