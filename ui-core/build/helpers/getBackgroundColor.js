import { PRIMARY, ACCENT, ACTIVE, ACTION, DANGER, ERROR, SUCCESS, WARNING, DISABLED } from '@redesign-system/theme';
export function getBackgroundColor(param) {
    var appearance = param.appearance, color = param.color;
    switch(appearance){
        case ACCENT:
            {
                return {
